...
xref:../README.adoc[NativeScript] / xref:../modules.adoc[Exports] / Button
...
* link:Button.adoc#constructor[constructor]

=== Properties

* link:Button.adoc#_androidcontentdescriptionupdated[_androidContentDescriptionUpdated]
* link:Button.adoc#_automaticallyadjustsscrollviewinsets[_automaticallyAdjustsScrollViewInsets]
* link:Button.adoc#_closemodalcallback[_closeModalCallback]
* link:Button.adoc#_context[_context]
* link:Button.adoc#_cssstate[_cssState]
* link:Button.adoc#_currentheightmeasurespec[_currentHeightMeasureSpec]
* link:Button.adoc#_currentwidthmeasurespec[_currentWidthMeasureSpec]
* link:Button.adoc#_defaultpaddingbottom[_defaultPaddingBottom]
* link:Button.adoc#_defaultpaddingleft[_defaultPaddingLeft]
* link:Button.adoc#_defaultpaddingright[_defaultPaddingRight]
* link:Button.adoc#_defaultpaddingtop[_defaultPaddingTop]
* link:Button.adoc#_domid[_domId]
* link:Button.adoc#_gestureobservers[_gestureObservers]
* link:Button.adoc#_ignoreflexminwidthheightreset[_ignoreFlexMinWidthHeightReset]
* link:Button.adoc#_isaddedtonativevisualtree[_isAddedToNativeVisualTree]
* link:Button.adoc#_islayoutvalid[_isLayoutValid]
* link:Button.adoc#_ispaddingrelative[_isPaddingRelative]
* link:Button.adoc#_issingleline[_isSingleLine]
* link:Button.adoc#_isstylescopehost[_isStyleScopeHost]
* link:Button.adoc#_isviewbase[_isViewBase]
* link:Button.adoc#_manager[_manager]
* link:Button.adoc#_modalparent[_modalParent]
* link:Button.adoc#_modulename[_moduleName]
* link:Button.adoc#_oldbottom[_oldBottom]
* link:Button.adoc#_oldleft[_oldLeft]
* link:Button.adoc#_oldright[_oldRight]
* link:Button.adoc#_oldtop[_oldTop]
* link:Button.adoc#_stylescope[_styleScope]
* link:Button.adoc#_suspendnativeupdatescount[_suspendNativeUpdatesCount]
* link:Button.adoc#_suspendedupdates[_suspendedUpdates]
* link:Button.adoc#accessibilityhidden[accessibilityHidden]
* link:Button.adoc#accessibilityhint[accessibilityHint]
* link:Button.adoc#accessibilityidentifier[accessibilityIdentifier]
* link:Button.adoc#accessibilitylabel[accessibilityLabel]
* link:Button.adoc#accessibilitylanguage[accessibilityLanguage]
* link:Button.adoc#accessibilityliveregion[accessibilityLiveRegion]
* link:Button.adoc#accessibilitymediasession[accessibilityMediaSession]
* link:Button.adoc#accessibilityrole[accessibilityRole]
* link:Button.adoc#accessibilitystate[accessibilityState]
* link:Button.adoc#accessibilityvalue[accessibilityValue]
* link:Button.adoc#accessible[accessible]
* link:Button.adoc#alignself[alignSelf]
* link:Button.adoc#android[android]
* link:Button.adoc#androiddynamicelevationoffset[androidDynamicElevationOffset]
* link:Button.adoc#androidelevation[androidElevation]
* link:Button.adoc#automationtext[automationText]
* link:Button.adoc#background[background]
* link:Button.adoc#backgroundcolor[backgroundColor]
* link:Button.adoc#backgroundimage[backgroundImage]
* link:Button.adoc#bindingcontext[bindingContext]
* link:Button.adoc#borderbottomcolor[borderBottomColor]
* link:Button.adoc#borderbottomleftradius[borderBottomLeftRadius]
* link:Button.adoc#borderbottomrightradius[borderBottomRightRadius]
* link:Button.adoc#borderbottomwidth[borderBottomWidth]
* link:Button.adoc#bordercolor[borderColor]
* link:Button.adoc#borderleftcolor[borderLeftColor]
* link:Button.adoc#borderleftwidth[borderLeftWidth]
* link:Button.adoc#borderradius[borderRadius]
* link:Button.adoc#borderrightcolor[borderRightColor]
* link:Button.adoc#borderrightwidth[borderRightWidth]
* link:Button.adoc#bordertopcolor[borderTopColor]
* link:Button.adoc#bordertopleftradius[borderTopLeftRadius]
* link:Button.adoc#bordertoprightradius[borderTopRightRadius]
* link:Button.adoc#bordertopwidth[borderTopWidth]
* link:Button.adoc#borderwidth[borderWidth]
* link:Button.adoc#boxshadow[boxShadow]
* link:Button.adoc#classname[className]
* link:Button.adoc#col[col]
* link:Button.adoc#colspan[colSpan]
* link:Button.adoc#color[color]
* link:Button.adoc#column[column]
* link:Button.adoc#columnspan[columnSpan]
* link:Button.adoc#css[css]
* link:Button.adoc#cssclasses[cssClasses]
* link:Button.adoc#csspseudoclasses[cssPseudoClasses]
* link:Button.adoc#csstype[cssType]
* link:Button.adoc#dock[dock]
* link:Button.adoc#domnode[domNode]
* link:Button.adoc#effectiveborderbottomwidth[effectiveBorderBottomWidth]
* link:Button.adoc#effectiveborderleftwidth[effectiveBorderLeftWidth]
* link:Button.adoc#effectiveborderrightwidth[effectiveBorderRightWidth]
* link:Button.adoc#effectivebordertopwidth[effectiveBorderTopWidth]
* link:Button.adoc#effectiveheight[effectiveHeight]
* link:Button.adoc#effectiveleft[effectiveLeft]
* link:Button.adoc#effectivemarginbottom[effectiveMarginBottom]
* link:Button.adoc#effectivemarginleft[effectiveMarginLeft]
* link:Button.adoc#effectivemarginright[effectiveMarginRight]
* link:Button.adoc#effectivemargintop[effectiveMarginTop]
* link:Button.adoc#effectiveminheight[effectiveMinHeight]
* link:Button.adoc#effectiveminwidth[effectiveMinWidth]
* link:Button.adoc#effectivepaddingbottom[effectivePaddingBottom]
* link:Button.adoc#effectivepaddingleft[effectivePaddingLeft]
* link:Button.adoc#effectivepaddingright[effectivePaddingRight]
* link:Button.adoc#effectivepaddingtop[effectivePaddingTop]
* link:Button.adoc#effectivetop[effectiveTop]
* link:Button.adoc#effectivewidth[effectiveWidth]
* link:Button.adoc#flexgrow[flexGrow]
* link:Button.adoc#flexshrink[flexShrink]
* link:Button.adoc#flexwrapbefore[flexWrapBefore]
* link:Button.adoc#fontsize[fontSize]
* link:Button.adoc#formattedtext[formattedText]
* link:Button.adoc#height[height]
* link:Button.adoc#horizontalalignment[horizontalAlignment]
* link:Button.adoc#id[id]
* link:Button.adoc#ignoretouchanimation[ignoreTouchAnimation]
* link:Button.adoc#ios[ios]
* link:Button.adoc#iosignoresafearea[iosIgnoreSafeArea]
* link:Button.adoc#iosoverflowsafearea[iosOverflowSafeArea]
* link:Button.adoc#iosoverflowsafeareaenabled[iosOverflowSafeAreaEnabled]
* link:Button.adoc#iscollapsed[isCollapsed]
* link:Button.adoc#isenabled[isEnabled]
* link:Button.adoc#islayoutrequired[isLayoutRequired]
* link:Button.adoc#islayoutvalid[isLayoutValid]
* link:Button.adoc#isuserinteractionenabled[isUserInteractionEnabled]
* link:Button.adoc#left[left]
* link:Button.adoc#letterspacing[letterSpacing]
* link:Button.adoc#lineheight[lineHeight]
* link:Button.adoc#margin[margin]
* link:Button.adoc#marginbottom[marginBottom]
* link:Button.adoc#marginleft[marginLeft]
* link:Button.adoc#marginright[marginRight]
* link:Button.adoc#margintop[marginTop]
* link:Button.adoc#maxlines[maxLines]
* link:Button.adoc#minheight[minHeight]
* link:Button.adoc#minwidth[minWidth]
* link:Button.adoc#modal[modal]
* link:Button.adoc#nativetextviewprotected[nativeTextViewProtected]
* link:Button.adoc#nativeviewprotected[nativeViewProtected]
* link:Button.adoc#opacity[opacity]
* link:Button.adoc#order[order]
* link:Button.adoc#originx[originX]
* link:Button.adoc#originy[originY]
* link:Button.adoc#padding[padding]
* link:Button.adoc#paddingbottom[paddingBottom]
* link:Button.adoc#paddingleft[paddingLeft]
* link:Button.adoc#paddingright[paddingRight]
* link:Button.adoc#paddingtop[paddingTop]
* link:Button.adoc#parent[parent]
* link:Button.adoc#perspective[perspective]
* link:Button.adoc#recyclenativeview[recycleNativeView]
* link:Button.adoc#reusable[reusable]
* link:Button.adoc#rotate[rotate]
* link:Button.adoc#rotatex[rotateX]
* link:Button.adoc#rotatey[rotateY]
* link:Button.adoc#row[row]
* link:Button.adoc#rowspan[rowSpan]
* link:Button.adoc#scalex[scaleX]
* link:Button.adoc#scaley[scaleY]
* link:Button.adoc#testid[testID]
* link:Button.adoc#text[text]
* link:Button.adoc#textalignment[textAlignment]
* link:Button.adoc#textdecoration[textDecoration]
* link:Button.adoc#textshadow[textShadow]
* link:Button.adoc#texttransform[textTransform]
* link:Button.adoc#textwrap[textWrap]
* link:Button.adoc#top[top]
* link:Button.adoc#touchanimation[touchAnimation]
* link:Button.adoc#touchdelay[touchDelay]
* link:Button.adoc#translatex[translateX]
* link:Button.adoc#translatey[translateY]
* link:Button.adoc#verticalalignment[verticalAlignment]
* link:Button.adoc#viewcontroller[viewController]
* link:Button.adoc#visibility[visibility]
* link:Button.adoc#whitespace[whiteSpace]
* link:Button.adoc#width[width]
* link:Button.adoc#accessibilityblurevent[accessibilityBlurEvent]
* link:Button.adoc#accessibilityfocuschangedevent[accessibilityFocusChangedEvent]
* link:Button.adoc#accessibilityfocusevent[accessibilityFocusEvent]
* link:Button.adoc#accessibilityperformescapeevent[accessibilityPerformEscapeEvent]
* link:Button.adoc#createdevent[createdEvent]
* link:Button.adoc#disposenativeviewevent[disposeNativeViewEvent]
* link:Button.adoc#layoutchangedevent[layoutChangedEvent]
* link:Button.adoc#loadedevent[loadedEvent]
* link:Button.adoc#propertychangeevent[propertyChangeEvent]
* link:Button.adoc#showingmodallyevent[showingModallyEvent]
* link:Button.adoc#shownmodallyevent[shownModallyEvent]
* link:Button.adoc#tapevent[tapEvent]
* link:Button.adoc#unloadedevent[unloadedEvent]

=== Accessors

* link:Button.adoc#backgroundposition[backgroundPosition]
* link:Button.adoc#backgroundrepeat[backgroundRepeat]
* link:Button.adoc#backgroundsize[backgroundSize]
* link:Button.adoc#class[class]
* link:Button.adoc#isloaded[isLoaded]
* link:Button.adoc#nativeview[nativeView]
* link:Button.adoc#page[page]
* link:Button.adoc#parentnode[parentNode]
* link:Button.adoc#style[style]
* link:Button.adoc#typename[typeName]

=== Methods

* link:Button.adoc#_addchildfrombuilder[_addChildFromBuilder]
* link:Button.adoc#_addview[_addView]
* link:Button.adoc#_addviewcore[_addViewCore]
* link:Button.adoc#_addviewtonativevisualtree[_addViewToNativeVisualTree]
* link:Button.adoc#_applybackground[_applyBackground]
* link:Button.adoc#_applyxmlattribute[_applyXmlAttribute]
* link:Button.adoc#_batchupdate[_batchUpdate]
* link:Button.adoc#_childindextonativechildindex[_childIndexToNativeChildIndex]
* link:Button.adoc#_closeallmodalviewsinternal[_closeAllModalViewsInternal]
* link:Button.adoc#_createpropertychangedata[_createPropertyChangeData]
* link:Button.adoc#_dialogclosed[_dialogClosed]
* link:Button.adoc#_eachlayoutview[_eachLayoutView]
* link:Button.adoc#_emit[_emit]
* link:Button.adoc#_getcurrentlayoutbounds[_getCurrentLayoutBounds]
* link:Button.adoc#_getfragmentmanager[_getFragmentManager]
* link:Button.adoc#_getnativeviewscount[_getNativeViewsCount]
* link:Button.adoc#_getrootmodalviews[_getRootModalViews]
* link:Button.adoc#_getvalue[_getValue]
* link:Button.adoc#_gotovisualstate[_goToVisualState]
* link:Button.adoc#_handlelivesync[_handleLivesync]
* link:Button.adoc#_hasancestorview[_hasAncestorView]
* link:Button.adoc#_hidenativemodalview[_hideNativeModalView]
* link:Button.adoc#_inheritstylescope[_inheritStyleScope]
* link:Button.adoc#_layoutparent[_layoutParent]
* link:Button.adoc#_observe[_observe]
* link:Button.adoc#_onattachedtowindow[_onAttachedToWindow]
* link:Button.adoc#_oncssstatechange[_onCssStateChange]
* link:Button.adoc#_ondetachedfromwindow[_onDetachedFromWindow]
* link:Button.adoc#_onlivesync[_onLivesync]
* link:Button.adoc#_onrootviewreset[_onRootViewReset]
* link:Button.adoc#_onsizechanged[_onSizeChanged]
* link:Button.adoc#_parentchanged[_parentChanged]
* link:Button.adoc#_raiselayoutchangedevent[_raiseLayoutChangedEvent]
* link:Button.adoc#_raiseshowingmodallyevent[_raiseShowingModallyEvent]
* link:Button.adoc#_raiseshownmodallyevent[_raiseShownModallyEvent]
* link:Button.adoc#_redrawnativebackground[_redrawNativeBackground]
* link:Button.adoc#_removeanimation[_removeAnimation]
* link:Button.adoc#_removeview[_removeView]
* link:Button.adoc#_removeviewcore[_removeViewCore]
* link:Button.adoc#_removeviewfromnativevisualtree[_removeViewFromNativeVisualTree]
* link:Button.adoc#_requestlayoutontextchanged[_requestLayoutOnTextChanged]
* link:Button.adoc#_resumenativeupdates[_resumeNativeUpdates]
* link:Button.adoc#_setcurrentlayoutbounds[_setCurrentLayoutBounds]
* link:Button.adoc#_setcurrentmeasurespecs[_setCurrentMeasureSpecs]
* link:Button.adoc#_setminheightnative[_setMinHeightNative]
* link:Button.adoc#_setminwidthnative[_setMinWidthNative]
* link:Button.adoc#_setnativecliptobounds[_setNativeClipToBounds]
* link:Button.adoc#_setnativetext[_setNativeText]
* link:Button.adoc#_setnativeviewframe[_setNativeViewFrame]
* link:Button.adoc#_setvalue[_setValue]
* link:Button.adoc#_setupasrootview[_setupAsRootView]
* link:Button.adoc#_setupui[_setupUI]
* link:Button.adoc#_shoulddelaylayout[_shouldDelayLayout]
* link:Button.adoc#_shownativemodalview[_showNativeModalView]
* link:Button.adoc#_suspendnativeupdates[_suspendNativeUpdates]
* link:Button.adoc#_teardownui[_tearDownUI]
* link:Button.adoc#_updateeffectivelayoutvalues[_updateEffectiveLayoutValues]
* link:Button.adoc#_updatestylescope[_updateStyleScope]
* link:Button.adoc#accessibilityannouncement[accessibilityAnnouncement]
* link:Button.adoc#accessibilityscreenchanged[accessibilityScreenChanged]
* link:Button.adoc#addcss[addCss]
* link:Button.adoc#addcssfile[addCssFile]
* link:Button.adoc#addeventlistener[addEventListener]
* link:Button.adoc#addpseudoclass[addPseudoClass]
* link:Button.adoc#animate[animate]
* link:Button.adoc#bind[bind]
* link:Button.adoc#callloaded[callLoaded]
* link:Button.adoc#callunloaded[callUnloaded]
* link:Button.adoc#changecssfile[changeCssFile]
* link:Button.adoc#closemodal[closeModal]
* link:Button.adoc#createanimation[createAnimation]
* link:Button.adoc#createnativeview[createNativeView]
* link:Button.adoc#deletepseudoclass[deletePseudoClass]
* link:Button.adoc#destroynode[destroyNode]
* link:Button.adoc#disposenativeview[disposeNativeView]
* link:Button.adoc#eachchild[eachChild]
* link:Button.adoc#eachchildview[eachChildView]
* link:Button.adoc#ensuredomnode[ensureDomNode]
* link:Button.adoc#focus[focus]
* link:Button.adoc#get[get]
* link:Button.adoc#getactualsize[getActualSize]
* link:Button.adoc#getgestureobservers[getGestureObservers]
* link:Button.adoc#getlocationinwindow[getLocationInWindow]
* link:Button.adoc#getlocationonscreen[getLocationOnScreen]
* link:Button.adoc#getlocationrelativeto[getLocationRelativeTo]
* link:Button.adoc#getmeasuredheight[getMeasuredHeight]
* link:Button.adoc#getmeasuredstate[getMeasuredState]
* link:Button.adoc#getmeasuredwidth[getMeasuredWidth]
* link:Button.adoc#getsafeareainsets[getSafeAreaInsets]
* link:Button.adoc#getviewbydomid[getViewByDomId]
* link:Button.adoc#getviewbyid[getViewById]
* link:Button.adoc#hasgestureobservers[hasGestureObservers]
* link:Button.adoc#haslisteners[hasListeners]
* link:Button.adoc#initnativeview[initNativeView]
* link:Button.adoc#layout[layout]
* link:Button.adoc#layoutnativeview[layoutNativeView]
* link:Button.adoc#loadview[loadView]
* link:Button.adoc#measure[measure]
* link:Button.adoc#notify[notify]
* link:Button.adoc#notifypropertychange[notifyPropertyChange]
* link:Button.adoc#off[off]
* link:Button.adoc#on[on]
* link:Button.adoc#onbackpressed[onBackPressed]
* link:Button.adoc#onlayout[onLayout]
* link:Button.adoc#onloaded[onLoaded]
* link:Button.adoc#onmeasure[onMeasure]
* link:Button.adoc#onresumenativeupdates[onResumeNativeUpdates]
* link:Button.adoc#onunloaded[onUnloaded]
* link:Button.adoc#once[once]
* link:Button.adoc#removeeventlistener[removeEventListener]
* link:Button.adoc#requestlayout[requestLayout]
* link:Button.adoc#resetnativeview[resetNativeView]
* link:Button.adoc#sendaccessibilityevent[sendAccessibilityEvent]
* link:Button.adoc#set[set]
* link:Button.adoc#setinlinestyle[setInlineStyle]
* link:Button.adoc#setmeasureddimension[setMeasuredDimension]
* link:Button.adoc#setnativeview[setNativeView]
* link:Button.adoc#setontouchlistener[setOnTouchListener]
* link:Button.adoc#setproperty[setProperty]
* link:Button.adoc#settestid[setTestID]
* link:Button.adoc#showmodal[showModal]
* link:Button.adoc#tostring[toString]
* link:Button.adoc#unbind[unbind]
* link:Button.adoc#unloadview[unloadView]
* link:Button.adoc#addeventlistener-1[addEventListener]
* link:Button.adoc#combinemeasuredstates[combineMeasuredStates]
* link:Button.adoc#layoutchild[layoutChild]
* link:Button.adoc#measurechild[measureChild]
* link:Button.adoc#off-1[off]
* link:Button.adoc#on-1[on]
* link:Button.adoc#once-1[once]
* link:Button.adoc#removeeventlistener-1[removeEventListener]
* link:Button.adoc#resolvesizeandstate[resolveSizeAndState]
...
Gets the native http://developer.android.com/reference/android/widget/Button.html[android widget] that represents the user interface for this component.
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/button/index.d.ts#L16[ui/button/index.d.ts:16]
...
Gets the native https://developer.apple.com/library/ios/documentation/UIKit/Reference/UIButton_Class/[UIButton] that represents the user interface for this component.
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/button/index.d.ts#L21[ui/button/index.d.ts:21]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/button/index.d.ts#L26[ui/button/index.d.ts:26]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/button/index.d.ts#L11[ui/button/index.d.ts:11]
...
xref:TextBase.adoc[TextBase].link:TextBase.adoc#on[on]

==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/button/index.d.ts#L34[ui/button/index.d.ts:34]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/button/index.d.ts#L39[ui/button/index.d.ts:39]
