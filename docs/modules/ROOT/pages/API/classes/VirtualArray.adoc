...
* link:VirtualArray.adoc#constructor[constructor]

=== Properties

* link:VirtualArray.adoc#_cache[_cache]
* link:VirtualArray.adoc#_isviewbase[_isViewBase]
* link:VirtualArray.adoc#_length[_length]
* link:VirtualArray.adoc#_loadsize[_loadSize]
* link:VirtualArray.adoc#_loadedindexes[_loadedIndexes]
* link:VirtualArray.adoc#_requestedindexes[_requestedIndexes]
* link:VirtualArray.adoc#changeevent[changeEvent]
* link:VirtualArray.adoc#itemsloadingevent[itemsLoadingEvent]
* link:VirtualArray.adoc#propertychangeevent[propertyChangeEvent]

=== Accessors

* link:VirtualArray.adoc#length[length]
* link:VirtualArray.adoc#loadsize[loadSize]

=== Methods

* link:VirtualArray.adoc#_createpropertychangedata[_createPropertyChangeData]
* link:VirtualArray.adoc#_emit[_emit]
* link:VirtualArray.adoc#addeventlistener[addEventListener]
* link:VirtualArray.adoc#get[get]
* link:VirtualArray.adoc#getitem[getItem]
* link:VirtualArray.adoc#haslisteners[hasListeners]
* link:VirtualArray.adoc#load[load]
* link:VirtualArray.adoc#notify[notify]
* link:VirtualArray.adoc#notifypropertychange[notifyPropertyChange]
* link:VirtualArray.adoc#off[off]
* link:VirtualArray.adoc#on[on]
* link:VirtualArray.adoc#once[once]
* link:VirtualArray.adoc#removeeventlistener[removeEventListener]
* link:VirtualArray.adoc#requestitems[requestItems]
* link:VirtualArray.adoc#set[set]
* link:VirtualArray.adoc#setitem[setItem]
* link:VirtualArray.adoc#setproperty[setProperty]
* link:VirtualArray.adoc#addeventlistener-1[addEventListener]
* link:VirtualArray.adoc#off-1[off]
* link:VirtualArray.adoc#on-1[on]
* link:VirtualArray.adoc#once-1[once]
* link:VirtualArray.adoc#removeeventlistener-1[removeEventListener]
