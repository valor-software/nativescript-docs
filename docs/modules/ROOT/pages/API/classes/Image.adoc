...
xref:../README.adoc[NativeScript] / xref:../modules.adoc[Exports] / Image
...
* link:Image.adoc#constructor[constructor]

=== Properties

* link:Image.adoc#_androidcontentdescriptionupdated[_androidContentDescriptionUpdated]
* link:Image.adoc#_automaticallyadjustsscrollviewinsets[_automaticallyAdjustsScrollViewInsets]
* link:Image.adoc#_closemodalcallback[_closeModalCallback]
* link:Image.adoc#_context[_context]
* link:Image.adoc#_cssstate[_cssState]
* link:Image.adoc#_currentheightmeasurespec[_currentHeightMeasureSpec]
* link:Image.adoc#_currentwidthmeasurespec[_currentWidthMeasureSpec]
* link:Image.adoc#_defaultpaddingbottom[_defaultPaddingBottom]
* link:Image.adoc#_defaultpaddingleft[_defaultPaddingLeft]
* link:Image.adoc#_defaultpaddingright[_defaultPaddingRight]
* link:Image.adoc#_defaultpaddingtop[_defaultPaddingTop]
* link:Image.adoc#_domid[_domId]
* link:Image.adoc#_gestureobservers[_gestureObservers]
* link:Image.adoc#_ignoreflexminwidthheightreset[_ignoreFlexMinWidthHeightReset]
* link:Image.adoc#_isaddedtonativevisualtree[_isAddedToNativeVisualTree]
* link:Image.adoc#_islayoutvalid[_isLayoutValid]
* link:Image.adoc#_ispaddingrelative[_isPaddingRelative]
* link:Image.adoc#_isstylescopehost[_isStyleScopeHost]
* link:Image.adoc#_isviewbase[_isViewBase]
* link:Image.adoc#_manager[_manager]
* link:Image.adoc#_modalparent[_modalParent]
* link:Image.adoc#_modulename[_moduleName]
* link:Image.adoc#_oldbottom[_oldBottom]
* link:Image.adoc#_oldleft[_oldLeft]
* link:Image.adoc#_oldright[_oldRight]
* link:Image.adoc#_oldtop[_oldTop]
* link:Image.adoc#_stylescope[_styleScope]
* link:Image.adoc#_suspendnativeupdatescount[_suspendNativeUpdatesCount]
* link:Image.adoc#_suspendedupdates[_suspendedUpdates]
* link:Image.adoc#accessibilityhidden[accessibilityHidden]
* link:Image.adoc#accessibilityhint[accessibilityHint]
* link:Image.adoc#accessibilityidentifier[accessibilityIdentifier]
* link:Image.adoc#accessibilitylabel[accessibilityLabel]
* link:Image.adoc#accessibilitylanguage[accessibilityLanguage]
* link:Image.adoc#accessibilityliveregion[accessibilityLiveRegion]
* link:Image.adoc#accessibilitymediasession[accessibilityMediaSession]
* link:Image.adoc#accessibilityrole[accessibilityRole]
* link:Image.adoc#accessibilitystate[accessibilityState]
* link:Image.adoc#accessibilityvalue[accessibilityValue]
* link:Image.adoc#accessible[accessible]
* link:Image.adoc#alignself[alignSelf]
* link:Image.adoc#android[android]
* link:Image.adoc#androiddynamicelevationoffset[androidDynamicElevationOffset]
* link:Image.adoc#androidelevation[androidElevation]
* link:Image.adoc#automationtext[automationText]
* link:Image.adoc#background[background]
* link:Image.adoc#backgroundcolor[backgroundColor]
* link:Image.adoc#backgroundimage[backgroundImage]
* link:Image.adoc#bindingcontext[bindingContext]
* link:Image.adoc#borderbottomcolor[borderBottomColor]
* link:Image.adoc#borderbottomleftradius[borderBottomLeftRadius]
* link:Image.adoc#borderbottomrightradius[borderBottomRightRadius]
* link:Image.adoc#borderbottomwidth[borderBottomWidth]
* link:Image.adoc#bordercolor[borderColor]
* link:Image.adoc#borderleftcolor[borderLeftColor]
* link:Image.adoc#borderleftwidth[borderLeftWidth]
* link:Image.adoc#borderradius[borderRadius]
* link:Image.adoc#borderrightcolor[borderRightColor]
* link:Image.adoc#borderrightwidth[borderRightWidth]
* link:Image.adoc#bordertopcolor[borderTopColor]
* link:Image.adoc#bordertopleftradius[borderTopLeftRadius]
* link:Image.adoc#bordertoprightradius[borderTopRightRadius]
* link:Image.adoc#bordertopwidth[borderTopWidth]
* link:Image.adoc#borderwidth[borderWidth]
* link:Image.adoc#boxshadow[boxShadow]
* link:Image.adoc#classname[className]
* link:Image.adoc#col[col]
* link:Image.adoc#colspan[colSpan]
* link:Image.adoc#color[color]
* link:Image.adoc#column[column]
* link:Image.adoc#columnspan[columnSpan]
* link:Image.adoc#css[css]
* link:Image.adoc#cssclasses[cssClasses]
* link:Image.adoc#csspseudoclasses[cssPseudoClasses]
* link:Image.adoc#csstype[cssType]
* link:Image.adoc#decodeheight[decodeHeight]
* link:Image.adoc#decodewidth[decodeWidth]
* link:Image.adoc#dock[dock]
* link:Image.adoc#domnode[domNode]
* link:Image.adoc#effectiveborderbottomwidth[effectiveBorderBottomWidth]
* link:Image.adoc#effectiveborderleftwidth[effectiveBorderLeftWidth]
* link:Image.adoc#effectiveborderrightwidth[effectiveBorderRightWidth]
* link:Image.adoc#effectivebordertopwidth[effectiveBorderTopWidth]
* link:Image.adoc#effectiveheight[effectiveHeight]
* link:Image.adoc#effectiveleft[effectiveLeft]
* link:Image.adoc#effectivemarginbottom[effectiveMarginBottom]
* link:Image.adoc#effectivemarginleft[effectiveMarginLeft]
* link:Image.adoc#effectivemarginright[effectiveMarginRight]
* link:Image.adoc#effectivemargintop[effectiveMarginTop]
* link:Image.adoc#effectiveminheight[effectiveMinHeight]
* link:Image.adoc#effectiveminwidth[effectiveMinWidth]
* link:Image.adoc#effectivepaddingbottom[effectivePaddingBottom]
* link:Image.adoc#effectivepaddingleft[effectivePaddingLeft]
* link:Image.adoc#effectivepaddingright[effectivePaddingRight]
* link:Image.adoc#effectivepaddingtop[effectivePaddingTop]
* link:Image.adoc#effectivetop[effectiveTop]
* link:Image.adoc#effectivewidth[effectiveWidth]
* link:Image.adoc#flexgrow[flexGrow]
* link:Image.adoc#flexshrink[flexShrink]
* link:Image.adoc#flexwrapbefore[flexWrapBefore]
* link:Image.adoc#height[height]
* link:Image.adoc#horizontalalignment[horizontalAlignment]
* link:Image.adoc#id[id]
* link:Image.adoc#ignoretouchanimation[ignoreTouchAnimation]
* link:Image.adoc#imagesource[imageSource]
* link:Image.adoc#ios[ios]
* link:Image.adoc#iosignoresafearea[iosIgnoreSafeArea]
* link:Image.adoc#iosoverflowsafearea[iosOverflowSafeArea]
* link:Image.adoc#iosoverflowsafeareaenabled[iosOverflowSafeAreaEnabled]
* link:Image.adoc#iscollapsed[isCollapsed]
* link:Image.adoc#isenabled[isEnabled]
* link:Image.adoc#islayoutrequired[isLayoutRequired]
* link:Image.adoc#islayoutvalid[isLayoutValid]
* link:Image.adoc#isloading[isLoading]
* link:Image.adoc#isuserinteractionenabled[isUserInteractionEnabled]
* link:Image.adoc#left[left]
* link:Image.adoc#loadmode[loadMode]
* link:Image.adoc#margin[margin]
* link:Image.adoc#marginbottom[marginBottom]
* link:Image.adoc#marginleft[marginLeft]
* link:Image.adoc#marginright[marginRight]
* link:Image.adoc#margintop[marginTop]
* link:Image.adoc#minheight[minHeight]
* link:Image.adoc#minwidth[minWidth]
* link:Image.adoc#modal[modal]
* link:Image.adoc#nativeviewprotected[nativeViewProtected]
* link:Image.adoc#opacity[opacity]
* link:Image.adoc#order[order]
* link:Image.adoc#originx[originX]
* link:Image.adoc#originy[originY]
* link:Image.adoc#parent[parent]
* link:Image.adoc#perspective[perspective]
* link:Image.adoc#recyclenativeview[recycleNativeView]
* link:Image.adoc#reusable[reusable]
* link:Image.adoc#rotate[rotate]
* link:Image.adoc#rotatex[rotateX]
* link:Image.adoc#rotatey[rotateY]
* link:Image.adoc#row[row]
* link:Image.adoc#rowspan[rowSpan]
* link:Image.adoc#scalex[scaleX]
* link:Image.adoc#scaley[scaleY]
* link:Image.adoc#src[src]
* link:Image.adoc#stretch[stretch]
* link:Image.adoc#testid[testID]
* link:Image.adoc#tintcolor[tintColor]
* link:Image.adoc#top[top]
* link:Image.adoc#touchanimation[touchAnimation]
* link:Image.adoc#touchdelay[touchDelay]
* link:Image.adoc#translatex[translateX]
* link:Image.adoc#translatey[translateY]
* link:Image.adoc#verticalalignment[verticalAlignment]
* link:Image.adoc#viewcontroller[viewController]
* link:Image.adoc#visibility[visibility]
* link:Image.adoc#width[width]
* link:Image.adoc#accessibilityblurevent[accessibilityBlurEvent]
* link:Image.adoc#accessibilityfocuschangedevent[accessibilityFocusChangedEvent]
* link:Image.adoc#accessibilityfocusevent[accessibilityFocusEvent]
* link:Image.adoc#accessibilityperformescapeevent[accessibilityPerformEscapeEvent]
* link:Image.adoc#createdevent[createdEvent]
* link:Image.adoc#disposenativeviewevent[disposeNativeViewEvent]
* link:Image.adoc#layoutchangedevent[layoutChangedEvent]
* link:Image.adoc#loadedevent[loadedEvent]
* link:Image.adoc#propertychangeevent[propertyChangeEvent]
* link:Image.adoc#showingmodallyevent[showingModallyEvent]
* link:Image.adoc#shownmodallyevent[shownModallyEvent]
* link:Image.adoc#unloadedevent[unloadedEvent]

=== Accessors

* link:Image.adoc#backgroundposition[backgroundPosition]
* link:Image.adoc#backgroundrepeat[backgroundRepeat]
* link:Image.adoc#backgroundsize[backgroundSize]
* link:Image.adoc#class[class]
* link:Image.adoc#isloaded[isLoaded]
* link:Image.adoc#nativeview[nativeView]
* link:Image.adoc#page[page]
* link:Image.adoc#parentnode[parentNode]
* link:Image.adoc#style[style]
* link:Image.adoc#texttransform[textTransform]
* link:Image.adoc#typename[typeName]

=== Methods

* link:Image.adoc#_addview[_addView]
* link:Image.adoc#_addviewcore[_addViewCore]
* link:Image.adoc#_addviewtonativevisualtree[_addViewToNativeVisualTree]
* link:Image.adoc#_applybackground[_applyBackground]
* link:Image.adoc#_applyxmlattribute[_applyXmlAttribute]
* link:Image.adoc#_batchupdate[_batchUpdate]
* link:Image.adoc#_childindextonativechildindex[_childIndexToNativeChildIndex]
* link:Image.adoc#_closeallmodalviewsinternal[_closeAllModalViewsInternal]
* link:Image.adoc#_createpropertychangedata[_createPropertyChangeData]
* link:Image.adoc#_dialogclosed[_dialogClosed]
* link:Image.adoc#_eachlayoutview[_eachLayoutView]
* link:Image.adoc#_emit[_emit]
* link:Image.adoc#_getcurrentlayoutbounds[_getCurrentLayoutBounds]
* link:Image.adoc#_getfragmentmanager[_getFragmentManager]
* link:Image.adoc#_getnativeviewscount[_getNativeViewsCount]
* link:Image.adoc#_getrootmodalviews[_getRootModalViews]
* link:Image.adoc#_getvalue[_getValue]
* link:Image.adoc#_gotovisualstate[_goToVisualState]
* link:Image.adoc#_handlelivesync[_handleLivesync]
* link:Image.adoc#_hasancestorview[_hasAncestorView]
* link:Image.adoc#_hidenativemodalview[_hideNativeModalView]
* link:Image.adoc#_inheritstylescope[_inheritStyleScope]
* link:Image.adoc#_layoutparent[_layoutParent]
* link:Image.adoc#_observe[_observe]
* link:Image.adoc#_onattachedtowindow[_onAttachedToWindow]
* link:Image.adoc#_oncssstatechange[_onCssStateChange]
* link:Image.adoc#_ondetachedfromwindow[_onDetachedFromWindow]
* link:Image.adoc#_onlivesync[_onLivesync]
* link:Image.adoc#_onrootviewreset[_onRootViewReset]
* link:Image.adoc#_onsizechanged[_onSizeChanged]
* link:Image.adoc#_parentchanged[_parentChanged]
* link:Image.adoc#_raiselayoutchangedevent[_raiseLayoutChangedEvent]
* link:Image.adoc#_raiseshowingmodallyevent[_raiseShowingModallyEvent]
* link:Image.adoc#_raiseshownmodallyevent[_raiseShownModallyEvent]
* link:Image.adoc#_redrawnativebackground[_redrawNativeBackground]
* link:Image.adoc#_removeanimation[_removeAnimation]
* link:Image.adoc#_removeview[_removeView]
* link:Image.adoc#_removeviewcore[_removeViewCore]
* link:Image.adoc#_removeviewfromnativevisualtree[_removeViewFromNativeVisualTree]
* link:Image.adoc#_resumenativeupdates[_resumeNativeUpdates]
* link:Image.adoc#_setcurrentlayoutbounds[_setCurrentLayoutBounds]
* link:Image.adoc#_setcurrentmeasurespecs[_setCurrentMeasureSpecs]
* link:Image.adoc#_setminheightnative[_setMinHeightNative]
* link:Image.adoc#_setminwidthnative[_setMinWidthNative]
* link:Image.adoc#_setnativecliptobounds[_setNativeClipToBounds]
* link:Image.adoc#_setnativeviewframe[_setNativeViewFrame]
* link:Image.adoc#_setvalue[_setValue]
* link:Image.adoc#_setupasrootview[_setupAsRootView]
* link:Image.adoc#_setupui[_setupUI]
* link:Image.adoc#_shoulddelaylayout[_shouldDelayLayout]
* link:Image.adoc#_shownativemodalview[_showNativeModalView]
* link:Image.adoc#_suspendnativeupdates[_suspendNativeUpdates]
* link:Image.adoc#_teardownui[_tearDownUI]
* link:Image.adoc#_updateeffectivelayoutvalues[_updateEffectiveLayoutValues]
* link:Image.adoc#_updatestylescope[_updateStyleScope]
* link:Image.adoc#accessibilityannouncement[accessibilityAnnouncement]
* link:Image.adoc#accessibilityscreenchanged[accessibilityScreenChanged]
* link:Image.adoc#addcss[addCss]
* link:Image.adoc#addcssfile[addCssFile]
* link:Image.adoc#addeventlistener[addEventListener]
* link:Image.adoc#addpseudoclass[addPseudoClass]
* link:Image.adoc#animate[animate]
* link:Image.adoc#bind[bind]
* link:Image.adoc#callloaded[callLoaded]
* link:Image.adoc#callunloaded[callUnloaded]
* link:Image.adoc#changecssfile[changeCssFile]
* link:Image.adoc#closemodal[closeModal]
* link:Image.adoc#createanimation[createAnimation]
* link:Image.adoc#createnativeview[createNativeView]
* link:Image.adoc#deletepseudoclass[deletePseudoClass]
* link:Image.adoc#destroynode[destroyNode]
* link:Image.adoc#disposenativeview[disposeNativeView]
* link:Image.adoc#eachchild[eachChild]
* link:Image.adoc#eachchildview[eachChildView]
* link:Image.adoc#ensuredomnode[ensureDomNode]
* link:Image.adoc#focus[focus]
* link:Image.adoc#get[get]
* link:Image.adoc#getactualsize[getActualSize]
* link:Image.adoc#getgestureobservers[getGestureObservers]
* link:Image.adoc#getlocationinwindow[getLocationInWindow]
* link:Image.adoc#getlocationonscreen[getLocationOnScreen]
* link:Image.adoc#getlocationrelativeto[getLocationRelativeTo]
* link:Image.adoc#getmeasuredheight[getMeasuredHeight]
* link:Image.adoc#getmeasuredstate[getMeasuredState]
* link:Image.adoc#getmeasuredwidth[getMeasuredWidth]
* link:Image.adoc#getsafeareainsets[getSafeAreaInsets]
* link:Image.adoc#getviewbydomid[getViewByDomId]
* link:Image.adoc#getviewbyid[getViewById]
* link:Image.adoc#hasgestureobservers[hasGestureObservers]
* link:Image.adoc#haslisteners[hasListeners]
* link:Image.adoc#initnativeview[initNativeView]
* link:Image.adoc#layout[layout]
* link:Image.adoc#layoutnativeview[layoutNativeView]
* link:Image.adoc#loadview[loadView]
* link:Image.adoc#measure[measure]
* link:Image.adoc#notify[notify]
* link:Image.adoc#notifypropertychange[notifyPropertyChange]
* link:Image.adoc#off[off]
* link:Image.adoc#on[on]
* link:Image.adoc#onbackpressed[onBackPressed]
* link:Image.adoc#onlayout[onLayout]
* link:Image.adoc#onloaded[onLoaded]
* link:Image.adoc#onmeasure[onMeasure]
* link:Image.adoc#onresumenativeupdates[onResumeNativeUpdates]
* link:Image.adoc#onunloaded[onUnloaded]
* link:Image.adoc#once[once]
* link:Image.adoc#removeeventlistener[removeEventListener]
* link:Image.adoc#requestlayout[requestLayout]
* link:Image.adoc#resetnativeview[resetNativeView]
* link:Image.adoc#sendaccessibilityevent[sendAccessibilityEvent]
* link:Image.adoc#set[set]
* link:Image.adoc#setinlinestyle[setInlineStyle]
* link:Image.adoc#setmeasureddimension[setMeasuredDimension]
* link:Image.adoc#setnativeview[setNativeView]
* link:Image.adoc#setontouchlistener[setOnTouchListener]
* link:Image.adoc#setproperty[setProperty]
* link:Image.adoc#settestid[setTestID]
* link:Image.adoc#showmodal[showModal]
* link:Image.adoc#tostring[toString]
* link:Image.adoc#unbind[unbind]
* link:Image.adoc#unloadview[unloadView]
* link:Image.adoc#addeventlistener-1[addEventListener]
* link:Image.adoc#combinemeasuredstates[combineMeasuredStates]
* link:Image.adoc#layoutchild[layoutChild]
* link:Image.adoc#measurechild[measureChild]
* link:Image.adoc#off-1[off]
* link:Image.adoc#on-1[on]
* link:Image.adoc#once-1[once]
* link:Image.adoc#removeeventlistener-1[removeEventListener]
* link:Image.adoc#resolvesizeandstate[resolveSizeAndState]
...
Gets the native http://developer.android.com/reference/android/widget/ImageView.html[android widget] that represents the user interface for this component.
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/image/index.d.ts#L15[ui/image/index.d.ts:15]
...
• *decodeHeight*: link:../modules/CoreTypes.adoc#lengthtype[`LengthType`]

Gets or sets the desired decode height of the image.
This property is Android specific.

==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/image/index.d.ts#L59[ui/image/index.d.ts:59]
...
• *decodeWidth*: link:../modules/CoreTypes.adoc#lengthtype[`LengthType`]

Gets or sets the desired decode width of the image.
This property is Android specific.

==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/image/index.d.ts#L65[ui/image/index.d.ts:65]
...
• *imageSource*: xref:ImageSource.adoc[`ImageSource`]

Gets or sets the image source of the image.

==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/image/index.d.ts#L25[ui/image/index.d.ts:25]
...
Gets the native iOS https://developer.apple.com/library/ios/documentation/UIKit/Reference/UIImageView_Class/[UIImageView] that represents the user interface for this component.
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/image/index.d.ts#L20[ui/image/index.d.ts:20]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/image/index.d.ts#L35[ui/image/index.d.ts:35]
...
* *async* _(default)_ - will load in the background, may appear with short delay, good for large images.
When loading images from web they are always loaded *async* no matter of loadMode value.

==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/image/index.d.ts#L48[ui/image/index.d.ts:48]
...
This can be either an URL string or a native image instance.

==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/image/index.d.ts#L30[ui/image/index.d.ts:30]
...
• *stretch*: link:../modules/CoreTypes.adoc#imagestretchtype[`ImageStretchType`]

Gets or sets the image stretch mode.

==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/image/index.d.ts#L40[ui/image/index.d.ts:40]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/image/index.d.ts#L53[ui/image/index.d.ts:53]
