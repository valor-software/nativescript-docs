...
* link:Image.md#constructor[constructor]

=== Properties

* link:Image.md#_androidcontentdescriptionupdated[_androidContentDescriptionUpdated]
* link:Image.md#_automaticallyadjustsscrollviewinsets[_automaticallyAdjustsScrollViewInsets]
* link:Image.md#_closemodalcallback[_closeModalCallback]
* link:Image.md#_context[_context]
* link:Image.md#_cssstate[_cssState]
* link:Image.md#_currentheightmeasurespec[_currentHeightMeasureSpec]
* link:Image.md#_currentwidthmeasurespec[_currentWidthMeasureSpec]
* link:Image.md#_defaultpaddingbottom[_defaultPaddingBottom]
* link:Image.md#_defaultpaddingleft[_defaultPaddingLeft]
* link:Image.md#_defaultpaddingright[_defaultPaddingRight]
* link:Image.md#_defaultpaddingtop[_defaultPaddingTop]
* link:Image.md#_domid[_domId]
* link:Image.md#_gestureobservers[_gestureObservers]
* link:Image.md#_ignoreflexminwidthheightreset[_ignoreFlexMinWidthHeightReset]
* link:Image.md#_isaddedtonativevisualtree[_isAddedToNativeVisualTree]
* link:Image.md#_islayoutvalid[_isLayoutValid]
* link:Image.md#_ispaddingrelative[_isPaddingRelative]
* link:Image.md#_isstylescopehost[_isStyleScopeHost]
* link:Image.md#_isviewbase[_isViewBase]
* link:Image.md#_manager[_manager]
* link:Image.md#_modalparent[_modalParent]
* link:Image.md#_modulename[_moduleName]
* link:Image.md#_oldbottom[_oldBottom]
* link:Image.md#_oldleft[_oldLeft]
* link:Image.md#_oldright[_oldRight]
* link:Image.md#_oldtop[_oldTop]
* link:Image.md#_stylescope[_styleScope]
* link:Image.md#_suspendnativeupdatescount[_suspendNativeUpdatesCount]
* link:Image.md#_suspendedupdates[_suspendedUpdates]
* link:Image.md#accessibilityhidden[accessibilityHidden]
* link:Image.md#accessibilityhint[accessibilityHint]
* link:Image.md#accessibilityidentifier[accessibilityIdentifier]
* link:Image.md#accessibilitylabel[accessibilityLabel]
* link:Image.md#accessibilitylanguage[accessibilityLanguage]
* link:Image.md#accessibilityliveregion[accessibilityLiveRegion]
* link:Image.md#accessibilitymediasession[accessibilityMediaSession]
* link:Image.md#accessibilityrole[accessibilityRole]
* link:Image.md#accessibilitystate[accessibilityState]
* link:Image.md#accessibilityvalue[accessibilityValue]
* link:Image.md#accessible[accessible]
* link:Image.md#alignself[alignSelf]
* link:Image.md#android[android]
* link:Image.md#androiddynamicelevationoffset[androidDynamicElevationOffset]
* link:Image.md#androidelevation[androidElevation]
* link:Image.md#automationtext[automationText]
* link:Image.md#background[background]
* link:Image.md#backgroundcolor[backgroundColor]
* link:Image.md#backgroundimage[backgroundImage]
* link:Image.md#bindingcontext[bindingContext]
* link:Image.md#borderbottomcolor[borderBottomColor]
* link:Image.md#borderbottomleftradius[borderBottomLeftRadius]
* link:Image.md#borderbottomrightradius[borderBottomRightRadius]
* link:Image.md#borderbottomwidth[borderBottomWidth]
* link:Image.md#bordercolor[borderColor]
* link:Image.md#borderleftcolor[borderLeftColor]
* link:Image.md#borderleftwidth[borderLeftWidth]
* link:Image.md#borderradius[borderRadius]
* link:Image.md#borderrightcolor[borderRightColor]
* link:Image.md#borderrightwidth[borderRightWidth]
* link:Image.md#bordertopcolor[borderTopColor]
* link:Image.md#bordertopleftradius[borderTopLeftRadius]
* link:Image.md#bordertoprightradius[borderTopRightRadius]
* link:Image.md#bordertopwidth[borderTopWidth]
* link:Image.md#borderwidth[borderWidth]
* link:Image.md#boxshadow[boxShadow]
* link:Image.md#classname[className]
* link:Image.md#col[col]
* link:Image.md#colspan[colSpan]
* link:Image.md#color[color]
* link:Image.md#column[column]
* link:Image.md#columnspan[columnSpan]
* link:Image.md#css[css]
* link:Image.md#cssclasses[cssClasses]
* link:Image.md#csspseudoclasses[cssPseudoClasses]
* link:Image.md#csstype[cssType]
* link:Image.md#decodeheight[decodeHeight]
* link:Image.md#decodewidth[decodeWidth]
* link:Image.md#dock[dock]
* link:Image.md#domnode[domNode]
* link:Image.md#effectiveborderbottomwidth[effectiveBorderBottomWidth]
* link:Image.md#effectiveborderleftwidth[effectiveBorderLeftWidth]
* link:Image.md#effectiveborderrightwidth[effectiveBorderRightWidth]
* link:Image.md#effectivebordertopwidth[effectiveBorderTopWidth]
* link:Image.md#effectiveheight[effectiveHeight]
* link:Image.md#effectiveleft[effectiveLeft]
* link:Image.md#effectivemarginbottom[effectiveMarginBottom]
* link:Image.md#effectivemarginleft[effectiveMarginLeft]
* link:Image.md#effectivemarginright[effectiveMarginRight]
* link:Image.md#effectivemargintop[effectiveMarginTop]
* link:Image.md#effectiveminheight[effectiveMinHeight]
* link:Image.md#effectiveminwidth[effectiveMinWidth]
* link:Image.md#effectivepaddingbottom[effectivePaddingBottom]
* link:Image.md#effectivepaddingleft[effectivePaddingLeft]
* link:Image.md#effectivepaddingright[effectivePaddingRight]
* link:Image.md#effectivepaddingtop[effectivePaddingTop]
* link:Image.md#effectivetop[effectiveTop]
* link:Image.md#effectivewidth[effectiveWidth]
* link:Image.md#flexgrow[flexGrow]
* link:Image.md#flexshrink[flexShrink]
* link:Image.md#flexwrapbefore[flexWrapBefore]
* link:Image.md#height[height]
* link:Image.md#horizontalalignment[horizontalAlignment]
* link:Image.md#id[id]
* link:Image.md#ignoretouchanimation[ignoreTouchAnimation]
* link:Image.md#imagesource[imageSource]
* link:Image.md#ios[ios]
* link:Image.md#iosignoresafearea[iosIgnoreSafeArea]
* link:Image.md#iosoverflowsafearea[iosOverflowSafeArea]
* link:Image.md#iosoverflowsafeareaenabled[iosOverflowSafeAreaEnabled]
* link:Image.md#iscollapsed[isCollapsed]
* link:Image.md#isenabled[isEnabled]
* link:Image.md#islayoutrequired[isLayoutRequired]
* link:Image.md#islayoutvalid[isLayoutValid]
* link:Image.md#isloading[isLoading]
* link:Image.md#isuserinteractionenabled[isUserInteractionEnabled]
* link:Image.md#left[left]
* link:Image.md#loadmode[loadMode]
* link:Image.md#margin[margin]
* link:Image.md#marginbottom[marginBottom]
* link:Image.md#marginleft[marginLeft]
* link:Image.md#marginright[marginRight]
* link:Image.md#margintop[marginTop]
* link:Image.md#minheight[minHeight]
* link:Image.md#minwidth[minWidth]
* link:Image.md#modal[modal]
* link:Image.md#nativeviewprotected[nativeViewProtected]
* link:Image.md#opacity[opacity]
* link:Image.md#order[order]
* link:Image.md#originx[originX]
* link:Image.md#originy[originY]
* link:Image.md#parent[parent]
* link:Image.md#perspective[perspective]
* link:Image.md#recyclenativeview[recycleNativeView]
* link:Image.md#reusable[reusable]
* link:Image.md#rotate[rotate]
* link:Image.md#rotatex[rotateX]
* link:Image.md#rotatey[rotateY]
* link:Image.md#row[row]
* link:Image.md#rowspan[rowSpan]
* link:Image.md#scalex[scaleX]
* link:Image.md#scaley[scaleY]
* link:Image.md#src[src]
* link:Image.md#stretch[stretch]
* link:Image.md#testid[testID]
* link:Image.md#tintcolor[tintColor]
* link:Image.md#top[top]
* link:Image.md#touchanimation[touchAnimation]
* link:Image.md#touchdelay[touchDelay]
* link:Image.md#translatex[translateX]
* link:Image.md#translatey[translateY]
* link:Image.md#verticalalignment[verticalAlignment]
* link:Image.md#viewcontroller[viewController]
* link:Image.md#visibility[visibility]
* link:Image.md#width[width]
* link:Image.md#accessibilityblurevent[accessibilityBlurEvent]
* link:Image.md#accessibilityfocuschangedevent[accessibilityFocusChangedEvent]
* link:Image.md#accessibilityfocusevent[accessibilityFocusEvent]
* link:Image.md#accessibilityperformescapeevent[accessibilityPerformEscapeEvent]
* link:Image.md#createdevent[createdEvent]
* link:Image.md#disposenativeviewevent[disposeNativeViewEvent]
* link:Image.md#layoutchangedevent[layoutChangedEvent]
* link:Image.md#loadedevent[loadedEvent]
* link:Image.md#propertychangeevent[propertyChangeEvent]
* link:Image.md#showingmodallyevent[showingModallyEvent]
* link:Image.md#shownmodallyevent[shownModallyEvent]
* link:Image.md#unloadedevent[unloadedEvent]

=== Accessors

* link:Image.md#backgroundposition[backgroundPosition]
* link:Image.md#backgroundrepeat[backgroundRepeat]
* link:Image.md#backgroundsize[backgroundSize]
* link:Image.md#class[class]
* link:Image.md#isloaded[isLoaded]
* link:Image.md#nativeview[nativeView]
* link:Image.md#page[page]
* link:Image.md#parentnode[parentNode]
* link:Image.md#style[style]
* link:Image.md#texttransform[textTransform]
* link:Image.md#typename[typeName]

=== Methods

* link:Image.md#_addview[_addView]
* link:Image.md#_addviewcore[_addViewCore]
* link:Image.md#_addviewtonativevisualtree[_addViewToNativeVisualTree]
* link:Image.md#_applybackground[_applyBackground]
* link:Image.md#_applyxmlattribute[_applyXmlAttribute]
* link:Image.md#_batchupdate[_batchUpdate]
* link:Image.md#_childindextonativechildindex[_childIndexToNativeChildIndex]
* link:Image.md#_closeallmodalviewsinternal[_closeAllModalViewsInternal]
* link:Image.md#_createpropertychangedata[_createPropertyChangeData]
* link:Image.md#_dialogclosed[_dialogClosed]
* link:Image.md#_eachlayoutview[_eachLayoutView]
* link:Image.md#_emit[_emit]
* link:Image.md#_getcurrentlayoutbounds[_getCurrentLayoutBounds]
* link:Image.md#_getfragmentmanager[_getFragmentManager]
* link:Image.md#_getnativeviewscount[_getNativeViewsCount]
* link:Image.md#_getrootmodalviews[_getRootModalViews]
* link:Image.md#_getvalue[_getValue]
* link:Image.md#_gotovisualstate[_goToVisualState]
* link:Image.md#_handlelivesync[_handleLivesync]
* link:Image.md#_hasancestorview[_hasAncestorView]
* link:Image.md#_hidenativemodalview[_hideNativeModalView]
* link:Image.md#_inheritstylescope[_inheritStyleScope]
* link:Image.md#_layoutparent[_layoutParent]
* link:Image.md#_observe[_observe]
* link:Image.md#_onattachedtowindow[_onAttachedToWindow]
* link:Image.md#_oncssstatechange[_onCssStateChange]
* link:Image.md#_ondetachedfromwindow[_onDetachedFromWindow]
* link:Image.md#_onlivesync[_onLivesync]
* link:Image.md#_onrootviewreset[_onRootViewReset]
* link:Image.md#_onsizechanged[_onSizeChanged]
* link:Image.md#_parentchanged[_parentChanged]
* link:Image.md#_raiselayoutchangedevent[_raiseLayoutChangedEvent]
* link:Image.md#_raiseshowingmodallyevent[_raiseShowingModallyEvent]
* link:Image.md#_raiseshownmodallyevent[_raiseShownModallyEvent]
* link:Image.md#_redrawnativebackground[_redrawNativeBackground]
* link:Image.md#_removeanimation[_removeAnimation]
* link:Image.md#_removeview[_removeView]
* link:Image.md#_removeviewcore[_removeViewCore]
* link:Image.md#_removeviewfromnativevisualtree[_removeViewFromNativeVisualTree]
* link:Image.md#_resumenativeupdates[_resumeNativeUpdates]
* link:Image.md#_setcurrentlayoutbounds[_setCurrentLayoutBounds]
* link:Image.md#_setcurrentmeasurespecs[_setCurrentMeasureSpecs]
* link:Image.md#_setminheightnative[_setMinHeightNative]
* link:Image.md#_setminwidthnative[_setMinWidthNative]
* link:Image.md#_setnativecliptobounds[_setNativeClipToBounds]
* link:Image.md#_setnativeviewframe[_setNativeViewFrame]
* link:Image.md#_setvalue[_setValue]
* link:Image.md#_setupasrootview[_setupAsRootView]
* link:Image.md#_setupui[_setupUI]
* link:Image.md#_shoulddelaylayout[_shouldDelayLayout]
* link:Image.md#_shownativemodalview[_showNativeModalView]
* link:Image.md#_suspendnativeupdates[_suspendNativeUpdates]
* link:Image.md#_teardownui[_tearDownUI]
* link:Image.md#_updateeffectivelayoutvalues[_updateEffectiveLayoutValues]
* link:Image.md#_updatestylescope[_updateStyleScope]
* link:Image.md#accessibilityannouncement[accessibilityAnnouncement]
* link:Image.md#accessibilityscreenchanged[accessibilityScreenChanged]
* link:Image.md#addcss[addCss]
* link:Image.md#addcssfile[addCssFile]
* link:Image.md#addeventlistener[addEventListener]
* link:Image.md#addpseudoclass[addPseudoClass]
* link:Image.md#animate[animate]
* link:Image.md#bind[bind]
* link:Image.md#callloaded[callLoaded]
* link:Image.md#callunloaded[callUnloaded]
* link:Image.md#changecssfile[changeCssFile]
* link:Image.md#closemodal[closeModal]
* link:Image.md#createanimation[createAnimation]
* link:Image.md#createnativeview[createNativeView]
* link:Image.md#deletepseudoclass[deletePseudoClass]
* link:Image.md#destroynode[destroyNode]
* link:Image.md#disposenativeview[disposeNativeView]
* link:Image.md#eachchild[eachChild]
* link:Image.md#eachchildview[eachChildView]
* link:Image.md#ensuredomnode[ensureDomNode]
* link:Image.md#focus[focus]
* link:Image.md#get[get]
* link:Image.md#getactualsize[getActualSize]
* link:Image.md#getgestureobservers[getGestureObservers]
* link:Image.md#getlocationinwindow[getLocationInWindow]
* link:Image.md#getlocationonscreen[getLocationOnScreen]
* link:Image.md#getlocationrelativeto[getLocationRelativeTo]
* link:Image.md#getmeasuredheight[getMeasuredHeight]
* link:Image.md#getmeasuredstate[getMeasuredState]
* link:Image.md#getmeasuredwidth[getMeasuredWidth]
* link:Image.md#getsafeareainsets[getSafeAreaInsets]
* link:Image.md#getviewbydomid[getViewByDomId]
* link:Image.md#getviewbyid[getViewById]
* link:Image.md#hasgestureobservers[hasGestureObservers]
* link:Image.md#haslisteners[hasListeners]
* link:Image.md#initnativeview[initNativeView]
* link:Image.md#layout[layout]
* link:Image.md#layoutnativeview[layoutNativeView]
* link:Image.md#loadview[loadView]
* link:Image.md#measure[measure]
* link:Image.md#notify[notify]
* link:Image.md#notifypropertychange[notifyPropertyChange]
* link:Image.md#off[off]
* link:Image.md#on[on]
* link:Image.md#onbackpressed[onBackPressed]
* link:Image.md#onlayout[onLayout]
* link:Image.md#onloaded[onLoaded]
* link:Image.md#onmeasure[onMeasure]
* link:Image.md#onresumenativeupdates[onResumeNativeUpdates]
* link:Image.md#onunloaded[onUnloaded]
* link:Image.md#once[once]
* link:Image.md#removeeventlistener[removeEventListener]
* link:Image.md#requestlayout[requestLayout]
* link:Image.md#resetnativeview[resetNativeView]
* link:Image.md#sendaccessibilityevent[sendAccessibilityEvent]
* link:Image.md#set[set]
* link:Image.md#setinlinestyle[setInlineStyle]
* link:Image.md#setmeasureddimension[setMeasuredDimension]
* link:Image.md#setnativeview[setNativeView]
* link:Image.md#setontouchlistener[setOnTouchListener]
* link:Image.md#setproperty[setProperty]
* link:Image.md#settestid[setTestID]
* link:Image.md#showmodal[showModal]
* link:Image.md#tostring[toString]
* link:Image.md#unbind[unbind]
* link:Image.md#unloadview[unloadView]
* link:Image.md#addeventlistener-1[addEventListener]
* link:Image.md#combinemeasuredstates[combineMeasuredStates]
* link:Image.md#layoutchild[layoutChild]
* link:Image.md#measurechild[measureChild]
* link:Image.md#off-1[off]
* link:Image.md#on-1[on]
* link:Image.md#once-1[once]
* link:Image.md#removeeventlistener-1[removeEventListener]
* link:Image.md#resolvesizeandstate[resolveSizeAndState]
...
• *decodeHeight*: link:../modules/CoreTypes.md#lengthtype[`LengthType`]
...
• *decodeWidth*: link:../modules/CoreTypes.md#lengthtype[`LengthType`]
...
• *stretch*: link:../modules/CoreTypes.md#imagestretchtype[`ImageStretchType`]
