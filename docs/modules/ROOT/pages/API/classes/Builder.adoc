...
* link:Builder.adoc#constructor[constructor]

=== Properties

* link:Builder.adoc#knowncollections[knownCollections]
* link:Builder.adoc#knownmultitemplates[knownMultiTemplates]
* link:Builder.adoc#knowntemplates[knownTemplates]

=== Methods

* link:Builder.adoc#createviewfromentry[createViewFromEntry]
* link:Builder.adoc#load[load]
* link:Builder.adoc#parse[parse]
* link:Builder.adoc#parsemultipletemplates[parseMultipleTemplates]
