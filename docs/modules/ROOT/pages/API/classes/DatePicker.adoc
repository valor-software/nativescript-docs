...
xref:../README.adoc[NativeScript] / xref:../modules.adoc[Exports] / DatePicker
...
* link:DatePicker.md#constructor[constructor]

=== Properties

* link:DatePicker.md#_androidcontentdescriptionupdated[_androidContentDescriptionUpdated]
* link:DatePicker.md#_automaticallyadjustsscrollviewinsets[_automaticallyAdjustsScrollViewInsets]
* link:DatePicker.md#_closemodalcallback[_closeModalCallback]
* link:DatePicker.md#_context[_context]
* link:DatePicker.md#_cssstate[_cssState]
* link:DatePicker.md#_currentheightmeasurespec[_currentHeightMeasureSpec]
* link:DatePicker.md#_currentwidthmeasurespec[_currentWidthMeasureSpec]
* link:DatePicker.md#_defaultpaddingbottom[_defaultPaddingBottom]
* link:DatePicker.md#_defaultpaddingleft[_defaultPaddingLeft]
* link:DatePicker.md#_defaultpaddingright[_defaultPaddingRight]
* link:DatePicker.md#_defaultpaddingtop[_defaultPaddingTop]
* link:DatePicker.md#_domid[_domId]
* link:DatePicker.md#_gestureobservers[_gestureObservers]
* link:DatePicker.md#_ignoreflexminwidthheightreset[_ignoreFlexMinWidthHeightReset]
* link:DatePicker.md#_isaddedtonativevisualtree[_isAddedToNativeVisualTree]
* link:DatePicker.md#_islayoutvalid[_isLayoutValid]
* link:DatePicker.md#_ispaddingrelative[_isPaddingRelative]
* link:DatePicker.md#_isstylescopehost[_isStyleScopeHost]
* link:DatePicker.md#_isviewbase[_isViewBase]
* link:DatePicker.md#_manager[_manager]
* link:DatePicker.md#_modalparent[_modalParent]
* link:DatePicker.md#_modulename[_moduleName]
* link:DatePicker.md#_oldbottom[_oldBottom]
* link:DatePicker.md#_oldleft[_oldLeft]
* link:DatePicker.md#_oldright[_oldRight]
* link:DatePicker.md#_oldtop[_oldTop]
* link:DatePicker.md#_stylescope[_styleScope]
* link:DatePicker.md#_suspendnativeupdatescount[_suspendNativeUpdatesCount]
* link:DatePicker.md#_suspendedupdates[_suspendedUpdates]
* link:DatePicker.md#accessibilityhidden[accessibilityHidden]
* link:DatePicker.md#accessibilityhint[accessibilityHint]
* link:DatePicker.md#accessibilityidentifier[accessibilityIdentifier]
* link:DatePicker.md#accessibilitylabel[accessibilityLabel]
* link:DatePicker.md#accessibilitylanguage[accessibilityLanguage]
* link:DatePicker.md#accessibilityliveregion[accessibilityLiveRegion]
* link:DatePicker.md#accessibilitymediasession[accessibilityMediaSession]
* link:DatePicker.md#accessibilityrole[accessibilityRole]
* link:DatePicker.md#accessibilitystate[accessibilityState]
* link:DatePicker.md#accessibilityvalue[accessibilityValue]
* link:DatePicker.md#accessible[accessible]
* link:DatePicker.md#alignself[alignSelf]
* link:DatePicker.md#android[android]
* link:DatePicker.md#androiddynamicelevationoffset[androidDynamicElevationOffset]
* link:DatePicker.md#androidelevation[androidElevation]
* link:DatePicker.md#automationtext[automationText]
* link:DatePicker.md#background[background]
* link:DatePicker.md#backgroundcolor[backgroundColor]
* link:DatePicker.md#backgroundimage[backgroundImage]
* link:DatePicker.md#bindingcontext[bindingContext]
* link:DatePicker.md#borderbottomcolor[borderBottomColor]
* link:DatePicker.md#borderbottomleftradius[borderBottomLeftRadius]
* link:DatePicker.md#borderbottomrightradius[borderBottomRightRadius]
* link:DatePicker.md#borderbottomwidth[borderBottomWidth]
* link:DatePicker.md#bordercolor[borderColor]
* link:DatePicker.md#borderleftcolor[borderLeftColor]
* link:DatePicker.md#borderleftwidth[borderLeftWidth]
* link:DatePicker.md#borderradius[borderRadius]
* link:DatePicker.md#borderrightcolor[borderRightColor]
* link:DatePicker.md#borderrightwidth[borderRightWidth]
* link:DatePicker.md#bordertopcolor[borderTopColor]
* link:DatePicker.md#bordertopleftradius[borderTopLeftRadius]
* link:DatePicker.md#bordertoprightradius[borderTopRightRadius]
* link:DatePicker.md#bordertopwidth[borderTopWidth]
* link:DatePicker.md#borderwidth[borderWidth]
* link:DatePicker.md#boxshadow[boxShadow]
* link:DatePicker.md#classname[className]
* link:DatePicker.md#col[col]
* link:DatePicker.md#colspan[colSpan]
* link:DatePicker.md#color[color]
* link:DatePicker.md#column[column]
* link:DatePicker.md#columnspan[columnSpan]
* link:DatePicker.md#css[css]
* link:DatePicker.md#cssclasses[cssClasses]
* link:DatePicker.md#csspseudoclasses[cssPseudoClasses]
* link:DatePicker.md#csstype[cssType]
* link:DatePicker.md#date[date]
* link:DatePicker.md#day[day]
* link:DatePicker.md#dock[dock]
* link:DatePicker.md#domnode[domNode]
* link:DatePicker.md#effectiveborderbottomwidth[effectiveBorderBottomWidth]
* link:DatePicker.md#effectiveborderleftwidth[effectiveBorderLeftWidth]
* link:DatePicker.md#effectiveborderrightwidth[effectiveBorderRightWidth]
* link:DatePicker.md#effectivebordertopwidth[effectiveBorderTopWidth]
* link:DatePicker.md#effectiveheight[effectiveHeight]
* link:DatePicker.md#effectiveleft[effectiveLeft]
* link:DatePicker.md#effectivemarginbottom[effectiveMarginBottom]
* link:DatePicker.md#effectivemarginleft[effectiveMarginLeft]
* link:DatePicker.md#effectivemarginright[effectiveMarginRight]
* link:DatePicker.md#effectivemargintop[effectiveMarginTop]
* link:DatePicker.md#effectiveminheight[effectiveMinHeight]
* link:DatePicker.md#effectiveminwidth[effectiveMinWidth]
* link:DatePicker.md#effectivepaddingbottom[effectivePaddingBottom]
* link:DatePicker.md#effectivepaddingleft[effectivePaddingLeft]
* link:DatePicker.md#effectivepaddingright[effectivePaddingRight]
* link:DatePicker.md#effectivepaddingtop[effectivePaddingTop]
* link:DatePicker.md#effectivetop[effectiveTop]
* link:DatePicker.md#effectivewidth[effectiveWidth]
* link:DatePicker.md#flexgrow[flexGrow]
* link:DatePicker.md#flexshrink[flexShrink]
* link:DatePicker.md#flexwrapbefore[flexWrapBefore]
* link:DatePicker.md#height[height]
* link:DatePicker.md#horizontalalignment[horizontalAlignment]
* link:DatePicker.md#id[id]
* link:DatePicker.md#ignoretouchanimation[ignoreTouchAnimation]
* link:DatePicker.md#ios[ios]
* link:DatePicker.md#iosignoresafearea[iosIgnoreSafeArea]
* link:DatePicker.md#iosoverflowsafearea[iosOverflowSafeArea]
* link:DatePicker.md#iosoverflowsafeareaenabled[iosOverflowSafeAreaEnabled]
* link:DatePicker.md#iospreferreddatepickerstyle[iosPreferredDatePickerStyle]
* link:DatePicker.md#iscollapsed[isCollapsed]
* link:DatePicker.md#isenabled[isEnabled]
* link:DatePicker.md#islayoutrequired[isLayoutRequired]
* link:DatePicker.md#islayoutvalid[isLayoutValid]
* link:DatePicker.md#isuserinteractionenabled[isUserInteractionEnabled]
* link:DatePicker.md#left[left]
* link:DatePicker.md#margin[margin]
* link:DatePicker.md#marginbottom[marginBottom]
* link:DatePicker.md#marginleft[marginLeft]
* link:DatePicker.md#marginright[marginRight]
* link:DatePicker.md#margintop[marginTop]
* link:DatePicker.md#maxdate[maxDate]
* link:DatePicker.md#mindate[minDate]
* link:DatePicker.md#minheight[minHeight]
* link:DatePicker.md#minwidth[minWidth]
* link:DatePicker.md#modal[modal]
* link:DatePicker.md#month[month]
* link:DatePicker.md#nativeviewprotected[nativeViewProtected]
* link:DatePicker.md#opacity[opacity]
* link:DatePicker.md#order[order]
* link:DatePicker.md#originx[originX]
* link:DatePicker.md#originy[originY]
* link:DatePicker.md#parent[parent]
* link:DatePicker.md#perspective[perspective]
* link:DatePicker.md#recyclenativeview[recycleNativeView]
* link:DatePicker.md#reusable[reusable]
* link:DatePicker.md#rotate[rotate]
* link:DatePicker.md#rotatex[rotateX]
* link:DatePicker.md#rotatey[rotateY]
* link:DatePicker.md#row[row]
* link:DatePicker.md#rowspan[rowSpan]
* link:DatePicker.md#scalex[scaleX]
* link:DatePicker.md#scaley[scaleY]
* link:DatePicker.md#testid[testID]
* link:DatePicker.md#top[top]
* link:DatePicker.md#touchanimation[touchAnimation]
* link:DatePicker.md#touchdelay[touchDelay]
* link:DatePicker.md#translatex[translateX]
* link:DatePicker.md#translatey[translateY]
* link:DatePicker.md#verticalalignment[verticalAlignment]
* link:DatePicker.md#viewcontroller[viewController]
* link:DatePicker.md#visibility[visibility]
* link:DatePicker.md#width[width]
* link:DatePicker.md#year[year]
* link:DatePicker.md#accessibilityblurevent[accessibilityBlurEvent]
* link:DatePicker.md#accessibilityfocuschangedevent[accessibilityFocusChangedEvent]
* link:DatePicker.md#accessibilityfocusevent[accessibilityFocusEvent]
* link:DatePicker.md#accessibilityperformescapeevent[accessibilityPerformEscapeEvent]
* link:DatePicker.md#createdevent[createdEvent]
* link:DatePicker.md#disposenativeviewevent[disposeNativeViewEvent]
* link:DatePicker.md#layoutchangedevent[layoutChangedEvent]
* link:DatePicker.md#loadedevent[loadedEvent]
* link:DatePicker.md#propertychangeevent[propertyChangeEvent]
* link:DatePicker.md#showingmodallyevent[showingModallyEvent]
* link:DatePicker.md#shownmodallyevent[shownModallyEvent]
* link:DatePicker.md#unloadedevent[unloadedEvent]

=== Accessors

* link:DatePicker.md#backgroundposition[backgroundPosition]
* link:DatePicker.md#backgroundrepeat[backgroundRepeat]
* link:DatePicker.md#backgroundsize[backgroundSize]
* link:DatePicker.md#class[class]
* link:DatePicker.md#isloaded[isLoaded]
* link:DatePicker.md#nativeview[nativeView]
* link:DatePicker.md#page[page]
* link:DatePicker.md#parentnode[parentNode]
* link:DatePicker.md#style[style]
* link:DatePicker.md#texttransform[textTransform]
* link:DatePicker.md#typename[typeName]

=== Methods

* link:DatePicker.md#_addview[_addView]
* link:DatePicker.md#_addviewcore[_addViewCore]
* link:DatePicker.md#_addviewtonativevisualtree[_addViewToNativeVisualTree]
* link:DatePicker.md#_applybackground[_applyBackground]
* link:DatePicker.md#_applyxmlattribute[_applyXmlAttribute]
* link:DatePicker.md#_batchupdate[_batchUpdate]
* link:DatePicker.md#_childindextonativechildindex[_childIndexToNativeChildIndex]
* link:DatePicker.md#_closeallmodalviewsinternal[_closeAllModalViewsInternal]
* link:DatePicker.md#_createpropertychangedata[_createPropertyChangeData]
* link:DatePicker.md#_dialogclosed[_dialogClosed]
* link:DatePicker.md#_eachlayoutview[_eachLayoutView]
* link:DatePicker.md#_emit[_emit]
* link:DatePicker.md#_getcurrentlayoutbounds[_getCurrentLayoutBounds]
* link:DatePicker.md#_getfragmentmanager[_getFragmentManager]
* link:DatePicker.md#_getnativeviewscount[_getNativeViewsCount]
* link:DatePicker.md#_getrootmodalviews[_getRootModalViews]
* link:DatePicker.md#_getvalue[_getValue]
* link:DatePicker.md#_gotovisualstate[_goToVisualState]
* link:DatePicker.md#_handlelivesync[_handleLivesync]
* link:DatePicker.md#_hasancestorview[_hasAncestorView]
* link:DatePicker.md#_hidenativemodalview[_hideNativeModalView]
* link:DatePicker.md#_inheritstylescope[_inheritStyleScope]
* link:DatePicker.md#_layoutparent[_layoutParent]
* link:DatePicker.md#_observe[_observe]
* link:DatePicker.md#_onattachedtowindow[_onAttachedToWindow]
* link:DatePicker.md#_oncssstatechange[_onCssStateChange]
* link:DatePicker.md#_ondetachedfromwindow[_onDetachedFromWindow]
* link:DatePicker.md#_onlivesync[_onLivesync]
* link:DatePicker.md#_onrootviewreset[_onRootViewReset]
* link:DatePicker.md#_onsizechanged[_onSizeChanged]
* link:DatePicker.md#_parentchanged[_parentChanged]
* link:DatePicker.md#_raiselayoutchangedevent[_raiseLayoutChangedEvent]
* link:DatePicker.md#_raiseshowingmodallyevent[_raiseShowingModallyEvent]
* link:DatePicker.md#_raiseshownmodallyevent[_raiseShownModallyEvent]
* link:DatePicker.md#_redrawnativebackground[_redrawNativeBackground]
* link:DatePicker.md#_removeanimation[_removeAnimation]
* link:DatePicker.md#_removeview[_removeView]
* link:DatePicker.md#_removeviewcore[_removeViewCore]
* link:DatePicker.md#_removeviewfromnativevisualtree[_removeViewFromNativeVisualTree]
* link:DatePicker.md#_resumenativeupdates[_resumeNativeUpdates]
* link:DatePicker.md#_setcurrentlayoutbounds[_setCurrentLayoutBounds]
* link:DatePicker.md#_setcurrentmeasurespecs[_setCurrentMeasureSpecs]
* link:DatePicker.md#_setminheightnative[_setMinHeightNative]
* link:DatePicker.md#_setminwidthnative[_setMinWidthNative]
* link:DatePicker.md#_setnativecliptobounds[_setNativeClipToBounds]
* link:DatePicker.md#_setnativeviewframe[_setNativeViewFrame]
* link:DatePicker.md#_setvalue[_setValue]
* link:DatePicker.md#_setupasrootview[_setupAsRootView]
* link:DatePicker.md#_setupui[_setupUI]
* link:DatePicker.md#_shoulddelaylayout[_shouldDelayLayout]
* link:DatePicker.md#_shownativemodalview[_showNativeModalView]
* link:DatePicker.md#_suspendnativeupdates[_suspendNativeUpdates]
* link:DatePicker.md#_teardownui[_tearDownUI]
* link:DatePicker.md#_updateeffectivelayoutvalues[_updateEffectiveLayoutValues]
* link:DatePicker.md#_updatestylescope[_updateStyleScope]
* link:DatePicker.md#accessibilityannouncement[accessibilityAnnouncement]
* link:DatePicker.md#accessibilityscreenchanged[accessibilityScreenChanged]
* link:DatePicker.md#addcss[addCss]
* link:DatePicker.md#addcssfile[addCssFile]
* link:DatePicker.md#addeventlistener[addEventListener]
* link:DatePicker.md#addpseudoclass[addPseudoClass]
* link:DatePicker.md#animate[animate]
* link:DatePicker.md#bind[bind]
* link:DatePicker.md#callloaded[callLoaded]
* link:DatePicker.md#callunloaded[callUnloaded]
* link:DatePicker.md#changecssfile[changeCssFile]
* link:DatePicker.md#closemodal[closeModal]
* link:DatePicker.md#createanimation[createAnimation]
* link:DatePicker.md#createnativeview[createNativeView]
* link:DatePicker.md#deletepseudoclass[deletePseudoClass]
* link:DatePicker.md#destroynode[destroyNode]
* link:DatePicker.md#disposenativeview[disposeNativeView]
* link:DatePicker.md#eachchild[eachChild]
* link:DatePicker.md#eachchildview[eachChildView]
* link:DatePicker.md#ensuredomnode[ensureDomNode]
* link:DatePicker.md#focus[focus]
* link:DatePicker.md#get[get]
* link:DatePicker.md#getactualsize[getActualSize]
* link:DatePicker.md#getgestureobservers[getGestureObservers]
* link:DatePicker.md#getlocationinwindow[getLocationInWindow]
* link:DatePicker.md#getlocationonscreen[getLocationOnScreen]
* link:DatePicker.md#getlocationrelativeto[getLocationRelativeTo]
* link:DatePicker.md#getmeasuredheight[getMeasuredHeight]
* link:DatePicker.md#getmeasuredstate[getMeasuredState]
* link:DatePicker.md#getmeasuredwidth[getMeasuredWidth]
* link:DatePicker.md#getsafeareainsets[getSafeAreaInsets]
* link:DatePicker.md#getviewbydomid[getViewByDomId]
* link:DatePicker.md#getviewbyid[getViewById]
* link:DatePicker.md#hasgestureobservers[hasGestureObservers]
* link:DatePicker.md#haslisteners[hasListeners]
* link:DatePicker.md#initnativeview[initNativeView]
* link:DatePicker.md#layout[layout]
* link:DatePicker.md#layoutnativeview[layoutNativeView]
* link:DatePicker.md#loadview[loadView]
* link:DatePicker.md#measure[measure]
* link:DatePicker.md#notify[notify]
* link:DatePicker.md#notifypropertychange[notifyPropertyChange]
* link:DatePicker.md#off[off]
* link:DatePicker.md#on[on]
* link:DatePicker.md#onbackpressed[onBackPressed]
* link:DatePicker.md#onlayout[onLayout]
* link:DatePicker.md#onloaded[onLoaded]
* link:DatePicker.md#onmeasure[onMeasure]
* link:DatePicker.md#onresumenativeupdates[onResumeNativeUpdates]
* link:DatePicker.md#onunloaded[onUnloaded]
* link:DatePicker.md#once[once]
* link:DatePicker.md#removeeventlistener[removeEventListener]
* link:DatePicker.md#requestlayout[requestLayout]
* link:DatePicker.md#resetnativeview[resetNativeView]
* link:DatePicker.md#sendaccessibilityevent[sendAccessibilityEvent]
* link:DatePicker.md#set[set]
* link:DatePicker.md#setinlinestyle[setInlineStyle]
* link:DatePicker.md#setmeasureddimension[setMeasuredDimension]
* link:DatePicker.md#setnativeview[setNativeView]
* link:DatePicker.md#setontouchlistener[setOnTouchListener]
* link:DatePicker.md#setproperty[setProperty]
* link:DatePicker.md#settestid[setTestID]
* link:DatePicker.md#showmodal[showModal]
* link:DatePicker.md#tostring[toString]
* link:DatePicker.md#unbind[unbind]
* link:DatePicker.md#unloadview[unloadView]
* link:DatePicker.md#addeventlistener-1[addEventListener]
* link:DatePicker.md#combinemeasuredstates[combineMeasuredStates]
* link:DatePicker.md#layoutchild[layoutChild]
* link:DatePicker.md#measurechild[measureChild]
* link:DatePicker.md#off-1[off]
* link:DatePicker.md#on-1[on]
* link:DatePicker.md#once-1[once]
* link:DatePicker.md#removeeventlistener-1[removeEventListener]
* link:DatePicker.md#resolvesizeandstate[resolveSizeAndState]
...
Gets the native http://developer.android.com/reference/android/widget/DatePicker.html[android.widget.DatePicker] that represents the user interface for this component.
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/date-picker/index.d.ts#L19[ui/date-picker/index.d.ts:19]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/date-picker/index.d.ts#L44[ui/date-picker/index.d.ts:44]
...
The days start from 1.

==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/date-picker/index.d.ts#L39[ui/date-picker/index.d.ts:39]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/date-picker/index.d.ts#L24[ui/date-picker/index.d.ts:24]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/date-picker/index.d.ts#L64[ui/date-picker/index.d.ts:64]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/date-picker/index.d.ts#L49[ui/date-picker/index.d.ts:49]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/date-picker/index.d.ts#L54[ui/date-picker/index.d.ts:54]
...
The months start from 1.

==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/date-picker/index.d.ts#L34[ui/date-picker/index.d.ts:34]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/date-picker/index.d.ts#L29[ui/date-picker/index.d.ts:29]
