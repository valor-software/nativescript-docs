...
xref:../README.adoc[NativeScript] / xref:../modules.adoc[Exports] / WrapLayout
...
* link:WrapLayout.md#constructor[constructor]

=== Properties

* link:WrapLayout.md#_androidcontentdescriptionupdated[_androidContentDescriptionUpdated]
* link:WrapLayout.md#_automaticallyadjustsscrollviewinsets[_automaticallyAdjustsScrollViewInsets]
* link:WrapLayout.md#_closemodalcallback[_closeModalCallback]
* link:WrapLayout.md#_context[_context]
* link:WrapLayout.md#_cssstate[_cssState]
* link:WrapLayout.md#_currentheightmeasurespec[_currentHeightMeasureSpec]
* link:WrapLayout.md#_currentwidthmeasurespec[_currentWidthMeasureSpec]
* link:WrapLayout.md#_defaultpaddingbottom[_defaultPaddingBottom]
* link:WrapLayout.md#_defaultpaddingleft[_defaultPaddingLeft]
* link:WrapLayout.md#_defaultpaddingright[_defaultPaddingRight]
* link:WrapLayout.md#_defaultpaddingtop[_defaultPaddingTop]
* link:WrapLayout.md#_domid[_domId]
* link:WrapLayout.md#_gestureobservers[_gestureObservers]
* link:WrapLayout.md#_ignoreflexminwidthheightreset[_ignoreFlexMinWidthHeightReset]
* link:WrapLayout.md#_isaddedtonativevisualtree[_isAddedToNativeVisualTree]
* link:WrapLayout.md#_islayoutvalid[_isLayoutValid]
* link:WrapLayout.md#_ispaddingrelative[_isPaddingRelative]
* link:WrapLayout.md#_isstylescopehost[_isStyleScopeHost]
* link:WrapLayout.md#_isviewbase[_isViewBase]
* link:WrapLayout.md#_manager[_manager]
* link:WrapLayout.md#_modalparent[_modalParent]
* link:WrapLayout.md#_modulename[_moduleName]
* link:WrapLayout.md#_oldbottom[_oldBottom]
* link:WrapLayout.md#_oldleft[_oldLeft]
* link:WrapLayout.md#_oldright[_oldRight]
* link:WrapLayout.md#_oldtop[_oldTop]
* link:WrapLayout.md#_stylescope[_styleScope]
* link:WrapLayout.md#_suspendnativeupdatescount[_suspendNativeUpdatesCount]
* link:WrapLayout.md#_suspendedupdates[_suspendedUpdates]
* link:WrapLayout.md#accessibilityhidden[accessibilityHidden]
* link:WrapLayout.md#accessibilityhint[accessibilityHint]
* link:WrapLayout.md#accessibilityidentifier[accessibilityIdentifier]
* link:WrapLayout.md#accessibilitylabel[accessibilityLabel]
* link:WrapLayout.md#accessibilitylanguage[accessibilityLanguage]
* link:WrapLayout.md#accessibilityliveregion[accessibilityLiveRegion]
* link:WrapLayout.md#accessibilitymediasession[accessibilityMediaSession]
* link:WrapLayout.md#accessibilityrole[accessibilityRole]
* link:WrapLayout.md#accessibilitystate[accessibilityState]
* link:WrapLayout.md#accessibilityvalue[accessibilityValue]
* link:WrapLayout.md#accessible[accessible]
* link:WrapLayout.md#alignself[alignSelf]
* link:WrapLayout.md#android[android]
* link:WrapLayout.md#androiddynamicelevationoffset[androidDynamicElevationOffset]
* link:WrapLayout.md#androidelevation[androidElevation]
* link:WrapLayout.md#automationtext[automationText]
* link:WrapLayout.md#background[background]
* link:WrapLayout.md#backgroundcolor[backgroundColor]
* link:WrapLayout.md#backgroundimage[backgroundImage]
* link:WrapLayout.md#bindingcontext[bindingContext]
* link:WrapLayout.md#borderbottomcolor[borderBottomColor]
* link:WrapLayout.md#borderbottomleftradius[borderBottomLeftRadius]
* link:WrapLayout.md#borderbottomrightradius[borderBottomRightRadius]
* link:WrapLayout.md#borderbottomwidth[borderBottomWidth]
* link:WrapLayout.md#bordercolor[borderColor]
* link:WrapLayout.md#borderleftcolor[borderLeftColor]
* link:WrapLayout.md#borderleftwidth[borderLeftWidth]
* link:WrapLayout.md#borderradius[borderRadius]
* link:WrapLayout.md#borderrightcolor[borderRightColor]
* link:WrapLayout.md#borderrightwidth[borderRightWidth]
* link:WrapLayout.md#bordertopcolor[borderTopColor]
* link:WrapLayout.md#bordertopleftradius[borderTopLeftRadius]
* link:WrapLayout.md#bordertoprightradius[borderTopRightRadius]
* link:WrapLayout.md#bordertopwidth[borderTopWidth]
* link:WrapLayout.md#borderwidth[borderWidth]
* link:WrapLayout.md#boxshadow[boxShadow]
* link:WrapLayout.md#classname[className]
* link:WrapLayout.md#cliptobounds[clipToBounds]
* link:WrapLayout.md#col[col]
* link:WrapLayout.md#colspan[colSpan]
* link:WrapLayout.md#color[color]
* link:WrapLayout.md#column[column]
* link:WrapLayout.md#columnspan[columnSpan]
* link:WrapLayout.md#css[css]
* link:WrapLayout.md#cssclasses[cssClasses]
* link:WrapLayout.md#csspseudoclasses[cssPseudoClasses]
* link:WrapLayout.md#csstype[cssType]
* link:WrapLayout.md#dock[dock]
* link:WrapLayout.md#domnode[domNode]
* link:WrapLayout.md#effectiveborderbottomwidth[effectiveBorderBottomWidth]
* link:WrapLayout.md#effectiveborderleftwidth[effectiveBorderLeftWidth]
* link:WrapLayout.md#effectiveborderrightwidth[effectiveBorderRightWidth]
* link:WrapLayout.md#effectivebordertopwidth[effectiveBorderTopWidth]
* link:WrapLayout.md#effectiveheight[effectiveHeight]
* link:WrapLayout.md#effectiveleft[effectiveLeft]
* link:WrapLayout.md#effectivemarginbottom[effectiveMarginBottom]
* link:WrapLayout.md#effectivemarginleft[effectiveMarginLeft]
* link:WrapLayout.md#effectivemarginright[effectiveMarginRight]
* link:WrapLayout.md#effectivemargintop[effectiveMarginTop]
* link:WrapLayout.md#effectiveminheight[effectiveMinHeight]
* link:WrapLayout.md#effectiveminwidth[effectiveMinWidth]
* link:WrapLayout.md#effectivepaddingbottom[effectivePaddingBottom]
* link:WrapLayout.md#effectivepaddingleft[effectivePaddingLeft]
* link:WrapLayout.md#effectivepaddingright[effectivePaddingRight]
* link:WrapLayout.md#effectivepaddingtop[effectivePaddingTop]
* link:WrapLayout.md#effectivetop[effectiveTop]
* link:WrapLayout.md#effectivewidth[effectiveWidth]
* link:WrapLayout.md#flexgrow[flexGrow]
* link:WrapLayout.md#flexshrink[flexShrink]
* link:WrapLayout.md#flexwrapbefore[flexWrapBefore]
* link:WrapLayout.md#height[height]
* link:WrapLayout.md#horizontalalignment[horizontalAlignment]
* link:WrapLayout.md#id[id]
* link:WrapLayout.md#ignoretouchanimation[ignoreTouchAnimation]
* link:WrapLayout.md#ios[ios]
* link:WrapLayout.md#iosignoresafearea[iosIgnoreSafeArea]
* link:WrapLayout.md#iosoverflowsafearea[iosOverflowSafeArea]
* link:WrapLayout.md#iosoverflowsafeareaenabled[iosOverflowSafeAreaEnabled]
* link:WrapLayout.md#iscollapsed[isCollapsed]
* link:WrapLayout.md#isenabled[isEnabled]
* link:WrapLayout.md#islayoutrequired[isLayoutRequired]
* link:WrapLayout.md#islayoutvalid[isLayoutValid]
* link:WrapLayout.md#ispassthroughparentenabled[isPassThroughParentEnabled]
* link:WrapLayout.md#isuserinteractionenabled[isUserInteractionEnabled]
* link:WrapLayout.md#itemheight[itemHeight]
* link:WrapLayout.md#itemwidth[itemWidth]
* link:WrapLayout.md#left[left]
* link:WrapLayout.md#margin[margin]
* link:WrapLayout.md#marginbottom[marginBottom]
* link:WrapLayout.md#marginleft[marginLeft]
* link:WrapLayout.md#marginright[marginRight]
* link:WrapLayout.md#margintop[marginTop]
* link:WrapLayout.md#minheight[minHeight]
* link:WrapLayout.md#minwidth[minWidth]
* link:WrapLayout.md#modal[modal]
* link:WrapLayout.md#nativeviewprotected[nativeViewProtected]
* link:WrapLayout.md#opacity[opacity]
* link:WrapLayout.md#order[order]
* link:WrapLayout.md#orientation[orientation]
* link:WrapLayout.md#originx[originX]
* link:WrapLayout.md#originy[originY]
* link:WrapLayout.md#padding[padding]
* link:WrapLayout.md#paddingbottom[paddingBottom]
* link:WrapLayout.md#paddingleft[paddingLeft]
* link:WrapLayout.md#paddingright[paddingRight]
* link:WrapLayout.md#paddingtop[paddingTop]
* link:WrapLayout.md#parent[parent]
* link:WrapLayout.md#perspective[perspective]
* link:WrapLayout.md#recyclenativeview[recycleNativeView]
* link:WrapLayout.md#reusable[reusable]
* link:WrapLayout.md#rotate[rotate]
* link:WrapLayout.md#rotatex[rotateX]
* link:WrapLayout.md#rotatey[rotateY]
* link:WrapLayout.md#row[row]
* link:WrapLayout.md#rowspan[rowSpan]
* link:WrapLayout.md#scalex[scaleX]
* link:WrapLayout.md#scaley[scaleY]
* link:WrapLayout.md#testid[testID]
* link:WrapLayout.md#top[top]
* link:WrapLayout.md#touchanimation[touchAnimation]
* link:WrapLayout.md#touchdelay[touchDelay]
* link:WrapLayout.md#translatex[translateX]
* link:WrapLayout.md#translatey[translateY]
* link:WrapLayout.md#verticalalignment[verticalAlignment]
* link:WrapLayout.md#viewcontroller[viewController]
* link:WrapLayout.md#visibility[visibility]
* link:WrapLayout.md#width[width]
* link:WrapLayout.md#accessibilityblurevent[accessibilityBlurEvent]
* link:WrapLayout.md#accessibilityfocuschangedevent[accessibilityFocusChangedEvent]
* link:WrapLayout.md#accessibilityfocusevent[accessibilityFocusEvent]
* link:WrapLayout.md#accessibilityperformescapeevent[accessibilityPerformEscapeEvent]
* link:WrapLayout.md#createdevent[createdEvent]
* link:WrapLayout.md#disposenativeviewevent[disposeNativeViewEvent]
* link:WrapLayout.md#layoutchangedevent[layoutChangedEvent]
* link:WrapLayout.md#loadedevent[loadedEvent]
* link:WrapLayout.md#propertychangeevent[propertyChangeEvent]
* link:WrapLayout.md#showingmodallyevent[showingModallyEvent]
* link:WrapLayout.md#shownmodallyevent[shownModallyEvent]
* link:WrapLayout.md#unloadedevent[unloadedEvent]

=== Accessors

* link:WrapLayout.md#backgroundposition[backgroundPosition]
* link:WrapLayout.md#backgroundrepeat[backgroundRepeat]
* link:WrapLayout.md#backgroundsize[backgroundSize]
* link:WrapLayout.md#class[class]
* link:WrapLayout.md#isloaded[isLoaded]
* link:WrapLayout.md#nativeview[nativeView]
* link:WrapLayout.md#page[page]
* link:WrapLayout.md#parentnode[parentNode]
* link:WrapLayout.md#style[style]
* link:WrapLayout.md#texttransform[textTransform]
* link:WrapLayout.md#typename[typeName]

=== Methods

* link:WrapLayout.md#_addview[_addView]
* link:WrapLayout.md#_addviewcore[_addViewCore]
* link:WrapLayout.md#_addviewtonativevisualtree[_addViewToNativeVisualTree]
* link:WrapLayout.md#_applybackground[_applyBackground]
* link:WrapLayout.md#_applyxmlattribute[_applyXmlAttribute]
* link:WrapLayout.md#_batchupdate[_batchUpdate]
* link:WrapLayout.md#_childindextonativechildindex[_childIndexToNativeChildIndex]
* link:WrapLayout.md#_closeallmodalviewsinternal[_closeAllModalViewsInternal]
* link:WrapLayout.md#_createpropertychangedata[_createPropertyChangeData]
* link:WrapLayout.md#_dialogclosed[_dialogClosed]
* link:WrapLayout.md#_eachlayoutview[_eachLayoutView]
* link:WrapLayout.md#_emit[_emit]
* link:WrapLayout.md#_getcurrentlayoutbounds[_getCurrentLayoutBounds]
* link:WrapLayout.md#_getfragmentmanager[_getFragmentManager]
* link:WrapLayout.md#_getnativeviewscount[_getNativeViewsCount]
* link:WrapLayout.md#_getrootmodalviews[_getRootModalViews]
* link:WrapLayout.md#_getvalue[_getValue]
* link:WrapLayout.md#_gotovisualstate[_goToVisualState]
* link:WrapLayout.md#_handlelivesync[_handleLivesync]
* link:WrapLayout.md#_hasancestorview[_hasAncestorView]
* link:WrapLayout.md#_hidenativemodalview[_hideNativeModalView]
* link:WrapLayout.md#_inheritstylescope[_inheritStyleScope]
* link:WrapLayout.md#_layoutparent[_layoutParent]
* link:WrapLayout.md#_observe[_observe]
* link:WrapLayout.md#_onattachedtowindow[_onAttachedToWindow]
* link:WrapLayout.md#_oncssstatechange[_onCssStateChange]
* link:WrapLayout.md#_ondetachedfromwindow[_onDetachedFromWindow]
* link:WrapLayout.md#_onlivesync[_onLivesync]
* link:WrapLayout.md#_onrootviewreset[_onRootViewReset]
* link:WrapLayout.md#_onsizechanged[_onSizeChanged]
* link:WrapLayout.md#_parentchanged[_parentChanged]
* link:WrapLayout.md#_raiselayoutchangedevent[_raiseLayoutChangedEvent]
* link:WrapLayout.md#_raiseshowingmodallyevent[_raiseShowingModallyEvent]
* link:WrapLayout.md#_raiseshownmodallyevent[_raiseShownModallyEvent]
* link:WrapLayout.md#_redrawnativebackground[_redrawNativeBackground]
* link:WrapLayout.md#_registerlayoutchild[_registerLayoutChild]
* link:WrapLayout.md#_removeanimation[_removeAnimation]
* link:WrapLayout.md#_removeview[_removeView]
* link:WrapLayout.md#_removeviewcore[_removeViewCore]
* link:WrapLayout.md#_removeviewfromnativevisualtree[_removeViewFromNativeVisualTree]
* link:WrapLayout.md#_resumenativeupdates[_resumeNativeUpdates]
* link:WrapLayout.md#_setchildminheightnative[_setChildMinHeightNative]
* link:WrapLayout.md#_setchildminwidthnative[_setChildMinWidthNative]
* link:WrapLayout.md#_setcurrentlayoutbounds[_setCurrentLayoutBounds]
* link:WrapLayout.md#_setcurrentmeasurespecs[_setCurrentMeasureSpecs]
* link:WrapLayout.md#_setminheightnative[_setMinHeightNative]
* link:WrapLayout.md#_setminwidthnative[_setMinWidthNative]
* link:WrapLayout.md#_setnativecliptobounds[_setNativeClipToBounds]
* link:WrapLayout.md#_setnativeviewframe[_setNativeViewFrame]
* link:WrapLayout.md#_setvalue[_setValue]
* link:WrapLayout.md#_setupasrootview[_setupAsRootView]
* link:WrapLayout.md#_setupui[_setupUI]
* link:WrapLayout.md#_shoulddelaylayout[_shouldDelayLayout]
* link:WrapLayout.md#_shownativemodalview[_showNativeModalView]
* link:WrapLayout.md#_suspendnativeupdates[_suspendNativeUpdates]
* link:WrapLayout.md#_teardownui[_tearDownUI]
* link:WrapLayout.md#_unregisterlayoutchild[_unregisterLayoutChild]
* link:WrapLayout.md#_updateeffectivelayoutvalues[_updateEffectiveLayoutValues]
* link:WrapLayout.md#_updatenativelayoutparams[_updateNativeLayoutParams]
* link:WrapLayout.md#_updatestylescope[_updateStyleScope]
* link:WrapLayout.md#accessibilityannouncement[accessibilityAnnouncement]
* link:WrapLayout.md#accessibilityscreenchanged[accessibilityScreenChanged]
* link:WrapLayout.md#addchild[addChild]
* link:WrapLayout.md#addcss[addCss]
* link:WrapLayout.md#addcssfile[addCssFile]
* link:WrapLayout.md#addeventlistener[addEventListener]
* link:WrapLayout.md#addpseudoclass[addPseudoClass]
* link:WrapLayout.md#animate[animate]
* link:WrapLayout.md#bind[bind]
* link:WrapLayout.md#callloaded[callLoaded]
* link:WrapLayout.md#callunloaded[callUnloaded]
* link:WrapLayout.md#changecssfile[changeCssFile]
* link:WrapLayout.md#closemodal[closeModal]
* link:WrapLayout.md#createanimation[createAnimation]
* link:WrapLayout.md#createnativeview[createNativeView]
* link:WrapLayout.md#deletepseudoclass[deletePseudoClass]
* link:WrapLayout.md#destroynode[destroyNode]
* link:WrapLayout.md#disposenativeview[disposeNativeView]
* link:WrapLayout.md#eachchild[eachChild]
* link:WrapLayout.md#eachchildview[eachChildView]
* link:WrapLayout.md#eachlayoutchild[eachLayoutChild]
* link:WrapLayout.md#ensuredomnode[ensureDomNode]
* link:WrapLayout.md#focus[focus]
* link:WrapLayout.md#get[get]
* link:WrapLayout.md#getactualsize[getActualSize]
* link:WrapLayout.md#getchildat[getChildAt]
* link:WrapLayout.md#getchildindex[getChildIndex]
* link:WrapLayout.md#getchildrencount[getChildrenCount]
* link:WrapLayout.md#getgestureobservers[getGestureObservers]
* link:WrapLayout.md#getlocationinwindow[getLocationInWindow]
* link:WrapLayout.md#getlocationonscreen[getLocationOnScreen]
* link:WrapLayout.md#getlocationrelativeto[getLocationRelativeTo]
* link:WrapLayout.md#getmeasuredheight[getMeasuredHeight]
* link:WrapLayout.md#getmeasuredstate[getMeasuredState]
* link:WrapLayout.md#getmeasuredwidth[getMeasuredWidth]
* link:WrapLayout.md#getsafeareainsets[getSafeAreaInsets]
* link:WrapLayout.md#getviewbydomid[getViewByDomId]
* link:WrapLayout.md#getviewbyid[getViewById]
* link:WrapLayout.md#hasgestureobservers[hasGestureObservers]
* link:WrapLayout.md#haslisteners[hasListeners]
* link:WrapLayout.md#initnativeview[initNativeView]
* link:WrapLayout.md#insertchild[insertChild]
* link:WrapLayout.md#layout[layout]
* link:WrapLayout.md#layoutnativeview[layoutNativeView]
* link:WrapLayout.md#loadview[loadView]
* link:WrapLayout.md#measure[measure]
* link:WrapLayout.md#notify[notify]
* link:WrapLayout.md#notifypropertychange[notifyPropertyChange]
* link:WrapLayout.md#off[off]
* link:WrapLayout.md#on[on]
* link:WrapLayout.md#onbackpressed[onBackPressed]
* link:WrapLayout.md#onlayout[onLayout]
* link:WrapLayout.md#onloaded[onLoaded]
* link:WrapLayout.md#onmeasure[onMeasure]
* link:WrapLayout.md#onresumenativeupdates[onResumeNativeUpdates]
* link:WrapLayout.md#onunloaded[onUnloaded]
* link:WrapLayout.md#once[once]
* link:WrapLayout.md#removechild[removeChild]
* link:WrapLayout.md#removechildren[removeChildren]
* link:WrapLayout.md#removeeventlistener[removeEventListener]
* link:WrapLayout.md#requestlayout[requestLayout]
* link:WrapLayout.md#resetnativeview[resetNativeView]
* link:WrapLayout.md#sendaccessibilityevent[sendAccessibilityEvent]
* link:WrapLayout.md#set[set]
* link:WrapLayout.md#setinlinestyle[setInlineStyle]
* link:WrapLayout.md#setmeasureddimension[setMeasuredDimension]
* link:WrapLayout.md#setnativeview[setNativeView]
* link:WrapLayout.md#setontouchlistener[setOnTouchListener]
* link:WrapLayout.md#setproperty[setProperty]
* link:WrapLayout.md#settestid[setTestID]
* link:WrapLayout.md#showmodal[showModal]
* link:WrapLayout.md#tostring[toString]
* link:WrapLayout.md#unbind[unbind]
* link:WrapLayout.md#unloadview[unloadView]
* link:WrapLayout.md#addeventlistener-1[addEventListener]
* link:WrapLayout.md#combinemeasuredstates[combineMeasuredStates]
* link:WrapLayout.md#layoutchild[layoutChild]
* link:WrapLayout.md#measurechild[measureChild]
* link:WrapLayout.md#off-1[off]
* link:WrapLayout.md#on-1[on]
* link:WrapLayout.md#once-1[once]
* link:WrapLayout.md#removeeventlistener-1[removeEventListener]
* link:WrapLayout.md#resolvesizeandstate[resolveSizeAndState]
...
• *itemHeight*: link:../modules/CoreTypes.md#lengthtype[`LengthType`]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/layouts/wrap-layout/index.d.ts#L27[ui/layouts/wrap-layout/index.d.ts:27]
...
• *itemWidth*: link:../modules/CoreTypes.md#lengthtype[`LengthType`]

Gets or sets the width used to measure and layout each child.
Default value is Number.NaN which does not restrict children.

==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/layouts/wrap-layout/index.d.ts#L21[ui/layouts/wrap-layout/index.d.ts:21]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/layouts/wrap-layout/index.d.ts#L15[ui/layouts/wrap-layout/index.d.ts:15]
