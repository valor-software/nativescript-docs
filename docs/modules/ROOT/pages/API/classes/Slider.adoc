...
xref:../README.adoc[NativeScript] / xref:../modules.adoc[Exports] / Slider
...
* link:Slider.adoc#constructor[constructor]

=== Properties

* link:Slider.adoc#_androidcontentdescriptionupdated[_androidContentDescriptionUpdated]
* link:Slider.adoc#_automaticallyadjustsscrollviewinsets[_automaticallyAdjustsScrollViewInsets]
* link:Slider.adoc#_closemodalcallback[_closeModalCallback]
* link:Slider.adoc#_context[_context]
* link:Slider.adoc#_cssstate[_cssState]
* link:Slider.adoc#_currentheightmeasurespec[_currentHeightMeasureSpec]
* link:Slider.adoc#_currentwidthmeasurespec[_currentWidthMeasureSpec]
* link:Slider.adoc#_defaultpaddingbottom[_defaultPaddingBottom]
* link:Slider.adoc#_defaultpaddingleft[_defaultPaddingLeft]
* link:Slider.adoc#_defaultpaddingright[_defaultPaddingRight]
* link:Slider.adoc#_defaultpaddingtop[_defaultPaddingTop]
* link:Slider.adoc#_domid[_domId]
* link:Slider.adoc#_gestureobservers[_gestureObservers]
* link:Slider.adoc#_ignoreflexminwidthheightreset[_ignoreFlexMinWidthHeightReset]
* link:Slider.adoc#_isaddedtonativevisualtree[_isAddedToNativeVisualTree]
* link:Slider.adoc#_islayoutvalid[_isLayoutValid]
* link:Slider.adoc#_ispaddingrelative[_isPaddingRelative]
* link:Slider.adoc#_isstylescopehost[_isStyleScopeHost]
* link:Slider.adoc#_isviewbase[_isViewBase]
* link:Slider.adoc#_manager[_manager]
* link:Slider.adoc#_modalparent[_modalParent]
* link:Slider.adoc#_modulename[_moduleName]
* link:Slider.adoc#_oldbottom[_oldBottom]
* link:Slider.adoc#_oldleft[_oldLeft]
* link:Slider.adoc#_oldright[_oldRight]
* link:Slider.adoc#_oldtop[_oldTop]
* link:Slider.adoc#_stylescope[_styleScope]
* link:Slider.adoc#_suspendnativeupdatescount[_suspendNativeUpdatesCount]
* link:Slider.adoc#_suspendedupdates[_suspendedUpdates]
* link:Slider.adoc#accessibilityhidden[accessibilityHidden]
* link:Slider.adoc#accessibilityhint[accessibilityHint]
* link:Slider.adoc#accessibilityidentifier[accessibilityIdentifier]
* link:Slider.adoc#accessibilitylabel[accessibilityLabel]
* link:Slider.adoc#accessibilitylanguage[accessibilityLanguage]
* link:Slider.adoc#accessibilityliveregion[accessibilityLiveRegion]
* link:Slider.adoc#accessibilitymediasession[accessibilityMediaSession]
* link:Slider.adoc#accessibilityrole[accessibilityRole]
* link:Slider.adoc#accessibilitystate[accessibilityState]
* link:Slider.adoc#accessibilitystep[accessibilityStep]
* link:Slider.adoc#accessibilityvalue[accessibilityValue]
* link:Slider.adoc#accessible[accessible]
* link:Slider.adoc#alignself[alignSelf]
* link:Slider.adoc#android[android]
* link:Slider.adoc#androiddynamicelevationoffset[androidDynamicElevationOffset]
* link:Slider.adoc#androidelevation[androidElevation]
* link:Slider.adoc#automationtext[automationText]
* link:Slider.adoc#background[background]
* link:Slider.adoc#backgroundcolor[backgroundColor]
* link:Slider.adoc#backgroundimage[backgroundImage]
* link:Slider.adoc#bindingcontext[bindingContext]
* link:Slider.adoc#borderbottomcolor[borderBottomColor]
* link:Slider.adoc#borderbottomleftradius[borderBottomLeftRadius]
* link:Slider.adoc#borderbottomrightradius[borderBottomRightRadius]
* link:Slider.adoc#borderbottomwidth[borderBottomWidth]
* link:Slider.adoc#bordercolor[borderColor]
* link:Slider.adoc#borderleftcolor[borderLeftColor]
* link:Slider.adoc#borderleftwidth[borderLeftWidth]
* link:Slider.adoc#borderradius[borderRadius]
* link:Slider.adoc#borderrightcolor[borderRightColor]
* link:Slider.adoc#borderrightwidth[borderRightWidth]
* link:Slider.adoc#bordertopcolor[borderTopColor]
* link:Slider.adoc#bordertopleftradius[borderTopLeftRadius]
* link:Slider.adoc#bordertoprightradius[borderTopRightRadius]
* link:Slider.adoc#bordertopwidth[borderTopWidth]
* link:Slider.adoc#borderwidth[borderWidth]
* link:Slider.adoc#boxshadow[boxShadow]
* link:Slider.adoc#classname[className]
* link:Slider.adoc#col[col]
* link:Slider.adoc#colspan[colSpan]
* link:Slider.adoc#color[color]
* link:Slider.adoc#column[column]
* link:Slider.adoc#columnspan[columnSpan]
* link:Slider.adoc#css[css]
* link:Slider.adoc#cssclasses[cssClasses]
* link:Slider.adoc#csspseudoclasses[cssPseudoClasses]
* link:Slider.adoc#csstype[cssType]
* link:Slider.adoc#dock[dock]
* link:Slider.adoc#domnode[domNode]
* link:Slider.adoc#effectiveborderbottomwidth[effectiveBorderBottomWidth]
* link:Slider.adoc#effectiveborderleftwidth[effectiveBorderLeftWidth]
* link:Slider.adoc#effectiveborderrightwidth[effectiveBorderRightWidth]
* link:Slider.adoc#effectivebordertopwidth[effectiveBorderTopWidth]
* link:Slider.adoc#effectiveheight[effectiveHeight]
* link:Slider.adoc#effectiveleft[effectiveLeft]
* link:Slider.adoc#effectivemarginbottom[effectiveMarginBottom]
* link:Slider.adoc#effectivemarginleft[effectiveMarginLeft]
* link:Slider.adoc#effectivemarginright[effectiveMarginRight]
* link:Slider.adoc#effectivemargintop[effectiveMarginTop]
* link:Slider.adoc#effectiveminheight[effectiveMinHeight]
* link:Slider.adoc#effectiveminwidth[effectiveMinWidth]
* link:Slider.adoc#effectivepaddingbottom[effectivePaddingBottom]
* link:Slider.adoc#effectivepaddingleft[effectivePaddingLeft]
* link:Slider.adoc#effectivepaddingright[effectivePaddingRight]
* link:Slider.adoc#effectivepaddingtop[effectivePaddingTop]
* link:Slider.adoc#effectivetop[effectiveTop]
* link:Slider.adoc#effectivewidth[effectiveWidth]
* link:Slider.adoc#flexgrow[flexGrow]
* link:Slider.adoc#flexshrink[flexShrink]
* link:Slider.adoc#flexwrapbefore[flexWrapBefore]
* link:Slider.adoc#height[height]
* link:Slider.adoc#horizontalalignment[horizontalAlignment]
* link:Slider.adoc#id[id]
* link:Slider.adoc#ignoretouchanimation[ignoreTouchAnimation]
* link:Slider.adoc#ios[ios]
* link:Slider.adoc#iosignoresafearea[iosIgnoreSafeArea]
* link:Slider.adoc#iosoverflowsafearea[iosOverflowSafeArea]
* link:Slider.adoc#iosoverflowsafeareaenabled[iosOverflowSafeAreaEnabled]
* link:Slider.adoc#iscollapsed[isCollapsed]
* link:Slider.adoc#isenabled[isEnabled]
* link:Slider.adoc#islayoutrequired[isLayoutRequired]
* link:Slider.adoc#islayoutvalid[isLayoutValid]
* link:Slider.adoc#isuserinteractionenabled[isUserInteractionEnabled]
* link:Slider.adoc#left[left]
* link:Slider.adoc#margin[margin]
* link:Slider.adoc#marginbottom[marginBottom]
* link:Slider.adoc#marginleft[marginLeft]
* link:Slider.adoc#marginright[marginRight]
* link:Slider.adoc#margintop[marginTop]
* link:Slider.adoc#maxvalue[maxValue]
* link:Slider.adoc#minheight[minHeight]
* link:Slider.adoc#minvalue[minValue]
* link:Slider.adoc#minwidth[minWidth]
* link:Slider.adoc#modal[modal]
* link:Slider.adoc#nativeviewprotected[nativeViewProtected]
* link:Slider.adoc#opacity[opacity]
* link:Slider.adoc#order[order]
* link:Slider.adoc#originx[originX]
* link:Slider.adoc#originy[originY]
* link:Slider.adoc#parent[parent]
* link:Slider.adoc#perspective[perspective]
* link:Slider.adoc#recyclenativeview[recycleNativeView]
* link:Slider.adoc#reusable[reusable]
* link:Slider.adoc#rotate[rotate]
* link:Slider.adoc#rotatex[rotateX]
* link:Slider.adoc#rotatey[rotateY]
* link:Slider.adoc#row[row]
* link:Slider.adoc#rowspan[rowSpan]
* link:Slider.adoc#scalex[scaleX]
* link:Slider.adoc#scaley[scaleY]
* link:Slider.adoc#testid[testID]
* link:Slider.adoc#top[top]
* link:Slider.adoc#touchanimation[touchAnimation]
* link:Slider.adoc#touchdelay[touchDelay]
* link:Slider.adoc#translatex[translateX]
* link:Slider.adoc#translatey[translateY]
* link:Slider.adoc#value[value]
* link:Slider.adoc#verticalalignment[verticalAlignment]
* link:Slider.adoc#viewcontroller[viewController]
* link:Slider.adoc#visibility[visibility]
* link:Slider.adoc#width[width]
* link:Slider.adoc#accessibilityblurevent[accessibilityBlurEvent]
* link:Slider.adoc#accessibilitydecrementevent[accessibilityDecrementEvent]
* link:Slider.adoc#accessibilityfocuschangedevent[accessibilityFocusChangedEvent]
* link:Slider.adoc#accessibilityfocusevent[accessibilityFocusEvent]
* link:Slider.adoc#accessibilityincrementevent[accessibilityIncrementEvent]
* link:Slider.adoc#accessibilityperformescapeevent[accessibilityPerformEscapeEvent]
* link:Slider.adoc#createdevent[createdEvent]
* link:Slider.adoc#disposenativeviewevent[disposeNativeViewEvent]
* link:Slider.adoc#layoutchangedevent[layoutChangedEvent]
* link:Slider.adoc#loadedevent[loadedEvent]
* link:Slider.adoc#propertychangeevent[propertyChangeEvent]
* link:Slider.adoc#showingmodallyevent[showingModallyEvent]
* link:Slider.adoc#shownmodallyevent[shownModallyEvent]
* link:Slider.adoc#unloadedevent[unloadedEvent]

=== Accessors

* link:Slider.adoc#backgroundposition[backgroundPosition]
* link:Slider.adoc#backgroundrepeat[backgroundRepeat]
* link:Slider.adoc#backgroundsize[backgroundSize]
* link:Slider.adoc#class[class]
* link:Slider.adoc#isloaded[isLoaded]
* link:Slider.adoc#nativeview[nativeView]
* link:Slider.adoc#page[page]
* link:Slider.adoc#parentnode[parentNode]
* link:Slider.adoc#style[style]
* link:Slider.adoc#texttransform[textTransform]
* link:Slider.adoc#typename[typeName]

=== Methods

* link:Slider.adoc#_addview[_addView]
* link:Slider.adoc#_addviewcore[_addViewCore]
* link:Slider.adoc#_addviewtonativevisualtree[_addViewToNativeVisualTree]
* link:Slider.adoc#_applybackground[_applyBackground]
* link:Slider.adoc#_applyxmlattribute[_applyXmlAttribute]
* link:Slider.adoc#_batchupdate[_batchUpdate]
* link:Slider.adoc#_childindextonativechildindex[_childIndexToNativeChildIndex]
* link:Slider.adoc#_closeallmodalviewsinternal[_closeAllModalViewsInternal]
* link:Slider.adoc#_createpropertychangedata[_createPropertyChangeData]
* link:Slider.adoc#_dialogclosed[_dialogClosed]
* link:Slider.adoc#_eachlayoutview[_eachLayoutView]
* link:Slider.adoc#_emit[_emit]
* link:Slider.adoc#_getcurrentlayoutbounds[_getCurrentLayoutBounds]
* link:Slider.adoc#_getfragmentmanager[_getFragmentManager]
* link:Slider.adoc#_getnativeviewscount[_getNativeViewsCount]
* link:Slider.adoc#_getrootmodalviews[_getRootModalViews]
* link:Slider.adoc#_getvalue[_getValue]
* link:Slider.adoc#_gotovisualstate[_goToVisualState]
* link:Slider.adoc#_handlelivesync[_handleLivesync]
* link:Slider.adoc#_hasancestorview[_hasAncestorView]
* link:Slider.adoc#_hidenativemodalview[_hideNativeModalView]
* link:Slider.adoc#_inheritstylescope[_inheritStyleScope]
* link:Slider.adoc#_layoutparent[_layoutParent]
* link:Slider.adoc#_observe[_observe]
* link:Slider.adoc#_onattachedtowindow[_onAttachedToWindow]
* link:Slider.adoc#_oncssstatechange[_onCssStateChange]
* link:Slider.adoc#_ondetachedfromwindow[_onDetachedFromWindow]
* link:Slider.adoc#_onlivesync[_onLivesync]
* link:Slider.adoc#_onrootviewreset[_onRootViewReset]
* link:Slider.adoc#_onsizechanged[_onSizeChanged]
* link:Slider.adoc#_parentchanged[_parentChanged]
* link:Slider.adoc#_raiselayoutchangedevent[_raiseLayoutChangedEvent]
* link:Slider.adoc#_raiseshowingmodallyevent[_raiseShowingModallyEvent]
* link:Slider.adoc#_raiseshownmodallyevent[_raiseShownModallyEvent]
* link:Slider.adoc#_redrawnativebackground[_redrawNativeBackground]
* link:Slider.adoc#_removeanimation[_removeAnimation]
* link:Slider.adoc#_removeview[_removeView]
* link:Slider.adoc#_removeviewcore[_removeViewCore]
* link:Slider.adoc#_removeviewfromnativevisualtree[_removeViewFromNativeVisualTree]
* link:Slider.adoc#_resumenativeupdates[_resumeNativeUpdates]
* link:Slider.adoc#_setcurrentlayoutbounds[_setCurrentLayoutBounds]
* link:Slider.adoc#_setcurrentmeasurespecs[_setCurrentMeasureSpecs]
* link:Slider.adoc#_setminheightnative[_setMinHeightNative]
* link:Slider.adoc#_setminwidthnative[_setMinWidthNative]
* link:Slider.adoc#_setnativecliptobounds[_setNativeClipToBounds]
* link:Slider.adoc#_setnativeviewframe[_setNativeViewFrame]
* link:Slider.adoc#_setvalue[_setValue]
* link:Slider.adoc#_setupasrootview[_setupAsRootView]
* link:Slider.adoc#_setupui[_setupUI]
* link:Slider.adoc#_shoulddelaylayout[_shouldDelayLayout]
* link:Slider.adoc#_shownativemodalview[_showNativeModalView]
* link:Slider.adoc#_suspendnativeupdates[_suspendNativeUpdates]
* link:Slider.adoc#_teardownui[_tearDownUI]
* link:Slider.adoc#_updateeffectivelayoutvalues[_updateEffectiveLayoutValues]
* link:Slider.adoc#_updatestylescope[_updateStyleScope]
* link:Slider.adoc#accessibilityannouncement[accessibilityAnnouncement]
* link:Slider.adoc#accessibilityscreenchanged[accessibilityScreenChanged]
* link:Slider.adoc#addcss[addCss]
* link:Slider.adoc#addcssfile[addCssFile]
* link:Slider.adoc#addeventlistener[addEventListener]
* link:Slider.adoc#addpseudoclass[addPseudoClass]
* link:Slider.adoc#animate[animate]
* link:Slider.adoc#bind[bind]
* link:Slider.adoc#callloaded[callLoaded]
* link:Slider.adoc#callunloaded[callUnloaded]
* link:Slider.adoc#changecssfile[changeCssFile]
* link:Slider.adoc#closemodal[closeModal]
* link:Slider.adoc#createanimation[createAnimation]
* link:Slider.adoc#createnativeview[createNativeView]
* link:Slider.adoc#deletepseudoclass[deletePseudoClass]
* link:Slider.adoc#destroynode[destroyNode]
* link:Slider.adoc#disposenativeview[disposeNativeView]
* link:Slider.adoc#eachchild[eachChild]
* link:Slider.adoc#eachchildview[eachChildView]
* link:Slider.adoc#ensuredomnode[ensureDomNode]
* link:Slider.adoc#focus[focus]
* link:Slider.adoc#get[get]
* link:Slider.adoc#getactualsize[getActualSize]
* link:Slider.adoc#getgestureobservers[getGestureObservers]
* link:Slider.adoc#getlocationinwindow[getLocationInWindow]
* link:Slider.adoc#getlocationonscreen[getLocationOnScreen]
* link:Slider.adoc#getlocationrelativeto[getLocationRelativeTo]
* link:Slider.adoc#getmeasuredheight[getMeasuredHeight]
* link:Slider.adoc#getmeasuredstate[getMeasuredState]
* link:Slider.adoc#getmeasuredwidth[getMeasuredWidth]
* link:Slider.adoc#getsafeareainsets[getSafeAreaInsets]
* link:Slider.adoc#getviewbydomid[getViewByDomId]
* link:Slider.adoc#getviewbyid[getViewById]
* link:Slider.adoc#hasgestureobservers[hasGestureObservers]
* link:Slider.adoc#haslisteners[hasListeners]
* link:Slider.adoc#initnativeview[initNativeView]
* link:Slider.adoc#layout[layout]
* link:Slider.adoc#layoutnativeview[layoutNativeView]
* link:Slider.adoc#loadview[loadView]
* link:Slider.adoc#measure[measure]
* link:Slider.adoc#notify[notify]
* link:Slider.adoc#notifypropertychange[notifyPropertyChange]
* link:Slider.adoc#off[off]
* link:Slider.adoc#on[on]
* link:Slider.adoc#onbackpressed[onBackPressed]
* link:Slider.adoc#onlayout[onLayout]
* link:Slider.adoc#onloaded[onLoaded]
* link:Slider.adoc#onmeasure[onMeasure]
* link:Slider.adoc#onresumenativeupdates[onResumeNativeUpdates]
* link:Slider.adoc#onunloaded[onUnloaded]
* link:Slider.adoc#once[once]
* link:Slider.adoc#removeeventlistener[removeEventListener]
* link:Slider.adoc#requestlayout[requestLayout]
* link:Slider.adoc#resetnativeview[resetNativeView]
* link:Slider.adoc#sendaccessibilityevent[sendAccessibilityEvent]
* link:Slider.adoc#set[set]
* link:Slider.adoc#setinlinestyle[setInlineStyle]
* link:Slider.adoc#setmeasureddimension[setMeasuredDimension]
* link:Slider.adoc#setnativeview[setNativeView]
* link:Slider.adoc#setontouchlistener[setOnTouchListener]
* link:Slider.adoc#setproperty[setProperty]
* link:Slider.adoc#settestid[setTestID]
* link:Slider.adoc#showmodal[showModal]
* link:Slider.adoc#tostring[toString]
* link:Slider.adoc#unbind[unbind]
* link:Slider.adoc#unloadview[unloadView]
* link:Slider.adoc#addeventlistener-1[addEventListener]
* link:Slider.adoc#combinemeasuredstates[combineMeasuredStates]
* link:Slider.adoc#layoutchild[layoutChild]
* link:Slider.adoc#measurechild[measureChild]
* link:Slider.adoc#off-1[off]
* link:Slider.adoc#on-1[on]
* link:Slider.adoc#once-1[once]
* link:Slider.adoc#removeeventlistener-1[removeEventListener]
* link:Slider.adoc#resolvesizeandstate[resolveSizeAndState]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/slider/index.d.ts#L41[ui/slider/index.d.ts:41]
...
Gets the native http://developer.android.com/reference/android/widget/SeekBar.html[android widget] that represents the user interface for this component.
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/slider/index.d.ts#L16[ui/slider/index.d.ts:16]
...
Gets the native iOS https://developer.apple.com/library/ios/documentation/UIKit/Reference/UISlider_Class/[UISlider] that represents the user interface for this component.
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/slider/index.d.ts#L21[ui/slider/index.d.ts:21]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/slider/index.d.ts#L36[ui/slider/index.d.ts:36]
...
Gets or sets a slider min value.
The default value is 0.

==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/slider/index.d.ts#L31[ui/slider/index.d.ts:31]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/slider/index.d.ts#L26[ui/slider/index.d.ts:26]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/slider/index.d.ts#L10[ui/slider/index.d.ts:10]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/slider/index.d.ts#L11[ui/slider/index.d.ts:11]
