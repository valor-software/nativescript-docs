...
xref:../README.adoc[NativeScript] / xref:../modules.adoc[Exports] / SegmentedBar
...
* link:SegmentedBar.adoc#constructor[constructor]

=== Properties

* link:SegmentedBar.adoc#_androidcontentdescriptionupdated[_androidContentDescriptionUpdated]
* link:SegmentedBar.adoc#_automaticallyadjustsscrollviewinsets[_automaticallyAdjustsScrollViewInsets]
* link:SegmentedBar.adoc#_closemodalcallback[_closeModalCallback]
* link:SegmentedBar.adoc#_context[_context]
* link:SegmentedBar.adoc#_cssstate[_cssState]
* link:SegmentedBar.adoc#_currentheightmeasurespec[_currentHeightMeasureSpec]
* link:SegmentedBar.adoc#_currentwidthmeasurespec[_currentWidthMeasureSpec]
* link:SegmentedBar.adoc#_defaultpaddingbottom[_defaultPaddingBottom]
* link:SegmentedBar.adoc#_defaultpaddingleft[_defaultPaddingLeft]
* link:SegmentedBar.adoc#_defaultpaddingright[_defaultPaddingRight]
* link:SegmentedBar.adoc#_defaultpaddingtop[_defaultPaddingTop]
* link:SegmentedBar.adoc#_domid[_domId]
* link:SegmentedBar.adoc#_gestureobservers[_gestureObservers]
* link:SegmentedBar.adoc#_ignoreflexminwidthheightreset[_ignoreFlexMinWidthHeightReset]
* link:SegmentedBar.adoc#_isaddedtonativevisualtree[_isAddedToNativeVisualTree]
* link:SegmentedBar.adoc#_islayoutvalid[_isLayoutValid]
* link:SegmentedBar.adoc#_ispaddingrelative[_isPaddingRelative]
* link:SegmentedBar.adoc#_isstylescopehost[_isStyleScopeHost]
* link:SegmentedBar.adoc#_isviewbase[_isViewBase]
* link:SegmentedBar.adoc#_manager[_manager]
* link:SegmentedBar.adoc#_modalparent[_modalParent]
* link:SegmentedBar.adoc#_modulename[_moduleName]
* link:SegmentedBar.adoc#_oldbottom[_oldBottom]
* link:SegmentedBar.adoc#_oldleft[_oldLeft]
* link:SegmentedBar.adoc#_oldright[_oldRight]
* link:SegmentedBar.adoc#_oldtop[_oldTop]
* link:SegmentedBar.adoc#_stylescope[_styleScope]
* link:SegmentedBar.adoc#_suspendnativeupdatescount[_suspendNativeUpdatesCount]
* link:SegmentedBar.adoc#_suspendedupdates[_suspendedUpdates]
* link:SegmentedBar.adoc#accessibilityhidden[accessibilityHidden]
* link:SegmentedBar.adoc#accessibilityhint[accessibilityHint]
* link:SegmentedBar.adoc#accessibilityidentifier[accessibilityIdentifier]
* link:SegmentedBar.adoc#accessibilitylabel[accessibilityLabel]
* link:SegmentedBar.adoc#accessibilitylanguage[accessibilityLanguage]
* link:SegmentedBar.adoc#accessibilityliveregion[accessibilityLiveRegion]
* link:SegmentedBar.adoc#accessibilitymediasession[accessibilityMediaSession]
* link:SegmentedBar.adoc#accessibilityrole[accessibilityRole]
* link:SegmentedBar.adoc#accessibilitystate[accessibilityState]
* link:SegmentedBar.adoc#accessibilityvalue[accessibilityValue]
* link:SegmentedBar.adoc#accessible[accessible]
* link:SegmentedBar.adoc#alignself[alignSelf]
* link:SegmentedBar.adoc#android[android]
* link:SegmentedBar.adoc#androiddynamicelevationoffset[androidDynamicElevationOffset]
* link:SegmentedBar.adoc#androidelevation[androidElevation]
* link:SegmentedBar.adoc#automationtext[automationText]
* link:SegmentedBar.adoc#background[background]
* link:SegmentedBar.adoc#backgroundcolor[backgroundColor]
* link:SegmentedBar.adoc#backgroundimage[backgroundImage]
* link:SegmentedBar.adoc#bindingcontext[bindingContext]
* link:SegmentedBar.adoc#borderbottomcolor[borderBottomColor]
* link:SegmentedBar.adoc#borderbottomleftradius[borderBottomLeftRadius]
* link:SegmentedBar.adoc#borderbottomrightradius[borderBottomRightRadius]
* link:SegmentedBar.adoc#borderbottomwidth[borderBottomWidth]
* link:SegmentedBar.adoc#bordercolor[borderColor]
* link:SegmentedBar.adoc#borderleftcolor[borderLeftColor]
* link:SegmentedBar.adoc#borderleftwidth[borderLeftWidth]
* link:SegmentedBar.adoc#borderradius[borderRadius]
* link:SegmentedBar.adoc#borderrightcolor[borderRightColor]
* link:SegmentedBar.adoc#borderrightwidth[borderRightWidth]
* link:SegmentedBar.adoc#bordertopcolor[borderTopColor]
* link:SegmentedBar.adoc#bordertopleftradius[borderTopLeftRadius]
* link:SegmentedBar.adoc#bordertoprightradius[borderTopRightRadius]
* link:SegmentedBar.adoc#bordertopwidth[borderTopWidth]
* link:SegmentedBar.adoc#borderwidth[borderWidth]
* link:SegmentedBar.adoc#boxshadow[boxShadow]
* link:SegmentedBar.adoc#classname[className]
* link:SegmentedBar.adoc#col[col]
* link:SegmentedBar.adoc#colspan[colSpan]
* link:SegmentedBar.adoc#color[color]
* link:SegmentedBar.adoc#column[column]
* link:SegmentedBar.adoc#columnspan[columnSpan]
* link:SegmentedBar.adoc#css[css]
* link:SegmentedBar.adoc#cssclasses[cssClasses]
* link:SegmentedBar.adoc#csspseudoclasses[cssPseudoClasses]
* link:SegmentedBar.adoc#csstype[cssType]
* link:SegmentedBar.adoc#dock[dock]
* link:SegmentedBar.adoc#domnode[domNode]
* link:SegmentedBar.adoc#effectiveborderbottomwidth[effectiveBorderBottomWidth]
* link:SegmentedBar.adoc#effectiveborderleftwidth[effectiveBorderLeftWidth]
* link:SegmentedBar.adoc#effectiveborderrightwidth[effectiveBorderRightWidth]
* link:SegmentedBar.adoc#effectivebordertopwidth[effectiveBorderTopWidth]
* link:SegmentedBar.adoc#effectiveheight[effectiveHeight]
* link:SegmentedBar.adoc#effectiveleft[effectiveLeft]
* link:SegmentedBar.adoc#effectivemarginbottom[effectiveMarginBottom]
* link:SegmentedBar.adoc#effectivemarginleft[effectiveMarginLeft]
* link:SegmentedBar.adoc#effectivemarginright[effectiveMarginRight]
* link:SegmentedBar.adoc#effectivemargintop[effectiveMarginTop]
* link:SegmentedBar.adoc#effectiveminheight[effectiveMinHeight]
* link:SegmentedBar.adoc#effectiveminwidth[effectiveMinWidth]
* link:SegmentedBar.adoc#effectivepaddingbottom[effectivePaddingBottom]
* link:SegmentedBar.adoc#effectivepaddingleft[effectivePaddingLeft]
* link:SegmentedBar.adoc#effectivepaddingright[effectivePaddingRight]
* link:SegmentedBar.adoc#effectivepaddingtop[effectivePaddingTop]
* link:SegmentedBar.adoc#effectivetop[effectiveTop]
* link:SegmentedBar.adoc#effectivewidth[effectiveWidth]
* link:SegmentedBar.adoc#flexgrow[flexGrow]
* link:SegmentedBar.adoc#flexshrink[flexShrink]
* link:SegmentedBar.adoc#flexwrapbefore[flexWrapBefore]
* link:SegmentedBar.adoc#height[height]
* link:SegmentedBar.adoc#horizontalalignment[horizontalAlignment]
* link:SegmentedBar.adoc#id[id]
* link:SegmentedBar.adoc#ignoretouchanimation[ignoreTouchAnimation]
* link:SegmentedBar.adoc#ios[ios]
* link:SegmentedBar.adoc#iosignoresafearea[iosIgnoreSafeArea]
* link:SegmentedBar.adoc#iosoverflowsafearea[iosOverflowSafeArea]
* link:SegmentedBar.adoc#iosoverflowsafeareaenabled[iosOverflowSafeAreaEnabled]
* link:SegmentedBar.adoc#iscollapsed[isCollapsed]
* link:SegmentedBar.adoc#isenabled[isEnabled]
* link:SegmentedBar.adoc#islayoutrequired[isLayoutRequired]
* link:SegmentedBar.adoc#islayoutvalid[isLayoutValid]
* link:SegmentedBar.adoc#isuserinteractionenabled[isUserInteractionEnabled]
* link:SegmentedBar.adoc#items[items]
* link:SegmentedBar.adoc#left[left]
* link:SegmentedBar.adoc#margin[margin]
* link:SegmentedBar.adoc#marginbottom[marginBottom]
* link:SegmentedBar.adoc#marginleft[marginLeft]
* link:SegmentedBar.adoc#marginright[marginRight]
* link:SegmentedBar.adoc#margintop[marginTop]
* link:SegmentedBar.adoc#minheight[minHeight]
* link:SegmentedBar.adoc#minwidth[minWidth]
* link:SegmentedBar.adoc#modal[modal]
* link:SegmentedBar.adoc#nativeviewprotected[nativeViewProtected]
* link:SegmentedBar.adoc#opacity[opacity]
* link:SegmentedBar.adoc#order[order]
* link:SegmentedBar.adoc#originx[originX]
* link:SegmentedBar.adoc#originy[originY]
* link:SegmentedBar.adoc#parent[parent]
* link:SegmentedBar.adoc#perspective[perspective]
* link:SegmentedBar.adoc#recyclenativeview[recycleNativeView]
* link:SegmentedBar.adoc#reusable[reusable]
* link:SegmentedBar.adoc#rotate[rotate]
* link:SegmentedBar.adoc#rotatex[rotateX]
* link:SegmentedBar.adoc#rotatey[rotateY]
* link:SegmentedBar.adoc#row[row]
* link:SegmentedBar.adoc#rowspan[rowSpan]
* link:SegmentedBar.adoc#scalex[scaleX]
* link:SegmentedBar.adoc#scaley[scaleY]
* link:SegmentedBar.adoc#selectedbackgroundcolor[selectedBackgroundColor]
* link:SegmentedBar.adoc#selectedindex[selectedIndex]
* link:SegmentedBar.adoc#testid[testID]
* link:SegmentedBar.adoc#top[top]
* link:SegmentedBar.adoc#touchanimation[touchAnimation]
* link:SegmentedBar.adoc#touchdelay[touchDelay]
* link:SegmentedBar.adoc#translatex[translateX]
* link:SegmentedBar.adoc#translatey[translateY]
* link:SegmentedBar.adoc#verticalalignment[verticalAlignment]
* link:SegmentedBar.adoc#viewcontroller[viewController]
* link:SegmentedBar.adoc#visibility[visibility]
* link:SegmentedBar.adoc#width[width]
* link:SegmentedBar.adoc#accessibilityblurevent[accessibilityBlurEvent]
* link:SegmentedBar.adoc#accessibilityfocuschangedevent[accessibilityFocusChangedEvent]
* link:SegmentedBar.adoc#accessibilityfocusevent[accessibilityFocusEvent]
* link:SegmentedBar.adoc#accessibilityperformescapeevent[accessibilityPerformEscapeEvent]
* link:SegmentedBar.adoc#createdevent[createdEvent]
* link:SegmentedBar.adoc#disposenativeviewevent[disposeNativeViewEvent]
* link:SegmentedBar.adoc#layoutchangedevent[layoutChangedEvent]
* link:SegmentedBar.adoc#loadedevent[loadedEvent]
* link:SegmentedBar.adoc#propertychangeevent[propertyChangeEvent]
* link:SegmentedBar.adoc#selectedindexchangedevent[selectedIndexChangedEvent]
* link:SegmentedBar.adoc#showingmodallyevent[showingModallyEvent]
* link:SegmentedBar.adoc#shownmodallyevent[shownModallyEvent]
* link:SegmentedBar.adoc#unloadedevent[unloadedEvent]

=== Accessors

* link:SegmentedBar.adoc#backgroundposition[backgroundPosition]
* link:SegmentedBar.adoc#backgroundrepeat[backgroundRepeat]
* link:SegmentedBar.adoc#backgroundsize[backgroundSize]
* link:SegmentedBar.adoc#class[class]
* link:SegmentedBar.adoc#isloaded[isLoaded]
* link:SegmentedBar.adoc#nativeview[nativeView]
* link:SegmentedBar.adoc#page[page]
* link:SegmentedBar.adoc#parentnode[parentNode]
* link:SegmentedBar.adoc#style[style]
* link:SegmentedBar.adoc#texttransform[textTransform]
* link:SegmentedBar.adoc#typename[typeName]

=== Methods

* link:SegmentedBar.adoc#_addarrayfrombuilder[_addArrayFromBuilder]
* link:SegmentedBar.adoc#_addchildfrombuilder[_addChildFromBuilder]
* link:SegmentedBar.adoc#_addview[_addView]
* link:SegmentedBar.adoc#_addviewcore[_addViewCore]
* link:SegmentedBar.adoc#_addviewtonativevisualtree[_addViewToNativeVisualTree]
* link:SegmentedBar.adoc#_applybackground[_applyBackground]
* link:SegmentedBar.adoc#_applyxmlattribute[_applyXmlAttribute]
* link:SegmentedBar.adoc#_batchupdate[_batchUpdate]
* link:SegmentedBar.adoc#_childindextonativechildindex[_childIndexToNativeChildIndex]
* link:SegmentedBar.adoc#_closeallmodalviewsinternal[_closeAllModalViewsInternal]
* link:SegmentedBar.adoc#_createpropertychangedata[_createPropertyChangeData]
* link:SegmentedBar.adoc#_dialogclosed[_dialogClosed]
* link:SegmentedBar.adoc#_eachlayoutview[_eachLayoutView]
* link:SegmentedBar.adoc#_emit[_emit]
* link:SegmentedBar.adoc#_getcurrentlayoutbounds[_getCurrentLayoutBounds]
* link:SegmentedBar.adoc#_getfragmentmanager[_getFragmentManager]
* link:SegmentedBar.adoc#_getnativeviewscount[_getNativeViewsCount]
* link:SegmentedBar.adoc#_getrootmodalviews[_getRootModalViews]
* link:SegmentedBar.adoc#_getvalue[_getValue]
* link:SegmentedBar.adoc#_gotovisualstate[_goToVisualState]
* link:SegmentedBar.adoc#_handlelivesync[_handleLivesync]
* link:SegmentedBar.adoc#_hasancestorview[_hasAncestorView]
* link:SegmentedBar.adoc#_hidenativemodalview[_hideNativeModalView]
* link:SegmentedBar.adoc#_inheritstylescope[_inheritStyleScope]
* link:SegmentedBar.adoc#_layoutparent[_layoutParent]
* link:SegmentedBar.adoc#_observe[_observe]
* link:SegmentedBar.adoc#_onattachedtowindow[_onAttachedToWindow]
* link:SegmentedBar.adoc#_oncssstatechange[_onCssStateChange]
* link:SegmentedBar.adoc#_ondetachedfromwindow[_onDetachedFromWindow]
* link:SegmentedBar.adoc#_onlivesync[_onLivesync]
* link:SegmentedBar.adoc#_onrootviewreset[_onRootViewReset]
* link:SegmentedBar.adoc#_onsizechanged[_onSizeChanged]
* link:SegmentedBar.adoc#_parentchanged[_parentChanged]
* link:SegmentedBar.adoc#_raiselayoutchangedevent[_raiseLayoutChangedEvent]
* link:SegmentedBar.adoc#_raiseshowingmodallyevent[_raiseShowingModallyEvent]
* link:SegmentedBar.adoc#_raiseshownmodallyevent[_raiseShownModallyEvent]
* link:SegmentedBar.adoc#_redrawnativebackground[_redrawNativeBackground]
* link:SegmentedBar.adoc#_removeanimation[_removeAnimation]
* link:SegmentedBar.adoc#_removeview[_removeView]
* link:SegmentedBar.adoc#_removeviewcore[_removeViewCore]
* link:SegmentedBar.adoc#_removeviewfromnativevisualtree[_removeViewFromNativeVisualTree]
* link:SegmentedBar.adoc#_resumenativeupdates[_resumeNativeUpdates]
* link:SegmentedBar.adoc#_setcurrentlayoutbounds[_setCurrentLayoutBounds]
* link:SegmentedBar.adoc#_setcurrentmeasurespecs[_setCurrentMeasureSpecs]
* link:SegmentedBar.adoc#_setminheightnative[_setMinHeightNative]
* link:SegmentedBar.adoc#_setminwidthnative[_setMinWidthNative]
* link:SegmentedBar.adoc#_setnativecliptobounds[_setNativeClipToBounds]
* link:SegmentedBar.adoc#_setnativeviewframe[_setNativeViewFrame]
* link:SegmentedBar.adoc#_setvalue[_setValue]
* link:SegmentedBar.adoc#_setupasrootview[_setupAsRootView]
* link:SegmentedBar.adoc#_setupui[_setupUI]
* link:SegmentedBar.adoc#_shoulddelaylayout[_shouldDelayLayout]
* link:SegmentedBar.adoc#_shownativemodalview[_showNativeModalView]
* link:SegmentedBar.adoc#_suspendnativeupdates[_suspendNativeUpdates]
* link:SegmentedBar.adoc#_teardownui[_tearDownUI]
* link:SegmentedBar.adoc#_updateeffectivelayoutvalues[_updateEffectiveLayoutValues]
* link:SegmentedBar.adoc#_updatestylescope[_updateStyleScope]
* link:SegmentedBar.adoc#accessibilityannouncement[accessibilityAnnouncement]
* link:SegmentedBar.adoc#accessibilityscreenchanged[accessibilityScreenChanged]
* link:SegmentedBar.adoc#addcss[addCss]
* link:SegmentedBar.adoc#addcssfile[addCssFile]
* link:SegmentedBar.adoc#addeventlistener[addEventListener]
* link:SegmentedBar.adoc#addpseudoclass[addPseudoClass]
* link:SegmentedBar.adoc#animate[animate]
* link:SegmentedBar.adoc#bind[bind]
* link:SegmentedBar.adoc#callloaded[callLoaded]
* link:SegmentedBar.adoc#callunloaded[callUnloaded]
* link:SegmentedBar.adoc#changecssfile[changeCssFile]
* link:SegmentedBar.adoc#closemodal[closeModal]
* link:SegmentedBar.adoc#createanimation[createAnimation]
* link:SegmentedBar.adoc#createnativeview[createNativeView]
* link:SegmentedBar.adoc#deletepseudoclass[deletePseudoClass]
* link:SegmentedBar.adoc#destroynode[destroyNode]
* link:SegmentedBar.adoc#disposenativeview[disposeNativeView]
* link:SegmentedBar.adoc#eachchild[eachChild]
* link:SegmentedBar.adoc#eachchildview[eachChildView]
* link:SegmentedBar.adoc#ensuredomnode[ensureDomNode]
* link:SegmentedBar.adoc#focus[focus]
* link:SegmentedBar.adoc#get[get]
* link:SegmentedBar.adoc#getactualsize[getActualSize]
* link:SegmentedBar.adoc#getgestureobservers[getGestureObservers]
* link:SegmentedBar.adoc#getlocationinwindow[getLocationInWindow]
* link:SegmentedBar.adoc#getlocationonscreen[getLocationOnScreen]
* link:SegmentedBar.adoc#getlocationrelativeto[getLocationRelativeTo]
* link:SegmentedBar.adoc#getmeasuredheight[getMeasuredHeight]
* link:SegmentedBar.adoc#getmeasuredstate[getMeasuredState]
* link:SegmentedBar.adoc#getmeasuredwidth[getMeasuredWidth]
* link:SegmentedBar.adoc#getsafeareainsets[getSafeAreaInsets]
* link:SegmentedBar.adoc#getviewbydomid[getViewByDomId]
* link:SegmentedBar.adoc#getviewbyid[getViewById]
* link:SegmentedBar.adoc#hasgestureobservers[hasGestureObservers]
* link:SegmentedBar.adoc#haslisteners[hasListeners]
* link:SegmentedBar.adoc#initnativeview[initNativeView]
* link:SegmentedBar.adoc#layout[layout]
* link:SegmentedBar.adoc#layoutnativeview[layoutNativeView]
* link:SegmentedBar.adoc#loadview[loadView]
* link:SegmentedBar.adoc#measure[measure]
* link:SegmentedBar.adoc#notify[notify]
* link:SegmentedBar.adoc#notifypropertychange[notifyPropertyChange]
* link:SegmentedBar.adoc#off[off]
* link:SegmentedBar.adoc#on[on]
* link:SegmentedBar.adoc#onbackpressed[onBackPressed]
* link:SegmentedBar.adoc#onlayout[onLayout]
* link:SegmentedBar.adoc#onloaded[onLoaded]
* link:SegmentedBar.adoc#onmeasure[onMeasure]
* link:SegmentedBar.adoc#onresumenativeupdates[onResumeNativeUpdates]
* link:SegmentedBar.adoc#onunloaded[onUnloaded]
* link:SegmentedBar.adoc#once[once]
* link:SegmentedBar.adoc#removeeventlistener[removeEventListener]
* link:SegmentedBar.adoc#requestlayout[requestLayout]
* link:SegmentedBar.adoc#resetnativeview[resetNativeView]
* link:SegmentedBar.adoc#sendaccessibilityevent[sendAccessibilityEvent]
* link:SegmentedBar.adoc#set[set]
* link:SegmentedBar.adoc#setinlinestyle[setInlineStyle]
* link:SegmentedBar.adoc#setmeasureddimension[setMeasuredDimension]
* link:SegmentedBar.adoc#setnativeview[setNativeView]
* link:SegmentedBar.adoc#setontouchlistener[setOnTouchListener]
* link:SegmentedBar.adoc#setproperty[setProperty]
* link:SegmentedBar.adoc#settestid[setTestID]
* link:SegmentedBar.adoc#showmodal[showModal]
* link:SegmentedBar.adoc#tostring[toString]
* link:SegmentedBar.adoc#unbind[unbind]
* link:SegmentedBar.adoc#unloadview[unloadView]
* link:SegmentedBar.adoc#addeventlistener-1[addEventListener]
* link:SegmentedBar.adoc#combinemeasuredstates[combineMeasuredStates]
* link:SegmentedBar.adoc#layoutchild[layoutChild]
* link:SegmentedBar.adoc#measurechild[measureChild]
* link:SegmentedBar.adoc#off-1[off]
* link:SegmentedBar.adoc#on-1[on]
* link:SegmentedBar.adoc#once-1[once]
* link:SegmentedBar.adoc#removeeventlistener-1[removeEventListener]
* link:SegmentedBar.adoc#resolvesizeandstate[resolveSizeAndState]
...
==== Inherited from xref:View.adoc[View].link:View.adoc#android[android]
...
==== Inherited from xref:View.adoc[View].link:View.adoc#ios[ios]
...
• *items*: xref:SegmentedBarItem.adoc[`SegmentedBarItem`][]

Gets or sets the items of the SegmentedBar.

==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/segmented-bar/index.d.ts#L50[ui/segmented-bar/index.d.ts:50]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/segmented-bar/index.d.ts#L45[ui/segmented-bar/index.d.ts:45]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/segmented-bar/index.d.ts#L40[ui/segmented-bar/index.d.ts:40]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/segmented-bar/index.d.ts#L55[ui/segmented-bar/index.d.ts:55]
...
xref:../interfaces/AddArrayFromBuilder.adoc[AddArrayFromBuilder].link:../interfaces/AddArrayFromBuilder.adoc#_addarrayfrombuilder[_addArrayFromBuilder]

==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/segmented-bar/index.d.ts#L76[ui/segmented-bar/index.d.ts:76]
...
xref:../interfaces/AddChildFromBuilder.adoc[AddChildFromBuilder].link:../interfaces/AddChildFromBuilder.adoc#_addchildfrombuilder[_addChildFromBuilder]

==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/segmented-bar/index.d.ts#L75[ui/segmented-bar/index.d.ts:75]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/segmented-bar/index.d.ts#L63[ui/segmented-bar/index.d.ts:63]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/segmented-bar/index.d.ts#L68[ui/segmented-bar/index.d.ts:68]
