...
* link:Transition.adoc#constructor[constructor]

=== Properties

* link:Transition.adoc#androidtransitiontype[AndroidTransitionType]

=== Methods

* link:Transition.adoc#animateiostransition[animateIOSTransition]
* link:Transition.adoc#createandroidanimator[createAndroidAnimator]
* link:Transition.adoc#getcurve[getCurve]
* link:Transition.adoc#getduration[getDuration]
* link:Transition.adoc#tostring[toString]
