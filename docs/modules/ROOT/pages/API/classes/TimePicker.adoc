...
xref:../README.adoc[NativeScript] / xref:../modules.adoc[Exports] / TimePicker
...
* link:TimePicker.md#constructor[constructor]

=== Properties

* link:TimePicker.md#_androidcontentdescriptionupdated[_androidContentDescriptionUpdated]
* link:TimePicker.md#_automaticallyadjustsscrollviewinsets[_automaticallyAdjustsScrollViewInsets]
* link:TimePicker.md#_closemodalcallback[_closeModalCallback]
* link:TimePicker.md#_context[_context]
* link:TimePicker.md#_cssstate[_cssState]
* link:TimePicker.md#_currentheightmeasurespec[_currentHeightMeasureSpec]
* link:TimePicker.md#_currentwidthmeasurespec[_currentWidthMeasureSpec]
* link:TimePicker.md#_defaultpaddingbottom[_defaultPaddingBottom]
* link:TimePicker.md#_defaultpaddingleft[_defaultPaddingLeft]
* link:TimePicker.md#_defaultpaddingright[_defaultPaddingRight]
* link:TimePicker.md#_defaultpaddingtop[_defaultPaddingTop]
* link:TimePicker.md#_domid[_domId]
* link:TimePicker.md#_gestureobservers[_gestureObservers]
* link:TimePicker.md#_ignoreflexminwidthheightreset[_ignoreFlexMinWidthHeightReset]
* link:TimePicker.md#_isaddedtonativevisualtree[_isAddedToNativeVisualTree]
* link:TimePicker.md#_islayoutvalid[_isLayoutValid]
* link:TimePicker.md#_ispaddingrelative[_isPaddingRelative]
* link:TimePicker.md#_isstylescopehost[_isStyleScopeHost]
* link:TimePicker.md#_isviewbase[_isViewBase]
* link:TimePicker.md#_manager[_manager]
* link:TimePicker.md#_modalparent[_modalParent]
* link:TimePicker.md#_modulename[_moduleName]
* link:TimePicker.md#_oldbottom[_oldBottom]
* link:TimePicker.md#_oldleft[_oldLeft]
* link:TimePicker.md#_oldright[_oldRight]
* link:TimePicker.md#_oldtop[_oldTop]
* link:TimePicker.md#_stylescope[_styleScope]
* link:TimePicker.md#_suspendnativeupdatescount[_suspendNativeUpdatesCount]
* link:TimePicker.md#_suspendedupdates[_suspendedUpdates]
* link:TimePicker.md#accessibilityhidden[accessibilityHidden]
* link:TimePicker.md#accessibilityhint[accessibilityHint]
* link:TimePicker.md#accessibilityidentifier[accessibilityIdentifier]
* link:TimePicker.md#accessibilitylabel[accessibilityLabel]
* link:TimePicker.md#accessibilitylanguage[accessibilityLanguage]
* link:TimePicker.md#accessibilityliveregion[accessibilityLiveRegion]
* link:TimePicker.md#accessibilitymediasession[accessibilityMediaSession]
* link:TimePicker.md#accessibilityrole[accessibilityRole]
* link:TimePicker.md#accessibilitystate[accessibilityState]
* link:TimePicker.md#accessibilityvalue[accessibilityValue]
* link:TimePicker.md#accessible[accessible]
* link:TimePicker.md#alignself[alignSelf]
* link:TimePicker.md#android[android]
* link:TimePicker.md#androiddynamicelevationoffset[androidDynamicElevationOffset]
* link:TimePicker.md#androidelevation[androidElevation]
* link:TimePicker.md#automationtext[automationText]
* link:TimePicker.md#background[background]
* link:TimePicker.md#backgroundcolor[backgroundColor]
* link:TimePicker.md#backgroundimage[backgroundImage]
* link:TimePicker.md#bindingcontext[bindingContext]
* link:TimePicker.md#borderbottomcolor[borderBottomColor]
* link:TimePicker.md#borderbottomleftradius[borderBottomLeftRadius]
* link:TimePicker.md#borderbottomrightradius[borderBottomRightRadius]
* link:TimePicker.md#borderbottomwidth[borderBottomWidth]
* link:TimePicker.md#bordercolor[borderColor]
* link:TimePicker.md#borderleftcolor[borderLeftColor]
* link:TimePicker.md#borderleftwidth[borderLeftWidth]
* link:TimePicker.md#borderradius[borderRadius]
* link:TimePicker.md#borderrightcolor[borderRightColor]
* link:TimePicker.md#borderrightwidth[borderRightWidth]
* link:TimePicker.md#bordertopcolor[borderTopColor]
* link:TimePicker.md#bordertopleftradius[borderTopLeftRadius]
* link:TimePicker.md#bordertoprightradius[borderTopRightRadius]
* link:TimePicker.md#bordertopwidth[borderTopWidth]
* link:TimePicker.md#borderwidth[borderWidth]
* link:TimePicker.md#boxshadow[boxShadow]
* link:TimePicker.md#classname[className]
* link:TimePicker.md#col[col]
* link:TimePicker.md#colspan[colSpan]
* link:TimePicker.md#color[color]
* link:TimePicker.md#column[column]
* link:TimePicker.md#columnspan[columnSpan]
* link:TimePicker.md#css[css]
* link:TimePicker.md#cssclasses[cssClasses]
* link:TimePicker.md#csspseudoclasses[cssPseudoClasses]
* link:TimePicker.md#csstype[cssType]
* link:TimePicker.md#dock[dock]
* link:TimePicker.md#domnode[domNode]
* link:TimePicker.md#effectiveborderbottomwidth[effectiveBorderBottomWidth]
* link:TimePicker.md#effectiveborderleftwidth[effectiveBorderLeftWidth]
* link:TimePicker.md#effectiveborderrightwidth[effectiveBorderRightWidth]
* link:TimePicker.md#effectivebordertopwidth[effectiveBorderTopWidth]
* link:TimePicker.md#effectiveheight[effectiveHeight]
* link:TimePicker.md#effectiveleft[effectiveLeft]
* link:TimePicker.md#effectivemarginbottom[effectiveMarginBottom]
* link:TimePicker.md#effectivemarginleft[effectiveMarginLeft]
* link:TimePicker.md#effectivemarginright[effectiveMarginRight]
* link:TimePicker.md#effectivemargintop[effectiveMarginTop]
* link:TimePicker.md#effectiveminheight[effectiveMinHeight]
* link:TimePicker.md#effectiveminwidth[effectiveMinWidth]
* link:TimePicker.md#effectivepaddingbottom[effectivePaddingBottom]
* link:TimePicker.md#effectivepaddingleft[effectivePaddingLeft]
* link:TimePicker.md#effectivepaddingright[effectivePaddingRight]
* link:TimePicker.md#effectivepaddingtop[effectivePaddingTop]
* link:TimePicker.md#effectivetop[effectiveTop]
* link:TimePicker.md#effectivewidth[effectiveWidth]
* link:TimePicker.md#flexgrow[flexGrow]
* link:TimePicker.md#flexshrink[flexShrink]
* link:TimePicker.md#flexwrapbefore[flexWrapBefore]
* link:TimePicker.md#height[height]
* link:TimePicker.md#horizontalalignment[horizontalAlignment]
* link:TimePicker.md#hour[hour]
* link:TimePicker.md#id[id]
* link:TimePicker.md#ignoretouchanimation[ignoreTouchAnimation]
* link:TimePicker.md#ios[ios]
* link:TimePicker.md#iosignoresafearea[iosIgnoreSafeArea]
* link:TimePicker.md#iosoverflowsafearea[iosOverflowSafeArea]
* link:TimePicker.md#iosoverflowsafeareaenabled[iosOverflowSafeAreaEnabled]
* link:TimePicker.md#iospreferreddatepickerstyle[iosPreferredDatePickerStyle]
* link:TimePicker.md#iscollapsed[isCollapsed]
* link:TimePicker.md#isenabled[isEnabled]
* link:TimePicker.md#islayoutrequired[isLayoutRequired]
* link:TimePicker.md#islayoutvalid[isLayoutValid]
* link:TimePicker.md#isuserinteractionenabled[isUserInteractionEnabled]
* link:TimePicker.md#left[left]
* link:TimePicker.md#margin[margin]
* link:TimePicker.md#marginbottom[marginBottom]
* link:TimePicker.md#marginleft[marginLeft]
* link:TimePicker.md#marginright[marginRight]
* link:TimePicker.md#margintop[marginTop]
* link:TimePicker.md#maxhour[maxHour]
* link:TimePicker.md#maxminute[maxMinute]
* link:TimePicker.md#minheight[minHeight]
* link:TimePicker.md#minhour[minHour]
* link:TimePicker.md#minminute[minMinute]
* link:TimePicker.md#minwidth[minWidth]
* link:TimePicker.md#minute[minute]
* link:TimePicker.md#minuteinterval[minuteInterval]
* link:TimePicker.md#modal[modal]
* link:TimePicker.md#nativeviewprotected[nativeViewProtected]
* link:TimePicker.md#opacity[opacity]
* link:TimePicker.md#order[order]
* link:TimePicker.md#originx[originX]
* link:TimePicker.md#originy[originY]
* link:TimePicker.md#parent[parent]
* link:TimePicker.md#perspective[perspective]
* link:TimePicker.md#recyclenativeview[recycleNativeView]
* link:TimePicker.md#reusable[reusable]
* link:TimePicker.md#rotate[rotate]
* link:TimePicker.md#rotatex[rotateX]
* link:TimePicker.md#rotatey[rotateY]
* link:TimePicker.md#row[row]
* link:TimePicker.md#rowspan[rowSpan]
* link:TimePicker.md#scalex[scaleX]
* link:TimePicker.md#scaley[scaleY]
* link:TimePicker.md#testid[testID]
* link:TimePicker.md#time[time]
* link:TimePicker.md#top[top]
* link:TimePicker.md#touchanimation[touchAnimation]
* link:TimePicker.md#touchdelay[touchDelay]
* link:TimePicker.md#translatex[translateX]
* link:TimePicker.md#translatey[translateY]
* link:TimePicker.md#verticalalignment[verticalAlignment]
* link:TimePicker.md#viewcontroller[viewController]
* link:TimePicker.md#visibility[visibility]
* link:TimePicker.md#width[width]
* link:TimePicker.md#accessibilityblurevent[accessibilityBlurEvent]
* link:TimePicker.md#accessibilityfocuschangedevent[accessibilityFocusChangedEvent]
* link:TimePicker.md#accessibilityfocusevent[accessibilityFocusEvent]
* link:TimePicker.md#accessibilityperformescapeevent[accessibilityPerformEscapeEvent]
* link:TimePicker.md#createdevent[createdEvent]
* link:TimePicker.md#disposenativeviewevent[disposeNativeViewEvent]
* link:TimePicker.md#layoutchangedevent[layoutChangedEvent]
* link:TimePicker.md#loadedevent[loadedEvent]
* link:TimePicker.md#propertychangeevent[propertyChangeEvent]
* link:TimePicker.md#showingmodallyevent[showingModallyEvent]
* link:TimePicker.md#shownmodallyevent[shownModallyEvent]
* link:TimePicker.md#unloadedevent[unloadedEvent]

=== Accessors

* link:TimePicker.md#backgroundposition[backgroundPosition]
* link:TimePicker.md#backgroundrepeat[backgroundRepeat]
* link:TimePicker.md#backgroundsize[backgroundSize]
* link:TimePicker.md#class[class]
* link:TimePicker.md#isloaded[isLoaded]
* link:TimePicker.md#nativeview[nativeView]
* link:TimePicker.md#page[page]
* link:TimePicker.md#parentnode[parentNode]
* link:TimePicker.md#style[style]
* link:TimePicker.md#texttransform[textTransform]
* link:TimePicker.md#typename[typeName]

=== Methods

* link:TimePicker.md#_addview[_addView]
* link:TimePicker.md#_addviewcore[_addViewCore]
* link:TimePicker.md#_addviewtonativevisualtree[_addViewToNativeVisualTree]
* link:TimePicker.md#_applybackground[_applyBackground]
* link:TimePicker.md#_applyxmlattribute[_applyXmlAttribute]
* link:TimePicker.md#_batchupdate[_batchUpdate]
* link:TimePicker.md#_childindextonativechildindex[_childIndexToNativeChildIndex]
* link:TimePicker.md#_closeallmodalviewsinternal[_closeAllModalViewsInternal]
* link:TimePicker.md#_createpropertychangedata[_createPropertyChangeData]
* link:TimePicker.md#_dialogclosed[_dialogClosed]
* link:TimePicker.md#_eachlayoutview[_eachLayoutView]
* link:TimePicker.md#_emit[_emit]
* link:TimePicker.md#_getcurrentlayoutbounds[_getCurrentLayoutBounds]
* link:TimePicker.md#_getfragmentmanager[_getFragmentManager]
* link:TimePicker.md#_getnativeviewscount[_getNativeViewsCount]
* link:TimePicker.md#_getrootmodalviews[_getRootModalViews]
* link:TimePicker.md#_getvalue[_getValue]
* link:TimePicker.md#_gotovisualstate[_goToVisualState]
* link:TimePicker.md#_handlelivesync[_handleLivesync]
* link:TimePicker.md#_hasancestorview[_hasAncestorView]
* link:TimePicker.md#_hidenativemodalview[_hideNativeModalView]
* link:TimePicker.md#_inheritstylescope[_inheritStyleScope]
* link:TimePicker.md#_layoutparent[_layoutParent]
* link:TimePicker.md#_observe[_observe]
* link:TimePicker.md#_onattachedtowindow[_onAttachedToWindow]
* link:TimePicker.md#_oncssstatechange[_onCssStateChange]
* link:TimePicker.md#_ondetachedfromwindow[_onDetachedFromWindow]
* link:TimePicker.md#_onlivesync[_onLivesync]
* link:TimePicker.md#_onrootviewreset[_onRootViewReset]
* link:TimePicker.md#_onsizechanged[_onSizeChanged]
* link:TimePicker.md#_parentchanged[_parentChanged]
* link:TimePicker.md#_raiselayoutchangedevent[_raiseLayoutChangedEvent]
* link:TimePicker.md#_raiseshowingmodallyevent[_raiseShowingModallyEvent]
* link:TimePicker.md#_raiseshownmodallyevent[_raiseShownModallyEvent]
* link:TimePicker.md#_redrawnativebackground[_redrawNativeBackground]
* link:TimePicker.md#_removeanimation[_removeAnimation]
* link:TimePicker.md#_removeview[_removeView]
* link:TimePicker.md#_removeviewcore[_removeViewCore]
* link:TimePicker.md#_removeviewfromnativevisualtree[_removeViewFromNativeVisualTree]
* link:TimePicker.md#_resumenativeupdates[_resumeNativeUpdates]
* link:TimePicker.md#_setcurrentlayoutbounds[_setCurrentLayoutBounds]
* link:TimePicker.md#_setcurrentmeasurespecs[_setCurrentMeasureSpecs]
* link:TimePicker.md#_setminheightnative[_setMinHeightNative]
* link:TimePicker.md#_setminwidthnative[_setMinWidthNative]
* link:TimePicker.md#_setnativecliptobounds[_setNativeClipToBounds]
* link:TimePicker.md#_setnativeviewframe[_setNativeViewFrame]
* link:TimePicker.md#_setvalue[_setValue]
* link:TimePicker.md#_setupasrootview[_setupAsRootView]
* link:TimePicker.md#_setupui[_setupUI]
* link:TimePicker.md#_shoulddelaylayout[_shouldDelayLayout]
* link:TimePicker.md#_shownativemodalview[_showNativeModalView]
* link:TimePicker.md#_suspendnativeupdates[_suspendNativeUpdates]
* link:TimePicker.md#_teardownui[_tearDownUI]
* link:TimePicker.md#_updateeffectivelayoutvalues[_updateEffectiveLayoutValues]
* link:TimePicker.md#_updatestylescope[_updateStyleScope]
* link:TimePicker.md#accessibilityannouncement[accessibilityAnnouncement]
* link:TimePicker.md#accessibilityscreenchanged[accessibilityScreenChanged]
* link:TimePicker.md#addcss[addCss]
* link:TimePicker.md#addcssfile[addCssFile]
* link:TimePicker.md#addeventlistener[addEventListener]
* link:TimePicker.md#addpseudoclass[addPseudoClass]
* link:TimePicker.md#animate[animate]
* link:TimePicker.md#bind[bind]
* link:TimePicker.md#callloaded[callLoaded]
* link:TimePicker.md#callunloaded[callUnloaded]
* link:TimePicker.md#changecssfile[changeCssFile]
* link:TimePicker.md#closemodal[closeModal]
* link:TimePicker.md#createanimation[createAnimation]
* link:TimePicker.md#createnativeview[createNativeView]
* link:TimePicker.md#deletepseudoclass[deletePseudoClass]
* link:TimePicker.md#destroynode[destroyNode]
* link:TimePicker.md#disposenativeview[disposeNativeView]
* link:TimePicker.md#eachchild[eachChild]
* link:TimePicker.md#eachchildview[eachChildView]
* link:TimePicker.md#ensuredomnode[ensureDomNode]
* link:TimePicker.md#focus[focus]
* link:TimePicker.md#get[get]
* link:TimePicker.md#getactualsize[getActualSize]
* link:TimePicker.md#getgestureobservers[getGestureObservers]
* link:TimePicker.md#getlocationinwindow[getLocationInWindow]
* link:TimePicker.md#getlocationonscreen[getLocationOnScreen]
* link:TimePicker.md#getlocationrelativeto[getLocationRelativeTo]
* link:TimePicker.md#getmeasuredheight[getMeasuredHeight]
* link:TimePicker.md#getmeasuredstate[getMeasuredState]
* link:TimePicker.md#getmeasuredwidth[getMeasuredWidth]
* link:TimePicker.md#getsafeareainsets[getSafeAreaInsets]
* link:TimePicker.md#getviewbydomid[getViewByDomId]
* link:TimePicker.md#getviewbyid[getViewById]
* link:TimePicker.md#hasgestureobservers[hasGestureObservers]
* link:TimePicker.md#haslisteners[hasListeners]
* link:TimePicker.md#initnativeview[initNativeView]
* link:TimePicker.md#layout[layout]
* link:TimePicker.md#layoutnativeview[layoutNativeView]
* link:TimePicker.md#loadview[loadView]
* link:TimePicker.md#measure[measure]
* link:TimePicker.md#notify[notify]
* link:TimePicker.md#notifypropertychange[notifyPropertyChange]
* link:TimePicker.md#off[off]
* link:TimePicker.md#on[on]
* link:TimePicker.md#onbackpressed[onBackPressed]
* link:TimePicker.md#onlayout[onLayout]
* link:TimePicker.md#onloaded[onLoaded]
* link:TimePicker.md#onmeasure[onMeasure]
* link:TimePicker.md#onresumenativeupdates[onResumeNativeUpdates]
* link:TimePicker.md#onunloaded[onUnloaded]
* link:TimePicker.md#once[once]
* link:TimePicker.md#removeeventlistener[removeEventListener]
* link:TimePicker.md#requestlayout[requestLayout]
* link:TimePicker.md#resetnativeview[resetNativeView]
* link:TimePicker.md#sendaccessibilityevent[sendAccessibilityEvent]
* link:TimePicker.md#set[set]
* link:TimePicker.md#setinlinestyle[setInlineStyle]
* link:TimePicker.md#setmeasureddimension[setMeasuredDimension]
* link:TimePicker.md#setnativeview[setNativeView]
* link:TimePicker.md#setontouchlistener[setOnTouchListener]
* link:TimePicker.md#setproperty[setProperty]
* link:TimePicker.md#settestid[setTestID]
* link:TimePicker.md#showmodal[showModal]
* link:TimePicker.md#tostring[toString]
* link:TimePicker.md#unbind[unbind]
* link:TimePicker.md#unloadview[unloadView]
* link:TimePicker.md#addeventlistener-1[addEventListener]
* link:TimePicker.md#combinemeasuredstates[combineMeasuredStates]
* link:TimePicker.md#layoutchild[layoutChild]
* link:TimePicker.md#measurechild[measureChild]
* link:TimePicker.md#off-1[off]
* link:TimePicker.md#on-1[on]
* link:TimePicker.md#once-1[once]
* link:TimePicker.md#removeeventlistener-1[removeEventListener]
* link:TimePicker.md#resolvesizeandstate[resolveSizeAndState]
...
Gets the native http://developer.android.com/reference/android/widget/TimePicker.html[android.widget.TimePicker] that represents the user interface for this component.
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/time-picker/index.d.ts#L11[ui/time-picker/index.d.ts:11]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/time-picker/index.d.ts#L21[ui/time-picker/index.d.ts:21]
...
Gets the native iOS http://developer.apple.com/library/prerelease/ios/documentation/UIKit/Reference/UIDatePicker_Class/index.html[UIDatePicker] that represents the user interface for this component.
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/time-picker/index.d.ts#L16[ui/time-picker/index.d.ts:16]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/time-picker/index.d.ts#L66[ui/time-picker/index.d.ts:66]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/time-picker/index.d.ts#L36[ui/time-picker/index.d.ts:36]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/time-picker/index.d.ts#L41[ui/time-picker/index.d.ts:41]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/time-picker/index.d.ts#L46[ui/time-picker/index.d.ts:46]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/time-picker/index.d.ts#L51[ui/time-picker/index.d.ts:51]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/time-picker/index.d.ts#L26[ui/time-picker/index.d.ts:26]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/time-picker/index.d.ts#L56[ui/time-picker/index.d.ts:56]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/time-picker/index.d.ts#L31[ui/time-picker/index.d.ts:31]
