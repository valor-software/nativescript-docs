...
* link:KeyframeAnimation.adoc#constructor[constructor]

=== Properties

* link:KeyframeAnimation.adoc#_isforwards[_isForwards]
* link:KeyframeAnimation.adoc#_isplaying[_isPlaying]
* link:KeyframeAnimation.adoc#_nativeanimations[_nativeAnimations]
* link:KeyframeAnimation.adoc#_resolve[_resolve]
* link:KeyframeAnimation.adoc#_target[_target]
* link:KeyframeAnimation.adoc#animations[animations]
* link:KeyframeAnimation.adoc#delay[delay]
* link:KeyframeAnimation.adoc#iterations[iterations]

=== Accessors

* link:KeyframeAnimation.adoc#isplaying[isPlaying]

=== Methods

* link:KeyframeAnimation.adoc#_resetanimationvalues[_resetAnimationValues]
* link:KeyframeAnimation.adoc#_resetanimations[_resetAnimations]
* link:KeyframeAnimation.adoc#_resolveanimationfinishedpromise[_resolveAnimationFinishedPromise]
* link:KeyframeAnimation.adoc#animate[animate]
* link:KeyframeAnimation.adoc#cancel[cancel]
* link:KeyframeAnimation.adoc#play[play]
* link:KeyframeAnimation.adoc#keyframeanimationfrominfo[keyframeAnimationFromInfo]
* link:KeyframeAnimation.adoc#parsekeyframe[parseKeyframe]
