...
xref:../README.adoc[NativeScript] / xref:../modules.adoc[Exports] / WebView
...
* link:WebView.adoc#constructor[constructor]

=== Properties

* link:WebView.adoc#_androidcontentdescriptionupdated[_androidContentDescriptionUpdated]
* link:WebView.adoc#_automaticallyadjustsscrollviewinsets[_automaticallyAdjustsScrollViewInsets]
* link:WebView.adoc#_closemodalcallback[_closeModalCallback]
* link:WebView.adoc#_context[_context]
* link:WebView.adoc#_cssstate[_cssState]
* link:WebView.adoc#_currentheightmeasurespec[_currentHeightMeasureSpec]
* link:WebView.adoc#_currentwidthmeasurespec[_currentWidthMeasureSpec]
* link:WebView.adoc#_defaultpaddingbottom[_defaultPaddingBottom]
* link:WebView.adoc#_defaultpaddingleft[_defaultPaddingLeft]
* link:WebView.adoc#_defaultpaddingright[_defaultPaddingRight]
* link:WebView.adoc#_defaultpaddingtop[_defaultPaddingTop]
* link:WebView.adoc#_domid[_domId]
* link:WebView.adoc#_gestureobservers[_gestureObservers]
* link:WebView.adoc#_ignoreflexminwidthheightreset[_ignoreFlexMinWidthHeightReset]
* link:WebView.adoc#_isaddedtonativevisualtree[_isAddedToNativeVisualTree]
* link:WebView.adoc#_islayoutvalid[_isLayoutValid]
* link:WebView.adoc#_ispaddingrelative[_isPaddingRelative]
* link:WebView.adoc#_isstylescopehost[_isStyleScopeHost]
* link:WebView.adoc#_isviewbase[_isViewBase]
* link:WebView.adoc#_manager[_manager]
* link:WebView.adoc#_modalparent[_modalParent]
* link:WebView.adoc#_modulename[_moduleName]
* link:WebView.adoc#_oldbottom[_oldBottom]
* link:WebView.adoc#_oldleft[_oldLeft]
* link:WebView.adoc#_oldright[_oldRight]
* link:WebView.adoc#_oldtop[_oldTop]
* link:WebView.adoc#_stylescope[_styleScope]
* link:WebView.adoc#_suspendnativeupdatescount[_suspendNativeUpdatesCount]
* link:WebView.adoc#_suspendedupdates[_suspendedUpdates]
* link:WebView.adoc#accessibilityhidden[accessibilityHidden]
* link:WebView.adoc#accessibilityhint[accessibilityHint]
* link:WebView.adoc#accessibilityidentifier[accessibilityIdentifier]
* link:WebView.adoc#accessibilitylabel[accessibilityLabel]
* link:WebView.adoc#accessibilitylanguage[accessibilityLanguage]
* link:WebView.adoc#accessibilityliveregion[accessibilityLiveRegion]
* link:WebView.adoc#accessibilitymediasession[accessibilityMediaSession]
* link:WebView.adoc#accessibilityrole[accessibilityRole]
* link:WebView.adoc#accessibilitystate[accessibilityState]
* link:WebView.adoc#accessibilityvalue[accessibilityValue]
* link:WebView.adoc#accessible[accessible]
* link:WebView.adoc#alignself[alignSelf]
* link:WebView.adoc#android[android]
* link:WebView.adoc#androiddynamicelevationoffset[androidDynamicElevationOffset]
* link:WebView.adoc#androidelevation[androidElevation]
* link:WebView.adoc#automationtext[automationText]
* link:WebView.adoc#background[background]
* link:WebView.adoc#backgroundcolor[backgroundColor]
* link:WebView.adoc#backgroundimage[backgroundImage]
* link:WebView.adoc#bindingcontext[bindingContext]
* link:WebView.adoc#borderbottomcolor[borderBottomColor]
* link:WebView.adoc#borderbottomleftradius[borderBottomLeftRadius]
* link:WebView.adoc#borderbottomrightradius[borderBottomRightRadius]
* link:WebView.adoc#borderbottomwidth[borderBottomWidth]
* link:WebView.adoc#bordercolor[borderColor]
* link:WebView.adoc#borderleftcolor[borderLeftColor]
* link:WebView.adoc#borderleftwidth[borderLeftWidth]
* link:WebView.adoc#borderradius[borderRadius]
* link:WebView.adoc#borderrightcolor[borderRightColor]
* link:WebView.adoc#borderrightwidth[borderRightWidth]
* link:WebView.adoc#bordertopcolor[borderTopColor]
* link:WebView.adoc#bordertopleftradius[borderTopLeftRadius]
* link:WebView.adoc#bordertoprightradius[borderTopRightRadius]
* link:WebView.adoc#bordertopwidth[borderTopWidth]
* link:WebView.adoc#borderwidth[borderWidth]
* link:WebView.adoc#boxshadow[boxShadow]
* link:WebView.adoc#cangoback[canGoBack]
* link:WebView.adoc#cangoforward[canGoForward]
* link:WebView.adoc#classname[className]
* link:WebView.adoc#col[col]
* link:WebView.adoc#colspan[colSpan]
* link:WebView.adoc#color[color]
* link:WebView.adoc#column[column]
* link:WebView.adoc#columnspan[columnSpan]
* link:WebView.adoc#css[css]
* link:WebView.adoc#cssclasses[cssClasses]
* link:WebView.adoc#csspseudoclasses[cssPseudoClasses]
* link:WebView.adoc#csstype[cssType]
* link:WebView.adoc#disablezoom[disableZoom]
* link:WebView.adoc#dock[dock]
* link:WebView.adoc#domnode[domNode]
* link:WebView.adoc#effectiveborderbottomwidth[effectiveBorderBottomWidth]
* link:WebView.adoc#effectiveborderleftwidth[effectiveBorderLeftWidth]
* link:WebView.adoc#effectiveborderrightwidth[effectiveBorderRightWidth]
* link:WebView.adoc#effectivebordertopwidth[effectiveBorderTopWidth]
* link:WebView.adoc#effectiveheight[effectiveHeight]
* link:WebView.adoc#effectiveleft[effectiveLeft]
* link:WebView.adoc#effectivemarginbottom[effectiveMarginBottom]
* link:WebView.adoc#effectivemarginleft[effectiveMarginLeft]
* link:WebView.adoc#effectivemarginright[effectiveMarginRight]
* link:WebView.adoc#effectivemargintop[effectiveMarginTop]
* link:WebView.adoc#effectiveminheight[effectiveMinHeight]
* link:WebView.adoc#effectiveminwidth[effectiveMinWidth]
* link:WebView.adoc#effectivepaddingbottom[effectivePaddingBottom]
* link:WebView.adoc#effectivepaddingleft[effectivePaddingLeft]
* link:WebView.adoc#effectivepaddingright[effectivePaddingRight]
* link:WebView.adoc#effectivepaddingtop[effectivePaddingTop]
* link:WebView.adoc#effectivetop[effectiveTop]
* link:WebView.adoc#effectivewidth[effectiveWidth]
* link:WebView.adoc#flexgrow[flexGrow]
* link:WebView.adoc#flexshrink[flexShrink]
* link:WebView.adoc#flexwrapbefore[flexWrapBefore]
* link:WebView.adoc#height[height]
* link:WebView.adoc#horizontalalignment[horizontalAlignment]
* link:WebView.adoc#id[id]
* link:WebView.adoc#ignoretouchanimation[ignoreTouchAnimation]
* link:WebView.adoc#ios[ios]
* link:WebView.adoc#iosignoresafearea[iosIgnoreSafeArea]
* link:WebView.adoc#iosoverflowsafearea[iosOverflowSafeArea]
* link:WebView.adoc#iosoverflowsafeareaenabled[iosOverflowSafeAreaEnabled]
* link:WebView.adoc#iscollapsed[isCollapsed]
* link:WebView.adoc#isenabled[isEnabled]
* link:WebView.adoc#islayoutrequired[isLayoutRequired]
* link:WebView.adoc#islayoutvalid[isLayoutValid]
* link:WebView.adoc#isuserinteractionenabled[isUserInteractionEnabled]
* link:WebView.adoc#left[left]
* link:WebView.adoc#margin[margin]
* link:WebView.adoc#marginbottom[marginBottom]
* link:WebView.adoc#marginleft[marginLeft]
* link:WebView.adoc#marginright[marginRight]
* link:WebView.adoc#margintop[marginTop]
* link:WebView.adoc#minheight[minHeight]
* link:WebView.adoc#minwidth[minWidth]
* link:WebView.adoc#modal[modal]
* link:WebView.adoc#nativeviewprotected[nativeViewProtected]
* link:WebView.adoc#opacity[opacity]
* link:WebView.adoc#order[order]
* link:WebView.adoc#originx[originX]
* link:WebView.adoc#originy[originY]
* link:WebView.adoc#parent[parent]
* link:WebView.adoc#perspective[perspective]
* link:WebView.adoc#recyclenativeview[recycleNativeView]
* link:WebView.adoc#reusable[reusable]
* link:WebView.adoc#rotate[rotate]
* link:WebView.adoc#rotatex[rotateX]
* link:WebView.adoc#rotatey[rotateY]
* link:WebView.adoc#row[row]
* link:WebView.adoc#rowspan[rowSpan]
* link:WebView.adoc#scalex[scaleX]
* link:WebView.adoc#scaley[scaleY]
* link:WebView.adoc#src[src]
* link:WebView.adoc#testid[testID]
* link:WebView.adoc#top[top]
* link:WebView.adoc#touchanimation[touchAnimation]
* link:WebView.adoc#touchdelay[touchDelay]
* link:WebView.adoc#translatex[translateX]
* link:WebView.adoc#translatey[translateY]
* link:WebView.adoc#verticalalignment[verticalAlignment]
* link:WebView.adoc#viewcontroller[viewController]
* link:WebView.adoc#visibility[visibility]
* link:WebView.adoc#width[width]
* link:WebView.adoc#accessibilityblurevent[accessibilityBlurEvent]
* link:WebView.adoc#accessibilityfocuschangedevent[accessibilityFocusChangedEvent]
* link:WebView.adoc#accessibilityfocusevent[accessibilityFocusEvent]
* link:WebView.adoc#accessibilityperformescapeevent[accessibilityPerformEscapeEvent]
* link:WebView.adoc#createdevent[createdEvent]
* link:WebView.adoc#disposenativeviewevent[disposeNativeViewEvent]
* link:WebView.adoc#layoutchangedevent[layoutChangedEvent]
* link:WebView.adoc#loadfinishedevent[loadFinishedEvent]
* link:WebView.adoc#loadstartedevent[loadStartedEvent]
* link:WebView.adoc#loadedevent[loadedEvent]
* link:WebView.adoc#propertychangeevent[propertyChangeEvent]
* link:WebView.adoc#showingmodallyevent[showingModallyEvent]
* link:WebView.adoc#shownmodallyevent[shownModallyEvent]
* link:WebView.adoc#unloadedevent[unloadedEvent]

=== Accessors

* link:WebView.adoc#backgroundposition[backgroundPosition]
* link:WebView.adoc#backgroundrepeat[backgroundRepeat]
* link:WebView.adoc#backgroundsize[backgroundSize]
* link:WebView.adoc#class[class]
* link:WebView.adoc#isloaded[isLoaded]
* link:WebView.adoc#nativeview[nativeView]
* link:WebView.adoc#page[page]
* link:WebView.adoc#parentnode[parentNode]
* link:WebView.adoc#style[style]
* link:WebView.adoc#texttransform[textTransform]
* link:WebView.adoc#typename[typeName]

=== Methods

* link:WebView.adoc#_addview[_addView]
* link:WebView.adoc#_addviewcore[_addViewCore]
* link:WebView.adoc#_addviewtonativevisualtree[_addViewToNativeVisualTree]
* link:WebView.adoc#_applybackground[_applyBackground]
* link:WebView.adoc#_applyxmlattribute[_applyXmlAttribute]
* link:WebView.adoc#_batchupdate[_batchUpdate]
* link:WebView.adoc#_childindextonativechildindex[_childIndexToNativeChildIndex]
* link:WebView.adoc#_closeallmodalviewsinternal[_closeAllModalViewsInternal]
* link:WebView.adoc#_createpropertychangedata[_createPropertyChangeData]
* link:WebView.adoc#_dialogclosed[_dialogClosed]
* link:WebView.adoc#_eachlayoutview[_eachLayoutView]
* link:WebView.adoc#_emit[_emit]
* link:WebView.adoc#_getcurrentlayoutbounds[_getCurrentLayoutBounds]
* link:WebView.adoc#_getfragmentmanager[_getFragmentManager]
* link:WebView.adoc#_getnativeviewscount[_getNativeViewsCount]
* link:WebView.adoc#_getrootmodalviews[_getRootModalViews]
* link:WebView.adoc#_getvalue[_getValue]
* link:WebView.adoc#_gotovisualstate[_goToVisualState]
* link:WebView.adoc#_handlelivesync[_handleLivesync]
* link:WebView.adoc#_hasancestorview[_hasAncestorView]
* link:WebView.adoc#_hidenativemodalview[_hideNativeModalView]
* link:WebView.adoc#_inheritstylescope[_inheritStyleScope]
* link:WebView.adoc#_layoutparent[_layoutParent]
* link:WebView.adoc#_observe[_observe]
* link:WebView.adoc#_onattachedtowindow[_onAttachedToWindow]
* link:WebView.adoc#_oncssstatechange[_onCssStateChange]
* link:WebView.adoc#_ondetachedfromwindow[_onDetachedFromWindow]
* link:WebView.adoc#_onlivesync[_onLivesync]
* link:WebView.adoc#_onrootviewreset[_onRootViewReset]
* link:WebView.adoc#_onsizechanged[_onSizeChanged]
* link:WebView.adoc#_parentchanged[_parentChanged]
* link:WebView.adoc#_raiselayoutchangedevent[_raiseLayoutChangedEvent]
* link:WebView.adoc#_raiseshowingmodallyevent[_raiseShowingModallyEvent]
* link:WebView.adoc#_raiseshownmodallyevent[_raiseShownModallyEvent]
* link:WebView.adoc#_redrawnativebackground[_redrawNativeBackground]
* link:WebView.adoc#_removeanimation[_removeAnimation]
* link:WebView.adoc#_removeview[_removeView]
* link:WebView.adoc#_removeviewcore[_removeViewCore]
* link:WebView.adoc#_removeviewfromnativevisualtree[_removeViewFromNativeVisualTree]
* link:WebView.adoc#_resumenativeupdates[_resumeNativeUpdates]
* link:WebView.adoc#_setcurrentlayoutbounds[_setCurrentLayoutBounds]
* link:WebView.adoc#_setcurrentmeasurespecs[_setCurrentMeasureSpecs]
* link:WebView.adoc#_setminheightnative[_setMinHeightNative]
* link:WebView.adoc#_setminwidthnative[_setMinWidthNative]
* link:WebView.adoc#_setnativecliptobounds[_setNativeClipToBounds]
* link:WebView.adoc#_setnativeviewframe[_setNativeViewFrame]
* link:WebView.adoc#_setvalue[_setValue]
* link:WebView.adoc#_setupasrootview[_setupAsRootView]
* link:WebView.adoc#_setupui[_setupUI]
* link:WebView.adoc#_shoulddelaylayout[_shouldDelayLayout]
* link:WebView.adoc#_shownativemodalview[_showNativeModalView]
* link:WebView.adoc#_suspendnativeupdates[_suspendNativeUpdates]
* link:WebView.adoc#_teardownui[_tearDownUI]
* link:WebView.adoc#_updateeffectivelayoutvalues[_updateEffectiveLayoutValues]
* link:WebView.adoc#_updatestylescope[_updateStyleScope]
* link:WebView.adoc#accessibilityannouncement[accessibilityAnnouncement]
* link:WebView.adoc#accessibilityscreenchanged[accessibilityScreenChanged]
* link:WebView.adoc#addcss[addCss]
* link:WebView.adoc#addcssfile[addCssFile]
* link:WebView.adoc#addeventlistener[addEventListener]
* link:WebView.adoc#addpseudoclass[addPseudoClass]
* link:WebView.adoc#animate[animate]
* link:WebView.adoc#bind[bind]
* link:WebView.adoc#callloaded[callLoaded]
* link:WebView.adoc#callunloaded[callUnloaded]
* link:WebView.adoc#changecssfile[changeCssFile]
* link:WebView.adoc#closemodal[closeModal]
* link:WebView.adoc#createanimation[createAnimation]
* link:WebView.adoc#createnativeview[createNativeView]
* link:WebView.adoc#deletepseudoclass[deletePseudoClass]
* link:WebView.adoc#destroynode[destroyNode]
* link:WebView.adoc#disposenativeview[disposeNativeView]
* link:WebView.adoc#eachchild[eachChild]
* link:WebView.adoc#eachchildview[eachChildView]
* link:WebView.adoc#ensuredomnode[ensureDomNode]
* link:WebView.adoc#focus[focus]
* link:WebView.adoc#get[get]
* link:WebView.adoc#getactualsize[getActualSize]
* link:WebView.adoc#getgestureobservers[getGestureObservers]
* link:WebView.adoc#getlocationinwindow[getLocationInWindow]
* link:WebView.adoc#getlocationonscreen[getLocationOnScreen]
* link:WebView.adoc#getlocationrelativeto[getLocationRelativeTo]
* link:WebView.adoc#getmeasuredheight[getMeasuredHeight]
* link:WebView.adoc#getmeasuredstate[getMeasuredState]
* link:WebView.adoc#getmeasuredwidth[getMeasuredWidth]
* link:WebView.adoc#getsafeareainsets[getSafeAreaInsets]
* link:WebView.adoc#getviewbydomid[getViewByDomId]
* link:WebView.adoc#getviewbyid[getViewById]
* link:WebView.adoc#goback[goBack]
* link:WebView.adoc#goforward[goForward]
* link:WebView.adoc#hasgestureobservers[hasGestureObservers]
* link:WebView.adoc#haslisteners[hasListeners]
* link:WebView.adoc#initnativeview[initNativeView]
* link:WebView.adoc#layout[layout]
* link:WebView.adoc#layoutnativeview[layoutNativeView]
* link:WebView.adoc#loadview[loadView]
* link:WebView.adoc#measure[measure]
* link:WebView.adoc#notify[notify]
* link:WebView.adoc#notifypropertychange[notifyPropertyChange]
* link:WebView.adoc#off[off]
* link:WebView.adoc#on[on]
* link:WebView.adoc#onbackpressed[onBackPressed]
* link:WebView.adoc#onlayout[onLayout]
* link:WebView.adoc#onloaded[onLoaded]
* link:WebView.adoc#onmeasure[onMeasure]
* link:WebView.adoc#onresumenativeupdates[onResumeNativeUpdates]
* link:WebView.adoc#onunloaded[onUnloaded]
* link:WebView.adoc#once[once]
* link:WebView.adoc#reload[reload]
* link:WebView.adoc#removeeventlistener[removeEventListener]
* link:WebView.adoc#requestlayout[requestLayout]
* link:WebView.adoc#resetnativeview[resetNativeView]
* link:WebView.adoc#sendaccessibilityevent[sendAccessibilityEvent]
* link:WebView.adoc#set[set]
* link:WebView.adoc#setinlinestyle[setInlineStyle]
* link:WebView.adoc#setmeasureddimension[setMeasuredDimension]
* link:WebView.adoc#setnativeview[setNativeView]
* link:WebView.adoc#setontouchlistener[setOnTouchListener]
* link:WebView.adoc#setproperty[setProperty]
* link:WebView.adoc#settestid[setTestID]
* link:WebView.adoc#showmodal[showModal]
* link:WebView.adoc#stoploading[stopLoading]
* link:WebView.adoc#tostring[toString]
* link:WebView.adoc#unbind[unbind]
* link:WebView.adoc#unloadview[unloadView]
* link:WebView.adoc#addeventlistener-1[addEventListener]
* link:WebView.adoc#combinemeasuredstates[combineMeasuredStates]
* link:WebView.adoc#layoutchild[layoutChild]
* link:WebView.adoc#measurechild[measureChild]
* link:WebView.adoc#off-1[off]
* link:WebView.adoc#on-1[on]
* link:WebView.adoc#once-1[once]
* link:WebView.adoc#removeeventlistener-1[removeEventListener]
* link:WebView.adoc#resolvesizeandstate[resolveSizeAndState]
...
Gets the native http://developer.android.com/reference/android/webkit/WebView.html[android widget] that represents the user interface for this component.
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/web-view/index.d.ts#L36[ui/web-view/index.d.ts:36]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/web-view/index.d.ts#L51[ui/web-view/index.d.ts:51]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/web-view/index.d.ts#L56[ui/web-view/index.d.ts:56]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/web-view/index.d.ts#L61[ui/web-view/index.d.ts:61]
...
Gets the native https://developer.apple.com/documentation/webkit/wkwebview/[WKWebView] that represents the user interface for this component.
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/web-view/index.d.ts#L41[ui/web-view/index.d.ts:41]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/web-view/index.d.ts#L46[ui/web-view/index.d.ts:46]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/web-view/index.d.ts#L31[ui/web-view/index.d.ts:31]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/web-view/index.d.ts#L26[ui/web-view/index.d.ts:26]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/web-view/index.d.ts#L71[ui/web-view/index.d.ts:71]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/web-view/index.d.ts#L76[ui/web-view/index.d.ts:76]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/web-view/index.d.ts#L89[ui/web-view/index.d.ts:89]
...
| `callback`
| (`args`: xref:../interfaces/LoadEventData.adoc[`LoadEventData`]) \=> `void`
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/web-view/index.d.ts#L94[ui/web-view/index.d.ts:94]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/web-view/index.d.ts#L99[ui/web-view/index.d.ts:99]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/web-view/index.d.ts#L81[ui/web-view/index.d.ts:81]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/web-view/index.d.ts#L66[ui/web-view/index.d.ts:66]
