...
* link:ImageSource.adoc#constructor[constructor]

=== Properties

* link:ImageSource.adoc#android[android]
* link:ImageSource.adoc#height[height]
* link:ImageSource.adoc#ios[ios]
* link:ImageSource.adoc#rotationangle[rotationAngle]
* link:ImageSource.adoc#width[width]

=== Methods

* link:ImageSource.adoc#fromasset[fromAsset]
* link:ImageSource.adoc#frombase64[fromBase64]
* link:ImageSource.adoc#fromdata[fromData]
* link:ImageSource.adoc#fromfile[fromFile]
* link:ImageSource.adoc#fromresource[fromResource]
* link:ImageSource.adoc#loadfrombase64[loadFromBase64]
* link:ImageSource.adoc#loadfromdata[loadFromData]
* link:ImageSource.adoc#loadfromfile[loadFromFile]
* link:ImageSource.adoc#loadfromfonticoncode[loadFromFontIconCode]
* link:ImageSource.adoc#loadfromresource[loadFromResource]
* link:ImageSource.adoc#resize[resize]
* link:ImageSource.adoc#resizeasync[resizeAsync]
* link:ImageSource.adoc#savetofile[saveToFile]
* link:ImageSource.adoc#savetofileasync[saveToFileAsync]
* link:ImageSource.adoc#setnativesource[setNativeSource]
* link:ImageSource.adoc#tobase64string[toBase64String]
* link:ImageSource.adoc#tobase64stringasync[toBase64StringAsync]
* link:ImageSource.adoc#fromasset-1[fromAsset]
* link:ImageSource.adoc#frombase64-1[fromBase64]
* link:ImageSource.adoc#frombase64sync[fromBase64Sync]
* link:ImageSource.adoc#fromdata-1[fromData]
* link:ImageSource.adoc#fromdatasync[fromDataSync]
* link:ImageSource.adoc#fromfile-1[fromFile]
* link:ImageSource.adoc#fromfileorresourcesync[fromFileOrResourceSync]
* link:ImageSource.adoc#fromfilesync[fromFileSync]
* link:ImageSource.adoc#fromfonticoncodesync[fromFontIconCodeSync]
* link:ImageSource.adoc#fromresource-1[fromResource]
* link:ImageSource.adoc#fromresourcesync[fromResourceSync]
* link:ImageSource.adoc#fromurl[fromUrl]
