...
* link:ChangeType.adoc#constructor[constructor]

=== Properties

* link:ChangeType.adoc#add[Add]
* link:ChangeType.adoc#change[Change]
* link:ChangeType.adoc#delete[Delete]
* link:ChangeType.adoc#splice[Splice]
* link:ChangeType.adoc#update[Update]
