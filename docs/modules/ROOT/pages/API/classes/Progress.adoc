...
xref:../README.adoc[NativeScript] / xref:../modules.adoc[Exports] / Progress
...
* link:Progress.adoc#constructor[constructor]

=== Properties

* link:Progress.adoc#_androidcontentdescriptionupdated[_androidContentDescriptionUpdated]
* link:Progress.adoc#_automaticallyadjustsscrollviewinsets[_automaticallyAdjustsScrollViewInsets]
* link:Progress.adoc#_closemodalcallback[_closeModalCallback]
* link:Progress.adoc#_context[_context]
* link:Progress.adoc#_cssstate[_cssState]
* link:Progress.adoc#_currentheightmeasurespec[_currentHeightMeasureSpec]
* link:Progress.adoc#_currentwidthmeasurespec[_currentWidthMeasureSpec]
* link:Progress.adoc#_defaultpaddingbottom[_defaultPaddingBottom]
* link:Progress.adoc#_defaultpaddingleft[_defaultPaddingLeft]
* link:Progress.adoc#_defaultpaddingright[_defaultPaddingRight]
* link:Progress.adoc#_defaultpaddingtop[_defaultPaddingTop]
* link:Progress.adoc#_domid[_domId]
* link:Progress.adoc#_gestureobservers[_gestureObservers]
* link:Progress.adoc#_ignoreflexminwidthheightreset[_ignoreFlexMinWidthHeightReset]
* link:Progress.adoc#_isaddedtonativevisualtree[_isAddedToNativeVisualTree]
* link:Progress.adoc#_islayoutvalid[_isLayoutValid]
* link:Progress.adoc#_ispaddingrelative[_isPaddingRelative]
* link:Progress.adoc#_isstylescopehost[_isStyleScopeHost]
* link:Progress.adoc#_isviewbase[_isViewBase]
* link:Progress.adoc#_manager[_manager]
* link:Progress.adoc#_modalparent[_modalParent]
* link:Progress.adoc#_modulename[_moduleName]
* link:Progress.adoc#_oldbottom[_oldBottom]
* link:Progress.adoc#_oldleft[_oldLeft]
* link:Progress.adoc#_oldright[_oldRight]
* link:Progress.adoc#_oldtop[_oldTop]
* link:Progress.adoc#_stylescope[_styleScope]
* link:Progress.adoc#_suspendnativeupdatescount[_suspendNativeUpdatesCount]
* link:Progress.adoc#_suspendedupdates[_suspendedUpdates]
* link:Progress.adoc#accessibilityhidden[accessibilityHidden]
* link:Progress.adoc#accessibilityhint[accessibilityHint]
* link:Progress.adoc#accessibilityidentifier[accessibilityIdentifier]
* link:Progress.adoc#accessibilitylabel[accessibilityLabel]
* link:Progress.adoc#accessibilitylanguage[accessibilityLanguage]
* link:Progress.adoc#accessibilityliveregion[accessibilityLiveRegion]
* link:Progress.adoc#accessibilitymediasession[accessibilityMediaSession]
* link:Progress.adoc#accessibilityrole[accessibilityRole]
* link:Progress.adoc#accessibilitystate[accessibilityState]
* link:Progress.adoc#accessibilityvalue[accessibilityValue]
* link:Progress.adoc#accessible[accessible]
* link:Progress.adoc#alignself[alignSelf]
* link:Progress.adoc#android[android]
* link:Progress.adoc#androiddynamicelevationoffset[androidDynamicElevationOffset]
* link:Progress.adoc#androidelevation[androidElevation]
* link:Progress.adoc#automationtext[automationText]
* link:Progress.adoc#background[background]
* link:Progress.adoc#backgroundcolor[backgroundColor]
* link:Progress.adoc#backgroundimage[backgroundImage]
* link:Progress.adoc#bindingcontext[bindingContext]
* link:Progress.adoc#borderbottomcolor[borderBottomColor]
* link:Progress.adoc#borderbottomleftradius[borderBottomLeftRadius]
* link:Progress.adoc#borderbottomrightradius[borderBottomRightRadius]
* link:Progress.adoc#borderbottomwidth[borderBottomWidth]
* link:Progress.adoc#bordercolor[borderColor]
* link:Progress.adoc#borderleftcolor[borderLeftColor]
* link:Progress.adoc#borderleftwidth[borderLeftWidth]
* link:Progress.adoc#borderradius[borderRadius]
* link:Progress.adoc#borderrightcolor[borderRightColor]
* link:Progress.adoc#borderrightwidth[borderRightWidth]
* link:Progress.adoc#bordertopcolor[borderTopColor]
* link:Progress.adoc#bordertopleftradius[borderTopLeftRadius]
* link:Progress.adoc#bordertoprightradius[borderTopRightRadius]
* link:Progress.adoc#bordertopwidth[borderTopWidth]
* link:Progress.adoc#borderwidth[borderWidth]
* link:Progress.adoc#boxshadow[boxShadow]
* link:Progress.adoc#classname[className]
* link:Progress.adoc#col[col]
* link:Progress.adoc#colspan[colSpan]
* link:Progress.adoc#color[color]
* link:Progress.adoc#column[column]
* link:Progress.adoc#columnspan[columnSpan]
* link:Progress.adoc#css[css]
* link:Progress.adoc#cssclasses[cssClasses]
* link:Progress.adoc#csspseudoclasses[cssPseudoClasses]
* link:Progress.adoc#csstype[cssType]
* link:Progress.adoc#dock[dock]
* link:Progress.adoc#domnode[domNode]
* link:Progress.adoc#effectiveborderbottomwidth[effectiveBorderBottomWidth]
* link:Progress.adoc#effectiveborderleftwidth[effectiveBorderLeftWidth]
* link:Progress.adoc#effectiveborderrightwidth[effectiveBorderRightWidth]
* link:Progress.adoc#effectivebordertopwidth[effectiveBorderTopWidth]
* link:Progress.adoc#effectiveheight[effectiveHeight]
* link:Progress.adoc#effectiveleft[effectiveLeft]
* link:Progress.adoc#effectivemarginbottom[effectiveMarginBottom]
* link:Progress.adoc#effectivemarginleft[effectiveMarginLeft]
* link:Progress.adoc#effectivemarginright[effectiveMarginRight]
* link:Progress.adoc#effectivemargintop[effectiveMarginTop]
* link:Progress.adoc#effectiveminheight[effectiveMinHeight]
* link:Progress.adoc#effectiveminwidth[effectiveMinWidth]
* link:Progress.adoc#effectivepaddingbottom[effectivePaddingBottom]
* link:Progress.adoc#effectivepaddingleft[effectivePaddingLeft]
* link:Progress.adoc#effectivepaddingright[effectivePaddingRight]
* link:Progress.adoc#effectivepaddingtop[effectivePaddingTop]
* link:Progress.adoc#effectivetop[effectiveTop]
* link:Progress.adoc#effectivewidth[effectiveWidth]
* link:Progress.adoc#flexgrow[flexGrow]
* link:Progress.adoc#flexshrink[flexShrink]
* link:Progress.adoc#flexwrapbefore[flexWrapBefore]
* link:Progress.adoc#height[height]
* link:Progress.adoc#horizontalalignment[horizontalAlignment]
* link:Progress.adoc#id[id]
* link:Progress.adoc#ignoretouchanimation[ignoreTouchAnimation]
* link:Progress.adoc#ios[ios]
* link:Progress.adoc#iosignoresafearea[iosIgnoreSafeArea]
* link:Progress.adoc#iosoverflowsafearea[iosOverflowSafeArea]
* link:Progress.adoc#iosoverflowsafeareaenabled[iosOverflowSafeAreaEnabled]
* link:Progress.adoc#iscollapsed[isCollapsed]
* link:Progress.adoc#isenabled[isEnabled]
* link:Progress.adoc#islayoutrequired[isLayoutRequired]
* link:Progress.adoc#islayoutvalid[isLayoutValid]
* link:Progress.adoc#isuserinteractionenabled[isUserInteractionEnabled]
* link:Progress.adoc#left[left]
* link:Progress.adoc#margin[margin]
* link:Progress.adoc#marginbottom[marginBottom]
* link:Progress.adoc#marginleft[marginLeft]
* link:Progress.adoc#marginright[marginRight]
* link:Progress.adoc#margintop[marginTop]
* link:Progress.adoc#maxvalue[maxValue]
* link:Progress.adoc#minheight[minHeight]
* link:Progress.adoc#minwidth[minWidth]
* link:Progress.adoc#modal[modal]
* link:Progress.adoc#nativeviewprotected[nativeViewProtected]
* link:Progress.adoc#opacity[opacity]
* link:Progress.adoc#order[order]
* link:Progress.adoc#originx[originX]
* link:Progress.adoc#originy[originY]
* link:Progress.adoc#parent[parent]
* link:Progress.adoc#perspective[perspective]
* link:Progress.adoc#recyclenativeview[recycleNativeView]
* link:Progress.adoc#reusable[reusable]
* link:Progress.adoc#rotate[rotate]
* link:Progress.adoc#rotatex[rotateX]
* link:Progress.adoc#rotatey[rotateY]
* link:Progress.adoc#row[row]
* link:Progress.adoc#rowspan[rowSpan]
* link:Progress.adoc#scalex[scaleX]
* link:Progress.adoc#scaley[scaleY]
* link:Progress.adoc#testid[testID]
* link:Progress.adoc#top[top]
* link:Progress.adoc#touchanimation[touchAnimation]
* link:Progress.adoc#touchdelay[touchDelay]
* link:Progress.adoc#translatex[translateX]
* link:Progress.adoc#translatey[translateY]
* link:Progress.adoc#value[value]
* link:Progress.adoc#verticalalignment[verticalAlignment]
* link:Progress.adoc#viewcontroller[viewController]
* link:Progress.adoc#visibility[visibility]
* link:Progress.adoc#width[width]
* link:Progress.adoc#accessibilityblurevent[accessibilityBlurEvent]
* link:Progress.adoc#accessibilityfocuschangedevent[accessibilityFocusChangedEvent]
* link:Progress.adoc#accessibilityfocusevent[accessibilityFocusEvent]
* link:Progress.adoc#accessibilityperformescapeevent[accessibilityPerformEscapeEvent]
* link:Progress.adoc#createdevent[createdEvent]
* link:Progress.adoc#disposenativeviewevent[disposeNativeViewEvent]
* link:Progress.adoc#layoutchangedevent[layoutChangedEvent]
* link:Progress.adoc#loadedevent[loadedEvent]
* link:Progress.adoc#propertychangeevent[propertyChangeEvent]
* link:Progress.adoc#showingmodallyevent[showingModallyEvent]
* link:Progress.adoc#shownmodallyevent[shownModallyEvent]
* link:Progress.adoc#unloadedevent[unloadedEvent]

=== Accessors

* link:Progress.adoc#backgroundposition[backgroundPosition]
* link:Progress.adoc#backgroundrepeat[backgroundRepeat]
* link:Progress.adoc#backgroundsize[backgroundSize]
* link:Progress.adoc#class[class]
* link:Progress.adoc#isloaded[isLoaded]
* link:Progress.adoc#nativeview[nativeView]
* link:Progress.adoc#page[page]
* link:Progress.adoc#parentnode[parentNode]
* link:Progress.adoc#style[style]
* link:Progress.adoc#texttransform[textTransform]
* link:Progress.adoc#typename[typeName]

=== Methods

* link:Progress.adoc#_addview[_addView]
* link:Progress.adoc#_addviewcore[_addViewCore]
* link:Progress.adoc#_addviewtonativevisualtree[_addViewToNativeVisualTree]
* link:Progress.adoc#_applybackground[_applyBackground]
* link:Progress.adoc#_applyxmlattribute[_applyXmlAttribute]
* link:Progress.adoc#_batchupdate[_batchUpdate]
* link:Progress.adoc#_childindextonativechildindex[_childIndexToNativeChildIndex]
* link:Progress.adoc#_closeallmodalviewsinternal[_closeAllModalViewsInternal]
* link:Progress.adoc#_createpropertychangedata[_createPropertyChangeData]
* link:Progress.adoc#_dialogclosed[_dialogClosed]
* link:Progress.adoc#_eachlayoutview[_eachLayoutView]
* link:Progress.adoc#_emit[_emit]
* link:Progress.adoc#_getcurrentlayoutbounds[_getCurrentLayoutBounds]
* link:Progress.adoc#_getfragmentmanager[_getFragmentManager]
* link:Progress.adoc#_getnativeviewscount[_getNativeViewsCount]
* link:Progress.adoc#_getrootmodalviews[_getRootModalViews]
* link:Progress.adoc#_getvalue[_getValue]
* link:Progress.adoc#_gotovisualstate[_goToVisualState]
* link:Progress.adoc#_handlelivesync[_handleLivesync]
* link:Progress.adoc#_hasancestorview[_hasAncestorView]
* link:Progress.adoc#_hidenativemodalview[_hideNativeModalView]
* link:Progress.adoc#_inheritstylescope[_inheritStyleScope]
* link:Progress.adoc#_layoutparent[_layoutParent]
* link:Progress.adoc#_observe[_observe]
* link:Progress.adoc#_onattachedtowindow[_onAttachedToWindow]
* link:Progress.adoc#_oncssstatechange[_onCssStateChange]
* link:Progress.adoc#_ondetachedfromwindow[_onDetachedFromWindow]
* link:Progress.adoc#_onlivesync[_onLivesync]
* link:Progress.adoc#_onrootviewreset[_onRootViewReset]
* link:Progress.adoc#_onsizechanged[_onSizeChanged]
* link:Progress.adoc#_parentchanged[_parentChanged]
* link:Progress.adoc#_raiselayoutchangedevent[_raiseLayoutChangedEvent]
* link:Progress.adoc#_raiseshowingmodallyevent[_raiseShowingModallyEvent]
* link:Progress.adoc#_raiseshownmodallyevent[_raiseShownModallyEvent]
* link:Progress.adoc#_redrawnativebackground[_redrawNativeBackground]
* link:Progress.adoc#_removeanimation[_removeAnimation]
* link:Progress.adoc#_removeview[_removeView]
* link:Progress.adoc#_removeviewcore[_removeViewCore]
* link:Progress.adoc#_removeviewfromnativevisualtree[_removeViewFromNativeVisualTree]
* link:Progress.adoc#_resumenativeupdates[_resumeNativeUpdates]
* link:Progress.adoc#_setcurrentlayoutbounds[_setCurrentLayoutBounds]
* link:Progress.adoc#_setcurrentmeasurespecs[_setCurrentMeasureSpecs]
* link:Progress.adoc#_setminheightnative[_setMinHeightNative]
* link:Progress.adoc#_setminwidthnative[_setMinWidthNative]
* link:Progress.adoc#_setnativecliptobounds[_setNativeClipToBounds]
* link:Progress.adoc#_setnativeviewframe[_setNativeViewFrame]
* link:Progress.adoc#_setvalue[_setValue]
* link:Progress.adoc#_setupasrootview[_setupAsRootView]
* link:Progress.adoc#_setupui[_setupUI]
* link:Progress.adoc#_shoulddelaylayout[_shouldDelayLayout]
* link:Progress.adoc#_shownativemodalview[_showNativeModalView]
* link:Progress.adoc#_suspendnativeupdates[_suspendNativeUpdates]
* link:Progress.adoc#_teardownui[_tearDownUI]
* link:Progress.adoc#_updateeffectivelayoutvalues[_updateEffectiveLayoutValues]
* link:Progress.adoc#_updatestylescope[_updateStyleScope]
* link:Progress.adoc#accessibilityannouncement[accessibilityAnnouncement]
* link:Progress.adoc#accessibilityscreenchanged[accessibilityScreenChanged]
* link:Progress.adoc#addcss[addCss]
* link:Progress.adoc#addcssfile[addCssFile]
* link:Progress.adoc#addeventlistener[addEventListener]
* link:Progress.adoc#addpseudoclass[addPseudoClass]
* link:Progress.adoc#animate[animate]
* link:Progress.adoc#bind[bind]
* link:Progress.adoc#callloaded[callLoaded]
* link:Progress.adoc#callunloaded[callUnloaded]
* link:Progress.adoc#changecssfile[changeCssFile]
* link:Progress.adoc#closemodal[closeModal]
* link:Progress.adoc#createanimation[createAnimation]
* link:Progress.adoc#createnativeview[createNativeView]
* link:Progress.adoc#deletepseudoclass[deletePseudoClass]
* link:Progress.adoc#destroynode[destroyNode]
* link:Progress.adoc#disposenativeview[disposeNativeView]
* link:Progress.adoc#eachchild[eachChild]
* link:Progress.adoc#eachchildview[eachChildView]
* link:Progress.adoc#ensuredomnode[ensureDomNode]
* link:Progress.adoc#focus[focus]
* link:Progress.adoc#get[get]
* link:Progress.adoc#getactualsize[getActualSize]
* link:Progress.adoc#getgestureobservers[getGestureObservers]
* link:Progress.adoc#getlocationinwindow[getLocationInWindow]
* link:Progress.adoc#getlocationonscreen[getLocationOnScreen]
* link:Progress.adoc#getlocationrelativeto[getLocationRelativeTo]
* link:Progress.adoc#getmeasuredheight[getMeasuredHeight]
* link:Progress.adoc#getmeasuredstate[getMeasuredState]
* link:Progress.adoc#getmeasuredwidth[getMeasuredWidth]
* link:Progress.adoc#getsafeareainsets[getSafeAreaInsets]
* link:Progress.adoc#getviewbydomid[getViewByDomId]
* link:Progress.adoc#getviewbyid[getViewById]
* link:Progress.adoc#hasgestureobservers[hasGestureObservers]
* link:Progress.adoc#haslisteners[hasListeners]
* link:Progress.adoc#initnativeview[initNativeView]
* link:Progress.adoc#layout[layout]
* link:Progress.adoc#layoutnativeview[layoutNativeView]
* link:Progress.adoc#loadview[loadView]
* link:Progress.adoc#measure[measure]
* link:Progress.adoc#notify[notify]
* link:Progress.adoc#notifypropertychange[notifyPropertyChange]
* link:Progress.adoc#off[off]
* link:Progress.adoc#on[on]
* link:Progress.adoc#onbackpressed[onBackPressed]
* link:Progress.adoc#onlayout[onLayout]
* link:Progress.adoc#onloaded[onLoaded]
* link:Progress.adoc#onmeasure[onMeasure]
* link:Progress.adoc#onresumenativeupdates[onResumeNativeUpdates]
* link:Progress.adoc#onunloaded[onUnloaded]
* link:Progress.adoc#once[once]
* link:Progress.adoc#removeeventlistener[removeEventListener]
* link:Progress.adoc#requestlayout[requestLayout]
* link:Progress.adoc#resetnativeview[resetNativeView]
* link:Progress.adoc#sendaccessibilityevent[sendAccessibilityEvent]
* link:Progress.adoc#set[set]
* link:Progress.adoc#setinlinestyle[setInlineStyle]
* link:Progress.adoc#setmeasureddimension[setMeasuredDimension]
* link:Progress.adoc#setnativeview[setNativeView]
* link:Progress.adoc#setontouchlistener[setOnTouchListener]
* link:Progress.adoc#setproperty[setProperty]
* link:Progress.adoc#settestid[setTestID]
* link:Progress.adoc#showmodal[showModal]
* link:Progress.adoc#tostring[toString]
* link:Progress.adoc#unbind[unbind]
* link:Progress.adoc#unloadview[unloadView]
* link:Progress.adoc#addeventlistener-1[addEventListener]
* link:Progress.adoc#combinemeasuredstates[combineMeasuredStates]
* link:Progress.adoc#layoutchild[layoutChild]
* link:Progress.adoc#measurechild[measureChild]
* link:Progress.adoc#off-1[off]
* link:Progress.adoc#on-1[on]
* link:Progress.adoc#once-1[once]
* link:Progress.adoc#removeeventlistener-1[removeEventListener]
* link:Progress.adoc#resolvesizeandstate[resolveSizeAndState]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/progress/index.d.ts#L11[ui/progress/index.d.ts:11]
...
Gets the native iOS https://developer.apple.com/library/ios/documentation/UIKit/Reference/UIProgressView_Class/[UIProgressView] that represents the user interface for this component.
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/progress/index.d.ts#L16[ui/progress/index.d.ts:16]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/progress/index.d.ts#L26[ui/progress/index.d.ts:26]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/progress/index.d.ts#L21[ui/progress/index.d.ts:21]
