...
* link:WrappedValue.adoc#constructor[constructor]

=== Properties

* link:WrappedValue.adoc#wrapped[wrapped]

=== Methods

* link:WrappedValue.adoc#unwrap[unwrap]
* link:WrappedValue.adoc#wrap[wrap]
