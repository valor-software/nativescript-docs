...
* link:FileSystemEntity.adoc#constructor[constructor]

=== Properties

* link:FileSystemEntity.adoc#_extension[_extension]
* link:FileSystemEntity.adoc#_isknown[_isKnown]
* link:FileSystemEntity.adoc#_lastmodified[_lastModified]
* link:FileSystemEntity.adoc#_locked[_locked]
* link:FileSystemEntity.adoc#_name[_name]
* link:FileSystemEntity.adoc#_path[_path]

=== Accessors

* link:FileSystemEntity.adoc#lastmodified[lastModified]
* link:FileSystemEntity.adoc#name[name]
* link:FileSystemEntity.adoc#parent[parent]
* link:FileSystemEntity.adoc#path[path]

=== Methods

* link:FileSystemEntity.adoc#remove[remove]
* link:FileSystemEntity.adoc#removesync[removeSync]
* link:FileSystemEntity.adoc#rename[rename]
* link:FileSystemEntity.adoc#renamesync[renameSync]
