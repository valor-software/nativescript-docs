...
* link:SearchBar.md#constructor[constructor]

=== Properties

* link:SearchBar.md#_androidcontentdescriptionupdated[_androidContentDescriptionUpdated]
* link:SearchBar.md#_automaticallyadjustsscrollviewinsets[_automaticallyAdjustsScrollViewInsets]
* link:SearchBar.md#_closemodalcallback[_closeModalCallback]
* link:SearchBar.md#_context[_context]
* link:SearchBar.md#_cssstate[_cssState]
* link:SearchBar.md#_currentheightmeasurespec[_currentHeightMeasureSpec]
* link:SearchBar.md#_currentwidthmeasurespec[_currentWidthMeasureSpec]
* link:SearchBar.md#_defaultpaddingbottom[_defaultPaddingBottom]
* link:SearchBar.md#_defaultpaddingleft[_defaultPaddingLeft]
* link:SearchBar.md#_defaultpaddingright[_defaultPaddingRight]
* link:SearchBar.md#_defaultpaddingtop[_defaultPaddingTop]
* link:SearchBar.md#_domid[_domId]
* link:SearchBar.md#_gestureobservers[_gestureObservers]
* link:SearchBar.md#_ignoreflexminwidthheightreset[_ignoreFlexMinWidthHeightReset]
* link:SearchBar.md#_isaddedtonativevisualtree[_isAddedToNativeVisualTree]
* link:SearchBar.md#_islayoutvalid[_isLayoutValid]
* link:SearchBar.md#_ispaddingrelative[_isPaddingRelative]
* link:SearchBar.md#_isstylescopehost[_isStyleScopeHost]
* link:SearchBar.md#_isviewbase[_isViewBase]
* link:SearchBar.md#_manager[_manager]
* link:SearchBar.md#_modalparent[_modalParent]
* link:SearchBar.md#_modulename[_moduleName]
* link:SearchBar.md#_oldbottom[_oldBottom]
* link:SearchBar.md#_oldleft[_oldLeft]
* link:SearchBar.md#_oldright[_oldRight]
* link:SearchBar.md#_oldtop[_oldTop]
* link:SearchBar.md#_stylescope[_styleScope]
* link:SearchBar.md#_suspendnativeupdatescount[_suspendNativeUpdatesCount]
* link:SearchBar.md#_suspendedupdates[_suspendedUpdates]
* link:SearchBar.md#accessibilityhidden[accessibilityHidden]
* link:SearchBar.md#accessibilityhint[accessibilityHint]
* link:SearchBar.md#accessibilityidentifier[accessibilityIdentifier]
* link:SearchBar.md#accessibilitylabel[accessibilityLabel]
* link:SearchBar.md#accessibilitylanguage[accessibilityLanguage]
* link:SearchBar.md#accessibilityliveregion[accessibilityLiveRegion]
* link:SearchBar.md#accessibilitymediasession[accessibilityMediaSession]
* link:SearchBar.md#accessibilityrole[accessibilityRole]
* link:SearchBar.md#accessibilitystate[accessibilityState]
* link:SearchBar.md#accessibilityvalue[accessibilityValue]
* link:SearchBar.md#accessible[accessible]
* link:SearchBar.md#alignself[alignSelf]
* link:SearchBar.md#android[android]
* link:SearchBar.md#androiddynamicelevationoffset[androidDynamicElevationOffset]
* link:SearchBar.md#androidelevation[androidElevation]
* link:SearchBar.md#automationtext[automationText]
* link:SearchBar.md#background[background]
* link:SearchBar.md#backgroundcolor[backgroundColor]
* link:SearchBar.md#backgroundimage[backgroundImage]
* link:SearchBar.md#bindingcontext[bindingContext]
* link:SearchBar.md#borderbottomcolor[borderBottomColor]
* link:SearchBar.md#borderbottomleftradius[borderBottomLeftRadius]
* link:SearchBar.md#borderbottomrightradius[borderBottomRightRadius]
* link:SearchBar.md#borderbottomwidth[borderBottomWidth]
* link:SearchBar.md#bordercolor[borderColor]
* link:SearchBar.md#borderleftcolor[borderLeftColor]
* link:SearchBar.md#borderleftwidth[borderLeftWidth]
* link:SearchBar.md#borderradius[borderRadius]
* link:SearchBar.md#borderrightcolor[borderRightColor]
* link:SearchBar.md#borderrightwidth[borderRightWidth]
* link:SearchBar.md#bordertopcolor[borderTopColor]
* link:SearchBar.md#bordertopleftradius[borderTopLeftRadius]
* link:SearchBar.md#bordertoprightradius[borderTopRightRadius]
* link:SearchBar.md#bordertopwidth[borderTopWidth]
* link:SearchBar.md#borderwidth[borderWidth]
* link:SearchBar.md#boxshadow[boxShadow]
* link:SearchBar.md#classname[className]
* link:SearchBar.md#col[col]
* link:SearchBar.md#colspan[colSpan]
* link:SearchBar.md#color[color]
* link:SearchBar.md#column[column]
* link:SearchBar.md#columnspan[columnSpan]
* link:SearchBar.md#css[css]
* link:SearchBar.md#cssclasses[cssClasses]
* link:SearchBar.md#csspseudoclasses[cssPseudoClasses]
* link:SearchBar.md#csstype[cssType]
* link:SearchBar.md#dock[dock]
* link:SearchBar.md#domnode[domNode]
* link:SearchBar.md#effectiveborderbottomwidth[effectiveBorderBottomWidth]
* link:SearchBar.md#effectiveborderleftwidth[effectiveBorderLeftWidth]
* link:SearchBar.md#effectiveborderrightwidth[effectiveBorderRightWidth]
* link:SearchBar.md#effectivebordertopwidth[effectiveBorderTopWidth]
* link:SearchBar.md#effectiveheight[effectiveHeight]
* link:SearchBar.md#effectiveleft[effectiveLeft]
* link:SearchBar.md#effectivemarginbottom[effectiveMarginBottom]
* link:SearchBar.md#effectivemarginleft[effectiveMarginLeft]
* link:SearchBar.md#effectivemarginright[effectiveMarginRight]
* link:SearchBar.md#effectivemargintop[effectiveMarginTop]
* link:SearchBar.md#effectiveminheight[effectiveMinHeight]
* link:SearchBar.md#effectiveminwidth[effectiveMinWidth]
* link:SearchBar.md#effectivepaddingbottom[effectivePaddingBottom]
* link:SearchBar.md#effectivepaddingleft[effectivePaddingLeft]
* link:SearchBar.md#effectivepaddingright[effectivePaddingRight]
* link:SearchBar.md#effectivepaddingtop[effectivePaddingTop]
* link:SearchBar.md#effectivetop[effectiveTop]
* link:SearchBar.md#effectivewidth[effectiveWidth]
* link:SearchBar.md#flexgrow[flexGrow]
* link:SearchBar.md#flexshrink[flexShrink]
* link:SearchBar.md#flexwrapbefore[flexWrapBefore]
* link:SearchBar.md#height[height]
* link:SearchBar.md#hint[hint]
* link:SearchBar.md#horizontalalignment[horizontalAlignment]
* link:SearchBar.md#id[id]
* link:SearchBar.md#ignoretouchanimation[ignoreTouchAnimation]
* link:SearchBar.md#ios[ios]
* link:SearchBar.md#iosignoresafearea[iosIgnoreSafeArea]
* link:SearchBar.md#iosoverflowsafearea[iosOverflowSafeArea]
* link:SearchBar.md#iosoverflowsafeareaenabled[iosOverflowSafeAreaEnabled]
* link:SearchBar.md#iscollapsed[isCollapsed]
* link:SearchBar.md#isenabled[isEnabled]
* link:SearchBar.md#islayoutrequired[isLayoutRequired]
* link:SearchBar.md#islayoutvalid[isLayoutValid]
* link:SearchBar.md#isuserinteractionenabled[isUserInteractionEnabled]
* link:SearchBar.md#left[left]
* link:SearchBar.md#margin[margin]
* link:SearchBar.md#marginbottom[marginBottom]
* link:SearchBar.md#marginleft[marginLeft]
* link:SearchBar.md#marginright[marginRight]
* link:SearchBar.md#margintop[marginTop]
* link:SearchBar.md#minheight[minHeight]
* link:SearchBar.md#minwidth[minWidth]
* link:SearchBar.md#modal[modal]
* link:SearchBar.md#nativeviewprotected[nativeViewProtected]
* link:SearchBar.md#opacity[opacity]
* link:SearchBar.md#order[order]
* link:SearchBar.md#originx[originX]
* link:SearchBar.md#originy[originY]
* link:SearchBar.md#parent[parent]
* link:SearchBar.md#perspective[perspective]
* link:SearchBar.md#recyclenativeview[recycleNativeView]
* link:SearchBar.md#reusable[reusable]
* link:SearchBar.md#rotate[rotate]
* link:SearchBar.md#rotatex[rotateX]
* link:SearchBar.md#rotatey[rotateY]
* link:SearchBar.md#row[row]
* link:SearchBar.md#rowspan[rowSpan]
* link:SearchBar.md#scalex[scaleX]
* link:SearchBar.md#scaley[scaleY]
* link:SearchBar.md#testid[testID]
* link:SearchBar.md#text[text]
* link:SearchBar.md#textfieldbackgroundcolor[textFieldBackgroundColor]
* link:SearchBar.md#textfieldhintcolor[textFieldHintColor]
* link:SearchBar.md#top[top]
* link:SearchBar.md#touchanimation[touchAnimation]
* link:SearchBar.md#touchdelay[touchDelay]
* link:SearchBar.md#translatex[translateX]
* link:SearchBar.md#translatey[translateY]
* link:SearchBar.md#verticalalignment[verticalAlignment]
* link:SearchBar.md#viewcontroller[viewController]
* link:SearchBar.md#visibility[visibility]
* link:SearchBar.md#width[width]
* link:SearchBar.md#accessibilityblurevent[accessibilityBlurEvent]
* link:SearchBar.md#accessibilityfocuschangedevent[accessibilityFocusChangedEvent]
* link:SearchBar.md#accessibilityfocusevent[accessibilityFocusEvent]
* link:SearchBar.md#accessibilityperformescapeevent[accessibilityPerformEscapeEvent]
* link:SearchBar.md#clearevent[clearEvent]
* link:SearchBar.md#createdevent[createdEvent]
* link:SearchBar.md#disposenativeviewevent[disposeNativeViewEvent]
* link:SearchBar.md#layoutchangedevent[layoutChangedEvent]
* link:SearchBar.md#loadedevent[loadedEvent]
* link:SearchBar.md#propertychangeevent[propertyChangeEvent]
* link:SearchBar.md#showingmodallyevent[showingModallyEvent]
* link:SearchBar.md#shownmodallyevent[shownModallyEvent]
* link:SearchBar.md#submitevent[submitEvent]
* link:SearchBar.md#unloadedevent[unloadedEvent]

=== Accessors

* link:SearchBar.md#backgroundposition[backgroundPosition]
* link:SearchBar.md#backgroundrepeat[backgroundRepeat]
* link:SearchBar.md#backgroundsize[backgroundSize]
* link:SearchBar.md#class[class]
* link:SearchBar.md#isloaded[isLoaded]
* link:SearchBar.md#nativeview[nativeView]
* link:SearchBar.md#page[page]
* link:SearchBar.md#parentnode[parentNode]
* link:SearchBar.md#style[style]
* link:SearchBar.md#texttransform[textTransform]
* link:SearchBar.md#typename[typeName]

=== Methods

* link:SearchBar.md#_addview[_addView]
* link:SearchBar.md#_addviewcore[_addViewCore]
* link:SearchBar.md#_addviewtonativevisualtree[_addViewToNativeVisualTree]
* link:SearchBar.md#_applybackground[_applyBackground]
* link:SearchBar.md#_applyxmlattribute[_applyXmlAttribute]
* link:SearchBar.md#_batchupdate[_batchUpdate]
* link:SearchBar.md#_childindextonativechildindex[_childIndexToNativeChildIndex]
* link:SearchBar.md#_closeallmodalviewsinternal[_closeAllModalViewsInternal]
* link:SearchBar.md#_createpropertychangedata[_createPropertyChangeData]
* link:SearchBar.md#_dialogclosed[_dialogClosed]
* link:SearchBar.md#_eachlayoutview[_eachLayoutView]
* link:SearchBar.md#_emit[_emit]
* link:SearchBar.md#_getcurrentlayoutbounds[_getCurrentLayoutBounds]
* link:SearchBar.md#_getfragmentmanager[_getFragmentManager]
* link:SearchBar.md#_getnativeviewscount[_getNativeViewsCount]
* link:SearchBar.md#_getrootmodalviews[_getRootModalViews]
* link:SearchBar.md#_getvalue[_getValue]
* link:SearchBar.md#_gotovisualstate[_goToVisualState]
* link:SearchBar.md#_handlelivesync[_handleLivesync]
* link:SearchBar.md#_hasancestorview[_hasAncestorView]
* link:SearchBar.md#_hidenativemodalview[_hideNativeModalView]
* link:SearchBar.md#_inheritstylescope[_inheritStyleScope]
* link:SearchBar.md#_layoutparent[_layoutParent]
* link:SearchBar.md#_observe[_observe]
* link:SearchBar.md#_onattachedtowindow[_onAttachedToWindow]
* link:SearchBar.md#_oncssstatechange[_onCssStateChange]
* link:SearchBar.md#_ondetachedfromwindow[_onDetachedFromWindow]
* link:SearchBar.md#_onlivesync[_onLivesync]
* link:SearchBar.md#_onrootviewreset[_onRootViewReset]
* link:SearchBar.md#_onsizechanged[_onSizeChanged]
* link:SearchBar.md#_parentchanged[_parentChanged]
* link:SearchBar.md#_raiselayoutchangedevent[_raiseLayoutChangedEvent]
* link:SearchBar.md#_raiseshowingmodallyevent[_raiseShowingModallyEvent]
* link:SearchBar.md#_raiseshownmodallyevent[_raiseShownModallyEvent]
* link:SearchBar.md#_redrawnativebackground[_redrawNativeBackground]
* link:SearchBar.md#_removeanimation[_removeAnimation]
* link:SearchBar.md#_removeview[_removeView]
* link:SearchBar.md#_removeviewcore[_removeViewCore]
* link:SearchBar.md#_removeviewfromnativevisualtree[_removeViewFromNativeVisualTree]
* link:SearchBar.md#_resumenativeupdates[_resumeNativeUpdates]
* link:SearchBar.md#_setcurrentlayoutbounds[_setCurrentLayoutBounds]
* link:SearchBar.md#_setcurrentmeasurespecs[_setCurrentMeasureSpecs]
* link:SearchBar.md#_setminheightnative[_setMinHeightNative]
* link:SearchBar.md#_setminwidthnative[_setMinWidthNative]
* link:SearchBar.md#_setnativecliptobounds[_setNativeClipToBounds]
* link:SearchBar.md#_setnativeviewframe[_setNativeViewFrame]
* link:SearchBar.md#_setvalue[_setValue]
* link:SearchBar.md#_setupasrootview[_setupAsRootView]
* link:SearchBar.md#_setupui[_setupUI]
* link:SearchBar.md#_shoulddelaylayout[_shouldDelayLayout]
* link:SearchBar.md#_shownativemodalview[_showNativeModalView]
* link:SearchBar.md#_suspendnativeupdates[_suspendNativeUpdates]
* link:SearchBar.md#_teardownui[_tearDownUI]
* link:SearchBar.md#_updateeffectivelayoutvalues[_updateEffectiveLayoutValues]
* link:SearchBar.md#_updatestylescope[_updateStyleScope]
* link:SearchBar.md#accessibilityannouncement[accessibilityAnnouncement]
* link:SearchBar.md#accessibilityscreenchanged[accessibilityScreenChanged]
* link:SearchBar.md#addcss[addCss]
* link:SearchBar.md#addcssfile[addCssFile]
* link:SearchBar.md#addeventlistener[addEventListener]
* link:SearchBar.md#addpseudoclass[addPseudoClass]
* link:SearchBar.md#animate[animate]
* link:SearchBar.md#bind[bind]
* link:SearchBar.md#callloaded[callLoaded]
* link:SearchBar.md#callunloaded[callUnloaded]
* link:SearchBar.md#changecssfile[changeCssFile]
* link:SearchBar.md#closemodal[closeModal]
* link:SearchBar.md#createanimation[createAnimation]
* link:SearchBar.md#createnativeview[createNativeView]
* link:SearchBar.md#deletepseudoclass[deletePseudoClass]
* link:SearchBar.md#destroynode[destroyNode]
* link:SearchBar.md#dismisssoftinput[dismissSoftInput]
* link:SearchBar.md#disposenativeview[disposeNativeView]
* link:SearchBar.md#eachchild[eachChild]
* link:SearchBar.md#eachchildview[eachChildView]
* link:SearchBar.md#ensuredomnode[ensureDomNode]
* link:SearchBar.md#focus[focus]
* link:SearchBar.md#get[get]
* link:SearchBar.md#getactualsize[getActualSize]
* link:SearchBar.md#getgestureobservers[getGestureObservers]
* link:SearchBar.md#getlocationinwindow[getLocationInWindow]
* link:SearchBar.md#getlocationonscreen[getLocationOnScreen]
* link:SearchBar.md#getlocationrelativeto[getLocationRelativeTo]
* link:SearchBar.md#getmeasuredheight[getMeasuredHeight]
* link:SearchBar.md#getmeasuredstate[getMeasuredState]
* link:SearchBar.md#getmeasuredwidth[getMeasuredWidth]
* link:SearchBar.md#getsafeareainsets[getSafeAreaInsets]
* link:SearchBar.md#getviewbydomid[getViewByDomId]
* link:SearchBar.md#getviewbyid[getViewById]
* link:SearchBar.md#hasgestureobservers[hasGestureObservers]
* link:SearchBar.md#haslisteners[hasListeners]
* link:SearchBar.md#initnativeview[initNativeView]
* link:SearchBar.md#layout[layout]
* link:SearchBar.md#layoutnativeview[layoutNativeView]
* link:SearchBar.md#loadview[loadView]
* link:SearchBar.md#measure[measure]
* link:SearchBar.md#notify[notify]
* link:SearchBar.md#notifypropertychange[notifyPropertyChange]
* link:SearchBar.md#off[off]
* link:SearchBar.md#on[on]
* link:SearchBar.md#onbackpressed[onBackPressed]
* link:SearchBar.md#onlayout[onLayout]
* link:SearchBar.md#onloaded[onLoaded]
* link:SearchBar.md#onmeasure[onMeasure]
* link:SearchBar.md#onresumenativeupdates[onResumeNativeUpdates]
* link:SearchBar.md#onunloaded[onUnloaded]
* link:SearchBar.md#once[once]
* link:SearchBar.md#removeeventlistener[removeEventListener]
* link:SearchBar.md#requestlayout[requestLayout]
* link:SearchBar.md#resetnativeview[resetNativeView]
* link:SearchBar.md#sendaccessibilityevent[sendAccessibilityEvent]
* link:SearchBar.md#set[set]
* link:SearchBar.md#setinlinestyle[setInlineStyle]
* link:SearchBar.md#setmeasureddimension[setMeasuredDimension]
* link:SearchBar.md#setnativeview[setNativeView]
* link:SearchBar.md#setontouchlistener[setOnTouchListener]
* link:SearchBar.md#setproperty[setProperty]
* link:SearchBar.md#settestid[setTestID]
* link:SearchBar.md#showmodal[showModal]
* link:SearchBar.md#tostring[toString]
* link:SearchBar.md#unbind[unbind]
* link:SearchBar.md#unloadview[unloadView]
* link:SearchBar.md#addeventlistener-1[addEventListener]
* link:SearchBar.md#combinemeasuredstates[combineMeasuredStates]
* link:SearchBar.md#layoutchild[layoutChild]
* link:SearchBar.md#measurechild[measureChild]
* link:SearchBar.md#off-1[off]
* link:SearchBar.md#on-1[on]
* link:SearchBar.md#once-1[once]
* link:SearchBar.md#removeeventlistener-1[removeEventListener]
* link:SearchBar.md#resolvesizeandstate[resolveSizeAndState]
