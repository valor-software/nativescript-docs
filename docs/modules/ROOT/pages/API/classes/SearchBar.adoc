...
xref:../README.adoc[NativeScript] / xref:../modules.adoc[Exports] / SearchBar
...
* link:SearchBar.adoc#constructor[constructor]

=== Properties

* link:SearchBar.adoc#_androidcontentdescriptionupdated[_androidContentDescriptionUpdated]
* link:SearchBar.adoc#_automaticallyadjustsscrollviewinsets[_automaticallyAdjustsScrollViewInsets]
* link:SearchBar.adoc#_closemodalcallback[_closeModalCallback]
* link:SearchBar.adoc#_context[_context]
* link:SearchBar.adoc#_cssstate[_cssState]
* link:SearchBar.adoc#_currentheightmeasurespec[_currentHeightMeasureSpec]
* link:SearchBar.adoc#_currentwidthmeasurespec[_currentWidthMeasureSpec]
* link:SearchBar.adoc#_defaultpaddingbottom[_defaultPaddingBottom]
* link:SearchBar.adoc#_defaultpaddingleft[_defaultPaddingLeft]
* link:SearchBar.adoc#_defaultpaddingright[_defaultPaddingRight]
* link:SearchBar.adoc#_defaultpaddingtop[_defaultPaddingTop]
* link:SearchBar.adoc#_domid[_domId]
* link:SearchBar.adoc#_gestureobservers[_gestureObservers]
* link:SearchBar.adoc#_ignoreflexminwidthheightreset[_ignoreFlexMinWidthHeightReset]
* link:SearchBar.adoc#_isaddedtonativevisualtree[_isAddedToNativeVisualTree]
* link:SearchBar.adoc#_islayoutvalid[_isLayoutValid]
* link:SearchBar.adoc#_ispaddingrelative[_isPaddingRelative]
* link:SearchBar.adoc#_isstylescopehost[_isStyleScopeHost]
* link:SearchBar.adoc#_isviewbase[_isViewBase]
* link:SearchBar.adoc#_manager[_manager]
* link:SearchBar.adoc#_modalparent[_modalParent]
* link:SearchBar.adoc#_modulename[_moduleName]
* link:SearchBar.adoc#_oldbottom[_oldBottom]
* link:SearchBar.adoc#_oldleft[_oldLeft]
* link:SearchBar.adoc#_oldright[_oldRight]
* link:SearchBar.adoc#_oldtop[_oldTop]
* link:SearchBar.adoc#_stylescope[_styleScope]
* link:SearchBar.adoc#_suspendnativeupdatescount[_suspendNativeUpdatesCount]
* link:SearchBar.adoc#_suspendedupdates[_suspendedUpdates]
* link:SearchBar.adoc#accessibilityhidden[accessibilityHidden]
* link:SearchBar.adoc#accessibilityhint[accessibilityHint]
* link:SearchBar.adoc#accessibilityidentifier[accessibilityIdentifier]
* link:SearchBar.adoc#accessibilitylabel[accessibilityLabel]
* link:SearchBar.adoc#accessibilitylanguage[accessibilityLanguage]
* link:SearchBar.adoc#accessibilityliveregion[accessibilityLiveRegion]
* link:SearchBar.adoc#accessibilitymediasession[accessibilityMediaSession]
* link:SearchBar.adoc#accessibilityrole[accessibilityRole]
* link:SearchBar.adoc#accessibilitystate[accessibilityState]
* link:SearchBar.adoc#accessibilityvalue[accessibilityValue]
* link:SearchBar.adoc#accessible[accessible]
* link:SearchBar.adoc#alignself[alignSelf]
* link:SearchBar.adoc#android[android]
* link:SearchBar.adoc#androiddynamicelevationoffset[androidDynamicElevationOffset]
* link:SearchBar.adoc#androidelevation[androidElevation]
* link:SearchBar.adoc#automationtext[automationText]
* link:SearchBar.adoc#background[background]
* link:SearchBar.adoc#backgroundcolor[backgroundColor]
* link:SearchBar.adoc#backgroundimage[backgroundImage]
* link:SearchBar.adoc#bindingcontext[bindingContext]
* link:SearchBar.adoc#borderbottomcolor[borderBottomColor]
* link:SearchBar.adoc#borderbottomleftradius[borderBottomLeftRadius]
* link:SearchBar.adoc#borderbottomrightradius[borderBottomRightRadius]
* link:SearchBar.adoc#borderbottomwidth[borderBottomWidth]
* link:SearchBar.adoc#bordercolor[borderColor]
* link:SearchBar.adoc#borderleftcolor[borderLeftColor]
* link:SearchBar.adoc#borderleftwidth[borderLeftWidth]
* link:SearchBar.adoc#borderradius[borderRadius]
* link:SearchBar.adoc#borderrightcolor[borderRightColor]
* link:SearchBar.adoc#borderrightwidth[borderRightWidth]
* link:SearchBar.adoc#bordertopcolor[borderTopColor]
* link:SearchBar.adoc#bordertopleftradius[borderTopLeftRadius]
* link:SearchBar.adoc#bordertoprightradius[borderTopRightRadius]
* link:SearchBar.adoc#bordertopwidth[borderTopWidth]
* link:SearchBar.adoc#borderwidth[borderWidth]
* link:SearchBar.adoc#boxshadow[boxShadow]
* link:SearchBar.adoc#classname[className]
* link:SearchBar.adoc#col[col]
* link:SearchBar.adoc#colspan[colSpan]
* link:SearchBar.adoc#color[color]
* link:SearchBar.adoc#column[column]
* link:SearchBar.adoc#columnspan[columnSpan]
* link:SearchBar.adoc#css[css]
* link:SearchBar.adoc#cssclasses[cssClasses]
* link:SearchBar.adoc#csspseudoclasses[cssPseudoClasses]
* link:SearchBar.adoc#csstype[cssType]
* link:SearchBar.adoc#dock[dock]
* link:SearchBar.adoc#domnode[domNode]
* link:SearchBar.adoc#effectiveborderbottomwidth[effectiveBorderBottomWidth]
* link:SearchBar.adoc#effectiveborderleftwidth[effectiveBorderLeftWidth]
* link:SearchBar.adoc#effectiveborderrightwidth[effectiveBorderRightWidth]
* link:SearchBar.adoc#effectivebordertopwidth[effectiveBorderTopWidth]
* link:SearchBar.adoc#effectiveheight[effectiveHeight]
* link:SearchBar.adoc#effectiveleft[effectiveLeft]
* link:SearchBar.adoc#effectivemarginbottom[effectiveMarginBottom]
* link:SearchBar.adoc#effectivemarginleft[effectiveMarginLeft]
* link:SearchBar.adoc#effectivemarginright[effectiveMarginRight]
* link:SearchBar.adoc#effectivemargintop[effectiveMarginTop]
* link:SearchBar.adoc#effectiveminheight[effectiveMinHeight]
* link:SearchBar.adoc#effectiveminwidth[effectiveMinWidth]
* link:SearchBar.adoc#effectivepaddingbottom[effectivePaddingBottom]
* link:SearchBar.adoc#effectivepaddingleft[effectivePaddingLeft]
* link:SearchBar.adoc#effectivepaddingright[effectivePaddingRight]
* link:SearchBar.adoc#effectivepaddingtop[effectivePaddingTop]
* link:SearchBar.adoc#effectivetop[effectiveTop]
* link:SearchBar.adoc#effectivewidth[effectiveWidth]
* link:SearchBar.adoc#flexgrow[flexGrow]
* link:SearchBar.adoc#flexshrink[flexShrink]
* link:SearchBar.adoc#flexwrapbefore[flexWrapBefore]
* link:SearchBar.adoc#height[height]
* link:SearchBar.adoc#hint[hint]
* link:SearchBar.adoc#horizontalalignment[horizontalAlignment]
* link:SearchBar.adoc#id[id]
* link:SearchBar.adoc#ignoretouchanimation[ignoreTouchAnimation]
* link:SearchBar.adoc#ios[ios]
* link:SearchBar.adoc#iosignoresafearea[iosIgnoreSafeArea]
* link:SearchBar.adoc#iosoverflowsafearea[iosOverflowSafeArea]
* link:SearchBar.adoc#iosoverflowsafeareaenabled[iosOverflowSafeAreaEnabled]
* link:SearchBar.adoc#iscollapsed[isCollapsed]
* link:SearchBar.adoc#isenabled[isEnabled]
* link:SearchBar.adoc#islayoutrequired[isLayoutRequired]
* link:SearchBar.adoc#islayoutvalid[isLayoutValid]
* link:SearchBar.adoc#isuserinteractionenabled[isUserInteractionEnabled]
* link:SearchBar.adoc#left[left]
* link:SearchBar.adoc#margin[margin]
* link:SearchBar.adoc#marginbottom[marginBottom]
* link:SearchBar.adoc#marginleft[marginLeft]
* link:SearchBar.adoc#marginright[marginRight]
* link:SearchBar.adoc#margintop[marginTop]
* link:SearchBar.adoc#minheight[minHeight]
* link:SearchBar.adoc#minwidth[minWidth]
* link:SearchBar.adoc#modal[modal]
* link:SearchBar.adoc#nativeviewprotected[nativeViewProtected]
* link:SearchBar.adoc#opacity[opacity]
* link:SearchBar.adoc#order[order]
* link:SearchBar.adoc#originx[originX]
* link:SearchBar.adoc#originy[originY]
* link:SearchBar.adoc#parent[parent]
* link:SearchBar.adoc#perspective[perspective]
* link:SearchBar.adoc#recyclenativeview[recycleNativeView]
* link:SearchBar.adoc#reusable[reusable]
* link:SearchBar.adoc#rotate[rotate]
* link:SearchBar.adoc#rotatex[rotateX]
* link:SearchBar.adoc#rotatey[rotateY]
* link:SearchBar.adoc#row[row]
* link:SearchBar.adoc#rowspan[rowSpan]
* link:SearchBar.adoc#scalex[scaleX]
* link:SearchBar.adoc#scaley[scaleY]
* link:SearchBar.adoc#testid[testID]
* link:SearchBar.adoc#text[text]
* link:SearchBar.adoc#textfieldbackgroundcolor[textFieldBackgroundColor]
* link:SearchBar.adoc#textfieldhintcolor[textFieldHintColor]
* link:SearchBar.adoc#top[top]
* link:SearchBar.adoc#touchanimation[touchAnimation]
* link:SearchBar.adoc#touchdelay[touchDelay]
* link:SearchBar.adoc#translatex[translateX]
* link:SearchBar.adoc#translatey[translateY]
* link:SearchBar.adoc#verticalalignment[verticalAlignment]
* link:SearchBar.adoc#viewcontroller[viewController]
* link:SearchBar.adoc#visibility[visibility]
* link:SearchBar.adoc#width[width]
* link:SearchBar.adoc#accessibilityblurevent[accessibilityBlurEvent]
* link:SearchBar.adoc#accessibilityfocuschangedevent[accessibilityFocusChangedEvent]
* link:SearchBar.adoc#accessibilityfocusevent[accessibilityFocusEvent]
* link:SearchBar.adoc#accessibilityperformescapeevent[accessibilityPerformEscapeEvent]
* link:SearchBar.adoc#clearevent[clearEvent]
* link:SearchBar.adoc#createdevent[createdEvent]
* link:SearchBar.adoc#disposenativeviewevent[disposeNativeViewEvent]
* link:SearchBar.adoc#layoutchangedevent[layoutChangedEvent]
* link:SearchBar.adoc#loadedevent[loadedEvent]
* link:SearchBar.adoc#propertychangeevent[propertyChangeEvent]
* link:SearchBar.adoc#showingmodallyevent[showingModallyEvent]
* link:SearchBar.adoc#shownmodallyevent[shownModallyEvent]
* link:SearchBar.adoc#submitevent[submitEvent]
* link:SearchBar.adoc#unloadedevent[unloadedEvent]

=== Accessors

* link:SearchBar.adoc#backgroundposition[backgroundPosition]
* link:SearchBar.adoc#backgroundrepeat[backgroundRepeat]
* link:SearchBar.adoc#backgroundsize[backgroundSize]
* link:SearchBar.adoc#class[class]
* link:SearchBar.adoc#isloaded[isLoaded]
* link:SearchBar.adoc#nativeview[nativeView]
* link:SearchBar.adoc#page[page]
* link:SearchBar.adoc#parentnode[parentNode]
* link:SearchBar.adoc#style[style]
* link:SearchBar.adoc#texttransform[textTransform]
* link:SearchBar.adoc#typename[typeName]

=== Methods

* link:SearchBar.adoc#_addview[_addView]
* link:SearchBar.adoc#_addviewcore[_addViewCore]
* link:SearchBar.adoc#_addviewtonativevisualtree[_addViewToNativeVisualTree]
* link:SearchBar.adoc#_applybackground[_applyBackground]
* link:SearchBar.adoc#_applyxmlattribute[_applyXmlAttribute]
* link:SearchBar.adoc#_batchupdate[_batchUpdate]
* link:SearchBar.adoc#_childindextonativechildindex[_childIndexToNativeChildIndex]
* link:SearchBar.adoc#_closeallmodalviewsinternal[_closeAllModalViewsInternal]
* link:SearchBar.adoc#_createpropertychangedata[_createPropertyChangeData]
* link:SearchBar.adoc#_dialogclosed[_dialogClosed]
* link:SearchBar.adoc#_eachlayoutview[_eachLayoutView]
* link:SearchBar.adoc#_emit[_emit]
* link:SearchBar.adoc#_getcurrentlayoutbounds[_getCurrentLayoutBounds]
* link:SearchBar.adoc#_getfragmentmanager[_getFragmentManager]
* link:SearchBar.adoc#_getnativeviewscount[_getNativeViewsCount]
* link:SearchBar.adoc#_getrootmodalviews[_getRootModalViews]
* link:SearchBar.adoc#_getvalue[_getValue]
* link:SearchBar.adoc#_gotovisualstate[_goToVisualState]
* link:SearchBar.adoc#_handlelivesync[_handleLivesync]
* link:SearchBar.adoc#_hasancestorview[_hasAncestorView]
* link:SearchBar.adoc#_hidenativemodalview[_hideNativeModalView]
* link:SearchBar.adoc#_inheritstylescope[_inheritStyleScope]
* link:SearchBar.adoc#_layoutparent[_layoutParent]
* link:SearchBar.adoc#_observe[_observe]
* link:SearchBar.adoc#_onattachedtowindow[_onAttachedToWindow]
* link:SearchBar.adoc#_oncssstatechange[_onCssStateChange]
* link:SearchBar.adoc#_ondetachedfromwindow[_onDetachedFromWindow]
* link:SearchBar.adoc#_onlivesync[_onLivesync]
* link:SearchBar.adoc#_onrootviewreset[_onRootViewReset]
* link:SearchBar.adoc#_onsizechanged[_onSizeChanged]
* link:SearchBar.adoc#_parentchanged[_parentChanged]
* link:SearchBar.adoc#_raiselayoutchangedevent[_raiseLayoutChangedEvent]
* link:SearchBar.adoc#_raiseshowingmodallyevent[_raiseShowingModallyEvent]
* link:SearchBar.adoc#_raiseshownmodallyevent[_raiseShownModallyEvent]
* link:SearchBar.adoc#_redrawnativebackground[_redrawNativeBackground]
* link:SearchBar.adoc#_removeanimation[_removeAnimation]
* link:SearchBar.adoc#_removeview[_removeView]
* link:SearchBar.adoc#_removeviewcore[_removeViewCore]
* link:SearchBar.adoc#_removeviewfromnativevisualtree[_removeViewFromNativeVisualTree]
* link:SearchBar.adoc#_resumenativeupdates[_resumeNativeUpdates]
* link:SearchBar.adoc#_setcurrentlayoutbounds[_setCurrentLayoutBounds]
* link:SearchBar.adoc#_setcurrentmeasurespecs[_setCurrentMeasureSpecs]
* link:SearchBar.adoc#_setminheightnative[_setMinHeightNative]
* link:SearchBar.adoc#_setminwidthnative[_setMinWidthNative]
* link:SearchBar.adoc#_setnativecliptobounds[_setNativeClipToBounds]
* link:SearchBar.adoc#_setnativeviewframe[_setNativeViewFrame]
* link:SearchBar.adoc#_setvalue[_setValue]
* link:SearchBar.adoc#_setupasrootview[_setupAsRootView]
* link:SearchBar.adoc#_setupui[_setupUI]
* link:SearchBar.adoc#_shoulddelaylayout[_shouldDelayLayout]
* link:SearchBar.adoc#_shownativemodalview[_showNativeModalView]
* link:SearchBar.adoc#_suspendnativeupdates[_suspendNativeUpdates]
* link:SearchBar.adoc#_teardownui[_tearDownUI]
* link:SearchBar.adoc#_updateeffectivelayoutvalues[_updateEffectiveLayoutValues]
* link:SearchBar.adoc#_updatestylescope[_updateStyleScope]
* link:SearchBar.adoc#accessibilityannouncement[accessibilityAnnouncement]
* link:SearchBar.adoc#accessibilityscreenchanged[accessibilityScreenChanged]
* link:SearchBar.adoc#addcss[addCss]
* link:SearchBar.adoc#addcssfile[addCssFile]
* link:SearchBar.adoc#addeventlistener[addEventListener]
* link:SearchBar.adoc#addpseudoclass[addPseudoClass]
* link:SearchBar.adoc#animate[animate]
* link:SearchBar.adoc#bind[bind]
* link:SearchBar.adoc#callloaded[callLoaded]
* link:SearchBar.adoc#callunloaded[callUnloaded]
* link:SearchBar.adoc#changecssfile[changeCssFile]
* link:SearchBar.adoc#closemodal[closeModal]
* link:SearchBar.adoc#createanimation[createAnimation]
* link:SearchBar.adoc#createnativeview[createNativeView]
* link:SearchBar.adoc#deletepseudoclass[deletePseudoClass]
* link:SearchBar.adoc#destroynode[destroyNode]
* link:SearchBar.adoc#dismisssoftinput[dismissSoftInput]
* link:SearchBar.adoc#disposenativeview[disposeNativeView]
* link:SearchBar.adoc#eachchild[eachChild]
* link:SearchBar.adoc#eachchildview[eachChildView]
* link:SearchBar.adoc#ensuredomnode[ensureDomNode]
* link:SearchBar.adoc#focus[focus]
* link:SearchBar.adoc#get[get]
* link:SearchBar.adoc#getactualsize[getActualSize]
* link:SearchBar.adoc#getgestureobservers[getGestureObservers]
* link:SearchBar.adoc#getlocationinwindow[getLocationInWindow]
* link:SearchBar.adoc#getlocationonscreen[getLocationOnScreen]
* link:SearchBar.adoc#getlocationrelativeto[getLocationRelativeTo]
* link:SearchBar.adoc#getmeasuredheight[getMeasuredHeight]
* link:SearchBar.adoc#getmeasuredstate[getMeasuredState]
* link:SearchBar.adoc#getmeasuredwidth[getMeasuredWidth]
* link:SearchBar.adoc#getsafeareainsets[getSafeAreaInsets]
* link:SearchBar.adoc#getviewbydomid[getViewByDomId]
* link:SearchBar.adoc#getviewbyid[getViewById]
* link:SearchBar.adoc#hasgestureobservers[hasGestureObservers]
* link:SearchBar.adoc#haslisteners[hasListeners]
* link:SearchBar.adoc#initnativeview[initNativeView]
* link:SearchBar.adoc#layout[layout]
* link:SearchBar.adoc#layoutnativeview[layoutNativeView]
* link:SearchBar.adoc#loadview[loadView]
* link:SearchBar.adoc#measure[measure]
* link:SearchBar.adoc#notify[notify]
* link:SearchBar.adoc#notifypropertychange[notifyPropertyChange]
* link:SearchBar.adoc#off[off]
* link:SearchBar.adoc#on[on]
* link:SearchBar.adoc#onbackpressed[onBackPressed]
* link:SearchBar.adoc#onlayout[onLayout]
* link:SearchBar.adoc#onloaded[onLoaded]
* link:SearchBar.adoc#onmeasure[onMeasure]
* link:SearchBar.adoc#onresumenativeupdates[onResumeNativeUpdates]
* link:SearchBar.adoc#onunloaded[onUnloaded]
* link:SearchBar.adoc#once[once]
* link:SearchBar.adoc#removeeventlistener[removeEventListener]
* link:SearchBar.adoc#requestlayout[requestLayout]
* link:SearchBar.adoc#resetnativeview[resetNativeView]
* link:SearchBar.adoc#sendaccessibilityevent[sendAccessibilityEvent]
* link:SearchBar.adoc#set[set]
* link:SearchBar.adoc#setinlinestyle[setInlineStyle]
* link:SearchBar.adoc#setmeasureddimension[setMeasuredDimension]
* link:SearchBar.adoc#setnativeview[setNativeView]
* link:SearchBar.adoc#setontouchlistener[setOnTouchListener]
* link:SearchBar.adoc#setproperty[setProperty]
* link:SearchBar.adoc#settestid[setTestID]
* link:SearchBar.adoc#showmodal[showModal]
* link:SearchBar.adoc#tostring[toString]
* link:SearchBar.adoc#unbind[unbind]
* link:SearchBar.adoc#unloadview[unloadView]
* link:SearchBar.adoc#addeventlistener-1[addEventListener]
* link:SearchBar.adoc#combinemeasuredstates[combineMeasuredStates]
* link:SearchBar.adoc#layoutchild[layoutChild]
* link:SearchBar.adoc#measurechild[measureChild]
* link:SearchBar.adoc#off-1[off]
* link:SearchBar.adoc#on-1[on]
* link:SearchBar.adoc#once-1[once]
* link:SearchBar.adoc#removeeventlistener-1[removeEventListener]
* link:SearchBar.adoc#resolvesizeandstate[resolveSizeAndState]
...
Gets the native http://developer.android.com/reference/android/widget/SearchView.html[android widget] that represents the user interface for this component.
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/search-bar/index.d.ts#L23[ui/search-bar/index.d.ts:23]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/search-bar/index.d.ts#L38[ui/search-bar/index.d.ts:38]
...
Gets the native iOS https://developer.apple.com/library/ios/documentation/UIKit/Reference/UISearchBar_Class/[UISearchBar] that represents the user interface for this component.
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/search-bar/index.d.ts#L28[ui/search-bar/index.d.ts:28]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/search-bar/index.d.ts#L33[ui/search-bar/index.d.ts:33]
...
• *textFieldBackgroundColor*: xref:Color.adoc[`Color`]

Gets or sets the TextField background color of the SearchBar component.

==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/search-bar/index.d.ts#L43[ui/search-bar/index.d.ts:43]
...
• *textFieldHintColor*: xref:Color.adoc[`Color`]

Gets or sets the TextField Hint color of the SearchBar component.

==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/search-bar/index.d.ts#L48[ui/search-bar/index.d.ts:48]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/search-bar/index.d.ts#L18[ui/search-bar/index.d.ts:18]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/search-bar/index.d.ts#L13[ui/search-bar/index.d.ts:13]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/search-bar/index.d.ts#L71[ui/search-bar/index.d.ts:71]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/search-bar/index.d.ts#L56[ui/search-bar/index.d.ts:56]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/search-bar/index.d.ts#L61[ui/search-bar/index.d.ts:61]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/search-bar/index.d.ts#L66[ui/search-bar/index.d.ts:66]
