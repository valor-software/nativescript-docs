...
* link:ScrollView.adoc#constructor[constructor]

=== Properties

* link:ScrollView.adoc#_androidcontentdescriptionupdated[_androidContentDescriptionUpdated]
* link:ScrollView.adoc#_automaticallyadjustsscrollviewinsets[_automaticallyAdjustsScrollViewInsets]
* link:ScrollView.adoc#_closemodalcallback[_closeModalCallback]
* link:ScrollView.adoc#_context[_context]
* link:ScrollView.adoc#_cssstate[_cssState]
* link:ScrollView.adoc#_currentheightmeasurespec[_currentHeightMeasureSpec]
* link:ScrollView.adoc#_currentwidthmeasurespec[_currentWidthMeasureSpec]
* link:ScrollView.adoc#_defaultpaddingbottom[_defaultPaddingBottom]
* link:ScrollView.adoc#_defaultpaddingleft[_defaultPaddingLeft]
* link:ScrollView.adoc#_defaultpaddingright[_defaultPaddingRight]
* link:ScrollView.adoc#_defaultpaddingtop[_defaultPaddingTop]
* link:ScrollView.adoc#_domid[_domId]
* link:ScrollView.adoc#_gestureobservers[_gestureObservers]
* link:ScrollView.adoc#_ignoreflexminwidthheightreset[_ignoreFlexMinWidthHeightReset]
* link:ScrollView.adoc#_isaddedtonativevisualtree[_isAddedToNativeVisualTree]
* link:ScrollView.adoc#_islayoutvalid[_isLayoutValid]
* link:ScrollView.adoc#_ispaddingrelative[_isPaddingRelative]
* link:ScrollView.adoc#_isstylescopehost[_isStyleScopeHost]
* link:ScrollView.adoc#_isviewbase[_isViewBase]
* link:ScrollView.adoc#_manager[_manager]
* link:ScrollView.adoc#_modalparent[_modalParent]
* link:ScrollView.adoc#_modulename[_moduleName]
* link:ScrollView.adoc#_oldbottom[_oldBottom]
* link:ScrollView.adoc#_oldleft[_oldLeft]
* link:ScrollView.adoc#_oldright[_oldRight]
* link:ScrollView.adoc#_oldtop[_oldTop]
* link:ScrollView.adoc#_stylescope[_styleScope]
* link:ScrollView.adoc#_suspendnativeupdatescount[_suspendNativeUpdatesCount]
* link:ScrollView.adoc#_suspendedupdates[_suspendedUpdates]
* link:ScrollView.adoc#accessibilityhidden[accessibilityHidden]
* link:ScrollView.adoc#accessibilityhint[accessibilityHint]
* link:ScrollView.adoc#accessibilityidentifier[accessibilityIdentifier]
* link:ScrollView.adoc#accessibilitylabel[accessibilityLabel]
* link:ScrollView.adoc#accessibilitylanguage[accessibilityLanguage]
* link:ScrollView.adoc#accessibilityliveregion[accessibilityLiveRegion]
* link:ScrollView.adoc#accessibilitymediasession[accessibilityMediaSession]
* link:ScrollView.adoc#accessibilityrole[accessibilityRole]
* link:ScrollView.adoc#accessibilitystate[accessibilityState]
* link:ScrollView.adoc#accessibilityvalue[accessibilityValue]
* link:ScrollView.adoc#accessible[accessible]
* link:ScrollView.adoc#alignself[alignSelf]
* link:ScrollView.adoc#android[android]
* link:ScrollView.adoc#androiddynamicelevationoffset[androidDynamicElevationOffset]
* link:ScrollView.adoc#androidelevation[androidElevation]
* link:ScrollView.adoc#automationtext[automationText]
* link:ScrollView.adoc#background[background]
* link:ScrollView.adoc#backgroundcolor[backgroundColor]
* link:ScrollView.adoc#backgroundimage[backgroundImage]
* link:ScrollView.adoc#bindingcontext[bindingContext]
* link:ScrollView.adoc#borderbottomcolor[borderBottomColor]
* link:ScrollView.adoc#borderbottomleftradius[borderBottomLeftRadius]
* link:ScrollView.adoc#borderbottomrightradius[borderBottomRightRadius]
* link:ScrollView.adoc#borderbottomwidth[borderBottomWidth]
* link:ScrollView.adoc#bordercolor[borderColor]
* link:ScrollView.adoc#borderleftcolor[borderLeftColor]
* link:ScrollView.adoc#borderleftwidth[borderLeftWidth]
* link:ScrollView.adoc#borderradius[borderRadius]
* link:ScrollView.adoc#borderrightcolor[borderRightColor]
* link:ScrollView.adoc#borderrightwidth[borderRightWidth]
* link:ScrollView.adoc#bordertopcolor[borderTopColor]
* link:ScrollView.adoc#bordertopleftradius[borderTopLeftRadius]
* link:ScrollView.adoc#bordertoprightradius[borderTopRightRadius]
* link:ScrollView.adoc#bordertopwidth[borderTopWidth]
* link:ScrollView.adoc#borderwidth[borderWidth]
* link:ScrollView.adoc#boxshadow[boxShadow]
* link:ScrollView.adoc#classname[className]
* link:ScrollView.adoc#col[col]
* link:ScrollView.adoc#colspan[colSpan]
* link:ScrollView.adoc#color[color]
* link:ScrollView.adoc#column[column]
* link:ScrollView.adoc#columnspan[columnSpan]
* link:ScrollView.adoc#css[css]
* link:ScrollView.adoc#cssclasses[cssClasses]
* link:ScrollView.adoc#csspseudoclasses[cssPseudoClasses]
* link:ScrollView.adoc#csstype[cssType]
* link:ScrollView.adoc#dock[dock]
* link:ScrollView.adoc#domnode[domNode]
* link:ScrollView.adoc#effectiveborderbottomwidth[effectiveBorderBottomWidth]
* link:ScrollView.adoc#effectiveborderleftwidth[effectiveBorderLeftWidth]
* link:ScrollView.adoc#effectiveborderrightwidth[effectiveBorderRightWidth]
* link:ScrollView.adoc#effectivebordertopwidth[effectiveBorderTopWidth]
* link:ScrollView.adoc#effectiveheight[effectiveHeight]
* link:ScrollView.adoc#effectiveleft[effectiveLeft]
* link:ScrollView.adoc#effectivemarginbottom[effectiveMarginBottom]
* link:ScrollView.adoc#effectivemarginleft[effectiveMarginLeft]
* link:ScrollView.adoc#effectivemarginright[effectiveMarginRight]
* link:ScrollView.adoc#effectivemargintop[effectiveMarginTop]
* link:ScrollView.adoc#effectiveminheight[effectiveMinHeight]
* link:ScrollView.adoc#effectiveminwidth[effectiveMinWidth]
* link:ScrollView.adoc#effectivepaddingbottom[effectivePaddingBottom]
* link:ScrollView.adoc#effectivepaddingleft[effectivePaddingLeft]
* link:ScrollView.adoc#effectivepaddingright[effectivePaddingRight]
* link:ScrollView.adoc#effectivepaddingtop[effectivePaddingTop]
* link:ScrollView.adoc#effectivetop[effectiveTop]
* link:ScrollView.adoc#effectivewidth[effectiveWidth]
* link:ScrollView.adoc#flexgrow[flexGrow]
* link:ScrollView.adoc#flexshrink[flexShrink]
* link:ScrollView.adoc#flexwrapbefore[flexWrapBefore]
* link:ScrollView.adoc#height[height]
* link:ScrollView.adoc#horizontalalignment[horizontalAlignment]
* link:ScrollView.adoc#horizontaloffset[horizontalOffset]
* link:ScrollView.adoc#id[id]
* link:ScrollView.adoc#ignoretouchanimation[ignoreTouchAnimation]
* link:ScrollView.adoc#ios[ios]
* link:ScrollView.adoc#iosignoresafearea[iosIgnoreSafeArea]
* link:ScrollView.adoc#iosoverflowsafearea[iosOverflowSafeArea]
* link:ScrollView.adoc#iosoverflowsafeareaenabled[iosOverflowSafeAreaEnabled]
* link:ScrollView.adoc#iscollapsed[isCollapsed]
* link:ScrollView.adoc#isenabled[isEnabled]
* link:ScrollView.adoc#islayoutrequired[isLayoutRequired]
* link:ScrollView.adoc#islayoutvalid[isLayoutValid]
* link:ScrollView.adoc#isscrollenabled[isScrollEnabled]
* link:ScrollView.adoc#isuserinteractionenabled[isUserInteractionEnabled]
* link:ScrollView.adoc#left[left]
* link:ScrollView.adoc#margin[margin]
* link:ScrollView.adoc#marginbottom[marginBottom]
* link:ScrollView.adoc#marginleft[marginLeft]
* link:ScrollView.adoc#marginright[marginRight]
* link:ScrollView.adoc#margintop[marginTop]
* link:ScrollView.adoc#minheight[minHeight]
* link:ScrollView.adoc#minwidth[minWidth]
* link:ScrollView.adoc#modal[modal]
* link:ScrollView.adoc#nativeviewprotected[nativeViewProtected]
* link:ScrollView.adoc#opacity[opacity]
* link:ScrollView.adoc#order[order]
* link:ScrollView.adoc#orientation[orientation]
* link:ScrollView.adoc#originx[originX]
* link:ScrollView.adoc#originy[originY]
* link:ScrollView.adoc#parent[parent]
* link:ScrollView.adoc#perspective[perspective]
* link:ScrollView.adoc#recyclenativeview[recycleNativeView]
* link:ScrollView.adoc#reusable[reusable]
* link:ScrollView.adoc#rotate[rotate]
* link:ScrollView.adoc#rotatex[rotateX]
* link:ScrollView.adoc#rotatey[rotateY]
* link:ScrollView.adoc#row[row]
* link:ScrollView.adoc#rowspan[rowSpan]
* link:ScrollView.adoc#scalex[scaleX]
* link:ScrollView.adoc#scaley[scaleY]
* link:ScrollView.adoc#scrollbarindicatorvisible[scrollBarIndicatorVisible]
* link:ScrollView.adoc#scrollableheight[scrollableHeight]
* link:ScrollView.adoc#scrollablewidth[scrollableWidth]
* link:ScrollView.adoc#testid[testID]
* link:ScrollView.adoc#top[top]
* link:ScrollView.adoc#touchanimation[touchAnimation]
* link:ScrollView.adoc#touchdelay[touchDelay]
* link:ScrollView.adoc#translatex[translateX]
* link:ScrollView.adoc#translatey[translateY]
* link:ScrollView.adoc#verticalalignment[verticalAlignment]
* link:ScrollView.adoc#verticaloffset[verticalOffset]
* link:ScrollView.adoc#viewcontroller[viewController]
* link:ScrollView.adoc#visibility[visibility]
* link:ScrollView.adoc#width[width]
* link:ScrollView.adoc#accessibilityblurevent[accessibilityBlurEvent]
* link:ScrollView.adoc#accessibilityfocuschangedevent[accessibilityFocusChangedEvent]
* link:ScrollView.adoc#accessibilityfocusevent[accessibilityFocusEvent]
* link:ScrollView.adoc#accessibilityperformescapeevent[accessibilityPerformEscapeEvent]
* link:ScrollView.adoc#createdevent[createdEvent]
* link:ScrollView.adoc#disposenativeviewevent[disposeNativeViewEvent]
* link:ScrollView.adoc#layoutchangedevent[layoutChangedEvent]
* link:ScrollView.adoc#loadedevent[loadedEvent]
* link:ScrollView.adoc#propertychangeevent[propertyChangeEvent]
* link:ScrollView.adoc#scrollevent[scrollEvent]
* link:ScrollView.adoc#showingmodallyevent[showingModallyEvent]
* link:ScrollView.adoc#shownmodallyevent[shownModallyEvent]
* link:ScrollView.adoc#unloadedevent[unloadedEvent]

=== Accessors

* link:ScrollView.adoc#_childrencount[_childrenCount]
* link:ScrollView.adoc#backgroundposition[backgroundPosition]
* link:ScrollView.adoc#backgroundrepeat[backgroundRepeat]
* link:ScrollView.adoc#backgroundsize[backgroundSize]
* link:ScrollView.adoc#class[class]
* link:ScrollView.adoc#content[content]
* link:ScrollView.adoc#isloaded[isLoaded]
* link:ScrollView.adoc#layoutview[layoutView]
* link:ScrollView.adoc#nativeview[nativeView]
* link:ScrollView.adoc#page[page]
* link:ScrollView.adoc#parentnode[parentNode]
* link:ScrollView.adoc#style[style]
* link:ScrollView.adoc#texttransform[textTransform]
* link:ScrollView.adoc#typename[typeName]

=== Methods

* link:ScrollView.adoc#_addchildfrombuilder[_addChildFromBuilder]
* link:ScrollView.adoc#_addview[_addView]
* link:ScrollView.adoc#_addviewcore[_addViewCore]
* link:ScrollView.adoc#_addviewtonativevisualtree[_addViewToNativeVisualTree]
* link:ScrollView.adoc#_applybackground[_applyBackground]
* link:ScrollView.adoc#_applyxmlattribute[_applyXmlAttribute]
* link:ScrollView.adoc#_batchupdate[_batchUpdate]
* link:ScrollView.adoc#_childindextonativechildindex[_childIndexToNativeChildIndex]
* link:ScrollView.adoc#_closeallmodalviewsinternal[_closeAllModalViewsInternal]
* link:ScrollView.adoc#_createpropertychangedata[_createPropertyChangeData]
* link:ScrollView.adoc#_dialogclosed[_dialogClosed]
* link:ScrollView.adoc#_eachlayoutview[_eachLayoutView]
* link:ScrollView.adoc#_emit[_emit]
* link:ScrollView.adoc#_getcurrentlayoutbounds[_getCurrentLayoutBounds]
* link:ScrollView.adoc#_getfragmentmanager[_getFragmentManager]
* link:ScrollView.adoc#_getnativeviewscount[_getNativeViewsCount]
* link:ScrollView.adoc#_getrootmodalviews[_getRootModalViews]
* link:ScrollView.adoc#_getvalue[_getValue]
* link:ScrollView.adoc#_gotovisualstate[_goToVisualState]
* link:ScrollView.adoc#_handlelivesync[_handleLivesync]
* link:ScrollView.adoc#_hasancestorview[_hasAncestorView]
* link:ScrollView.adoc#_hidenativemodalview[_hideNativeModalView]
* link:ScrollView.adoc#_inheritstylescope[_inheritStyleScope]
* link:ScrollView.adoc#_layoutparent[_layoutParent]
* link:ScrollView.adoc#_observe[_observe]
* link:ScrollView.adoc#_onattachedtowindow[_onAttachedToWindow]
* link:ScrollView.adoc#_oncontentchanged[_onContentChanged]
* link:ScrollView.adoc#_oncssstatechange[_onCssStateChange]
* link:ScrollView.adoc#_ondetachedfromwindow[_onDetachedFromWindow]
* link:ScrollView.adoc#_onlivesync[_onLivesync]
* link:ScrollView.adoc#_onorientationchanged[_onOrientationChanged]
* link:ScrollView.adoc#_onrootviewreset[_onRootViewReset]
* link:ScrollView.adoc#_onsizechanged[_onSizeChanged]
* link:ScrollView.adoc#_parentchanged[_parentChanged]
* link:ScrollView.adoc#_raiselayoutchangedevent[_raiseLayoutChangedEvent]
* link:ScrollView.adoc#_raiseshowingmodallyevent[_raiseShowingModallyEvent]
* link:ScrollView.adoc#_raiseshownmodallyevent[_raiseShownModallyEvent]
* link:ScrollView.adoc#_redrawnativebackground[_redrawNativeBackground]
* link:ScrollView.adoc#_removeanimation[_removeAnimation]
* link:ScrollView.adoc#_removeview[_removeView]
* link:ScrollView.adoc#_removeviewcore[_removeViewCore]
* link:ScrollView.adoc#_removeviewfromnativevisualtree[_removeViewFromNativeVisualTree]
* link:ScrollView.adoc#_resumenativeupdates[_resumeNativeUpdates]
* link:ScrollView.adoc#_setchildminheightnative[_setChildMinHeightNative]
* link:ScrollView.adoc#_setchildminwidthnative[_setChildMinWidthNative]
* link:ScrollView.adoc#_setcurrentlayoutbounds[_setCurrentLayoutBounds]
* link:ScrollView.adoc#_setcurrentmeasurespecs[_setCurrentMeasureSpecs]
* link:ScrollView.adoc#_setminheightnative[_setMinHeightNative]
* link:ScrollView.adoc#_setminwidthnative[_setMinWidthNative]
* link:ScrollView.adoc#_setnativecliptobounds[_setNativeClipToBounds]
* link:ScrollView.adoc#_setnativeviewframe[_setNativeViewFrame]
* link:ScrollView.adoc#_setvalue[_setValue]
* link:ScrollView.adoc#_setupasrootview[_setupAsRootView]
* link:ScrollView.adoc#_setupui[_setupUI]
* link:ScrollView.adoc#_shoulddelaylayout[_shouldDelayLayout]
* link:ScrollView.adoc#_shownativemodalview[_showNativeModalView]
* link:ScrollView.adoc#_suspendnativeupdates[_suspendNativeUpdates]
* link:ScrollView.adoc#_teardownui[_tearDownUI]
* link:ScrollView.adoc#_updateeffectivelayoutvalues[_updateEffectiveLayoutValues]
* link:ScrollView.adoc#_updatenativelayoutparams[_updateNativeLayoutParams]
* link:ScrollView.adoc#_updatestylescope[_updateStyleScope]
* link:ScrollView.adoc#accessibilityannouncement[accessibilityAnnouncement]
* link:ScrollView.adoc#accessibilityscreenchanged[accessibilityScreenChanged]
* link:ScrollView.adoc#addcss[addCss]
* link:ScrollView.adoc#addcssfile[addCssFile]
* link:ScrollView.adoc#addeventlistener[addEventListener]
* link:ScrollView.adoc#addpseudoclass[addPseudoClass]
* link:ScrollView.adoc#animate[animate]
* link:ScrollView.adoc#bind[bind]
* link:ScrollView.adoc#callloaded[callLoaded]
* link:ScrollView.adoc#callunloaded[callUnloaded]
* link:ScrollView.adoc#changecssfile[changeCssFile]
* link:ScrollView.adoc#closemodal[closeModal]
* link:ScrollView.adoc#createanimation[createAnimation]
* link:ScrollView.adoc#createnativeview[createNativeView]
* link:ScrollView.adoc#deletepseudoclass[deletePseudoClass]
* link:ScrollView.adoc#destroynode[destroyNode]
* link:ScrollView.adoc#disposenativeview[disposeNativeView]
* link:ScrollView.adoc#eachchild[eachChild]
* link:ScrollView.adoc#eachchildview[eachChildView]
* link:ScrollView.adoc#ensuredomnode[ensureDomNode]
* link:ScrollView.adoc#focus[focus]
* link:ScrollView.adoc#get[get]
* link:ScrollView.adoc#getactualsize[getActualSize]
* link:ScrollView.adoc#getgestureobservers[getGestureObservers]
* link:ScrollView.adoc#getlocationinwindow[getLocationInWindow]
* link:ScrollView.adoc#getlocationonscreen[getLocationOnScreen]
* link:ScrollView.adoc#getlocationrelativeto[getLocationRelativeTo]
* link:ScrollView.adoc#getmeasuredheight[getMeasuredHeight]
* link:ScrollView.adoc#getmeasuredstate[getMeasuredState]
* link:ScrollView.adoc#getmeasuredwidth[getMeasuredWidth]
* link:ScrollView.adoc#getsafeareainsets[getSafeAreaInsets]
* link:ScrollView.adoc#getviewbydomid[getViewByDomId]
* link:ScrollView.adoc#getviewbyid[getViewById]
* link:ScrollView.adoc#hasgestureobservers[hasGestureObservers]
* link:ScrollView.adoc#haslisteners[hasListeners]
* link:ScrollView.adoc#initnativeview[initNativeView]
* link:ScrollView.adoc#layout[layout]
* link:ScrollView.adoc#layoutnativeview[layoutNativeView]
* link:ScrollView.adoc#loadview[loadView]
* link:ScrollView.adoc#measure[measure]
* link:ScrollView.adoc#notify[notify]
* link:ScrollView.adoc#notifypropertychange[notifyPropertyChange]
* link:ScrollView.adoc#off[off]
* link:ScrollView.adoc#on[on]
* link:ScrollView.adoc#onbackpressed[onBackPressed]
* link:ScrollView.adoc#onlayout[onLayout]
* link:ScrollView.adoc#onloaded[onLoaded]
* link:ScrollView.adoc#onmeasure[onMeasure]
* link:ScrollView.adoc#onresumenativeupdates[onResumeNativeUpdates]
* link:ScrollView.adoc#onunloaded[onUnloaded]
* link:ScrollView.adoc#once[once]
* link:ScrollView.adoc#removeeventlistener[removeEventListener]
* link:ScrollView.adoc#requestlayout[requestLayout]
* link:ScrollView.adoc#resetnativeview[resetNativeView]
* link:ScrollView.adoc#scrolltohorizontaloffset[scrollToHorizontalOffset]
* link:ScrollView.adoc#scrolltoverticaloffset[scrollToVerticalOffset]
* link:ScrollView.adoc#sendaccessibilityevent[sendAccessibilityEvent]
* link:ScrollView.adoc#set[set]
* link:ScrollView.adoc#setinlinestyle[setInlineStyle]
* link:ScrollView.adoc#setmeasureddimension[setMeasuredDimension]
* link:ScrollView.adoc#setnativeview[setNativeView]
* link:ScrollView.adoc#setontouchlistener[setOnTouchListener]
* link:ScrollView.adoc#setproperty[setProperty]
* link:ScrollView.adoc#settestid[setTestID]
* link:ScrollView.adoc#showmodal[showModal]
* link:ScrollView.adoc#tostring[toString]
* link:ScrollView.adoc#unbind[unbind]
* link:ScrollView.adoc#unloadview[unloadView]
* link:ScrollView.adoc#addeventlistener-1[addEventListener]
* link:ScrollView.adoc#combinemeasuredstates[combineMeasuredStates]
* link:ScrollView.adoc#layoutchild[layoutChild]
* link:ScrollView.adoc#measurechild[measureChild]
* link:ScrollView.adoc#off-1[off]
* link:ScrollView.adoc#on-1[on]
* link:ScrollView.adoc#once-1[once]
* link:ScrollView.adoc#removeeventlistener-1[removeEventListener]
* link:ScrollView.adoc#resolvesizeandstate[resolveSizeAndState]
...
• *orientation*: link:../modules/CoreTypes.adoc#orientationtype[`OrientationType`]
...
==== Inherited from xref:ContentView.adoc[ContentView].link:ContentView.adoc#_addchildfrombuilder[_addChildFromBuilder]
...
==== Inherited from xref:ContentView.adoc[ContentView].link:ContentView.adoc#accessibilityscreenchanged[accessibilityScreenChanged]
...
==== Inherited from xref:ContentView.adoc[ContentView].link:ContentView.adoc#eachchildview[eachChildView]
...
xref:ContentView.adoc[ContentView].link:ContentView.adoc#on[on]
