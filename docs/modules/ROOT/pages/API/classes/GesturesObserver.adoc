...
* link:GesturesObserver.adoc#constructor[constructor]

=== Properties

* link:GesturesObserver.adoc#androidontouchevent[androidOnTouchEvent]
* link:GesturesObserver.adoc#callback[callback]
* link:GesturesObserver.adoc#context[context]
* link:GesturesObserver.adoc#type[type]

=== Methods

* link:GesturesObserver.adoc#disconnect[disconnect]
* link:GesturesObserver.adoc#observe[observe]
