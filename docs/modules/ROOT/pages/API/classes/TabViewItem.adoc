...
xref:../README.adoc[NativeScript] / xref:../modules.adoc[Exports] / TabViewItem
...
* link:TabViewItem.md#constructor[constructor]

=== Properties

* link:TabViewItem.md#_automaticallyadjustsscrollviewinsets[_automaticallyAdjustsScrollViewInsets]
* link:TabViewItem.md#_context[_context]
* link:TabViewItem.md#_cssstate[_cssState]
* link:TabViewItem.md#_defaultpaddingbottom[_defaultPaddingBottom]
* link:TabViewItem.md#_defaultpaddingleft[_defaultPaddingLeft]
* link:TabViewItem.md#_defaultpaddingright[_defaultPaddingRight]
* link:TabViewItem.md#_defaultpaddingtop[_defaultPaddingTop]
* link:TabViewItem.md#_domid[_domId]
* link:TabViewItem.md#_ignoreflexminwidthheightreset[_ignoreFlexMinWidthHeightReset]
* link:TabViewItem.md#_isaddedtonativevisualtree[_isAddedToNativeVisualTree]
* link:TabViewItem.md#_ispaddingrelative[_isPaddingRelative]
* link:TabViewItem.md#_isstylescopehost[_isStyleScopeHost]
* link:TabViewItem.md#_isviewbase[_isViewBase]
* link:TabViewItem.md#_modulename[_moduleName]
* link:TabViewItem.md#_oldbottom[_oldBottom]
* link:TabViewItem.md#_oldleft[_oldLeft]
* link:TabViewItem.md#_oldright[_oldRight]
* link:TabViewItem.md#_oldtop[_oldTop]
* link:TabViewItem.md#_stylescope[_styleScope]
* link:TabViewItem.md#_suspendnativeupdatescount[_suspendNativeUpdatesCount]
* link:TabViewItem.md#_suspendedupdates[_suspendedUpdates]
* link:TabViewItem.md#alignself[alignSelf]
* link:TabViewItem.md#bindingcontext[bindingContext]
* link:TabViewItem.md#canbeloaded[canBeLoaded]
* link:TabViewItem.md#classname[className]
* link:TabViewItem.md#col[col]
* link:TabViewItem.md#colspan[colSpan]
* link:TabViewItem.md#column[column]
* link:TabViewItem.md#columnspan[columnSpan]
* link:TabViewItem.md#cssclasses[cssClasses]
* link:TabViewItem.md#csspseudoclasses[cssPseudoClasses]
* link:TabViewItem.md#dock[dock]
* link:TabViewItem.md#domnode[domNode]
* link:TabViewItem.md#effectiveborderbottomwidth[effectiveBorderBottomWidth]
* link:TabViewItem.md#effectiveborderleftwidth[effectiveBorderLeftWidth]
* link:TabViewItem.md#effectiveborderrightwidth[effectiveBorderRightWidth]
* link:TabViewItem.md#effectivebordertopwidth[effectiveBorderTopWidth]
* link:TabViewItem.md#effectiveheight[effectiveHeight]
* link:TabViewItem.md#effectiveleft[effectiveLeft]
* link:TabViewItem.md#effectivemarginbottom[effectiveMarginBottom]
* link:TabViewItem.md#effectivemarginleft[effectiveMarginLeft]
* link:TabViewItem.md#effectivemarginright[effectiveMarginRight]
* link:TabViewItem.md#effectivemargintop[effectiveMarginTop]
* link:TabViewItem.md#effectiveminheight[effectiveMinHeight]
* link:TabViewItem.md#effectiveminwidth[effectiveMinWidth]
* link:TabViewItem.md#effectivepaddingbottom[effectivePaddingBottom]
* link:TabViewItem.md#effectivepaddingleft[effectivePaddingLeft]
* link:TabViewItem.md#effectivepaddingright[effectivePaddingRight]
* link:TabViewItem.md#effectivepaddingtop[effectivePaddingTop]
* link:TabViewItem.md#effectivetop[effectiveTop]
* link:TabViewItem.md#effectivewidth[effectiveWidth]
* link:TabViewItem.md#flexgrow[flexGrow]
* link:TabViewItem.md#flexshrink[flexShrink]
* link:TabViewItem.md#flexwrapbefore[flexWrapBefore]
* link:TabViewItem.md#iconsource[iconSource]
* link:TabViewItem.md#id[id]
* link:TabViewItem.md#iscollapsed[isCollapsed]
* link:TabViewItem.md#left[left]
* link:TabViewItem.md#nativeviewprotected[nativeViewProtected]
* link:TabViewItem.md#order[order]
* link:TabViewItem.md#parent[parent]
* link:TabViewItem.md#recyclenativeview[recycleNativeView]
* link:TabViewItem.md#reusable[reusable]
* link:TabViewItem.md#row[row]
* link:TabViewItem.md#rowspan[rowSpan]
* link:TabViewItem.md#texttransform[textTransform]
* link:TabViewItem.md#title[title]
* link:TabViewItem.md#top[top]
* link:TabViewItem.md#view[view]
* link:TabViewItem.md#viewcontroller[viewController]
* link:TabViewItem.md#createdevent[createdEvent]
* link:TabViewItem.md#disposenativeviewevent[disposeNativeViewEvent]
* link:TabViewItem.md#loadedevent[loadedEvent]
* link:TabViewItem.md#propertychangeevent[propertyChangeEvent]
* link:TabViewItem.md#unloadedevent[unloadedEvent]

=== Accessors

* link:TabViewItem.md#android[android]
* link:TabViewItem.md#class[class]
* link:TabViewItem.md#ios[ios]
* link:TabViewItem.md#isloaded[isLoaded]
* link:TabViewItem.md#nativeview[nativeView]
* link:TabViewItem.md#page[page]
* link:TabViewItem.md#parentnode[parentNode]
* link:TabViewItem.md#style[style]
* link:TabViewItem.md#typename[typeName]

=== Methods

* link:TabViewItem.md#_addview[_addView]
* link:TabViewItem.md#_addviewcore[_addViewCore]
* link:TabViewItem.md#_addviewtonativevisualtree[_addViewToNativeVisualTree]
* link:TabViewItem.md#_applyxmlattribute[_applyXmlAttribute]
* link:TabViewItem.md#_batchupdate[_batchUpdate]
* link:TabViewItem.md#_childindextonativechildindex[_childIndexToNativeChildIndex]
* link:TabViewItem.md#_createpropertychangedata[_createPropertyChangeData]
* link:TabViewItem.md#_dialogclosed[_dialogClosed]
* link:TabViewItem.md#_emit[_emit]
* link:TabViewItem.md#_gotovisualstate[_goToVisualState]
* link:TabViewItem.md#_inheritstylescope[_inheritStyleScope]
* link:TabViewItem.md#_layoutparent[_layoutParent]
* link:TabViewItem.md#_oncssstatechange[_onCssStateChange]
* link:TabViewItem.md#_onrootviewreset[_onRootViewReset]
* link:TabViewItem.md#_parentchanged[_parentChanged]
* link:TabViewItem.md#_removeview[_removeView]
* link:TabViewItem.md#_removeviewcore[_removeViewCore]
* link:TabViewItem.md#_removeviewfromnativevisualtree[_removeViewFromNativeVisualTree]
* link:TabViewItem.md#_resumenativeupdates[_resumeNativeUpdates]
* link:TabViewItem.md#_setupasrootview[_setupAsRootView]
* link:TabViewItem.md#_setupui[_setupUI]
* link:TabViewItem.md#_shoulddelaylayout[_shouldDelayLayout]
* link:TabViewItem.md#_suspendnativeupdates[_suspendNativeUpdates]
* link:TabViewItem.md#_teardownui[_tearDownUI]
* link:TabViewItem.md#addeventlistener[addEventListener]
* link:TabViewItem.md#addpseudoclass[addPseudoClass]
* link:TabViewItem.md#bind[bind]
* link:TabViewItem.md#callloaded[callLoaded]
* link:TabViewItem.md#callunloaded[callUnloaded]
* link:TabViewItem.md#closemodal[closeModal]
* link:TabViewItem.md#createnativeview[createNativeView]
* link:TabViewItem.md#deletepseudoclass[deletePseudoClass]
* link:TabViewItem.md#destroynode[destroyNode]
* link:TabViewItem.md#disposenativeview[disposeNativeView]
* link:TabViewItem.md#eachchild[eachChild]
* link:TabViewItem.md#ensuredomnode[ensureDomNode]
* link:TabViewItem.md#get[get]
* link:TabViewItem.md#getviewbydomid[getViewByDomId]
* link:TabViewItem.md#getviewbyid[getViewById]
* link:TabViewItem.md#haslisteners[hasListeners]
* link:TabViewItem.md#initnativeview[initNativeView]
* link:TabViewItem.md#loadview[loadView]
* link:TabViewItem.md#notify[notify]
* link:TabViewItem.md#notifypropertychange[notifyPropertyChange]
* link:TabViewItem.md#off[off]
* link:TabViewItem.md#on[on]
* link:TabViewItem.md#onloaded[onLoaded]
* link:TabViewItem.md#onresumenativeupdates[onResumeNativeUpdates]
* link:TabViewItem.md#onunloaded[onUnloaded]
* link:TabViewItem.md#once[once]
* link:TabViewItem.md#removeeventlistener[removeEventListener]
* link:TabViewItem.md#requestlayout[requestLayout]
* link:TabViewItem.md#resetnativeview[resetNativeView]
* link:TabViewItem.md#set[set]
* link:TabViewItem.md#setinlinestyle[setInlineStyle]
* link:TabViewItem.md#setnativeview[setNativeView]
* link:TabViewItem.md#setproperty[setProperty]
* link:TabViewItem.md#showmodal[showModal]
* link:TabViewItem.md#tostring[toString]
* link:TabViewItem.md#unbind[unbind]
* link:TabViewItem.md#unloadview[unloadView]
* link:TabViewItem.md#addeventlistener-1[addEventListener]
* link:TabViewItem.md#off-1[off]
* link:TabViewItem.md#on-1[on]
* link:TabViewItem.md#once-1[once]
* link:TabViewItem.md#removeeventlistener-1[removeEventListener]
...
• `Optional` `Private` *canBeLoaded*: `boolean`

==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/tab-view/index.d.ts#L39[ui/tab-view/index.d.ts:39]
...
Gets or sets the icon source of the TabViewItem.
This could either be a a file name or resource id.

==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/tab-view/index.d.ts#L29[ui/tab-view/index.d.ts:29]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/tab-view/index.d.ts#L34[ui/tab-view/index.d.ts:34]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/tab-view/index.d.ts#L19[ui/tab-view/index.d.ts:19]
...
• *view*: xref:View.adoc[`View`]

Gets or sets the view of the TabViewItem.

==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/tab-view/index.d.ts#L24[ui/tab-view/index.d.ts:24]
