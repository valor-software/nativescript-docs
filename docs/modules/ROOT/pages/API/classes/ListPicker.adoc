...
xref:../README.adoc[NativeScript] / xref:../modules.adoc[Exports] / ListPicker
...
* link:ListPicker.adoc#constructor[constructor]

=== Properties

* link:ListPicker.adoc#_androidcontentdescriptionupdated[_androidContentDescriptionUpdated]
* link:ListPicker.adoc#_automaticallyadjustsscrollviewinsets[_automaticallyAdjustsScrollViewInsets]
* link:ListPicker.adoc#_closemodalcallback[_closeModalCallback]
* link:ListPicker.adoc#_context[_context]
* link:ListPicker.adoc#_cssstate[_cssState]
* link:ListPicker.adoc#_currentheightmeasurespec[_currentHeightMeasureSpec]
* link:ListPicker.adoc#_currentwidthmeasurespec[_currentWidthMeasureSpec]
* link:ListPicker.adoc#_defaultpaddingbottom[_defaultPaddingBottom]
* link:ListPicker.adoc#_defaultpaddingleft[_defaultPaddingLeft]
* link:ListPicker.adoc#_defaultpaddingright[_defaultPaddingRight]
* link:ListPicker.adoc#_defaultpaddingtop[_defaultPaddingTop]
* link:ListPicker.adoc#_domid[_domId]
* link:ListPicker.adoc#_gestureobservers[_gestureObservers]
* link:ListPicker.adoc#_ignoreflexminwidthheightreset[_ignoreFlexMinWidthHeightReset]
* link:ListPicker.adoc#_isaddedtonativevisualtree[_isAddedToNativeVisualTree]
* link:ListPicker.adoc#_islayoutvalid[_isLayoutValid]
* link:ListPicker.adoc#_ispaddingrelative[_isPaddingRelative]
* link:ListPicker.adoc#_isstylescopehost[_isStyleScopeHost]
* link:ListPicker.adoc#_isviewbase[_isViewBase]
* link:ListPicker.adoc#_manager[_manager]
* link:ListPicker.adoc#_modalparent[_modalParent]
* link:ListPicker.adoc#_modulename[_moduleName]
* link:ListPicker.adoc#_oldbottom[_oldBottom]
* link:ListPicker.adoc#_oldleft[_oldLeft]
* link:ListPicker.adoc#_oldright[_oldRight]
* link:ListPicker.adoc#_oldtop[_oldTop]
* link:ListPicker.adoc#_stylescope[_styleScope]
* link:ListPicker.adoc#_suspendnativeupdatescount[_suspendNativeUpdatesCount]
* link:ListPicker.adoc#_suspendedupdates[_suspendedUpdates]
* link:ListPicker.adoc#accessibilityhidden[accessibilityHidden]
* link:ListPicker.adoc#accessibilityhint[accessibilityHint]
* link:ListPicker.adoc#accessibilityidentifier[accessibilityIdentifier]
* link:ListPicker.adoc#accessibilitylabel[accessibilityLabel]
* link:ListPicker.adoc#accessibilitylanguage[accessibilityLanguage]
* link:ListPicker.adoc#accessibilityliveregion[accessibilityLiveRegion]
* link:ListPicker.adoc#accessibilitymediasession[accessibilityMediaSession]
* link:ListPicker.adoc#accessibilityrole[accessibilityRole]
* link:ListPicker.adoc#accessibilitystate[accessibilityState]
* link:ListPicker.adoc#accessibilityvalue[accessibilityValue]
* link:ListPicker.adoc#accessible[accessible]
* link:ListPicker.adoc#alignself[alignSelf]
* link:ListPicker.adoc#android[android]
* link:ListPicker.adoc#androiddynamicelevationoffset[androidDynamicElevationOffset]
* link:ListPicker.adoc#androidelevation[androidElevation]
* link:ListPicker.adoc#automationtext[automationText]
* link:ListPicker.adoc#background[background]
* link:ListPicker.adoc#backgroundcolor[backgroundColor]
* link:ListPicker.adoc#backgroundimage[backgroundImage]
* link:ListPicker.adoc#bindingcontext[bindingContext]
* link:ListPicker.adoc#borderbottomcolor[borderBottomColor]
* link:ListPicker.adoc#borderbottomleftradius[borderBottomLeftRadius]
* link:ListPicker.adoc#borderbottomrightradius[borderBottomRightRadius]
* link:ListPicker.adoc#borderbottomwidth[borderBottomWidth]
* link:ListPicker.adoc#bordercolor[borderColor]
* link:ListPicker.adoc#borderleftcolor[borderLeftColor]
* link:ListPicker.adoc#borderleftwidth[borderLeftWidth]
* link:ListPicker.adoc#borderradius[borderRadius]
* link:ListPicker.adoc#borderrightcolor[borderRightColor]
* link:ListPicker.adoc#borderrightwidth[borderRightWidth]
* link:ListPicker.adoc#bordertopcolor[borderTopColor]
* link:ListPicker.adoc#bordertopleftradius[borderTopLeftRadius]
* link:ListPicker.adoc#bordertoprightradius[borderTopRightRadius]
* link:ListPicker.adoc#bordertopwidth[borderTopWidth]
* link:ListPicker.adoc#borderwidth[borderWidth]
* link:ListPicker.adoc#boxshadow[boxShadow]
* link:ListPicker.adoc#classname[className]
* link:ListPicker.adoc#col[col]
* link:ListPicker.adoc#colspan[colSpan]
* link:ListPicker.adoc#color[color]
* link:ListPicker.adoc#column[column]
* link:ListPicker.adoc#columnspan[columnSpan]
* link:ListPicker.adoc#css[css]
* link:ListPicker.adoc#cssclasses[cssClasses]
* link:ListPicker.adoc#csspseudoclasses[cssPseudoClasses]
* link:ListPicker.adoc#csstype[cssType]
* link:ListPicker.adoc#dock[dock]
* link:ListPicker.adoc#domnode[domNode]
* link:ListPicker.adoc#effectiveborderbottomwidth[effectiveBorderBottomWidth]
* link:ListPicker.adoc#effectiveborderleftwidth[effectiveBorderLeftWidth]
* link:ListPicker.adoc#effectiveborderrightwidth[effectiveBorderRightWidth]
* link:ListPicker.adoc#effectivebordertopwidth[effectiveBorderTopWidth]
* link:ListPicker.adoc#effectiveheight[effectiveHeight]
* link:ListPicker.adoc#effectiveleft[effectiveLeft]
* link:ListPicker.adoc#effectivemarginbottom[effectiveMarginBottom]
* link:ListPicker.adoc#effectivemarginleft[effectiveMarginLeft]
* link:ListPicker.adoc#effectivemarginright[effectiveMarginRight]
* link:ListPicker.adoc#effectivemargintop[effectiveMarginTop]
* link:ListPicker.adoc#effectiveminheight[effectiveMinHeight]
* link:ListPicker.adoc#effectiveminwidth[effectiveMinWidth]
* link:ListPicker.adoc#effectivepaddingbottom[effectivePaddingBottom]
* link:ListPicker.adoc#effectivepaddingleft[effectivePaddingLeft]
* link:ListPicker.adoc#effectivepaddingright[effectivePaddingRight]
* link:ListPicker.adoc#effectivepaddingtop[effectivePaddingTop]
* link:ListPicker.adoc#effectivetop[effectiveTop]
* link:ListPicker.adoc#effectivewidth[effectiveWidth]
* link:ListPicker.adoc#flexgrow[flexGrow]
* link:ListPicker.adoc#flexshrink[flexShrink]
* link:ListPicker.adoc#flexwrapbefore[flexWrapBefore]
* link:ListPicker.adoc#height[height]
* link:ListPicker.adoc#horizontalalignment[horizontalAlignment]
* link:ListPicker.adoc#id[id]
* link:ListPicker.adoc#ignoretouchanimation[ignoreTouchAnimation]
* link:ListPicker.adoc#ios[ios]
* link:ListPicker.adoc#iosignoresafearea[iosIgnoreSafeArea]
* link:ListPicker.adoc#iosoverflowsafearea[iosOverflowSafeArea]
* link:ListPicker.adoc#iosoverflowsafeareaenabled[iosOverflowSafeAreaEnabled]
* link:ListPicker.adoc#iscollapsed[isCollapsed]
* link:ListPicker.adoc#isenabled[isEnabled]
* link:ListPicker.adoc#islayoutrequired[isLayoutRequired]
* link:ListPicker.adoc#islayoutvalid[isLayoutValid]
* link:ListPicker.adoc#isuserinteractionenabled[isUserInteractionEnabled]
* link:ListPicker.adoc#items[items]
* link:ListPicker.adoc#left[left]
* link:ListPicker.adoc#margin[margin]
* link:ListPicker.adoc#marginbottom[marginBottom]
* link:ListPicker.adoc#marginleft[marginLeft]
* link:ListPicker.adoc#marginright[marginRight]
* link:ListPicker.adoc#margintop[marginTop]
* link:ListPicker.adoc#minheight[minHeight]
* link:ListPicker.adoc#minwidth[minWidth]
* link:ListPicker.adoc#modal[modal]
* link:ListPicker.adoc#nativeviewprotected[nativeViewProtected]
* link:ListPicker.adoc#opacity[opacity]
* link:ListPicker.adoc#order[order]
* link:ListPicker.adoc#originx[originX]
* link:ListPicker.adoc#originy[originY]
* link:ListPicker.adoc#parent[parent]
* link:ListPicker.adoc#perspective[perspective]
* link:ListPicker.adoc#recyclenativeview[recycleNativeView]
* link:ListPicker.adoc#reusable[reusable]
* link:ListPicker.adoc#rotate[rotate]
* link:ListPicker.adoc#rotatex[rotateX]
* link:ListPicker.adoc#rotatey[rotateY]
* link:ListPicker.adoc#row[row]
* link:ListPicker.adoc#rowspan[rowSpan]
* link:ListPicker.adoc#scalex[scaleX]
* link:ListPicker.adoc#scaley[scaleY]
* link:ListPicker.adoc#selectedindex[selectedIndex]
* link:ListPicker.adoc#testid[testID]
* link:ListPicker.adoc#top[top]
* link:ListPicker.adoc#touchanimation[touchAnimation]
* link:ListPicker.adoc#touchdelay[touchDelay]
* link:ListPicker.adoc#translatex[translateX]
* link:ListPicker.adoc#translatey[translateY]
* link:ListPicker.adoc#verticalalignment[verticalAlignment]
* link:ListPicker.adoc#viewcontroller[viewController]
* link:ListPicker.adoc#visibility[visibility]
* link:ListPicker.adoc#width[width]
* link:ListPicker.adoc#accessibilityblurevent[accessibilityBlurEvent]
* link:ListPicker.adoc#accessibilityfocuschangedevent[accessibilityFocusChangedEvent]
* link:ListPicker.adoc#accessibilityfocusevent[accessibilityFocusEvent]
* link:ListPicker.adoc#accessibilityperformescapeevent[accessibilityPerformEscapeEvent]
* link:ListPicker.adoc#createdevent[createdEvent]
* link:ListPicker.adoc#disposenativeviewevent[disposeNativeViewEvent]
* link:ListPicker.adoc#layoutchangedevent[layoutChangedEvent]
* link:ListPicker.adoc#loadedevent[loadedEvent]
* link:ListPicker.adoc#propertychangeevent[propertyChangeEvent]
* link:ListPicker.adoc#showingmodallyevent[showingModallyEvent]
* link:ListPicker.adoc#shownmodallyevent[shownModallyEvent]
* link:ListPicker.adoc#unloadedevent[unloadedEvent]

=== Accessors

* link:ListPicker.adoc#backgroundposition[backgroundPosition]
* link:ListPicker.adoc#backgroundrepeat[backgroundRepeat]
* link:ListPicker.adoc#backgroundsize[backgroundSize]
* link:ListPicker.adoc#class[class]
* link:ListPicker.adoc#isloaded[isLoaded]
* link:ListPicker.adoc#nativeview[nativeView]
* link:ListPicker.adoc#page[page]
* link:ListPicker.adoc#parentnode[parentNode]
* link:ListPicker.adoc#style[style]
* link:ListPicker.adoc#texttransform[textTransform]
* link:ListPicker.adoc#typename[typeName]

=== Methods

* link:ListPicker.adoc#_addview[_addView]
* link:ListPicker.adoc#_addviewcore[_addViewCore]
* link:ListPicker.adoc#_addviewtonativevisualtree[_addViewToNativeVisualTree]
* link:ListPicker.adoc#_applybackground[_applyBackground]
* link:ListPicker.adoc#_applyxmlattribute[_applyXmlAttribute]
* link:ListPicker.adoc#_batchupdate[_batchUpdate]
* link:ListPicker.adoc#_childindextonativechildindex[_childIndexToNativeChildIndex]
* link:ListPicker.adoc#_closeallmodalviewsinternal[_closeAllModalViewsInternal]
* link:ListPicker.adoc#_createpropertychangedata[_createPropertyChangeData]
* link:ListPicker.adoc#_dialogclosed[_dialogClosed]
* link:ListPicker.adoc#_eachlayoutview[_eachLayoutView]
* link:ListPicker.adoc#_emit[_emit]
* link:ListPicker.adoc#_getcurrentlayoutbounds[_getCurrentLayoutBounds]
* link:ListPicker.adoc#_getfragmentmanager[_getFragmentManager]
* link:ListPicker.adoc#_getnativeviewscount[_getNativeViewsCount]
* link:ListPicker.adoc#_getrootmodalviews[_getRootModalViews]
* link:ListPicker.adoc#_getvalue[_getValue]
* link:ListPicker.adoc#_gotovisualstate[_goToVisualState]
* link:ListPicker.adoc#_handlelivesync[_handleLivesync]
* link:ListPicker.adoc#_hasancestorview[_hasAncestorView]
* link:ListPicker.adoc#_hidenativemodalview[_hideNativeModalView]
* link:ListPicker.adoc#_inheritstylescope[_inheritStyleScope]
* link:ListPicker.adoc#_layoutparent[_layoutParent]
* link:ListPicker.adoc#_observe[_observe]
* link:ListPicker.adoc#_onattachedtowindow[_onAttachedToWindow]
* link:ListPicker.adoc#_oncssstatechange[_onCssStateChange]
* link:ListPicker.adoc#_ondetachedfromwindow[_onDetachedFromWindow]
* link:ListPicker.adoc#_onlivesync[_onLivesync]
* link:ListPicker.adoc#_onrootviewreset[_onRootViewReset]
* link:ListPicker.adoc#_onsizechanged[_onSizeChanged]
* link:ListPicker.adoc#_parentchanged[_parentChanged]
* link:ListPicker.adoc#_raiselayoutchangedevent[_raiseLayoutChangedEvent]
* link:ListPicker.adoc#_raiseshowingmodallyevent[_raiseShowingModallyEvent]
* link:ListPicker.adoc#_raiseshownmodallyevent[_raiseShownModallyEvent]
* link:ListPicker.adoc#_redrawnativebackground[_redrawNativeBackground]
* link:ListPicker.adoc#_removeanimation[_removeAnimation]
* link:ListPicker.adoc#_removeview[_removeView]
* link:ListPicker.adoc#_removeviewcore[_removeViewCore]
* link:ListPicker.adoc#_removeviewfromnativevisualtree[_removeViewFromNativeVisualTree]
* link:ListPicker.adoc#_resumenativeupdates[_resumeNativeUpdates]
* link:ListPicker.adoc#_setcurrentlayoutbounds[_setCurrentLayoutBounds]
* link:ListPicker.adoc#_setcurrentmeasurespecs[_setCurrentMeasureSpecs]
* link:ListPicker.adoc#_setminheightnative[_setMinHeightNative]
* link:ListPicker.adoc#_setminwidthnative[_setMinWidthNative]
* link:ListPicker.adoc#_setnativecliptobounds[_setNativeClipToBounds]
* link:ListPicker.adoc#_setnativeviewframe[_setNativeViewFrame]
* link:ListPicker.adoc#_setvalue[_setValue]
* link:ListPicker.adoc#_setupasrootview[_setupAsRootView]
* link:ListPicker.adoc#_setupui[_setupUI]
* link:ListPicker.adoc#_shoulddelaylayout[_shouldDelayLayout]
* link:ListPicker.adoc#_shownativemodalview[_showNativeModalView]
* link:ListPicker.adoc#_suspendnativeupdates[_suspendNativeUpdates]
* link:ListPicker.adoc#_teardownui[_tearDownUI]
* link:ListPicker.adoc#_updateeffectivelayoutvalues[_updateEffectiveLayoutValues]
* link:ListPicker.adoc#_updatestylescope[_updateStyleScope]
* link:ListPicker.adoc#accessibilityannouncement[accessibilityAnnouncement]
* link:ListPicker.adoc#accessibilityscreenchanged[accessibilityScreenChanged]
* link:ListPicker.adoc#addcss[addCss]
* link:ListPicker.adoc#addcssfile[addCssFile]
* link:ListPicker.adoc#addeventlistener[addEventListener]
* link:ListPicker.adoc#addpseudoclass[addPseudoClass]
* link:ListPicker.adoc#animate[animate]
* link:ListPicker.adoc#bind[bind]
* link:ListPicker.adoc#callloaded[callLoaded]
* link:ListPicker.adoc#callunloaded[callUnloaded]
* link:ListPicker.adoc#changecssfile[changeCssFile]
* link:ListPicker.adoc#closemodal[closeModal]
* link:ListPicker.adoc#createanimation[createAnimation]
* link:ListPicker.adoc#createnativeview[createNativeView]
* link:ListPicker.adoc#deletepseudoclass[deletePseudoClass]
* link:ListPicker.adoc#destroynode[destroyNode]
* link:ListPicker.adoc#disposenativeview[disposeNativeView]
* link:ListPicker.adoc#eachchild[eachChild]
* link:ListPicker.adoc#eachchildview[eachChildView]
* link:ListPicker.adoc#ensuredomnode[ensureDomNode]
* link:ListPicker.adoc#focus[focus]
* link:ListPicker.adoc#get[get]
* link:ListPicker.adoc#getactualsize[getActualSize]
* link:ListPicker.adoc#getgestureobservers[getGestureObservers]
* link:ListPicker.adoc#getlocationinwindow[getLocationInWindow]
* link:ListPicker.adoc#getlocationonscreen[getLocationOnScreen]
* link:ListPicker.adoc#getlocationrelativeto[getLocationRelativeTo]
* link:ListPicker.adoc#getmeasuredheight[getMeasuredHeight]
* link:ListPicker.adoc#getmeasuredstate[getMeasuredState]
* link:ListPicker.adoc#getmeasuredwidth[getMeasuredWidth]
* link:ListPicker.adoc#getsafeareainsets[getSafeAreaInsets]
* link:ListPicker.adoc#getviewbydomid[getViewByDomId]
* link:ListPicker.adoc#getviewbyid[getViewById]
* link:ListPicker.adoc#hasgestureobservers[hasGestureObservers]
* link:ListPicker.adoc#haslisteners[hasListeners]
* link:ListPicker.adoc#initnativeview[initNativeView]
* link:ListPicker.adoc#layout[layout]
* link:ListPicker.adoc#layoutnativeview[layoutNativeView]
* link:ListPicker.adoc#loadview[loadView]
* link:ListPicker.adoc#measure[measure]
* link:ListPicker.adoc#notify[notify]
* link:ListPicker.adoc#notifypropertychange[notifyPropertyChange]
* link:ListPicker.adoc#off[off]
* link:ListPicker.adoc#on[on]
* link:ListPicker.adoc#onbackpressed[onBackPressed]
* link:ListPicker.adoc#onlayout[onLayout]
* link:ListPicker.adoc#onloaded[onLoaded]
* link:ListPicker.adoc#onmeasure[onMeasure]
* link:ListPicker.adoc#onresumenativeupdates[onResumeNativeUpdates]
* link:ListPicker.adoc#onunloaded[onUnloaded]
* link:ListPicker.adoc#once[once]
* link:ListPicker.adoc#removeeventlistener[removeEventListener]
* link:ListPicker.adoc#requestlayout[requestLayout]
* link:ListPicker.adoc#resetnativeview[resetNativeView]
* link:ListPicker.adoc#sendaccessibilityevent[sendAccessibilityEvent]
* link:ListPicker.adoc#set[set]
* link:ListPicker.adoc#setinlinestyle[setInlineStyle]
* link:ListPicker.adoc#setmeasureddimension[setMeasuredDimension]
* link:ListPicker.adoc#setnativeview[setNativeView]
* link:ListPicker.adoc#setontouchlistener[setOnTouchListener]
* link:ListPicker.adoc#setproperty[setProperty]
* link:ListPicker.adoc#settestid[setTestID]
* link:ListPicker.adoc#showmodal[showModal]
* link:ListPicker.adoc#tostring[toString]
* link:ListPicker.adoc#unbind[unbind]
* link:ListPicker.adoc#unloadview[unloadView]
* link:ListPicker.adoc#addeventlistener-1[addEventListener]
* link:ListPicker.adoc#combinemeasuredstates[combineMeasuredStates]
* link:ListPicker.adoc#layoutchild[layoutChild]
* link:ListPicker.adoc#measurechild[measureChild]
* link:ListPicker.adoc#off-1[off]
* link:ListPicker.adoc#on-1[on]
* link:ListPicker.adoc#once-1[once]
* link:ListPicker.adoc#removeeventlistener-1[removeEventListener]
* link:ListPicker.adoc#resolvesizeandstate[resolveSizeAndState]
...
Gets the native http://developer.android.com/reference/android/widget/NumberPicker.html[android.widget.NumberPicker] that represents the user interface for this component.
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/list-picker/index.d.ts#L12[ui/list-picker/index.d.ts:12]
...
Gets the native iOS http://developer.apple.com/library/prerelease/ios/documentation/UIKit/Reference/UIDatePicker_Class/index.html[UIPickerView] that represents the user interface for this component.
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/list-picker/index.d.ts#L17[ui/list-picker/index.d.ts:17]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/list-picker/index.d.ts#L28[ui/list-picker/index.d.ts:28]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/list-picker/index.d.ts#L22[ui/list-picker/index.d.ts:22]
