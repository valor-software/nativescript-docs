...
xref:../README.adoc[NativeScript] / xref:../modules.adoc[Exports] / TabView
...
* link:TabView.md#constructor[constructor]

=== Properties

* link:TabView.md#_androidcontentdescriptionupdated[_androidContentDescriptionUpdated]
* link:TabView.md#_automaticallyadjustsscrollviewinsets[_automaticallyAdjustsScrollViewInsets]
* link:TabView.md#_closemodalcallback[_closeModalCallback]
* link:TabView.md#_context[_context]
* link:TabView.md#_cssstate[_cssState]
* link:TabView.md#_currentheightmeasurespec[_currentHeightMeasureSpec]
* link:TabView.md#_currentwidthmeasurespec[_currentWidthMeasureSpec]
* link:TabView.md#_defaultpaddingbottom[_defaultPaddingBottom]
* link:TabView.md#_defaultpaddingleft[_defaultPaddingLeft]
* link:TabView.md#_defaultpaddingright[_defaultPaddingRight]
* link:TabView.md#_defaultpaddingtop[_defaultPaddingTop]
* link:TabView.md#_domid[_domId]
* link:TabView.md#_gestureobservers[_gestureObservers]
* link:TabView.md#_ignoreflexminwidthheightreset[_ignoreFlexMinWidthHeightReset]
* link:TabView.md#_isaddedtonativevisualtree[_isAddedToNativeVisualTree]
* link:TabView.md#_islayoutvalid[_isLayoutValid]
* link:TabView.md#_ispaddingrelative[_isPaddingRelative]
* link:TabView.md#_isstylescopehost[_isStyleScopeHost]
* link:TabView.md#_isviewbase[_isViewBase]
* link:TabView.md#_manager[_manager]
* link:TabView.md#_modalparent[_modalParent]
* link:TabView.md#_modulename[_moduleName]
* link:TabView.md#_oldbottom[_oldBottom]
* link:TabView.md#_oldleft[_oldLeft]
* link:TabView.md#_oldright[_oldRight]
* link:TabView.md#_oldtop[_oldTop]
* link:TabView.md#_stylescope[_styleScope]
* link:TabView.md#_suspendnativeupdatescount[_suspendNativeUpdatesCount]
* link:TabView.md#_suspendedupdates[_suspendedUpdates]
* link:TabView.md#accessibilityhidden[accessibilityHidden]
* link:TabView.md#accessibilityhint[accessibilityHint]
* link:TabView.md#accessibilityidentifier[accessibilityIdentifier]
* link:TabView.md#accessibilitylabel[accessibilityLabel]
* link:TabView.md#accessibilitylanguage[accessibilityLanguage]
* link:TabView.md#accessibilityliveregion[accessibilityLiveRegion]
* link:TabView.md#accessibilitymediasession[accessibilityMediaSession]
* link:TabView.md#accessibilityrole[accessibilityRole]
* link:TabView.md#accessibilitystate[accessibilityState]
* link:TabView.md#accessibilityvalue[accessibilityValue]
* link:TabView.md#accessible[accessible]
* link:TabView.md#alignself[alignSelf]
* link:TabView.md#android[android]
* link:TabView.md#androiddynamicelevationoffset[androidDynamicElevationOffset]
* link:TabView.md#androidelevation[androidElevation]
* link:TabView.md#androidiconrenderingmode[androidIconRenderingMode]
* link:TabView.md#androidoffscreentablimit[androidOffscreenTabLimit]
* link:TabView.md#androidselectedtabhighlightcolor[androidSelectedTabHighlightColor]
* link:TabView.md#androidswipeenabled[androidSwipeEnabled]
* link:TabView.md#androidtabsposition[androidTabsPosition]
* link:TabView.md#automationtext[automationText]
* link:TabView.md#background[background]
* link:TabView.md#backgroundcolor[backgroundColor]
* link:TabView.md#backgroundimage[backgroundImage]
* link:TabView.md#bindingcontext[bindingContext]
* link:TabView.md#borderbottomcolor[borderBottomColor]
* link:TabView.md#borderbottomleftradius[borderBottomLeftRadius]
* link:TabView.md#borderbottomrightradius[borderBottomRightRadius]
* link:TabView.md#borderbottomwidth[borderBottomWidth]
* link:TabView.md#bordercolor[borderColor]
* link:TabView.md#borderleftcolor[borderLeftColor]
* link:TabView.md#borderleftwidth[borderLeftWidth]
* link:TabView.md#borderradius[borderRadius]
* link:TabView.md#borderrightcolor[borderRightColor]
* link:TabView.md#borderrightwidth[borderRightWidth]
* link:TabView.md#bordertopcolor[borderTopColor]
* link:TabView.md#bordertopleftradius[borderTopLeftRadius]
* link:TabView.md#bordertoprightradius[borderTopRightRadius]
* link:TabView.md#bordertopwidth[borderTopWidth]
* link:TabView.md#borderwidth[borderWidth]
* link:TabView.md#boxshadow[boxShadow]
* link:TabView.md#classname[className]
* link:TabView.md#col[col]
* link:TabView.md#colspan[colSpan]
* link:TabView.md#color[color]
* link:TabView.md#column[column]
* link:TabView.md#columnspan[columnSpan]
* link:TabView.md#css[css]
* link:TabView.md#cssclasses[cssClasses]
* link:TabView.md#csspseudoclasses[cssPseudoClasses]
* link:TabView.md#csstype[cssType]
* link:TabView.md#dock[dock]
* link:TabView.md#domnode[domNode]
* link:TabView.md#effectiveborderbottomwidth[effectiveBorderBottomWidth]
* link:TabView.md#effectiveborderleftwidth[effectiveBorderLeftWidth]
* link:TabView.md#effectiveborderrightwidth[effectiveBorderRightWidth]
* link:TabView.md#effectivebordertopwidth[effectiveBorderTopWidth]
* link:TabView.md#effectiveheight[effectiveHeight]
* link:TabView.md#effectiveleft[effectiveLeft]
* link:TabView.md#effectivemarginbottom[effectiveMarginBottom]
* link:TabView.md#effectivemarginleft[effectiveMarginLeft]
* link:TabView.md#effectivemarginright[effectiveMarginRight]
* link:TabView.md#effectivemargintop[effectiveMarginTop]
* link:TabView.md#effectiveminheight[effectiveMinHeight]
* link:TabView.md#effectiveminwidth[effectiveMinWidth]
* link:TabView.md#effectivepaddingbottom[effectivePaddingBottom]
* link:TabView.md#effectivepaddingleft[effectivePaddingLeft]
* link:TabView.md#effectivepaddingright[effectivePaddingRight]
* link:TabView.md#effectivepaddingtop[effectivePaddingTop]
* link:TabView.md#effectivetop[effectiveTop]
* link:TabView.md#effectivewidth[effectiveWidth]
* link:TabView.md#flexgrow[flexGrow]
* link:TabView.md#flexshrink[flexShrink]
* link:TabView.md#flexwrapbefore[flexWrapBefore]
* link:TabView.md#height[height]
* link:TabView.md#horizontalalignment[horizontalAlignment]
* link:TabView.md#id[id]
* link:TabView.md#ignoretouchanimation[ignoreTouchAnimation]
* link:TabView.md#ios[ios]
* link:TabView.md#iosiconrenderingmode[iosIconRenderingMode]
* link:TabView.md#iosignoresafearea[iosIgnoreSafeArea]
* link:TabView.md#iosoverflowsafearea[iosOverflowSafeArea]
* link:TabView.md#iosoverflowsafeareaenabled[iosOverflowSafeAreaEnabled]
* link:TabView.md#iscollapsed[isCollapsed]
* link:TabView.md#isenabled[isEnabled]
* link:TabView.md#islayoutrequired[isLayoutRequired]
* link:TabView.md#islayoutvalid[isLayoutValid]
* link:TabView.md#isuserinteractionenabled[isUserInteractionEnabled]
* link:TabView.md#items[items]
* link:TabView.md#left[left]
* link:TabView.md#margin[margin]
* link:TabView.md#marginbottom[marginBottom]
* link:TabView.md#marginleft[marginLeft]
* link:TabView.md#marginright[marginRight]
* link:TabView.md#margintop[marginTop]
* link:TabView.md#minheight[minHeight]
* link:TabView.md#minwidth[minWidth]
* link:TabView.md#modal[modal]
* link:TabView.md#nativeviewprotected[nativeViewProtected]
* link:TabView.md#opacity[opacity]
* link:TabView.md#order[order]
* link:TabView.md#originx[originX]
* link:TabView.md#originy[originY]
* link:TabView.md#parent[parent]
* link:TabView.md#perspective[perspective]
* link:TabView.md#recyclenativeview[recycleNativeView]
* link:TabView.md#reusable[reusable]
* link:TabView.md#rotate[rotate]
* link:TabView.md#rotatex[rotateX]
* link:TabView.md#rotatey[rotateY]
* link:TabView.md#row[row]
* link:TabView.md#rowspan[rowSpan]
* link:TabView.md#scalex[scaleX]
* link:TabView.md#scaley[scaleY]
* link:TabView.md#selectedindex[selectedIndex]
* link:TabView.md#selectedtabtextcolor[selectedTabTextColor]
* link:TabView.md#tabbackgroundcolor[tabBackgroundColor]
* link:TabView.md#tabtextcolor[tabTextColor]
* link:TabView.md#tabtextfontsize[tabTextFontSize]
* link:TabView.md#testid[testID]
* link:TabView.md#top[top]
* link:TabView.md#touchanimation[touchAnimation]
* link:TabView.md#touchdelay[touchDelay]
* link:TabView.md#translatex[translateX]
* link:TabView.md#translatey[translateY]
* link:TabView.md#verticalalignment[verticalAlignment]
* link:TabView.md#viewcontroller[viewController]
* link:TabView.md#visibility[visibility]
* link:TabView.md#width[width]
* link:TabView.md#accessibilityblurevent[accessibilityBlurEvent]
* link:TabView.md#accessibilityfocuschangedevent[accessibilityFocusChangedEvent]
* link:TabView.md#accessibilityfocusevent[accessibilityFocusEvent]
* link:TabView.md#accessibilityperformescapeevent[accessibilityPerformEscapeEvent]
* link:TabView.md#createdevent[createdEvent]
* link:TabView.md#disposenativeviewevent[disposeNativeViewEvent]
* link:TabView.md#layoutchangedevent[layoutChangedEvent]
* link:TabView.md#loadedevent[loadedEvent]
* link:TabView.md#propertychangeevent[propertyChangeEvent]
* link:TabView.md#selectedindexchangedevent[selectedIndexChangedEvent]
* link:TabView.md#showingmodallyevent[showingModallyEvent]
* link:TabView.md#shownmodallyevent[shownModallyEvent]
* link:TabView.md#unloadedevent[unloadedEvent]

=== Accessors

* link:TabView.md#backgroundposition[backgroundPosition]
* link:TabView.md#backgroundrepeat[backgroundRepeat]
* link:TabView.md#backgroundsize[backgroundSize]
* link:TabView.md#class[class]
* link:TabView.md#isloaded[isLoaded]
* link:TabView.md#nativeview[nativeView]
* link:TabView.md#page[page]
* link:TabView.md#parentnode[parentNode]
* link:TabView.md#style[style]
* link:TabView.md#texttransform[textTransform]
* link:TabView.md#typename[typeName]

=== Methods

* link:TabView.md#_addview[_addView]
* link:TabView.md#_addviewcore[_addViewCore]
* link:TabView.md#_addviewtonativevisualtree[_addViewToNativeVisualTree]
* link:TabView.md#_applybackground[_applyBackground]
* link:TabView.md#_applyxmlattribute[_applyXmlAttribute]
* link:TabView.md#_batchupdate[_batchUpdate]
* link:TabView.md#_childindextonativechildindex[_childIndexToNativeChildIndex]
* link:TabView.md#_closeallmodalviewsinternal[_closeAllModalViewsInternal]
* link:TabView.md#_createpropertychangedata[_createPropertyChangeData]
* link:TabView.md#_dialogclosed[_dialogClosed]
* link:TabView.md#_eachlayoutview[_eachLayoutView]
* link:TabView.md#_emit[_emit]
* link:TabView.md#_getcurrentlayoutbounds[_getCurrentLayoutBounds]
* link:TabView.md#_getfragmentmanager[_getFragmentManager]
* link:TabView.md#_getnativeviewscount[_getNativeViewsCount]
* link:TabView.md#_getrootmodalviews[_getRootModalViews]
* link:TabView.md#_getvalue[_getValue]
* link:TabView.md#_gotovisualstate[_goToVisualState]
* link:TabView.md#_handlelivesync[_handleLivesync]
* link:TabView.md#_hasancestorview[_hasAncestorView]
* link:TabView.md#_hidenativemodalview[_hideNativeModalView]
* link:TabView.md#_inheritstylescope[_inheritStyleScope]
* link:TabView.md#_layoutparent[_layoutParent]
* link:TabView.md#_observe[_observe]
* link:TabView.md#_onattachedtowindow[_onAttachedToWindow]
* link:TabView.md#_oncssstatechange[_onCssStateChange]
* link:TabView.md#_ondetachedfromwindow[_onDetachedFromWindow]
* link:TabView.md#_onlivesync[_onLivesync]
* link:TabView.md#_onrootviewreset[_onRootViewReset]
* link:TabView.md#_onsizechanged[_onSizeChanged]
* link:TabView.md#_parentchanged[_parentChanged]
* link:TabView.md#_raiselayoutchangedevent[_raiseLayoutChangedEvent]
* link:TabView.md#_raiseshowingmodallyevent[_raiseShowingModallyEvent]
* link:TabView.md#_raiseshownmodallyevent[_raiseShownModallyEvent]
* link:TabView.md#_redrawnativebackground[_redrawNativeBackground]
* link:TabView.md#_removeanimation[_removeAnimation]
* link:TabView.md#_removeview[_removeView]
* link:TabView.md#_removeviewcore[_removeViewCore]
* link:TabView.md#_removeviewfromnativevisualtree[_removeViewFromNativeVisualTree]
* link:TabView.md#_resumenativeupdates[_resumeNativeUpdates]
* link:TabView.md#_setcurrentlayoutbounds[_setCurrentLayoutBounds]
* link:TabView.md#_setcurrentmeasurespecs[_setCurrentMeasureSpecs]
* link:TabView.md#_setminheightnative[_setMinHeightNative]
* link:TabView.md#_setminwidthnative[_setMinWidthNative]
* link:TabView.md#_setnativecliptobounds[_setNativeClipToBounds]
* link:TabView.md#_setnativeviewframe[_setNativeViewFrame]
* link:TabView.md#_setvalue[_setValue]
* link:TabView.md#_setupasrootview[_setupAsRootView]
* link:TabView.md#_setupui[_setupUI]
* link:TabView.md#_shoulddelaylayout[_shouldDelayLayout]
* link:TabView.md#_shownativemodalview[_showNativeModalView]
* link:TabView.md#_suspendnativeupdates[_suspendNativeUpdates]
* link:TabView.md#_teardownui[_tearDownUI]
* link:TabView.md#_updateeffectivelayoutvalues[_updateEffectiveLayoutValues]
* link:TabView.md#_updatestylescope[_updateStyleScope]
* link:TabView.md#accessibilityannouncement[accessibilityAnnouncement]
* link:TabView.md#accessibilityscreenchanged[accessibilityScreenChanged]
* link:TabView.md#addcss[addCss]
* link:TabView.md#addcssfile[addCssFile]
* link:TabView.md#addeventlistener[addEventListener]
* link:TabView.md#addpseudoclass[addPseudoClass]
* link:TabView.md#animate[animate]
* link:TabView.md#bind[bind]
* link:TabView.md#callloaded[callLoaded]
* link:TabView.md#callunloaded[callUnloaded]
* link:TabView.md#changecssfile[changeCssFile]
* link:TabView.md#closemodal[closeModal]
* link:TabView.md#createanimation[createAnimation]
* link:TabView.md#createnativeview[createNativeView]
* link:TabView.md#deletepseudoclass[deletePseudoClass]
* link:TabView.md#destroynode[destroyNode]
* link:TabView.md#disposenativeview[disposeNativeView]
* link:TabView.md#eachchild[eachChild]
* link:TabView.md#eachchildview[eachChildView]
* link:TabView.md#ensuredomnode[ensureDomNode]
* link:TabView.md#focus[focus]
* link:TabView.md#get[get]
* link:TabView.md#getactualsize[getActualSize]
* link:TabView.md#getgestureobservers[getGestureObservers]
* link:TabView.md#getlocationinwindow[getLocationInWindow]
* link:TabView.md#getlocationonscreen[getLocationOnScreen]
* link:TabView.md#getlocationrelativeto[getLocationRelativeTo]
* link:TabView.md#getmeasuredheight[getMeasuredHeight]
* link:TabView.md#getmeasuredstate[getMeasuredState]
* link:TabView.md#getmeasuredwidth[getMeasuredWidth]
* link:TabView.md#getsafeareainsets[getSafeAreaInsets]
* link:TabView.md#getviewbydomid[getViewByDomId]
* link:TabView.md#getviewbyid[getViewById]
* link:TabView.md#hasgestureobservers[hasGestureObservers]
* link:TabView.md#haslisteners[hasListeners]
* link:TabView.md#initnativeview[initNativeView]
* link:TabView.md#layout[layout]
* link:TabView.md#layoutnativeview[layoutNativeView]
* link:TabView.md#loadview[loadView]
* link:TabView.md#measure[measure]
* link:TabView.md#notify[notify]
* link:TabView.md#notifypropertychange[notifyPropertyChange]
* link:TabView.md#off[off]
* link:TabView.md#on[on]
* link:TabView.md#onbackpressed[onBackPressed]
* link:TabView.md#onlayout[onLayout]
* link:TabView.md#onloaded[onLoaded]
* link:TabView.md#onmeasure[onMeasure]
* link:TabView.md#onresumenativeupdates[onResumeNativeUpdates]
* link:TabView.md#onunloaded[onUnloaded]
* link:TabView.md#once[once]
* link:TabView.md#removeeventlistener[removeEventListener]
* link:TabView.md#requestlayout[requestLayout]
* link:TabView.md#resetnativeview[resetNativeView]
* link:TabView.md#sendaccessibilityevent[sendAccessibilityEvent]
* link:TabView.md#set[set]
* link:TabView.md#setinlinestyle[setInlineStyle]
* link:TabView.md#setmeasureddimension[setMeasuredDimension]
* link:TabView.md#setnativeview[setNativeView]
* link:TabView.md#setontouchlistener[setOnTouchListener]
* link:TabView.md#setproperty[setProperty]
* link:TabView.md#settestid[setTestID]
* link:TabView.md#showmodal[showModal]
* link:TabView.md#tostring[toString]
* link:TabView.md#unbind[unbind]
* link:TabView.md#unloadview[unloadView]
* link:TabView.md#addeventlistener-1[addEventListener]
* link:TabView.md#combinemeasuredstates[combineMeasuredStates]
* link:TabView.md#layoutchild[layoutChild]
* link:TabView.md#measurechild[measureChild]
* link:TabView.md#off-1[off]
* link:TabView.md#on-1[on]
* link:TabView.md#once-1[once]
* link:TabView.md#removeeventlistener-1[removeEventListener]
* link:TabView.md#resolvesizeandstate[resolveSizeAndState]
...
Gets the native http://developer.android.com/reference/android/support/v4/view/ViewPager.html[android widget] that represents the user interface for this component.
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/tab-view/index.d.ts#L99[ui/tab-view/index.d.ts:99]
...
Gets or sets the rendering mode of tab icons on Android.
Defaults to "original" Valid values are:

* alwaysOriginal
* alwaysTemplate

==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/tab-view/index.d.ts#L121[ui/tab-view/index.d.ts:121]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/tab-view/index.d.ts#L127[ui/tab-view/index.d.ts:127]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/tab-view/index.d.ts#L94[ui/tab-view/index.d.ts:94]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/tab-view/index.d.ts#L140[ui/tab-view/index.d.ts:140]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/tab-view/index.d.ts#L135[ui/tab-view/index.d.ts:135]
...
Gets the native iOS https://developer.apple.com/library/ios/documentation/UIKit/Reference/UITabBarController_Class/[UITabBarController] that represents the user interface for this component.
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/tab-view/index.d.ts#L104[ui/tab-view/index.d.ts:104]
...
Defaults to "automatic" Valid values are:

* automatic
* alwaysOriginal
* alwaysTemplate

==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/tab-view/index.d.ts#L113[ui/tab-view/index.d.ts:113]
...
• *items*: xref:TabViewItem.adoc[`TabViewItem`][]

Gets or sets the items of the TabView.

==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/tab-view/index.d.ts#L64[ui/tab-view/index.d.ts:64]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/tab-view/index.d.ts#L69[ui/tab-view/index.d.ts:69]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/tab-view/index.d.ts#L89[ui/tab-view/index.d.ts:89]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/tab-view/index.d.ts#L84[ui/tab-view/index.d.ts:84]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/tab-view/index.d.ts#L79[ui/tab-view/index.d.ts:79]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/tab-view/index.d.ts#L74[ui/tab-view/index.d.ts:74]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/tab-view/index.d.ts#L145[ui/tab-view/index.d.ts:145]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/tab-view/index.d.ts#L153[ui/tab-view/index.d.ts:153]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/tab-view/index.d.ts#L158[ui/tab-view/index.d.ts:158]
