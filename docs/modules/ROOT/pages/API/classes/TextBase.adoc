...
xref:../README.adoc[NativeScript] / xref:../modules.adoc[Exports] / TextBase
...
* link:TextBase.md#constructor[constructor]

=== Properties

* link:TextBase.md#_androidcontentdescriptionupdated[_androidContentDescriptionUpdated]
* link:TextBase.md#_automaticallyadjustsscrollviewinsets[_automaticallyAdjustsScrollViewInsets]
* link:TextBase.md#_closemodalcallback[_closeModalCallback]
* link:TextBase.md#_context[_context]
* link:TextBase.md#_cssstate[_cssState]
* link:TextBase.md#_currentheightmeasurespec[_currentHeightMeasureSpec]
* link:TextBase.md#_currentwidthmeasurespec[_currentWidthMeasureSpec]
* link:TextBase.md#_defaultpaddingbottom[_defaultPaddingBottom]
* link:TextBase.md#_defaultpaddingleft[_defaultPaddingLeft]
* link:TextBase.md#_defaultpaddingright[_defaultPaddingRight]
* link:TextBase.md#_defaultpaddingtop[_defaultPaddingTop]
* link:TextBase.md#_domid[_domId]
* link:TextBase.md#_gestureobservers[_gestureObservers]
* link:TextBase.md#_ignoreflexminwidthheightreset[_ignoreFlexMinWidthHeightReset]
* link:TextBase.md#_isaddedtonativevisualtree[_isAddedToNativeVisualTree]
* link:TextBase.md#_islayoutvalid[_isLayoutValid]
* link:TextBase.md#_ispaddingrelative[_isPaddingRelative]
* link:TextBase.md#_issingleline[_isSingleLine]
* link:TextBase.md#_isstylescopehost[_isStyleScopeHost]
* link:TextBase.md#_isviewbase[_isViewBase]
* link:TextBase.md#_manager[_manager]
* link:TextBase.md#_modalparent[_modalParent]
* link:TextBase.md#_modulename[_moduleName]
* link:TextBase.md#_oldbottom[_oldBottom]
* link:TextBase.md#_oldleft[_oldLeft]
* link:TextBase.md#_oldright[_oldRight]
* link:TextBase.md#_oldtop[_oldTop]
* link:TextBase.md#_stylescope[_styleScope]
* link:TextBase.md#_suspendnativeupdatescount[_suspendNativeUpdatesCount]
* link:TextBase.md#_suspendedupdates[_suspendedUpdates]
* link:TextBase.md#accessibilityhidden[accessibilityHidden]
* link:TextBase.md#accessibilityhint[accessibilityHint]
* link:TextBase.md#accessibilityidentifier[accessibilityIdentifier]
* link:TextBase.md#accessibilitylabel[accessibilityLabel]
* link:TextBase.md#accessibilitylanguage[accessibilityLanguage]
* link:TextBase.md#accessibilityliveregion[accessibilityLiveRegion]
* link:TextBase.md#accessibilitymediasession[accessibilityMediaSession]
* link:TextBase.md#accessibilityrole[accessibilityRole]
* link:TextBase.md#accessibilitystate[accessibilityState]
* link:TextBase.md#accessibilityvalue[accessibilityValue]
* link:TextBase.md#accessible[accessible]
* link:TextBase.md#alignself[alignSelf]
* link:TextBase.md#android[android]
* link:TextBase.md#androiddynamicelevationoffset[androidDynamicElevationOffset]
* link:TextBase.md#androidelevation[androidElevation]
* link:TextBase.md#automationtext[automationText]
* link:TextBase.md#background[background]
* link:TextBase.md#backgroundcolor[backgroundColor]
* link:TextBase.md#backgroundimage[backgroundImage]
* link:TextBase.md#bindingcontext[bindingContext]
* link:TextBase.md#borderbottomcolor[borderBottomColor]
* link:TextBase.md#borderbottomleftradius[borderBottomLeftRadius]
* link:TextBase.md#borderbottomrightradius[borderBottomRightRadius]
* link:TextBase.md#borderbottomwidth[borderBottomWidth]
* link:TextBase.md#bordercolor[borderColor]
* link:TextBase.md#borderleftcolor[borderLeftColor]
* link:TextBase.md#borderleftwidth[borderLeftWidth]
* link:TextBase.md#borderradius[borderRadius]
* link:TextBase.md#borderrightcolor[borderRightColor]
* link:TextBase.md#borderrightwidth[borderRightWidth]
* link:TextBase.md#bordertopcolor[borderTopColor]
* link:TextBase.md#bordertopleftradius[borderTopLeftRadius]
* link:TextBase.md#bordertoprightradius[borderTopRightRadius]
* link:TextBase.md#bordertopwidth[borderTopWidth]
* link:TextBase.md#borderwidth[borderWidth]
* link:TextBase.md#boxshadow[boxShadow]
* link:TextBase.md#classname[className]
* link:TextBase.md#col[col]
* link:TextBase.md#colspan[colSpan]
* link:TextBase.md#color[color]
* link:TextBase.md#column[column]
* link:TextBase.md#columnspan[columnSpan]
* link:TextBase.md#css[css]
* link:TextBase.md#cssclasses[cssClasses]
* link:TextBase.md#csspseudoclasses[cssPseudoClasses]
* link:TextBase.md#csstype[cssType]
* link:TextBase.md#dock[dock]
* link:TextBase.md#domnode[domNode]
* link:TextBase.md#effectiveborderbottomwidth[effectiveBorderBottomWidth]
* link:TextBase.md#effectiveborderleftwidth[effectiveBorderLeftWidth]
* link:TextBase.md#effectiveborderrightwidth[effectiveBorderRightWidth]
* link:TextBase.md#effectivebordertopwidth[effectiveBorderTopWidth]
* link:TextBase.md#effectiveheight[effectiveHeight]
* link:TextBase.md#effectiveleft[effectiveLeft]
* link:TextBase.md#effectivemarginbottom[effectiveMarginBottom]
* link:TextBase.md#effectivemarginleft[effectiveMarginLeft]
* link:TextBase.md#effectivemarginright[effectiveMarginRight]
* link:TextBase.md#effectivemargintop[effectiveMarginTop]
* link:TextBase.md#effectiveminheight[effectiveMinHeight]
* link:TextBase.md#effectiveminwidth[effectiveMinWidth]
* link:TextBase.md#effectivepaddingbottom[effectivePaddingBottom]
* link:TextBase.md#effectivepaddingleft[effectivePaddingLeft]
* link:TextBase.md#effectivepaddingright[effectivePaddingRight]
* link:TextBase.md#effectivepaddingtop[effectivePaddingTop]
* link:TextBase.md#effectivetop[effectiveTop]
* link:TextBase.md#effectivewidth[effectiveWidth]
* link:TextBase.md#flexgrow[flexGrow]
* link:TextBase.md#flexshrink[flexShrink]
* link:TextBase.md#flexwrapbefore[flexWrapBefore]
* link:TextBase.md#fontsize[fontSize]
* link:TextBase.md#formattedtext[formattedText]
* link:TextBase.md#height[height]
* link:TextBase.md#horizontalalignment[horizontalAlignment]
* link:TextBase.md#id[id]
* link:TextBase.md#ignoretouchanimation[ignoreTouchAnimation]
* link:TextBase.md#ios[ios]
* link:TextBase.md#iosignoresafearea[iosIgnoreSafeArea]
* link:TextBase.md#iosoverflowsafearea[iosOverflowSafeArea]
* link:TextBase.md#iosoverflowsafeareaenabled[iosOverflowSafeAreaEnabled]
* link:TextBase.md#iscollapsed[isCollapsed]
* link:TextBase.md#isenabled[isEnabled]
* link:TextBase.md#islayoutrequired[isLayoutRequired]
* link:TextBase.md#islayoutvalid[isLayoutValid]
* link:TextBase.md#isuserinteractionenabled[isUserInteractionEnabled]
* link:TextBase.md#left[left]
* link:TextBase.md#letterspacing[letterSpacing]
* link:TextBase.md#lineheight[lineHeight]
* link:TextBase.md#margin[margin]
* link:TextBase.md#marginbottom[marginBottom]
* link:TextBase.md#marginleft[marginLeft]
* link:TextBase.md#marginright[marginRight]
* link:TextBase.md#margintop[marginTop]
* link:TextBase.md#maxlines[maxLines]
* link:TextBase.md#minheight[minHeight]
* link:TextBase.md#minwidth[minWidth]
* link:TextBase.md#modal[modal]
* link:TextBase.md#nativetextviewprotected[nativeTextViewProtected]
* link:TextBase.md#nativeviewprotected[nativeViewProtected]
* link:TextBase.md#opacity[opacity]
* link:TextBase.md#order[order]
* link:TextBase.md#originx[originX]
* link:TextBase.md#originy[originY]
* link:TextBase.md#padding[padding]
* link:TextBase.md#paddingbottom[paddingBottom]
* link:TextBase.md#paddingleft[paddingLeft]
* link:TextBase.md#paddingright[paddingRight]
* link:TextBase.md#paddingtop[paddingTop]
* link:TextBase.md#parent[parent]
* link:TextBase.md#perspective[perspective]
* link:TextBase.md#recyclenativeview[recycleNativeView]
* link:TextBase.md#reusable[reusable]
* link:TextBase.md#rotate[rotate]
* link:TextBase.md#rotatex[rotateX]
* link:TextBase.md#rotatey[rotateY]
* link:TextBase.md#row[row]
* link:TextBase.md#rowspan[rowSpan]
* link:TextBase.md#scalex[scaleX]
* link:TextBase.md#scaley[scaleY]
* link:TextBase.md#testid[testID]
* link:TextBase.md#text[text]
* link:TextBase.md#textalignment[textAlignment]
* link:TextBase.md#textdecoration[textDecoration]
* link:TextBase.md#textshadow[textShadow]
* link:TextBase.md#texttransform[textTransform]
* link:TextBase.md#top[top]
* link:TextBase.md#touchanimation[touchAnimation]
* link:TextBase.md#touchdelay[touchDelay]
* link:TextBase.md#translatex[translateX]
* link:TextBase.md#translatey[translateY]
* link:TextBase.md#verticalalignment[verticalAlignment]
* link:TextBase.md#viewcontroller[viewController]
* link:TextBase.md#visibility[visibility]
* link:TextBase.md#whitespace[whiteSpace]
* link:TextBase.md#width[width]
* link:TextBase.md#accessibilityblurevent[accessibilityBlurEvent]
* link:TextBase.md#accessibilityfocuschangedevent[accessibilityFocusChangedEvent]
* link:TextBase.md#accessibilityfocusevent[accessibilityFocusEvent]
* link:TextBase.md#accessibilityperformescapeevent[accessibilityPerformEscapeEvent]
* link:TextBase.md#createdevent[createdEvent]
* link:TextBase.md#disposenativeviewevent[disposeNativeViewEvent]
* link:TextBase.md#layoutchangedevent[layoutChangedEvent]
* link:TextBase.md#loadedevent[loadedEvent]
* link:TextBase.md#propertychangeevent[propertyChangeEvent]
* link:TextBase.md#showingmodallyevent[showingModallyEvent]
* link:TextBase.md#shownmodallyevent[shownModallyEvent]
* link:TextBase.md#unloadedevent[unloadedEvent]

=== Accessors

* link:TextBase.md#backgroundposition[backgroundPosition]
* link:TextBase.md#backgroundrepeat[backgroundRepeat]
* link:TextBase.md#backgroundsize[backgroundSize]
* link:TextBase.md#class[class]
* link:TextBase.md#isloaded[isLoaded]
* link:TextBase.md#nativeview[nativeView]
* link:TextBase.md#page[page]
* link:TextBase.md#parentnode[parentNode]
* link:TextBase.md#style[style]
* link:TextBase.md#typename[typeName]

=== Methods

* link:TextBase.md#_addchildfrombuilder[_addChildFromBuilder]
* link:TextBase.md#_addview[_addView]
* link:TextBase.md#_addviewcore[_addViewCore]
* link:TextBase.md#_addviewtonativevisualtree[_addViewToNativeVisualTree]
* link:TextBase.md#_applybackground[_applyBackground]
* link:TextBase.md#_applyxmlattribute[_applyXmlAttribute]
* link:TextBase.md#_batchupdate[_batchUpdate]
* link:TextBase.md#_childindextonativechildindex[_childIndexToNativeChildIndex]
* link:TextBase.md#_closeallmodalviewsinternal[_closeAllModalViewsInternal]
* link:TextBase.md#_createpropertychangedata[_createPropertyChangeData]
* link:TextBase.md#_dialogclosed[_dialogClosed]
* link:TextBase.md#_eachlayoutview[_eachLayoutView]
* link:TextBase.md#_emit[_emit]
* link:TextBase.md#_getcurrentlayoutbounds[_getCurrentLayoutBounds]
* link:TextBase.md#_getfragmentmanager[_getFragmentManager]
* link:TextBase.md#_getnativeviewscount[_getNativeViewsCount]
* link:TextBase.md#_getrootmodalviews[_getRootModalViews]
* link:TextBase.md#_getvalue[_getValue]
* link:TextBase.md#_gotovisualstate[_goToVisualState]
* link:TextBase.md#_handlelivesync[_handleLivesync]
* link:TextBase.md#_hasancestorview[_hasAncestorView]
* link:TextBase.md#_hidenativemodalview[_hideNativeModalView]
* link:TextBase.md#_inheritstylescope[_inheritStyleScope]
* link:TextBase.md#_layoutparent[_layoutParent]
* link:TextBase.md#_observe[_observe]
* link:TextBase.md#_onattachedtowindow[_onAttachedToWindow]
* link:TextBase.md#_oncssstatechange[_onCssStateChange]
* link:TextBase.md#_ondetachedfromwindow[_onDetachedFromWindow]
* link:TextBase.md#_onlivesync[_onLivesync]
* link:TextBase.md#_onrootviewreset[_onRootViewReset]
* link:TextBase.md#_onsizechanged[_onSizeChanged]
* link:TextBase.md#_parentchanged[_parentChanged]
* link:TextBase.md#_raiselayoutchangedevent[_raiseLayoutChangedEvent]
* link:TextBase.md#_raiseshowingmodallyevent[_raiseShowingModallyEvent]
* link:TextBase.md#_raiseshownmodallyevent[_raiseShownModallyEvent]
* link:TextBase.md#_redrawnativebackground[_redrawNativeBackground]
* link:TextBase.md#_removeanimation[_removeAnimation]
* link:TextBase.md#_removeview[_removeView]
* link:TextBase.md#_removeviewcore[_removeViewCore]
* link:TextBase.md#_removeviewfromnativevisualtree[_removeViewFromNativeVisualTree]
* link:TextBase.md#_requestlayoutontextchanged[_requestLayoutOnTextChanged]
* link:TextBase.md#_resumenativeupdates[_resumeNativeUpdates]
* link:TextBase.md#_setcurrentlayoutbounds[_setCurrentLayoutBounds]
* link:TextBase.md#_setcurrentmeasurespecs[_setCurrentMeasureSpecs]
* link:TextBase.md#_setminheightnative[_setMinHeightNative]
* link:TextBase.md#_setminwidthnative[_setMinWidthNative]
* link:TextBase.md#_setnativecliptobounds[_setNativeClipToBounds]
* link:TextBase.md#_setnativetext[_setNativeText]
* link:TextBase.md#_setnativeviewframe[_setNativeViewFrame]
* link:TextBase.md#_setvalue[_setValue]
* link:TextBase.md#_setupasrootview[_setupAsRootView]
* link:TextBase.md#_setupui[_setupUI]
* link:TextBase.md#_shoulddelaylayout[_shouldDelayLayout]
* link:TextBase.md#_shownativemodalview[_showNativeModalView]
* link:TextBase.md#_suspendnativeupdates[_suspendNativeUpdates]
* link:TextBase.md#_teardownui[_tearDownUI]
* link:TextBase.md#_updateeffectivelayoutvalues[_updateEffectiveLayoutValues]
* link:TextBase.md#_updatestylescope[_updateStyleScope]
* link:TextBase.md#accessibilityannouncement[accessibilityAnnouncement]
* link:TextBase.md#accessibilityscreenchanged[accessibilityScreenChanged]
* link:TextBase.md#addcss[addCss]
* link:TextBase.md#addcssfile[addCssFile]
* link:TextBase.md#addeventlistener[addEventListener]
* link:TextBase.md#addpseudoclass[addPseudoClass]
* link:TextBase.md#animate[animate]
* link:TextBase.md#bind[bind]
* link:TextBase.md#callloaded[callLoaded]
* link:TextBase.md#callunloaded[callUnloaded]
* link:TextBase.md#changecssfile[changeCssFile]
* link:TextBase.md#closemodal[closeModal]
* link:TextBase.md#createanimation[createAnimation]
* link:TextBase.md#createnativeview[createNativeView]
* link:TextBase.md#deletepseudoclass[deletePseudoClass]
* link:TextBase.md#destroynode[destroyNode]
* link:TextBase.md#disposenativeview[disposeNativeView]
* link:TextBase.md#eachchild[eachChild]
* link:TextBase.md#eachchildview[eachChildView]
* link:TextBase.md#ensuredomnode[ensureDomNode]
* link:TextBase.md#focus[focus]
* link:TextBase.md#get[get]
* link:TextBase.md#getactualsize[getActualSize]
* link:TextBase.md#getgestureobservers[getGestureObservers]
* link:TextBase.md#getlocationinwindow[getLocationInWindow]
* link:TextBase.md#getlocationonscreen[getLocationOnScreen]
* link:TextBase.md#getlocationrelativeto[getLocationRelativeTo]
* link:TextBase.md#getmeasuredheight[getMeasuredHeight]
* link:TextBase.md#getmeasuredstate[getMeasuredState]
* link:TextBase.md#getmeasuredwidth[getMeasuredWidth]
* link:TextBase.md#getsafeareainsets[getSafeAreaInsets]
* link:TextBase.md#getviewbydomid[getViewByDomId]
* link:TextBase.md#getviewbyid[getViewById]
* link:TextBase.md#hasgestureobservers[hasGestureObservers]
* link:TextBase.md#haslisteners[hasListeners]
* link:TextBase.md#initnativeview[initNativeView]
* link:TextBase.md#layout[layout]
* link:TextBase.md#layoutnativeview[layoutNativeView]
* link:TextBase.md#loadview[loadView]
* link:TextBase.md#measure[measure]
* link:TextBase.md#notify[notify]
* link:TextBase.md#notifypropertychange[notifyPropertyChange]
* link:TextBase.md#off[off]
* link:TextBase.md#on[on]
* link:TextBase.md#onbackpressed[onBackPressed]
* link:TextBase.md#onlayout[onLayout]
* link:TextBase.md#onloaded[onLoaded]
* link:TextBase.md#onmeasure[onMeasure]
* link:TextBase.md#onresumenativeupdates[onResumeNativeUpdates]
* link:TextBase.md#onunloaded[onUnloaded]
* link:TextBase.md#once[once]
* link:TextBase.md#removeeventlistener[removeEventListener]
* link:TextBase.md#requestlayout[requestLayout]
* link:TextBase.md#resetnativeview[resetNativeView]
* link:TextBase.md#sendaccessibilityevent[sendAccessibilityEvent]
* link:TextBase.md#set[set]
* link:TextBase.md#setinlinestyle[setInlineStyle]
* link:TextBase.md#setmeasureddimension[setMeasuredDimension]
* link:TextBase.md#setnativeview[setNativeView]
* link:TextBase.md#setontouchlistener[setOnTouchListener]
* link:TextBase.md#setproperty[setProperty]
* link:TextBase.md#settestid[setTestID]
* link:TextBase.md#showmodal[showModal]
* link:TextBase.md#tostring[toString]
* link:TextBase.md#unbind[unbind]
* link:TextBase.md#unloadview[unloadView]
* link:TextBase.md#addeventlistener-1[addEventListener]
* link:TextBase.md#combinemeasuredstates[combineMeasuredStates]
* link:TextBase.md#layoutchild[layoutChild]
* link:TextBase.md#measurechild[measureChild]
* link:TextBase.md#off-1[off]
* link:TextBase.md#on-1[on]
* link:TextBase.md#once-1[once]
* link:TextBase.md#removeeventlistener-1[removeEventListener]
* link:TextBase.md#resolvesizeandstate[resolveSizeAndState]
...
xref:View.adoc[View].link:View.md#texttransform[textTransform]
