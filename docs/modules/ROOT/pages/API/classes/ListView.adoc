...
* link:ListView.md#constructor[constructor]

=== Properties

* link:ListView.md#_androidcontentdescriptionupdated[_androidContentDescriptionUpdated]
* link:ListView.md#_automaticallyadjustsscrollviewinsets[_automaticallyAdjustsScrollViewInsets]
* link:ListView.md#_closemodalcallback[_closeModalCallback]
* link:ListView.md#_context[_context]
* link:ListView.md#_cssstate[_cssState]
* link:ListView.md#_currentheightmeasurespec[_currentHeightMeasureSpec]
* link:ListView.md#_currentwidthmeasurespec[_currentWidthMeasureSpec]
* link:ListView.md#_defaultpaddingbottom[_defaultPaddingBottom]
* link:ListView.md#_defaultpaddingleft[_defaultPaddingLeft]
* link:ListView.md#_defaultpaddingright[_defaultPaddingRight]
* link:ListView.md#_defaultpaddingtop[_defaultPaddingTop]
* link:ListView.md#_domid[_domId]
* link:ListView.md#_gestureobservers[_gestureObservers]
* link:ListView.md#_ignoreflexminwidthheightreset[_ignoreFlexMinWidthHeightReset]
* link:ListView.md#_isaddedtonativevisualtree[_isAddedToNativeVisualTree]
* link:ListView.md#_islayoutvalid[_isLayoutValid]
* link:ListView.md#_ispaddingrelative[_isPaddingRelative]
* link:ListView.md#_isstylescopehost[_isStyleScopeHost]
* link:ListView.md#_isviewbase[_isViewBase]
* link:ListView.md#_manager[_manager]
* link:ListView.md#_modalparent[_modalParent]
* link:ListView.md#_modulename[_moduleName]
* link:ListView.md#_oldbottom[_oldBottom]
* link:ListView.md#_oldleft[_oldLeft]
* link:ListView.md#_oldright[_oldRight]
* link:ListView.md#_oldtop[_oldTop]
* link:ListView.md#_stylescope[_styleScope]
* link:ListView.md#_suspendnativeupdatescount[_suspendNativeUpdatesCount]
* link:ListView.md#_suspendedupdates[_suspendedUpdates]
* link:ListView.md#accessibilityhidden[accessibilityHidden]
* link:ListView.md#accessibilityhint[accessibilityHint]
* link:ListView.md#accessibilityidentifier[accessibilityIdentifier]
* link:ListView.md#accessibilitylabel[accessibilityLabel]
* link:ListView.md#accessibilitylanguage[accessibilityLanguage]
* link:ListView.md#accessibilityliveregion[accessibilityLiveRegion]
* link:ListView.md#accessibilitymediasession[accessibilityMediaSession]
* link:ListView.md#accessibilityrole[accessibilityRole]
* link:ListView.md#accessibilitystate[accessibilityState]
* link:ListView.md#accessibilityvalue[accessibilityValue]
* link:ListView.md#accessible[accessible]
* link:ListView.md#alignself[alignSelf]
* link:ListView.md#android[android]
* link:ListView.md#androiddynamicelevationoffset[androidDynamicElevationOffset]
* link:ListView.md#androidelevation[androidElevation]
* link:ListView.md#automationtext[automationText]
* link:ListView.md#background[background]
* link:ListView.md#backgroundcolor[backgroundColor]
* link:ListView.md#backgroundimage[backgroundImage]
* link:ListView.md#bindingcontext[bindingContext]
* link:ListView.md#borderbottomcolor[borderBottomColor]
* link:ListView.md#borderbottomleftradius[borderBottomLeftRadius]
* link:ListView.md#borderbottomrightradius[borderBottomRightRadius]
* link:ListView.md#borderbottomwidth[borderBottomWidth]
* link:ListView.md#bordercolor[borderColor]
* link:ListView.md#borderleftcolor[borderLeftColor]
* link:ListView.md#borderleftwidth[borderLeftWidth]
* link:ListView.md#borderradius[borderRadius]
* link:ListView.md#borderrightcolor[borderRightColor]
* link:ListView.md#borderrightwidth[borderRightWidth]
* link:ListView.md#bordertopcolor[borderTopColor]
* link:ListView.md#bordertopleftradius[borderTopLeftRadius]
* link:ListView.md#bordertoprightradius[borderTopRightRadius]
* link:ListView.md#bordertopwidth[borderTopWidth]
* link:ListView.md#borderwidth[borderWidth]
* link:ListView.md#boxshadow[boxShadow]
* link:ListView.md#classname[className]
* link:ListView.md#col[col]
* link:ListView.md#colspan[colSpan]
* link:ListView.md#color[color]
* link:ListView.md#column[column]
* link:ListView.md#columnspan[columnSpan]
* link:ListView.md#css[css]
* link:ListView.md#cssclasses[cssClasses]
* link:ListView.md#csspseudoclasses[cssPseudoClasses]
* link:ListView.md#csstype[cssType]
* link:ListView.md#dock[dock]
* link:ListView.md#domnode[domNode]
* link:ListView.md#effectiveborderbottomwidth[effectiveBorderBottomWidth]
* link:ListView.md#effectiveborderleftwidth[effectiveBorderLeftWidth]
* link:ListView.md#effectiveborderrightwidth[effectiveBorderRightWidth]
* link:ListView.md#effectivebordertopwidth[effectiveBorderTopWidth]
* link:ListView.md#effectiveheight[effectiveHeight]
* link:ListView.md#effectiveleft[effectiveLeft]
* link:ListView.md#effectivemarginbottom[effectiveMarginBottom]
* link:ListView.md#effectivemarginleft[effectiveMarginLeft]
* link:ListView.md#effectivemarginright[effectiveMarginRight]
* link:ListView.md#effectivemargintop[effectiveMarginTop]
* link:ListView.md#effectiveminheight[effectiveMinHeight]
* link:ListView.md#effectiveminwidth[effectiveMinWidth]
* link:ListView.md#effectivepaddingbottom[effectivePaddingBottom]
* link:ListView.md#effectivepaddingleft[effectivePaddingLeft]
* link:ListView.md#effectivepaddingright[effectivePaddingRight]
* link:ListView.md#effectivepaddingtop[effectivePaddingTop]
* link:ListView.md#effectivetop[effectiveTop]
* link:ListView.md#effectivewidth[effectiveWidth]
* link:ListView.md#flexgrow[flexGrow]
* link:ListView.md#flexshrink[flexShrink]
* link:ListView.md#flexwrapbefore[flexWrapBefore]
* link:ListView.md#height[height]
* link:ListView.md#horizontalalignment[horizontalAlignment]
* link:ListView.md#id[id]
* link:ListView.md#ignoretouchanimation[ignoreTouchAnimation]
* link:ListView.md#ios[ios]
* link:ListView.md#iosestimatedrowheight[iosEstimatedRowHeight]
* link:ListView.md#iosignoresafearea[iosIgnoreSafeArea]
* link:ListView.md#iosoverflowsafearea[iosOverflowSafeArea]
* link:ListView.md#iosoverflowsafeareaenabled[iosOverflowSafeAreaEnabled]
* link:ListView.md#iscollapsed[isCollapsed]
* link:ListView.md#isenabled[isEnabled]
* link:ListView.md#islayoutrequired[isLayoutRequired]
* link:ListView.md#islayoutvalid[isLayoutValid]
* link:ListView.md#isuserinteractionenabled[isUserInteractionEnabled]
* link:ListView.md#itemidgenerator[itemIdGenerator]
* link:ListView.md#itemtemplate[itemTemplate]
* link:ListView.md#itemtemplateselector[itemTemplateSelector]
* link:ListView.md#itemtemplates[itemTemplates]
* link:ListView.md#items[items]
* link:ListView.md#left[left]
* link:ListView.md#margin[margin]
* link:ListView.md#marginbottom[marginBottom]
* link:ListView.md#marginleft[marginLeft]
* link:ListView.md#marginright[marginRight]
* link:ListView.md#margintop[marginTop]
* link:ListView.md#minheight[minHeight]
* link:ListView.md#minwidth[minWidth]
* link:ListView.md#modal[modal]
* link:ListView.md#nativeviewprotected[nativeViewProtected]
* link:ListView.md#opacity[opacity]
* link:ListView.md#order[order]
* link:ListView.md#originx[originX]
* link:ListView.md#originy[originY]
* link:ListView.md#parent[parent]
* link:ListView.md#perspective[perspective]
* link:ListView.md#recyclenativeview[recycleNativeView]
* link:ListView.md#reusable[reusable]
* link:ListView.md#rotate[rotate]
* link:ListView.md#rotatex[rotateX]
* link:ListView.md#rotatey[rotateY]
* link:ListView.md#row[row]
* link:ListView.md#rowheight[rowHeight]
* link:ListView.md#rowspan[rowSpan]
* link:ListView.md#scalex[scaleX]
* link:ListView.md#scaley[scaleY]
* link:ListView.md#separatorcolor[separatorColor]
* link:ListView.md#testid[testID]
* link:ListView.md#top[top]
* link:ListView.md#touchanimation[touchAnimation]
* link:ListView.md#touchdelay[touchDelay]
* link:ListView.md#translatex[translateX]
* link:ListView.md#translatey[translateY]
* link:ListView.md#verticalalignment[verticalAlignment]
* link:ListView.md#viewcontroller[viewController]
* link:ListView.md#visibility[visibility]
* link:ListView.md#width[width]
* link:ListView.md#accessibilityblurevent[accessibilityBlurEvent]
* link:ListView.md#accessibilityfocuschangedevent[accessibilityFocusChangedEvent]
* link:ListView.md#accessibilityfocusevent[accessibilityFocusEvent]
* link:ListView.md#accessibilityperformescapeevent[accessibilityPerformEscapeEvent]
* link:ListView.md#createdevent[createdEvent]
* link:ListView.md#disposenativeviewevent[disposeNativeViewEvent]
* link:ListView.md#itemloadingevent[itemLoadingEvent]
* link:ListView.md#itemtapevent[itemTapEvent]
* link:ListView.md#layoutchangedevent[layoutChangedEvent]
* link:ListView.md#loadmoreitemsevent[loadMoreItemsEvent]
* link:ListView.md#loadedevent[loadedEvent]
* link:ListView.md#propertychangeevent[propertyChangeEvent]
* link:ListView.md#showingmodallyevent[showingModallyEvent]
* link:ListView.md#shownmodallyevent[shownModallyEvent]
* link:ListView.md#unloadedevent[unloadedEvent]

=== Accessors

* link:ListView.md#backgroundposition[backgroundPosition]
* link:ListView.md#backgroundrepeat[backgroundRepeat]
* link:ListView.md#backgroundsize[backgroundSize]
* link:ListView.md#class[class]
* link:ListView.md#isloaded[isLoaded]
* link:ListView.md#nativeview[nativeView]
* link:ListView.md#page[page]
* link:ListView.md#parentnode[parentNode]
* link:ListView.md#style[style]
* link:ListView.md#texttransform[textTransform]
* link:ListView.md#typename[typeName]

=== Methods

* link:ListView.md#_addview[_addView]
* link:ListView.md#_addviewcore[_addViewCore]
* link:ListView.md#_addviewtonativevisualtree[_addViewToNativeVisualTree]
* link:ListView.md#_applybackground[_applyBackground]
* link:ListView.md#_applyxmlattribute[_applyXmlAttribute]
* link:ListView.md#_batchupdate[_batchUpdate]
* link:ListView.md#_childindextonativechildindex[_childIndexToNativeChildIndex]
* link:ListView.md#_closeallmodalviewsinternal[_closeAllModalViewsInternal]
* link:ListView.md#_createpropertychangedata[_createPropertyChangeData]
* link:ListView.md#_dialogclosed[_dialogClosed]
* link:ListView.md#_eachlayoutview[_eachLayoutView]
* link:ListView.md#_emit[_emit]
* link:ListView.md#_getcurrentlayoutbounds[_getCurrentLayoutBounds]
* link:ListView.md#_getfragmentmanager[_getFragmentManager]
* link:ListView.md#_getnativeviewscount[_getNativeViewsCount]
* link:ListView.md#_getrootmodalviews[_getRootModalViews]
* link:ListView.md#_getvalue[_getValue]
* link:ListView.md#_gotovisualstate[_goToVisualState]
* link:ListView.md#_handlelivesync[_handleLivesync]
* link:ListView.md#_hasancestorview[_hasAncestorView]
* link:ListView.md#_hidenativemodalview[_hideNativeModalView]
* link:ListView.md#_inheritstylescope[_inheritStyleScope]
* link:ListView.md#_layoutparent[_layoutParent]
* link:ListView.md#_observe[_observe]
* link:ListView.md#_onattachedtowindow[_onAttachedToWindow]
* link:ListView.md#_oncssstatechange[_onCssStateChange]
* link:ListView.md#_ondetachedfromwindow[_onDetachedFromWindow]
* link:ListView.md#_onlivesync[_onLivesync]
* link:ListView.md#_onrootviewreset[_onRootViewReset]
* link:ListView.md#_onsizechanged[_onSizeChanged]
* link:ListView.md#_parentchanged[_parentChanged]
* link:ListView.md#_raiselayoutchangedevent[_raiseLayoutChangedEvent]
* link:ListView.md#_raiseshowingmodallyevent[_raiseShowingModallyEvent]
* link:ListView.md#_raiseshownmodallyevent[_raiseShownModallyEvent]
* link:ListView.md#_redrawnativebackground[_redrawNativeBackground]
* link:ListView.md#_removeanimation[_removeAnimation]
* link:ListView.md#_removeview[_removeView]
* link:ListView.md#_removeviewcore[_removeViewCore]
* link:ListView.md#_removeviewfromnativevisualtree[_removeViewFromNativeVisualTree]
* link:ListView.md#_resumenativeupdates[_resumeNativeUpdates]
* link:ListView.md#_setcurrentlayoutbounds[_setCurrentLayoutBounds]
* link:ListView.md#_setcurrentmeasurespecs[_setCurrentMeasureSpecs]
* link:ListView.md#_setminheightnative[_setMinHeightNative]
* link:ListView.md#_setminwidthnative[_setMinWidthNative]
* link:ListView.md#_setnativecliptobounds[_setNativeClipToBounds]
* link:ListView.md#_setnativeviewframe[_setNativeViewFrame]
* link:ListView.md#_setvalue[_setValue]
* link:ListView.md#_setupasrootview[_setupAsRootView]
* link:ListView.md#_setupui[_setupUI]
* link:ListView.md#_shoulddelaylayout[_shouldDelayLayout]
* link:ListView.md#_shownativemodalview[_showNativeModalView]
* link:ListView.md#_suspendnativeupdates[_suspendNativeUpdates]
* link:ListView.md#_teardownui[_tearDownUI]
* link:ListView.md#_updateeffectivelayoutvalues[_updateEffectiveLayoutValues]
* link:ListView.md#_updatestylescope[_updateStyleScope]
* link:ListView.md#accessibilityannouncement[accessibilityAnnouncement]
* link:ListView.md#accessibilityscreenchanged[accessibilityScreenChanged]
* link:ListView.md#addcss[addCss]
* link:ListView.md#addcssfile[addCssFile]
* link:ListView.md#addeventlistener[addEventListener]
* link:ListView.md#addpseudoclass[addPseudoClass]
* link:ListView.md#animate[animate]
* link:ListView.md#bind[bind]
* link:ListView.md#callloaded[callLoaded]
* link:ListView.md#callunloaded[callUnloaded]
* link:ListView.md#changecssfile[changeCssFile]
* link:ListView.md#closemodal[closeModal]
* link:ListView.md#createanimation[createAnimation]
* link:ListView.md#createnativeview[createNativeView]
* link:ListView.md#deletepseudoclass[deletePseudoClass]
* link:ListView.md#destroynode[destroyNode]
* link:ListView.md#disposenativeview[disposeNativeView]
* link:ListView.md#eachchild[eachChild]
* link:ListView.md#eachchildview[eachChildView]
* link:ListView.md#ensuredomnode[ensureDomNode]
* link:ListView.md#focus[focus]
* link:ListView.md#get[get]
* link:ListView.md#getactualsize[getActualSize]
* link:ListView.md#getgestureobservers[getGestureObservers]
* link:ListView.md#getlocationinwindow[getLocationInWindow]
* link:ListView.md#getlocationonscreen[getLocationOnScreen]
* link:ListView.md#getlocationrelativeto[getLocationRelativeTo]
* link:ListView.md#getmeasuredheight[getMeasuredHeight]
* link:ListView.md#getmeasuredstate[getMeasuredState]
* link:ListView.md#getmeasuredwidth[getMeasuredWidth]
* link:ListView.md#getsafeareainsets[getSafeAreaInsets]
* link:ListView.md#getviewbydomid[getViewByDomId]
* link:ListView.md#getviewbyid[getViewById]
* link:ListView.md#hasgestureobservers[hasGestureObservers]
* link:ListView.md#haslisteners[hasListeners]
* link:ListView.md#initnativeview[initNativeView]
* link:ListView.md#isitematindexvisible[isItemAtIndexVisible]
* link:ListView.md#layout[layout]
* link:ListView.md#layoutnativeview[layoutNativeView]
* link:ListView.md#loadview[loadView]
* link:ListView.md#measure[measure]
* link:ListView.md#notify[notify]
* link:ListView.md#notifypropertychange[notifyPropertyChange]
* link:ListView.md#off[off]
* link:ListView.md#on[on]
* link:ListView.md#onbackpressed[onBackPressed]
* link:ListView.md#onlayout[onLayout]
* link:ListView.md#onloaded[onLoaded]
* link:ListView.md#onmeasure[onMeasure]
* link:ListView.md#onresumenativeupdates[onResumeNativeUpdates]
* link:ListView.md#onunloaded[onUnloaded]
* link:ListView.md#once[once]
* link:ListView.md#refresh[refresh]
* link:ListView.md#removeeventlistener[removeEventListener]
* link:ListView.md#requestlayout[requestLayout]
* link:ListView.md#resetnativeview[resetNativeView]
* link:ListView.md#scrolltoindex[scrollToIndex]
* link:ListView.md#scrolltoindexanimated[scrollToIndexAnimated]
* link:ListView.md#sendaccessibilityevent[sendAccessibilityEvent]
* link:ListView.md#set[set]
* link:ListView.md#setinlinestyle[setInlineStyle]
* link:ListView.md#setmeasureddimension[setMeasuredDimension]
* link:ListView.md#setnativeview[setNativeView]
* link:ListView.md#setontouchlistener[setOnTouchListener]
* link:ListView.md#setproperty[setProperty]
* link:ListView.md#settestid[setTestID]
* link:ListView.md#showmodal[showModal]
* link:ListView.md#tostring[toString]
* link:ListView.md#unbind[unbind]
* link:ListView.md#unloadview[unloadView]
* link:ListView.md#addeventlistener-1[addEventListener]
* link:ListView.md#combinemeasuredstates[combineMeasuredStates]
* link:ListView.md#layoutchild[layoutChild]
* link:ListView.md#measurechild[measureChild]
* link:ListView.md#off-1[off]
* link:ListView.md#on-1[on]
* link:ListView.md#once-1[once]
* link:ListView.md#removeeventlistener-1[removeEventListener]
* link:ListView.md#resolvesizeandstate[resolveSizeAndState]
...
• *iosEstimatedRowHeight*: link:../modules/CoreTypes.md#lengthtype[`LengthType`]
...
• *rowHeight*: link:../modules/CoreTypes.md#lengthtype[`LengthType`]
...
xref:View.adoc[View].link:View.md#on[on]
