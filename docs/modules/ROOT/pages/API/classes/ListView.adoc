...
xref:../README.adoc[NativeScript] / xref:../modules.adoc[Exports] / ListView
...
* link:ListView.adoc#constructor[constructor]

=== Properties

* link:ListView.adoc#_androidcontentdescriptionupdated[_androidContentDescriptionUpdated]
* link:ListView.adoc#_automaticallyadjustsscrollviewinsets[_automaticallyAdjustsScrollViewInsets]
* link:ListView.adoc#_closemodalcallback[_closeModalCallback]
* link:ListView.adoc#_context[_context]
* link:ListView.adoc#_cssstate[_cssState]
* link:ListView.adoc#_currentheightmeasurespec[_currentHeightMeasureSpec]
* link:ListView.adoc#_currentwidthmeasurespec[_currentWidthMeasureSpec]
* link:ListView.adoc#_defaultpaddingbottom[_defaultPaddingBottom]
* link:ListView.adoc#_defaultpaddingleft[_defaultPaddingLeft]
* link:ListView.adoc#_defaultpaddingright[_defaultPaddingRight]
* link:ListView.adoc#_defaultpaddingtop[_defaultPaddingTop]
* link:ListView.adoc#_domid[_domId]
* link:ListView.adoc#_gestureobservers[_gestureObservers]
* link:ListView.adoc#_ignoreflexminwidthheightreset[_ignoreFlexMinWidthHeightReset]
* link:ListView.adoc#_isaddedtonativevisualtree[_isAddedToNativeVisualTree]
* link:ListView.adoc#_islayoutvalid[_isLayoutValid]
* link:ListView.adoc#_ispaddingrelative[_isPaddingRelative]
* link:ListView.adoc#_isstylescopehost[_isStyleScopeHost]
* link:ListView.adoc#_isviewbase[_isViewBase]
* link:ListView.adoc#_manager[_manager]
* link:ListView.adoc#_modalparent[_modalParent]
* link:ListView.adoc#_modulename[_moduleName]
* link:ListView.adoc#_oldbottom[_oldBottom]
* link:ListView.adoc#_oldleft[_oldLeft]
* link:ListView.adoc#_oldright[_oldRight]
* link:ListView.adoc#_oldtop[_oldTop]
* link:ListView.adoc#_stylescope[_styleScope]
* link:ListView.adoc#_suspendnativeupdatescount[_suspendNativeUpdatesCount]
* link:ListView.adoc#_suspendedupdates[_suspendedUpdates]
* link:ListView.adoc#accessibilityhidden[accessibilityHidden]
* link:ListView.adoc#accessibilityhint[accessibilityHint]
* link:ListView.adoc#accessibilityidentifier[accessibilityIdentifier]
* link:ListView.adoc#accessibilitylabel[accessibilityLabel]
* link:ListView.adoc#accessibilitylanguage[accessibilityLanguage]
* link:ListView.adoc#accessibilityliveregion[accessibilityLiveRegion]
* link:ListView.adoc#accessibilitymediasession[accessibilityMediaSession]
* link:ListView.adoc#accessibilityrole[accessibilityRole]
* link:ListView.adoc#accessibilitystate[accessibilityState]
* link:ListView.adoc#accessibilityvalue[accessibilityValue]
* link:ListView.adoc#accessible[accessible]
* link:ListView.adoc#alignself[alignSelf]
* link:ListView.adoc#android[android]
* link:ListView.adoc#androiddynamicelevationoffset[androidDynamicElevationOffset]
* link:ListView.adoc#androidelevation[androidElevation]
* link:ListView.adoc#automationtext[automationText]
* link:ListView.adoc#background[background]
* link:ListView.adoc#backgroundcolor[backgroundColor]
* link:ListView.adoc#backgroundimage[backgroundImage]
* link:ListView.adoc#bindingcontext[bindingContext]
* link:ListView.adoc#borderbottomcolor[borderBottomColor]
* link:ListView.adoc#borderbottomleftradius[borderBottomLeftRadius]
* link:ListView.adoc#borderbottomrightradius[borderBottomRightRadius]
* link:ListView.adoc#borderbottomwidth[borderBottomWidth]
* link:ListView.adoc#bordercolor[borderColor]
* link:ListView.adoc#borderleftcolor[borderLeftColor]
* link:ListView.adoc#borderleftwidth[borderLeftWidth]
* link:ListView.adoc#borderradius[borderRadius]
* link:ListView.adoc#borderrightcolor[borderRightColor]
* link:ListView.adoc#borderrightwidth[borderRightWidth]
* link:ListView.adoc#bordertopcolor[borderTopColor]
* link:ListView.adoc#bordertopleftradius[borderTopLeftRadius]
* link:ListView.adoc#bordertoprightradius[borderTopRightRadius]
* link:ListView.adoc#bordertopwidth[borderTopWidth]
* link:ListView.adoc#borderwidth[borderWidth]
* link:ListView.adoc#boxshadow[boxShadow]
* link:ListView.adoc#classname[className]
* link:ListView.adoc#col[col]
* link:ListView.adoc#colspan[colSpan]
* link:ListView.adoc#color[color]
* link:ListView.adoc#column[column]
* link:ListView.adoc#columnspan[columnSpan]
* link:ListView.adoc#css[css]
* link:ListView.adoc#cssclasses[cssClasses]
* link:ListView.adoc#csspseudoclasses[cssPseudoClasses]
* link:ListView.adoc#csstype[cssType]
* link:ListView.adoc#dock[dock]
* link:ListView.adoc#domnode[domNode]
* link:ListView.adoc#effectiveborderbottomwidth[effectiveBorderBottomWidth]
* link:ListView.adoc#effectiveborderleftwidth[effectiveBorderLeftWidth]
* link:ListView.adoc#effectiveborderrightwidth[effectiveBorderRightWidth]
* link:ListView.adoc#effectivebordertopwidth[effectiveBorderTopWidth]
* link:ListView.adoc#effectiveheight[effectiveHeight]
* link:ListView.adoc#effectiveleft[effectiveLeft]
* link:ListView.adoc#effectivemarginbottom[effectiveMarginBottom]
* link:ListView.adoc#effectivemarginleft[effectiveMarginLeft]
* link:ListView.adoc#effectivemarginright[effectiveMarginRight]
* link:ListView.adoc#effectivemargintop[effectiveMarginTop]
* link:ListView.adoc#effectiveminheight[effectiveMinHeight]
* link:ListView.adoc#effectiveminwidth[effectiveMinWidth]
* link:ListView.adoc#effectivepaddingbottom[effectivePaddingBottom]
* link:ListView.adoc#effectivepaddingleft[effectivePaddingLeft]
* link:ListView.adoc#effectivepaddingright[effectivePaddingRight]
* link:ListView.adoc#effectivepaddingtop[effectivePaddingTop]
* link:ListView.adoc#effectivetop[effectiveTop]
* link:ListView.adoc#effectivewidth[effectiveWidth]
* link:ListView.adoc#flexgrow[flexGrow]
* link:ListView.adoc#flexshrink[flexShrink]
* link:ListView.adoc#flexwrapbefore[flexWrapBefore]
* link:ListView.adoc#height[height]
* link:ListView.adoc#horizontalalignment[horizontalAlignment]
* link:ListView.adoc#id[id]
* link:ListView.adoc#ignoretouchanimation[ignoreTouchAnimation]
* link:ListView.adoc#ios[ios]
* link:ListView.adoc#iosestimatedrowheight[iosEstimatedRowHeight]
* link:ListView.adoc#iosignoresafearea[iosIgnoreSafeArea]
* link:ListView.adoc#iosoverflowsafearea[iosOverflowSafeArea]
* link:ListView.adoc#iosoverflowsafeareaenabled[iosOverflowSafeAreaEnabled]
* link:ListView.adoc#iscollapsed[isCollapsed]
* link:ListView.adoc#isenabled[isEnabled]
* link:ListView.adoc#islayoutrequired[isLayoutRequired]
* link:ListView.adoc#islayoutvalid[isLayoutValid]
* link:ListView.adoc#isuserinteractionenabled[isUserInteractionEnabled]
* link:ListView.adoc#itemidgenerator[itemIdGenerator]
* link:ListView.adoc#itemtemplate[itemTemplate]
* link:ListView.adoc#itemtemplateselector[itemTemplateSelector]
* link:ListView.adoc#itemtemplates[itemTemplates]
* link:ListView.adoc#items[items]
* link:ListView.adoc#left[left]
* link:ListView.adoc#margin[margin]
* link:ListView.adoc#marginbottom[marginBottom]
* link:ListView.adoc#marginleft[marginLeft]
* link:ListView.adoc#marginright[marginRight]
* link:ListView.adoc#margintop[marginTop]
* link:ListView.adoc#minheight[minHeight]
* link:ListView.adoc#minwidth[minWidth]
* link:ListView.adoc#modal[modal]
* link:ListView.adoc#nativeviewprotected[nativeViewProtected]
* link:ListView.adoc#opacity[opacity]
* link:ListView.adoc#order[order]
* link:ListView.adoc#originx[originX]
* link:ListView.adoc#originy[originY]
* link:ListView.adoc#parent[parent]
* link:ListView.adoc#perspective[perspective]
* link:ListView.adoc#recyclenativeview[recycleNativeView]
* link:ListView.adoc#reusable[reusable]
* link:ListView.adoc#rotate[rotate]
* link:ListView.adoc#rotatex[rotateX]
* link:ListView.adoc#rotatey[rotateY]
* link:ListView.adoc#row[row]
* link:ListView.adoc#rowheight[rowHeight]
* link:ListView.adoc#rowspan[rowSpan]
* link:ListView.adoc#scalex[scaleX]
* link:ListView.adoc#scaley[scaleY]
* link:ListView.adoc#separatorcolor[separatorColor]
* link:ListView.adoc#testid[testID]
* link:ListView.adoc#top[top]
* link:ListView.adoc#touchanimation[touchAnimation]
* link:ListView.adoc#touchdelay[touchDelay]
* link:ListView.adoc#translatex[translateX]
* link:ListView.adoc#translatey[translateY]
* link:ListView.adoc#verticalalignment[verticalAlignment]
* link:ListView.adoc#viewcontroller[viewController]
* link:ListView.adoc#visibility[visibility]
* link:ListView.adoc#width[width]
* link:ListView.adoc#accessibilityblurevent[accessibilityBlurEvent]
* link:ListView.adoc#accessibilityfocuschangedevent[accessibilityFocusChangedEvent]
* link:ListView.adoc#accessibilityfocusevent[accessibilityFocusEvent]
* link:ListView.adoc#accessibilityperformescapeevent[accessibilityPerformEscapeEvent]
* link:ListView.adoc#createdevent[createdEvent]
* link:ListView.adoc#disposenativeviewevent[disposeNativeViewEvent]
* link:ListView.adoc#itemloadingevent[itemLoadingEvent]
* link:ListView.adoc#itemtapevent[itemTapEvent]
* link:ListView.adoc#layoutchangedevent[layoutChangedEvent]
* link:ListView.adoc#loadmoreitemsevent[loadMoreItemsEvent]
* link:ListView.adoc#loadedevent[loadedEvent]
* link:ListView.adoc#propertychangeevent[propertyChangeEvent]
* link:ListView.adoc#showingmodallyevent[showingModallyEvent]
* link:ListView.adoc#shownmodallyevent[shownModallyEvent]
* link:ListView.adoc#unloadedevent[unloadedEvent]

=== Accessors

* link:ListView.adoc#backgroundposition[backgroundPosition]
* link:ListView.adoc#backgroundrepeat[backgroundRepeat]
* link:ListView.adoc#backgroundsize[backgroundSize]
* link:ListView.adoc#class[class]
* link:ListView.adoc#isloaded[isLoaded]
* link:ListView.adoc#nativeview[nativeView]
* link:ListView.adoc#page[page]
* link:ListView.adoc#parentnode[parentNode]
* link:ListView.adoc#style[style]
* link:ListView.adoc#texttransform[textTransform]
* link:ListView.adoc#typename[typeName]

=== Methods

* link:ListView.adoc#_addview[_addView]
* link:ListView.adoc#_addviewcore[_addViewCore]
* link:ListView.adoc#_addviewtonativevisualtree[_addViewToNativeVisualTree]
* link:ListView.adoc#_applybackground[_applyBackground]
* link:ListView.adoc#_applyxmlattribute[_applyXmlAttribute]
* link:ListView.adoc#_batchupdate[_batchUpdate]
* link:ListView.adoc#_childindextonativechildindex[_childIndexToNativeChildIndex]
* link:ListView.adoc#_closeallmodalviewsinternal[_closeAllModalViewsInternal]
* link:ListView.adoc#_createpropertychangedata[_createPropertyChangeData]
* link:ListView.adoc#_dialogclosed[_dialogClosed]
* link:ListView.adoc#_eachlayoutview[_eachLayoutView]
* link:ListView.adoc#_emit[_emit]
* link:ListView.adoc#_getcurrentlayoutbounds[_getCurrentLayoutBounds]
* link:ListView.adoc#_getfragmentmanager[_getFragmentManager]
* link:ListView.adoc#_getnativeviewscount[_getNativeViewsCount]
* link:ListView.adoc#_getrootmodalviews[_getRootModalViews]
* link:ListView.adoc#_getvalue[_getValue]
* link:ListView.adoc#_gotovisualstate[_goToVisualState]
* link:ListView.adoc#_handlelivesync[_handleLivesync]
* link:ListView.adoc#_hasancestorview[_hasAncestorView]
* link:ListView.adoc#_hidenativemodalview[_hideNativeModalView]
* link:ListView.adoc#_inheritstylescope[_inheritStyleScope]
* link:ListView.adoc#_layoutparent[_layoutParent]
* link:ListView.adoc#_observe[_observe]
* link:ListView.adoc#_onattachedtowindow[_onAttachedToWindow]
* link:ListView.adoc#_oncssstatechange[_onCssStateChange]
* link:ListView.adoc#_ondetachedfromwindow[_onDetachedFromWindow]
* link:ListView.adoc#_onlivesync[_onLivesync]
* link:ListView.adoc#_onrootviewreset[_onRootViewReset]
* link:ListView.adoc#_onsizechanged[_onSizeChanged]
* link:ListView.adoc#_parentchanged[_parentChanged]
* link:ListView.adoc#_raiselayoutchangedevent[_raiseLayoutChangedEvent]
* link:ListView.adoc#_raiseshowingmodallyevent[_raiseShowingModallyEvent]
* link:ListView.adoc#_raiseshownmodallyevent[_raiseShownModallyEvent]
* link:ListView.adoc#_redrawnativebackground[_redrawNativeBackground]
* link:ListView.adoc#_removeanimation[_removeAnimation]
* link:ListView.adoc#_removeview[_removeView]
* link:ListView.adoc#_removeviewcore[_removeViewCore]
* link:ListView.adoc#_removeviewfromnativevisualtree[_removeViewFromNativeVisualTree]
* link:ListView.adoc#_resumenativeupdates[_resumeNativeUpdates]
* link:ListView.adoc#_setcurrentlayoutbounds[_setCurrentLayoutBounds]
* link:ListView.adoc#_setcurrentmeasurespecs[_setCurrentMeasureSpecs]
* link:ListView.adoc#_setminheightnative[_setMinHeightNative]
* link:ListView.adoc#_setminwidthnative[_setMinWidthNative]
* link:ListView.adoc#_setnativecliptobounds[_setNativeClipToBounds]
* link:ListView.adoc#_setnativeviewframe[_setNativeViewFrame]
* link:ListView.adoc#_setvalue[_setValue]
* link:ListView.adoc#_setupasrootview[_setupAsRootView]
* link:ListView.adoc#_setupui[_setupUI]
* link:ListView.adoc#_shoulddelaylayout[_shouldDelayLayout]
* link:ListView.adoc#_shownativemodalview[_showNativeModalView]
* link:ListView.adoc#_suspendnativeupdates[_suspendNativeUpdates]
* link:ListView.adoc#_teardownui[_tearDownUI]
* link:ListView.adoc#_updateeffectivelayoutvalues[_updateEffectiveLayoutValues]
* link:ListView.adoc#_updatestylescope[_updateStyleScope]
* link:ListView.adoc#accessibilityannouncement[accessibilityAnnouncement]
* link:ListView.adoc#accessibilityscreenchanged[accessibilityScreenChanged]
* link:ListView.adoc#addcss[addCss]
* link:ListView.adoc#addcssfile[addCssFile]
* link:ListView.adoc#addeventlistener[addEventListener]
* link:ListView.adoc#addpseudoclass[addPseudoClass]
* link:ListView.adoc#animate[animate]
* link:ListView.adoc#bind[bind]
* link:ListView.adoc#callloaded[callLoaded]
* link:ListView.adoc#callunloaded[callUnloaded]
* link:ListView.adoc#changecssfile[changeCssFile]
* link:ListView.adoc#closemodal[closeModal]
* link:ListView.adoc#createanimation[createAnimation]
* link:ListView.adoc#createnativeview[createNativeView]
* link:ListView.adoc#deletepseudoclass[deletePseudoClass]
* link:ListView.adoc#destroynode[destroyNode]
* link:ListView.adoc#disposenativeview[disposeNativeView]
* link:ListView.adoc#eachchild[eachChild]
* link:ListView.adoc#eachchildview[eachChildView]
* link:ListView.adoc#ensuredomnode[ensureDomNode]
* link:ListView.adoc#focus[focus]
* link:ListView.adoc#get[get]
* link:ListView.adoc#getactualsize[getActualSize]
* link:ListView.adoc#getgestureobservers[getGestureObservers]
* link:ListView.adoc#getlocationinwindow[getLocationInWindow]
* link:ListView.adoc#getlocationonscreen[getLocationOnScreen]
* link:ListView.adoc#getlocationrelativeto[getLocationRelativeTo]
* link:ListView.adoc#getmeasuredheight[getMeasuredHeight]
* link:ListView.adoc#getmeasuredstate[getMeasuredState]
* link:ListView.adoc#getmeasuredwidth[getMeasuredWidth]
* link:ListView.adoc#getsafeareainsets[getSafeAreaInsets]
* link:ListView.adoc#getviewbydomid[getViewByDomId]
* link:ListView.adoc#getviewbyid[getViewById]
* link:ListView.adoc#hasgestureobservers[hasGestureObservers]
* link:ListView.adoc#haslisteners[hasListeners]
* link:ListView.adoc#initnativeview[initNativeView]
* link:ListView.adoc#isitematindexvisible[isItemAtIndexVisible]
* link:ListView.adoc#layout[layout]
* link:ListView.adoc#layoutnativeview[layoutNativeView]
* link:ListView.adoc#loadview[loadView]
* link:ListView.adoc#measure[measure]
* link:ListView.adoc#notify[notify]
* link:ListView.adoc#notifypropertychange[notifyPropertyChange]
* link:ListView.adoc#off[off]
* link:ListView.adoc#on[on]
* link:ListView.adoc#onbackpressed[onBackPressed]
* link:ListView.adoc#onlayout[onLayout]
* link:ListView.adoc#onloaded[onLoaded]
* link:ListView.adoc#onmeasure[onMeasure]
* link:ListView.adoc#onresumenativeupdates[onResumeNativeUpdates]
* link:ListView.adoc#onunloaded[onUnloaded]
* link:ListView.adoc#once[once]
* link:ListView.adoc#refresh[refresh]
* link:ListView.adoc#removeeventlistener[removeEventListener]
* link:ListView.adoc#requestlayout[requestLayout]
* link:ListView.adoc#resetnativeview[resetNativeView]
* link:ListView.adoc#scrolltoindex[scrollToIndex]
* link:ListView.adoc#scrolltoindexanimated[scrollToIndexAnimated]
* link:ListView.adoc#sendaccessibilityevent[sendAccessibilityEvent]
* link:ListView.adoc#set[set]
* link:ListView.adoc#setinlinestyle[setInlineStyle]
* link:ListView.adoc#setmeasureddimension[setMeasuredDimension]
* link:ListView.adoc#setnativeview[setNativeView]
* link:ListView.adoc#setontouchlistener[setOnTouchListener]
* link:ListView.adoc#setproperty[setProperty]
* link:ListView.adoc#settestid[setTestID]
* link:ListView.adoc#showmodal[showModal]
* link:ListView.adoc#tostring[toString]
* link:ListView.adoc#unbind[unbind]
* link:ListView.adoc#unloadview[unloadView]
* link:ListView.adoc#addeventlistener-1[addEventListener]
* link:ListView.adoc#combinemeasuredstates[combineMeasuredStates]
* link:ListView.adoc#layoutchild[layoutChild]
* link:ListView.adoc#measurechild[measureChild]
* link:ListView.adoc#off-1[off]
* link:ListView.adoc#on-1[on]
* link:ListView.adoc#once-1[once]
* link:ListView.adoc#removeeventlistener-1[removeEventListener]
* link:ListView.adoc#resolvesizeandstate[resolveSizeAndState]
...
Gets the native http://developer.android.com/reference/android/widget/ListView.html[android widget] that represents the user interface for this component.
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/list-view/index.d.ts#L29[ui/list-view/index.d.ts:29]
...
Gets the native https://developer.apple.com/library/ios/documentation/UIKit/Reference/UITableView_Class/[iOS view] that represents the user interface for this component.
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/list-view/index.d.ts#L34[ui/list-view/index.d.ts:34]
...
• *iosEstimatedRowHeight*: link:../modules/CoreTypes.adoc#lengthtype[`LengthType`]

Gets or set the estimated height of rows in the ListView.
The default value is 44px.

==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/list-view/index.d.ts#L76[ui/list-view/index.d.ts:76]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/list-view/index.d.ts#L60[ui/list-view/index.d.ts:60]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/list-view/index.d.ts#L45[ui/list-view/index.d.ts:45]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/list-view/index.d.ts#L55[ui/list-view/index.d.ts:55]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/list-view/index.d.ts#L50[ui/list-view/index.d.ts:50]
...
• *items*: `any`[] | xref:../interfaces/ItemsSource.adoc[`ItemsSource`]

Gets or set the items collection of the ListView.
The items property can be set to an array or an object defining length and getItem(index) method.

==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/list-view/index.d.ts#L40[ui/list-view/index.d.ts:40]
...
• *rowHeight*: link:../modules/CoreTypes.adoc#lengthtype[`LengthType`]

Gets or set row height of the ListView.

==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/list-view/index.d.ts#L70[ui/list-view/index.d.ts:70]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/list-view/index.d.ts#L65[ui/list-view/index.d.ts:65]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/list-view/index.d.ts#L16[ui/list-view/index.d.ts:16]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/list-view/index.d.ts#L20[ui/list-view/index.d.ts:20]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/list-view/index.d.ts#L24[ui/list-view/index.d.ts:24]
...
▸ *isItemAtIndexVisible*(`index`): `boolean`
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/list-view/index.d.ts#L103[ui/list-view/index.d.ts:103]
...
xref:View.adoc[View].link:View.adoc#on[on]

==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/list-view/index.d.ts#L111[ui/list-view/index.d.ts:111]
...
Note, that the view property of the event data can be pre-initialized with an old instance of a view, so that it can be reused.
...
| `callback`
| (`args`: xref:../interfaces/ItemEventData.adoc[`ItemEventData`]) \=> `void`
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/list-view/index.d.ts#L119[ui/list-view/index.d.ts:119]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/list-view/index.d.ts#L124[ui/list-view/index.d.ts:124]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/list-view/index.d.ts#L129[ui/list-view/index.d.ts:129]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/list-view/index.d.ts#L81[ui/list-view/index.d.ts:81]
...
https://developer.apple.com/library/prerelease/ios/documentation/UIKit/Reference/UITableView_Class/#//apple_ref/occ/instm/UITableView/scrollToRowAtIndexPath:atScrollPosition:animated:[iOS] http://developer.android.com/reference/android/widget/ListView.html#setSelection(int)[Android]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/list-view/index.d.ts#L89[ui/list-view/index.d.ts:89]
...
▸ *scrollToIndexAnimated*(`index`): `any`

Scrolls the specified item with index into view with animation.
https://developer.apple.com/library/prerelease/ios/documentation/UIKit/Reference/UITableView_Class/#//apple_ref/occ/instm/UITableView/scrollToRowAtIndexPath:atScrollPosition:animated:[iOS] https://developer.android.com/reference/android/widget/ListView.html#smoothScrollToPosition(int)[Android]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/list-view/index.d.ts#L97[ui/list-view/index.d.ts:97]
