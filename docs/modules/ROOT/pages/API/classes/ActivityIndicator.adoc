...
xref:../README.adoc[NativeScript] / xref:../modules.adoc[Exports] / ActivityIndicator
...
* link:ActivityIndicator.adoc#constructor[constructor]

=== Properties

* link:ActivityIndicator.adoc#_androidcontentdescriptionupdated[_androidContentDescriptionUpdated]
* link:ActivityIndicator.adoc#_automaticallyadjustsscrollviewinsets[_automaticallyAdjustsScrollViewInsets]
* link:ActivityIndicator.adoc#_closemodalcallback[_closeModalCallback]
* link:ActivityIndicator.adoc#_context[_context]
* link:ActivityIndicator.adoc#_cssstate[_cssState]
* link:ActivityIndicator.adoc#_currentheightmeasurespec[_currentHeightMeasureSpec]
* link:ActivityIndicator.adoc#_currentwidthmeasurespec[_currentWidthMeasureSpec]
* link:ActivityIndicator.adoc#_defaultpaddingbottom[_defaultPaddingBottom]
* link:ActivityIndicator.adoc#_defaultpaddingleft[_defaultPaddingLeft]
* link:ActivityIndicator.adoc#_defaultpaddingright[_defaultPaddingRight]
* link:ActivityIndicator.adoc#_defaultpaddingtop[_defaultPaddingTop]
* link:ActivityIndicator.adoc#_domid[_domId]
* link:ActivityIndicator.adoc#_gestureobservers[_gestureObservers]
* link:ActivityIndicator.adoc#_ignoreflexminwidthheightreset[_ignoreFlexMinWidthHeightReset]
* link:ActivityIndicator.adoc#_isaddedtonativevisualtree[_isAddedToNativeVisualTree]
* link:ActivityIndicator.adoc#_islayoutvalid[_isLayoutValid]
* link:ActivityIndicator.adoc#_ispaddingrelative[_isPaddingRelative]
* link:ActivityIndicator.adoc#_isstylescopehost[_isStyleScopeHost]
* link:ActivityIndicator.adoc#_isviewbase[_isViewBase]
* link:ActivityIndicator.adoc#_manager[_manager]
* link:ActivityIndicator.adoc#_modalparent[_modalParent]
* link:ActivityIndicator.adoc#_modulename[_moduleName]
* link:ActivityIndicator.adoc#_oldbottom[_oldBottom]
* link:ActivityIndicator.adoc#_oldleft[_oldLeft]
* link:ActivityIndicator.adoc#_oldright[_oldRight]
* link:ActivityIndicator.adoc#_oldtop[_oldTop]
* link:ActivityIndicator.adoc#_stylescope[_styleScope]
* link:ActivityIndicator.adoc#_suspendnativeupdatescount[_suspendNativeUpdatesCount]
* link:ActivityIndicator.adoc#_suspendedupdates[_suspendedUpdates]
* link:ActivityIndicator.adoc#accessibilityhidden[accessibilityHidden]
* link:ActivityIndicator.adoc#accessibilityhint[accessibilityHint]
* link:ActivityIndicator.adoc#accessibilityidentifier[accessibilityIdentifier]
* link:ActivityIndicator.adoc#accessibilitylabel[accessibilityLabel]
* link:ActivityIndicator.adoc#accessibilitylanguage[accessibilityLanguage]
* link:ActivityIndicator.adoc#accessibilityliveregion[accessibilityLiveRegion]
* link:ActivityIndicator.adoc#accessibilitymediasession[accessibilityMediaSession]
* link:ActivityIndicator.adoc#accessibilityrole[accessibilityRole]
* link:ActivityIndicator.adoc#accessibilitystate[accessibilityState]
* link:ActivityIndicator.adoc#accessibilityvalue[accessibilityValue]
* link:ActivityIndicator.adoc#accessible[accessible]
* link:ActivityIndicator.adoc#alignself[alignSelf]
* link:ActivityIndicator.adoc#android[android]
* link:ActivityIndicator.adoc#androiddynamicelevationoffset[androidDynamicElevationOffset]
* link:ActivityIndicator.adoc#androidelevation[androidElevation]
* link:ActivityIndicator.adoc#automationtext[automationText]
* link:ActivityIndicator.adoc#background[background]
* link:ActivityIndicator.adoc#backgroundcolor[backgroundColor]
* link:ActivityIndicator.adoc#backgroundimage[backgroundImage]
* link:ActivityIndicator.adoc#bindingcontext[bindingContext]
* link:ActivityIndicator.adoc#borderbottomcolor[borderBottomColor]
* link:ActivityIndicator.adoc#borderbottomleftradius[borderBottomLeftRadius]
* link:ActivityIndicator.adoc#borderbottomrightradius[borderBottomRightRadius]
* link:ActivityIndicator.adoc#borderbottomwidth[borderBottomWidth]
* link:ActivityIndicator.adoc#bordercolor[borderColor]
* link:ActivityIndicator.adoc#borderleftcolor[borderLeftColor]
* link:ActivityIndicator.adoc#borderleftwidth[borderLeftWidth]
* link:ActivityIndicator.adoc#borderradius[borderRadius]
* link:ActivityIndicator.adoc#borderrightcolor[borderRightColor]
* link:ActivityIndicator.adoc#borderrightwidth[borderRightWidth]
* link:ActivityIndicator.adoc#bordertopcolor[borderTopColor]
* link:ActivityIndicator.adoc#bordertopleftradius[borderTopLeftRadius]
* link:ActivityIndicator.adoc#bordertoprightradius[borderTopRightRadius]
* link:ActivityIndicator.adoc#bordertopwidth[borderTopWidth]
* link:ActivityIndicator.adoc#borderwidth[borderWidth]
* link:ActivityIndicator.adoc#boxshadow[boxShadow]
* link:ActivityIndicator.adoc#busy[busy]
* link:ActivityIndicator.adoc#classname[className]
* link:ActivityIndicator.adoc#col[col]
* link:ActivityIndicator.adoc#colspan[colSpan]
* link:ActivityIndicator.adoc#color[color]
* link:ActivityIndicator.adoc#column[column]
* link:ActivityIndicator.adoc#columnspan[columnSpan]
* link:ActivityIndicator.adoc#css[css]
* link:ActivityIndicator.adoc#cssclasses[cssClasses]
* link:ActivityIndicator.adoc#csspseudoclasses[cssPseudoClasses]
* link:ActivityIndicator.adoc#csstype[cssType]
* link:ActivityIndicator.adoc#dock[dock]
* link:ActivityIndicator.adoc#domnode[domNode]
* link:ActivityIndicator.adoc#effectiveborderbottomwidth[effectiveBorderBottomWidth]
* link:ActivityIndicator.adoc#effectiveborderleftwidth[effectiveBorderLeftWidth]
* link:ActivityIndicator.adoc#effectiveborderrightwidth[effectiveBorderRightWidth]
* link:ActivityIndicator.adoc#effectivebordertopwidth[effectiveBorderTopWidth]
* link:ActivityIndicator.adoc#effectiveheight[effectiveHeight]
* link:ActivityIndicator.adoc#effectiveleft[effectiveLeft]
* link:ActivityIndicator.adoc#effectivemarginbottom[effectiveMarginBottom]
* link:ActivityIndicator.adoc#effectivemarginleft[effectiveMarginLeft]
* link:ActivityIndicator.adoc#effectivemarginright[effectiveMarginRight]
* link:ActivityIndicator.adoc#effectivemargintop[effectiveMarginTop]
* link:ActivityIndicator.adoc#effectiveminheight[effectiveMinHeight]
* link:ActivityIndicator.adoc#effectiveminwidth[effectiveMinWidth]
* link:ActivityIndicator.adoc#effectivepaddingbottom[effectivePaddingBottom]
* link:ActivityIndicator.adoc#effectivepaddingleft[effectivePaddingLeft]
* link:ActivityIndicator.adoc#effectivepaddingright[effectivePaddingRight]
* link:ActivityIndicator.adoc#effectivepaddingtop[effectivePaddingTop]
* link:ActivityIndicator.adoc#effectivetop[effectiveTop]
* link:ActivityIndicator.adoc#effectivewidth[effectiveWidth]
* link:ActivityIndicator.adoc#flexgrow[flexGrow]
* link:ActivityIndicator.adoc#flexshrink[flexShrink]
* link:ActivityIndicator.adoc#flexwrapbefore[flexWrapBefore]
* link:ActivityIndicator.adoc#height[height]
* link:ActivityIndicator.adoc#horizontalalignment[horizontalAlignment]
* link:ActivityIndicator.adoc#id[id]
* link:ActivityIndicator.adoc#ignoretouchanimation[ignoreTouchAnimation]
* link:ActivityIndicator.adoc#ios[ios]
* link:ActivityIndicator.adoc#iosignoresafearea[iosIgnoreSafeArea]
* link:ActivityIndicator.adoc#iosoverflowsafearea[iosOverflowSafeArea]
* link:ActivityIndicator.adoc#iosoverflowsafeareaenabled[iosOverflowSafeAreaEnabled]
* link:ActivityIndicator.adoc#iscollapsed[isCollapsed]
* link:ActivityIndicator.adoc#isenabled[isEnabled]
* link:ActivityIndicator.adoc#islayoutrequired[isLayoutRequired]
* link:ActivityIndicator.adoc#islayoutvalid[isLayoutValid]
* link:ActivityIndicator.adoc#isuserinteractionenabled[isUserInteractionEnabled]
* link:ActivityIndicator.adoc#left[left]
* link:ActivityIndicator.adoc#margin[margin]
* link:ActivityIndicator.adoc#marginbottom[marginBottom]
* link:ActivityIndicator.adoc#marginleft[marginLeft]
* link:ActivityIndicator.adoc#marginright[marginRight]
* link:ActivityIndicator.adoc#margintop[marginTop]
* link:ActivityIndicator.adoc#minheight[minHeight]
* link:ActivityIndicator.adoc#minwidth[minWidth]
* link:ActivityIndicator.adoc#modal[modal]
* link:ActivityIndicator.adoc#nativeviewprotected[nativeViewProtected]
* link:ActivityIndicator.adoc#opacity[opacity]
* link:ActivityIndicator.adoc#order[order]
* link:ActivityIndicator.adoc#originx[originX]
* link:ActivityIndicator.adoc#originy[originY]
* link:ActivityIndicator.adoc#parent[parent]
* link:ActivityIndicator.adoc#perspective[perspective]
* link:ActivityIndicator.adoc#recyclenativeview[recycleNativeView]
* link:ActivityIndicator.adoc#reusable[reusable]
* link:ActivityIndicator.adoc#rotate[rotate]
* link:ActivityIndicator.adoc#rotatex[rotateX]
* link:ActivityIndicator.adoc#rotatey[rotateY]
* link:ActivityIndicator.adoc#row[row]
* link:ActivityIndicator.adoc#rowspan[rowSpan]
* link:ActivityIndicator.adoc#scalex[scaleX]
* link:ActivityIndicator.adoc#scaley[scaleY]
* link:ActivityIndicator.adoc#testid[testID]
* link:ActivityIndicator.adoc#top[top]
* link:ActivityIndicator.adoc#touchanimation[touchAnimation]
* link:ActivityIndicator.adoc#touchdelay[touchDelay]
* link:ActivityIndicator.adoc#translatex[translateX]
* link:ActivityIndicator.adoc#translatey[translateY]
* link:ActivityIndicator.adoc#verticalalignment[verticalAlignment]
* link:ActivityIndicator.adoc#viewcontroller[viewController]
* link:ActivityIndicator.adoc#visibility[visibility]
* link:ActivityIndicator.adoc#width[width]
* link:ActivityIndicator.adoc#accessibilityblurevent[accessibilityBlurEvent]
* link:ActivityIndicator.adoc#accessibilityfocuschangedevent[accessibilityFocusChangedEvent]
* link:ActivityIndicator.adoc#accessibilityfocusevent[accessibilityFocusEvent]
* link:ActivityIndicator.adoc#accessibilityperformescapeevent[accessibilityPerformEscapeEvent]
* link:ActivityIndicator.adoc#createdevent[createdEvent]
* link:ActivityIndicator.adoc#disposenativeviewevent[disposeNativeViewEvent]
* link:ActivityIndicator.adoc#layoutchangedevent[layoutChangedEvent]
* link:ActivityIndicator.adoc#loadedevent[loadedEvent]
* link:ActivityIndicator.adoc#propertychangeevent[propertyChangeEvent]
* link:ActivityIndicator.adoc#showingmodallyevent[showingModallyEvent]
* link:ActivityIndicator.adoc#shownmodallyevent[shownModallyEvent]
* link:ActivityIndicator.adoc#unloadedevent[unloadedEvent]

=== Accessors

* link:ActivityIndicator.adoc#backgroundposition[backgroundPosition]
* link:ActivityIndicator.adoc#backgroundrepeat[backgroundRepeat]
* link:ActivityIndicator.adoc#backgroundsize[backgroundSize]
* link:ActivityIndicator.adoc#class[class]
* link:ActivityIndicator.adoc#isloaded[isLoaded]
* link:ActivityIndicator.adoc#nativeview[nativeView]
* link:ActivityIndicator.adoc#page[page]
* link:ActivityIndicator.adoc#parentnode[parentNode]
* link:ActivityIndicator.adoc#style[style]
* link:ActivityIndicator.adoc#texttransform[textTransform]
* link:ActivityIndicator.adoc#typename[typeName]

=== Methods

* link:ActivityIndicator.adoc#_addview[_addView]
* link:ActivityIndicator.adoc#_addviewcore[_addViewCore]
* link:ActivityIndicator.adoc#_addviewtonativevisualtree[_addViewToNativeVisualTree]
* link:ActivityIndicator.adoc#_applybackground[_applyBackground]
* link:ActivityIndicator.adoc#_applyxmlattribute[_applyXmlAttribute]
* link:ActivityIndicator.adoc#_batchupdate[_batchUpdate]
* link:ActivityIndicator.adoc#_childindextonativechildindex[_childIndexToNativeChildIndex]
* link:ActivityIndicator.adoc#_closeallmodalviewsinternal[_closeAllModalViewsInternal]
* link:ActivityIndicator.adoc#_createpropertychangedata[_createPropertyChangeData]
* link:ActivityIndicator.adoc#_dialogclosed[_dialogClosed]
* link:ActivityIndicator.adoc#_eachlayoutview[_eachLayoutView]
* link:ActivityIndicator.adoc#_emit[_emit]
* link:ActivityIndicator.adoc#_getcurrentlayoutbounds[_getCurrentLayoutBounds]
* link:ActivityIndicator.adoc#_getfragmentmanager[_getFragmentManager]
* link:ActivityIndicator.adoc#_getnativeviewscount[_getNativeViewsCount]
* link:ActivityIndicator.adoc#_getrootmodalviews[_getRootModalViews]
* link:ActivityIndicator.adoc#_getvalue[_getValue]
* link:ActivityIndicator.adoc#_gotovisualstate[_goToVisualState]
* link:ActivityIndicator.adoc#_handlelivesync[_handleLivesync]
* link:ActivityIndicator.adoc#_hasancestorview[_hasAncestorView]
* link:ActivityIndicator.adoc#_hidenativemodalview[_hideNativeModalView]
* link:ActivityIndicator.adoc#_inheritstylescope[_inheritStyleScope]
* link:ActivityIndicator.adoc#_layoutparent[_layoutParent]
* link:ActivityIndicator.adoc#_observe[_observe]
* link:ActivityIndicator.adoc#_onattachedtowindow[_onAttachedToWindow]
* link:ActivityIndicator.adoc#_oncssstatechange[_onCssStateChange]
* link:ActivityIndicator.adoc#_ondetachedfromwindow[_onDetachedFromWindow]
* link:ActivityIndicator.adoc#_onlivesync[_onLivesync]
* link:ActivityIndicator.adoc#_onrootviewreset[_onRootViewReset]
* link:ActivityIndicator.adoc#_onsizechanged[_onSizeChanged]
* link:ActivityIndicator.adoc#_parentchanged[_parentChanged]
* link:ActivityIndicator.adoc#_raiselayoutchangedevent[_raiseLayoutChangedEvent]
* link:ActivityIndicator.adoc#_raiseshowingmodallyevent[_raiseShowingModallyEvent]
* link:ActivityIndicator.adoc#_raiseshownmodallyevent[_raiseShownModallyEvent]
* link:ActivityIndicator.adoc#_redrawnativebackground[_redrawNativeBackground]
* link:ActivityIndicator.adoc#_removeanimation[_removeAnimation]
* link:ActivityIndicator.adoc#_removeview[_removeView]
* link:ActivityIndicator.adoc#_removeviewcore[_removeViewCore]
* link:ActivityIndicator.adoc#_removeviewfromnativevisualtree[_removeViewFromNativeVisualTree]
* link:ActivityIndicator.adoc#_resumenativeupdates[_resumeNativeUpdates]
* link:ActivityIndicator.adoc#_setcurrentlayoutbounds[_setCurrentLayoutBounds]
* link:ActivityIndicator.adoc#_setcurrentmeasurespecs[_setCurrentMeasureSpecs]
* link:ActivityIndicator.adoc#_setminheightnative[_setMinHeightNative]
* link:ActivityIndicator.adoc#_setminwidthnative[_setMinWidthNative]
* link:ActivityIndicator.adoc#_setnativecliptobounds[_setNativeClipToBounds]
* link:ActivityIndicator.adoc#_setnativeviewframe[_setNativeViewFrame]
* link:ActivityIndicator.adoc#_setvalue[_setValue]
* link:ActivityIndicator.adoc#_setupasrootview[_setupAsRootView]
* link:ActivityIndicator.adoc#_setupui[_setupUI]
* link:ActivityIndicator.adoc#_shoulddelaylayout[_shouldDelayLayout]
* link:ActivityIndicator.adoc#_shownativemodalview[_showNativeModalView]
* link:ActivityIndicator.adoc#_suspendnativeupdates[_suspendNativeUpdates]
* link:ActivityIndicator.adoc#_teardownui[_tearDownUI]
* link:ActivityIndicator.adoc#_updateeffectivelayoutvalues[_updateEffectiveLayoutValues]
* link:ActivityIndicator.adoc#_updatestylescope[_updateStyleScope]
* link:ActivityIndicator.adoc#accessibilityannouncement[accessibilityAnnouncement]
* link:ActivityIndicator.adoc#accessibilityscreenchanged[accessibilityScreenChanged]
* link:ActivityIndicator.adoc#addcss[addCss]
* link:ActivityIndicator.adoc#addcssfile[addCssFile]
* link:ActivityIndicator.adoc#addeventlistener[addEventListener]
* link:ActivityIndicator.adoc#addpseudoclass[addPseudoClass]
* link:ActivityIndicator.adoc#animate[animate]
* link:ActivityIndicator.adoc#bind[bind]
* link:ActivityIndicator.adoc#callloaded[callLoaded]
* link:ActivityIndicator.adoc#callunloaded[callUnloaded]
* link:ActivityIndicator.adoc#changecssfile[changeCssFile]
* link:ActivityIndicator.adoc#closemodal[closeModal]
* link:ActivityIndicator.adoc#createanimation[createAnimation]
* link:ActivityIndicator.adoc#createnativeview[createNativeView]
* link:ActivityIndicator.adoc#deletepseudoclass[deletePseudoClass]
* link:ActivityIndicator.adoc#destroynode[destroyNode]
* link:ActivityIndicator.adoc#disposenativeview[disposeNativeView]
* link:ActivityIndicator.adoc#eachchild[eachChild]
* link:ActivityIndicator.adoc#eachchildview[eachChildView]
* link:ActivityIndicator.adoc#ensuredomnode[ensureDomNode]
* link:ActivityIndicator.adoc#focus[focus]
* link:ActivityIndicator.adoc#get[get]
* link:ActivityIndicator.adoc#getactualsize[getActualSize]
* link:ActivityIndicator.adoc#getgestureobservers[getGestureObservers]
* link:ActivityIndicator.adoc#getlocationinwindow[getLocationInWindow]
* link:ActivityIndicator.adoc#getlocationonscreen[getLocationOnScreen]
* link:ActivityIndicator.adoc#getlocationrelativeto[getLocationRelativeTo]
* link:ActivityIndicator.adoc#getmeasuredheight[getMeasuredHeight]
* link:ActivityIndicator.adoc#getmeasuredstate[getMeasuredState]
* link:ActivityIndicator.adoc#getmeasuredwidth[getMeasuredWidth]
* link:ActivityIndicator.adoc#getsafeareainsets[getSafeAreaInsets]
* link:ActivityIndicator.adoc#getviewbydomid[getViewByDomId]
* link:ActivityIndicator.adoc#getviewbyid[getViewById]
* link:ActivityIndicator.adoc#hasgestureobservers[hasGestureObservers]
* link:ActivityIndicator.adoc#haslisteners[hasListeners]
* link:ActivityIndicator.adoc#initnativeview[initNativeView]
* link:ActivityIndicator.adoc#layout[layout]
* link:ActivityIndicator.adoc#layoutnativeview[layoutNativeView]
* link:ActivityIndicator.adoc#loadview[loadView]
* link:ActivityIndicator.adoc#measure[measure]
* link:ActivityIndicator.adoc#notify[notify]
* link:ActivityIndicator.adoc#notifypropertychange[notifyPropertyChange]
* link:ActivityIndicator.adoc#off[off]
* link:ActivityIndicator.adoc#on[on]
* link:ActivityIndicator.adoc#onbackpressed[onBackPressed]
* link:ActivityIndicator.adoc#onlayout[onLayout]
* link:ActivityIndicator.adoc#onloaded[onLoaded]
* link:ActivityIndicator.adoc#onmeasure[onMeasure]
* link:ActivityIndicator.adoc#onresumenativeupdates[onResumeNativeUpdates]
* link:ActivityIndicator.adoc#onunloaded[onUnloaded]
* link:ActivityIndicator.adoc#once[once]
* link:ActivityIndicator.adoc#removeeventlistener[removeEventListener]
* link:ActivityIndicator.adoc#requestlayout[requestLayout]
* link:ActivityIndicator.adoc#resetnativeview[resetNativeView]
* link:ActivityIndicator.adoc#sendaccessibilityevent[sendAccessibilityEvent]
* link:ActivityIndicator.adoc#set[set]
* link:ActivityIndicator.adoc#setinlinestyle[setInlineStyle]
* link:ActivityIndicator.adoc#setmeasureddimension[setMeasuredDimension]
* link:ActivityIndicator.adoc#setnativeview[setNativeView]
* link:ActivityIndicator.adoc#setontouchlistener[setOnTouchListener]
* link:ActivityIndicator.adoc#setproperty[setProperty]
* link:ActivityIndicator.adoc#settestid[setTestID]
* link:ActivityIndicator.adoc#showmodal[showModal]
* link:ActivityIndicator.adoc#tostring[toString]
* link:ActivityIndicator.adoc#unbind[unbind]
* link:ActivityIndicator.adoc#unloadview[unloadView]
* link:ActivityIndicator.adoc#addeventlistener-1[addEventListener]
* link:ActivityIndicator.adoc#combinemeasuredstates[combineMeasuredStates]
* link:ActivityIndicator.adoc#layoutchild[layoutChild]
* link:ActivityIndicator.adoc#measurechild[measureChild]
* link:ActivityIndicator.adoc#off-1[off]
* link:ActivityIndicator.adoc#on-1[on]
* link:ActivityIndicator.adoc#once-1[once]
* link:ActivityIndicator.adoc#removeeventlistener-1[removeEventListener]
* link:ActivityIndicator.adoc#resolvesizeandstate[resolveSizeAndState]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/activity-indicator/index.d.ts#L10[ui/activity-indicator/index.d.ts:10]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/activity-indicator/index.d.ts#L20[ui/activity-indicator/index.d.ts:20]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/activity-indicator/index.d.ts#L15[ui/activity-indicator/index.d.ts:15]
