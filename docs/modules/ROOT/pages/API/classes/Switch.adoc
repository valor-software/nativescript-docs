...
xref:../README.adoc[NativeScript] / xref:../modules.adoc[Exports] / Switch
...
* link:Switch.md#constructor[constructor]

=== Properties

* link:Switch.md#_androidcontentdescriptionupdated[_androidContentDescriptionUpdated]
* link:Switch.md#_automaticallyadjustsscrollviewinsets[_automaticallyAdjustsScrollViewInsets]
* link:Switch.md#_closemodalcallback[_closeModalCallback]
* link:Switch.md#_context[_context]
* link:Switch.md#_cssstate[_cssState]
* link:Switch.md#_currentheightmeasurespec[_currentHeightMeasureSpec]
* link:Switch.md#_currentwidthmeasurespec[_currentWidthMeasureSpec]
* link:Switch.md#_defaultpaddingbottom[_defaultPaddingBottom]
* link:Switch.md#_defaultpaddingleft[_defaultPaddingLeft]
* link:Switch.md#_defaultpaddingright[_defaultPaddingRight]
* link:Switch.md#_defaultpaddingtop[_defaultPaddingTop]
* link:Switch.md#_domid[_domId]
* link:Switch.md#_gestureobservers[_gestureObservers]
* link:Switch.md#_ignoreflexminwidthheightreset[_ignoreFlexMinWidthHeightReset]
* link:Switch.md#_isaddedtonativevisualtree[_isAddedToNativeVisualTree]
* link:Switch.md#_islayoutvalid[_isLayoutValid]
* link:Switch.md#_ispaddingrelative[_isPaddingRelative]
* link:Switch.md#_isstylescopehost[_isStyleScopeHost]
* link:Switch.md#_isviewbase[_isViewBase]
* link:Switch.md#_manager[_manager]
* link:Switch.md#_modalparent[_modalParent]
* link:Switch.md#_modulename[_moduleName]
* link:Switch.md#_oldbottom[_oldBottom]
* link:Switch.md#_oldleft[_oldLeft]
* link:Switch.md#_oldright[_oldRight]
* link:Switch.md#_oldtop[_oldTop]
* link:Switch.md#_stylescope[_styleScope]
* link:Switch.md#_suspendnativeupdatescount[_suspendNativeUpdatesCount]
* link:Switch.md#_suspendedupdates[_suspendedUpdates]
* link:Switch.md#accessibilityhidden[accessibilityHidden]
* link:Switch.md#accessibilityhint[accessibilityHint]
* link:Switch.md#accessibilityidentifier[accessibilityIdentifier]
* link:Switch.md#accessibilitylabel[accessibilityLabel]
* link:Switch.md#accessibilitylanguage[accessibilityLanguage]
* link:Switch.md#accessibilityliveregion[accessibilityLiveRegion]
* link:Switch.md#accessibilitymediasession[accessibilityMediaSession]
* link:Switch.md#accessibilityrole[accessibilityRole]
* link:Switch.md#accessibilitystate[accessibilityState]
* link:Switch.md#accessibilityvalue[accessibilityValue]
* link:Switch.md#accessible[accessible]
* link:Switch.md#alignself[alignSelf]
* link:Switch.md#android[android]
* link:Switch.md#androiddynamicelevationoffset[androidDynamicElevationOffset]
* link:Switch.md#androidelevation[androidElevation]
* link:Switch.md#automationtext[automationText]
* link:Switch.md#background[background]
* link:Switch.md#backgroundcolor[backgroundColor]
* link:Switch.md#backgroundimage[backgroundImage]
* link:Switch.md#bindingcontext[bindingContext]
* link:Switch.md#borderbottomcolor[borderBottomColor]
* link:Switch.md#borderbottomleftradius[borderBottomLeftRadius]
* link:Switch.md#borderbottomrightradius[borderBottomRightRadius]
* link:Switch.md#borderbottomwidth[borderBottomWidth]
* link:Switch.md#bordercolor[borderColor]
* link:Switch.md#borderleftcolor[borderLeftColor]
* link:Switch.md#borderleftwidth[borderLeftWidth]
* link:Switch.md#borderradius[borderRadius]
* link:Switch.md#borderrightcolor[borderRightColor]
* link:Switch.md#borderrightwidth[borderRightWidth]
* link:Switch.md#bordertopcolor[borderTopColor]
* link:Switch.md#bordertopleftradius[borderTopLeftRadius]
* link:Switch.md#bordertoprightradius[borderTopRightRadius]
* link:Switch.md#bordertopwidth[borderTopWidth]
* link:Switch.md#borderwidth[borderWidth]
* link:Switch.md#boxshadow[boxShadow]
* link:Switch.md#checked[checked]
* link:Switch.md#classname[className]
* link:Switch.md#col[col]
* link:Switch.md#colspan[colSpan]
* link:Switch.md#color[color]
* link:Switch.md#column[column]
* link:Switch.md#columnspan[columnSpan]
* link:Switch.md#css[css]
* link:Switch.md#cssclasses[cssClasses]
* link:Switch.md#csspseudoclasses[cssPseudoClasses]
* link:Switch.md#csstype[cssType]
* link:Switch.md#dock[dock]
* link:Switch.md#domnode[domNode]
* link:Switch.md#effectiveborderbottomwidth[effectiveBorderBottomWidth]
* link:Switch.md#effectiveborderleftwidth[effectiveBorderLeftWidth]
* link:Switch.md#effectiveborderrightwidth[effectiveBorderRightWidth]
* link:Switch.md#effectivebordertopwidth[effectiveBorderTopWidth]
* link:Switch.md#effectiveheight[effectiveHeight]
* link:Switch.md#effectiveleft[effectiveLeft]
* link:Switch.md#effectivemarginbottom[effectiveMarginBottom]
* link:Switch.md#effectivemarginleft[effectiveMarginLeft]
* link:Switch.md#effectivemarginright[effectiveMarginRight]
* link:Switch.md#effectivemargintop[effectiveMarginTop]
* link:Switch.md#effectiveminheight[effectiveMinHeight]
* link:Switch.md#effectiveminwidth[effectiveMinWidth]
* link:Switch.md#effectivepaddingbottom[effectivePaddingBottom]
* link:Switch.md#effectivepaddingleft[effectivePaddingLeft]
* link:Switch.md#effectivepaddingright[effectivePaddingRight]
* link:Switch.md#effectivepaddingtop[effectivePaddingTop]
* link:Switch.md#effectivetop[effectiveTop]
* link:Switch.md#effectivewidth[effectiveWidth]
* link:Switch.md#flexgrow[flexGrow]
* link:Switch.md#flexshrink[flexShrink]
* link:Switch.md#flexwrapbefore[flexWrapBefore]
* link:Switch.md#height[height]
* link:Switch.md#horizontalalignment[horizontalAlignment]
* link:Switch.md#id[id]
* link:Switch.md#ignoretouchanimation[ignoreTouchAnimation]
* link:Switch.md#ios[ios]
* link:Switch.md#iosignoresafearea[iosIgnoreSafeArea]
* link:Switch.md#iosoverflowsafearea[iosOverflowSafeArea]
* link:Switch.md#iosoverflowsafeareaenabled[iosOverflowSafeAreaEnabled]
* link:Switch.md#iscollapsed[isCollapsed]
* link:Switch.md#isenabled[isEnabled]
* link:Switch.md#islayoutrequired[isLayoutRequired]
* link:Switch.md#islayoutvalid[isLayoutValid]
* link:Switch.md#isuserinteractionenabled[isUserInteractionEnabled]
* link:Switch.md#left[left]
* link:Switch.md#margin[margin]
* link:Switch.md#marginbottom[marginBottom]
* link:Switch.md#marginleft[marginLeft]
* link:Switch.md#marginright[marginRight]
* link:Switch.md#margintop[marginTop]
* link:Switch.md#minheight[minHeight]
* link:Switch.md#minwidth[minWidth]
* link:Switch.md#modal[modal]
* link:Switch.md#nativeviewprotected[nativeViewProtected]
* link:Switch.md#offbackgroundcolor[offBackgroundColor]
* link:Switch.md#opacity[opacity]
* link:Switch.md#order[order]
* link:Switch.md#originx[originX]
* link:Switch.md#originy[originY]
* link:Switch.md#parent[parent]
* link:Switch.md#perspective[perspective]
* link:Switch.md#recyclenativeview[recycleNativeView]
* link:Switch.md#reusable[reusable]
* link:Switch.md#rotate[rotate]
* link:Switch.md#rotatex[rotateX]
* link:Switch.md#rotatey[rotateY]
* link:Switch.md#row[row]
* link:Switch.md#rowspan[rowSpan]
* link:Switch.md#scalex[scaleX]
* link:Switch.md#scaley[scaleY]
* link:Switch.md#testid[testID]
* link:Switch.md#top[top]
* link:Switch.md#touchanimation[touchAnimation]
* link:Switch.md#touchdelay[touchDelay]
* link:Switch.md#translatex[translateX]
* link:Switch.md#translatey[translateY]
* link:Switch.md#verticalalignment[verticalAlignment]
* link:Switch.md#viewcontroller[viewController]
* link:Switch.md#visibility[visibility]
* link:Switch.md#width[width]
* link:Switch.md#accessibilityblurevent[accessibilityBlurEvent]
* link:Switch.md#accessibilityfocuschangedevent[accessibilityFocusChangedEvent]
* link:Switch.md#accessibilityfocusevent[accessibilityFocusEvent]
* link:Switch.md#accessibilityperformescapeevent[accessibilityPerformEscapeEvent]
* link:Switch.md#checkedchangeevent[checkedChangeEvent]
* link:Switch.md#createdevent[createdEvent]
* link:Switch.md#disposenativeviewevent[disposeNativeViewEvent]
* link:Switch.md#layoutchangedevent[layoutChangedEvent]
* link:Switch.md#loadedevent[loadedEvent]
* link:Switch.md#propertychangeevent[propertyChangeEvent]
* link:Switch.md#showingmodallyevent[showingModallyEvent]
* link:Switch.md#shownmodallyevent[shownModallyEvent]
* link:Switch.md#unloadedevent[unloadedEvent]

=== Accessors

* link:Switch.md#backgroundposition[backgroundPosition]
* link:Switch.md#backgroundrepeat[backgroundRepeat]
* link:Switch.md#backgroundsize[backgroundSize]
* link:Switch.md#class[class]
* link:Switch.md#isloaded[isLoaded]
* link:Switch.md#nativeview[nativeView]
* link:Switch.md#page[page]
* link:Switch.md#parentnode[parentNode]
* link:Switch.md#style[style]
* link:Switch.md#texttransform[textTransform]
* link:Switch.md#typename[typeName]

=== Methods

* link:Switch.md#_addview[_addView]
* link:Switch.md#_addviewcore[_addViewCore]
* link:Switch.md#_addviewtonativevisualtree[_addViewToNativeVisualTree]
* link:Switch.md#_applybackground[_applyBackground]
* link:Switch.md#_applyxmlattribute[_applyXmlAttribute]
* link:Switch.md#_batchupdate[_batchUpdate]
* link:Switch.md#_childindextonativechildindex[_childIndexToNativeChildIndex]
* link:Switch.md#_closeallmodalviewsinternal[_closeAllModalViewsInternal]
* link:Switch.md#_createpropertychangedata[_createPropertyChangeData]
* link:Switch.md#_dialogclosed[_dialogClosed]
* link:Switch.md#_eachlayoutview[_eachLayoutView]
* link:Switch.md#_emit[_emit]
* link:Switch.md#_getcurrentlayoutbounds[_getCurrentLayoutBounds]
* link:Switch.md#_getfragmentmanager[_getFragmentManager]
* link:Switch.md#_getnativeviewscount[_getNativeViewsCount]
* link:Switch.md#_getrootmodalviews[_getRootModalViews]
* link:Switch.md#_getvalue[_getValue]
* link:Switch.md#_gotovisualstate[_goToVisualState]
* link:Switch.md#_handlelivesync[_handleLivesync]
* link:Switch.md#_hasancestorview[_hasAncestorView]
* link:Switch.md#_hidenativemodalview[_hideNativeModalView]
* link:Switch.md#_inheritstylescope[_inheritStyleScope]
* link:Switch.md#_layoutparent[_layoutParent]
* link:Switch.md#_observe[_observe]
* link:Switch.md#_onattachedtowindow[_onAttachedToWindow]
* link:Switch.md#_oncssstatechange[_onCssStateChange]
* link:Switch.md#_ondetachedfromwindow[_onDetachedFromWindow]
* link:Switch.md#_onlivesync[_onLivesync]
* link:Switch.md#_onrootviewreset[_onRootViewReset]
* link:Switch.md#_onsizechanged[_onSizeChanged]
* link:Switch.md#_parentchanged[_parentChanged]
* link:Switch.md#_raiselayoutchangedevent[_raiseLayoutChangedEvent]
* link:Switch.md#_raiseshowingmodallyevent[_raiseShowingModallyEvent]
* link:Switch.md#_raiseshownmodallyevent[_raiseShownModallyEvent]
* link:Switch.md#_redrawnativebackground[_redrawNativeBackground]
* link:Switch.md#_removeanimation[_removeAnimation]
* link:Switch.md#_removeview[_removeView]
* link:Switch.md#_removeviewcore[_removeViewCore]
* link:Switch.md#_removeviewfromnativevisualtree[_removeViewFromNativeVisualTree]
* link:Switch.md#_resumenativeupdates[_resumeNativeUpdates]
* link:Switch.md#_setcurrentlayoutbounds[_setCurrentLayoutBounds]
* link:Switch.md#_setcurrentmeasurespecs[_setCurrentMeasureSpecs]
* link:Switch.md#_setminheightnative[_setMinHeightNative]
* link:Switch.md#_setminwidthnative[_setMinWidthNative]
* link:Switch.md#_setnativecliptobounds[_setNativeClipToBounds]
* link:Switch.md#_setnativeviewframe[_setNativeViewFrame]
* link:Switch.md#_setvalue[_setValue]
* link:Switch.md#_setupasrootview[_setupAsRootView]
* link:Switch.md#_setupui[_setupUI]
* link:Switch.md#_shoulddelaylayout[_shouldDelayLayout]
* link:Switch.md#_shownativemodalview[_showNativeModalView]
* link:Switch.md#_suspendnativeupdates[_suspendNativeUpdates]
* link:Switch.md#_teardownui[_tearDownUI]
* link:Switch.md#_updateeffectivelayoutvalues[_updateEffectiveLayoutValues]
* link:Switch.md#_updatestylescope[_updateStyleScope]
* link:Switch.md#accessibilityannouncement[accessibilityAnnouncement]
* link:Switch.md#accessibilityscreenchanged[accessibilityScreenChanged]
* link:Switch.md#addcss[addCss]
* link:Switch.md#addcssfile[addCssFile]
* link:Switch.md#addeventlistener[addEventListener]
* link:Switch.md#addpseudoclass[addPseudoClass]
* link:Switch.md#animate[animate]
* link:Switch.md#bind[bind]
* link:Switch.md#callloaded[callLoaded]
* link:Switch.md#callunloaded[callUnloaded]
* link:Switch.md#changecssfile[changeCssFile]
* link:Switch.md#closemodal[closeModal]
* link:Switch.md#createanimation[createAnimation]
* link:Switch.md#createnativeview[createNativeView]
* link:Switch.md#deletepseudoclass[deletePseudoClass]
* link:Switch.md#destroynode[destroyNode]
* link:Switch.md#disposenativeview[disposeNativeView]
* link:Switch.md#eachchild[eachChild]
* link:Switch.md#eachchildview[eachChildView]
* link:Switch.md#ensuredomnode[ensureDomNode]
* link:Switch.md#focus[focus]
* link:Switch.md#get[get]
* link:Switch.md#getactualsize[getActualSize]
* link:Switch.md#getgestureobservers[getGestureObservers]
* link:Switch.md#getlocationinwindow[getLocationInWindow]
* link:Switch.md#getlocationonscreen[getLocationOnScreen]
* link:Switch.md#getlocationrelativeto[getLocationRelativeTo]
* link:Switch.md#getmeasuredheight[getMeasuredHeight]
* link:Switch.md#getmeasuredstate[getMeasuredState]
* link:Switch.md#getmeasuredwidth[getMeasuredWidth]
* link:Switch.md#getsafeareainsets[getSafeAreaInsets]
* link:Switch.md#getviewbydomid[getViewByDomId]
* link:Switch.md#getviewbyid[getViewById]
* link:Switch.md#hasgestureobservers[hasGestureObservers]
* link:Switch.md#haslisteners[hasListeners]
* link:Switch.md#initnativeview[initNativeView]
* link:Switch.md#layout[layout]
* link:Switch.md#layoutnativeview[layoutNativeView]
* link:Switch.md#loadview[loadView]
* link:Switch.md#measure[measure]
* link:Switch.md#notify[notify]
* link:Switch.md#notifypropertychange[notifyPropertyChange]
* link:Switch.md#off[off]
* link:Switch.md#on[on]
* link:Switch.md#onbackpressed[onBackPressed]
* link:Switch.md#onlayout[onLayout]
* link:Switch.md#onloaded[onLoaded]
* link:Switch.md#onmeasure[onMeasure]
* link:Switch.md#onresumenativeupdates[onResumeNativeUpdates]
* link:Switch.md#onunloaded[onUnloaded]
* link:Switch.md#once[once]
* link:Switch.md#removeeventlistener[removeEventListener]
* link:Switch.md#requestlayout[requestLayout]
* link:Switch.md#resetnativeview[resetNativeView]
* link:Switch.md#sendaccessibilityevent[sendAccessibilityEvent]
* link:Switch.md#set[set]
* link:Switch.md#setinlinestyle[setInlineStyle]
* link:Switch.md#setmeasureddimension[setMeasuredDimension]
* link:Switch.md#setnativeview[setNativeView]
* link:Switch.md#setontouchlistener[setOnTouchListener]
* link:Switch.md#setproperty[setProperty]
* link:Switch.md#settestid[setTestID]
* link:Switch.md#showmodal[showModal]
* link:Switch.md#tostring[toString]
* link:Switch.md#unbind[unbind]
* link:Switch.md#unloadview[unloadView]
* link:Switch.md#addeventlistener-1[addEventListener]
* link:Switch.md#combinemeasuredstates[combineMeasuredStates]
* link:Switch.md#layoutchild[layoutChild]
* link:Switch.md#measurechild[measureChild]
* link:Switch.md#off-1[off]
* link:Switch.md#on-1[on]
* link:Switch.md#once-1[once]
* link:Switch.md#removeeventlistener-1[removeEventListener]
* link:Switch.md#resolvesizeandstate[resolveSizeAndState]
...
Gets the native http://developer.android.com/reference/android/widget/Switch.html[android widget] that represents the user interface for this component.
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/switch/index.d.ts#L14[ui/switch/index.d.ts:14]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/switch/index.d.ts#L24[ui/switch/index.d.ts:24]
...
Gets the native iOS https://developer.apple.com/library/ios/documentation/UIKit/Reference/UISwitch_Class/[UISwitch] that represents the user interface for this component.
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/switch/index.d.ts#L19[ui/switch/index.d.ts:19]
...
• *offBackgroundColor*: xref:Color.adoc[`Color`]

Gets or sets the background color of the Switch when it is turned off.

==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/switch/index.d.ts#L29[ui/switch/index.d.ts:29]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/switch/index.d.ts#L9[ui/switch/index.d.ts:9]
