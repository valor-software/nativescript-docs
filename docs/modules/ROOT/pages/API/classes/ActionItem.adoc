...
* link:ActionItem.md#constructor[constructor]

=== Properties

* link:ActionItem.md#_automaticallyadjustsscrollviewinsets[_automaticallyAdjustsScrollViewInsets]
* link:ActionItem.md#_context[_context]
* link:ActionItem.md#_cssstate[_cssState]
* link:ActionItem.md#_defaultpaddingbottom[_defaultPaddingBottom]
* link:ActionItem.md#_defaultpaddingleft[_defaultPaddingLeft]
* link:ActionItem.md#_defaultpaddingright[_defaultPaddingRight]
* link:ActionItem.md#_defaultpaddingtop[_defaultPaddingTop]
* link:ActionItem.md#_domid[_domId]
* link:ActionItem.md#_ignoreflexminwidthheightreset[_ignoreFlexMinWidthHeightReset]
* link:ActionItem.md#_isaddedtonativevisualtree[_isAddedToNativeVisualTree]
* link:ActionItem.md#_ispaddingrelative[_isPaddingRelative]
* link:ActionItem.md#_isstylescopehost[_isStyleScopeHost]
* link:ActionItem.md#_isviewbase[_isViewBase]
* link:ActionItem.md#_modulename[_moduleName]
* link:ActionItem.md#_oldbottom[_oldBottom]
* link:ActionItem.md#_oldleft[_oldLeft]
* link:ActionItem.md#_oldright[_oldRight]
* link:ActionItem.md#_oldtop[_oldTop]
* link:ActionItem.md#_stylescope[_styleScope]
* link:ActionItem.md#_suspendnativeupdatescount[_suspendNativeUpdatesCount]
* link:ActionItem.md#_suspendedupdates[_suspendedUpdates]
* link:ActionItem.md#actionbar[actionBar]
* link:ActionItem.md#actionview[actionView]
* link:ActionItem.md#alignself[alignSelf]
* link:ActionItem.md#android[android]
* link:ActionItem.md#bindingcontext[bindingContext]
* link:ActionItem.md#classname[className]
* link:ActionItem.md#col[col]
* link:ActionItem.md#colspan[colSpan]
* link:ActionItem.md#column[column]
* link:ActionItem.md#columnspan[columnSpan]
* link:ActionItem.md#cssclasses[cssClasses]
* link:ActionItem.md#csspseudoclasses[cssPseudoClasses]
* link:ActionItem.md#dock[dock]
* link:ActionItem.md#domnode[domNode]
* link:ActionItem.md#effectiveborderbottomwidth[effectiveBorderBottomWidth]
* link:ActionItem.md#effectiveborderleftwidth[effectiveBorderLeftWidth]
* link:ActionItem.md#effectiveborderrightwidth[effectiveBorderRightWidth]
* link:ActionItem.md#effectivebordertopwidth[effectiveBorderTopWidth]
* link:ActionItem.md#effectiveheight[effectiveHeight]
* link:ActionItem.md#effectiveleft[effectiveLeft]
* link:ActionItem.md#effectivemarginbottom[effectiveMarginBottom]
* link:ActionItem.md#effectivemarginleft[effectiveMarginLeft]
* link:ActionItem.md#effectivemarginright[effectiveMarginRight]
* link:ActionItem.md#effectivemargintop[effectiveMarginTop]
* link:ActionItem.md#effectiveminheight[effectiveMinHeight]
* link:ActionItem.md#effectiveminwidth[effectiveMinWidth]
* link:ActionItem.md#effectivepaddingbottom[effectivePaddingBottom]
* link:ActionItem.md#effectivepaddingleft[effectivePaddingLeft]
* link:ActionItem.md#effectivepaddingright[effectivePaddingRight]
* link:ActionItem.md#effectivepaddingtop[effectivePaddingTop]
* link:ActionItem.md#effectivetop[effectiveTop]
* link:ActionItem.md#effectivewidth[effectiveWidth]
* link:ActionItem.md#flexgrow[flexGrow]
* link:ActionItem.md#flexshrink[flexShrink]
* link:ActionItem.md#flexwrapbefore[flexWrapBefore]
* link:ActionItem.md#icon[icon]
* link:ActionItem.md#id[id]
* link:ActionItem.md#ios[ios]
* link:ActionItem.md#iscollapsed[isCollapsed]
* link:ActionItem.md#left[left]
* link:ActionItem.md#nativeviewprotected[nativeViewProtected]
* link:ActionItem.md#order[order]
* link:ActionItem.md#parent[parent]
* link:ActionItem.md#recyclenativeview[recycleNativeView]
* link:ActionItem.md#reusable[reusable]
* link:ActionItem.md#row[row]
* link:ActionItem.md#rowspan[rowSpan]
* link:ActionItem.md#text[text]
* link:ActionItem.md#top[top]
* link:ActionItem.md#viewcontroller[viewController]
* link:ActionItem.md#visibility[visibility]
* link:ActionItem.md#createdevent[createdEvent]
* link:ActionItem.md#disposenativeviewevent[disposeNativeViewEvent]
* link:ActionItem.md#loadedevent[loadedEvent]
* link:ActionItem.md#propertychangeevent[propertyChangeEvent]
* link:ActionItem.md#unloadedevent[unloadedEvent]

=== Accessors

* link:ActionItem.md#class[class]
* link:ActionItem.md#isloaded[isLoaded]
* link:ActionItem.md#nativeview[nativeView]
* link:ActionItem.md#page[page]
* link:ActionItem.md#parentnode[parentNode]
* link:ActionItem.md#style[style]
* link:ActionItem.md#typename[typeName]

=== Methods

* link:ActionItem.md#_addview[_addView]
* link:ActionItem.md#_addviewcore[_addViewCore]
* link:ActionItem.md#_addviewtonativevisualtree[_addViewToNativeVisualTree]
* link:ActionItem.md#_applyxmlattribute[_applyXmlAttribute]
* link:ActionItem.md#_batchupdate[_batchUpdate]
* link:ActionItem.md#_childindextonativechildindex[_childIndexToNativeChildIndex]
* link:ActionItem.md#_createpropertychangedata[_createPropertyChangeData]
* link:ActionItem.md#_dialogclosed[_dialogClosed]
* link:ActionItem.md#_emit[_emit]
* link:ActionItem.md#_gotovisualstate[_goToVisualState]
* link:ActionItem.md#_inheritstylescope[_inheritStyleScope]
* link:ActionItem.md#_layoutparent[_layoutParent]
* link:ActionItem.md#_oncssstatechange[_onCssStateChange]
* link:ActionItem.md#_onrootviewreset[_onRootViewReset]
* link:ActionItem.md#_parentchanged[_parentChanged]
* link:ActionItem.md#_raisetap[_raiseTap]
* link:ActionItem.md#_removeview[_removeView]
* link:ActionItem.md#_removeviewcore[_removeViewCore]
* link:ActionItem.md#_removeviewfromnativevisualtree[_removeViewFromNativeVisualTree]
* link:ActionItem.md#_resumenativeupdates[_resumeNativeUpdates]
* link:ActionItem.md#_setupasrootview[_setupAsRootView]
* link:ActionItem.md#_setupui[_setupUI]
* link:ActionItem.md#_shoulddelaylayout[_shouldDelayLayout]
* link:ActionItem.md#_suspendnativeupdates[_suspendNativeUpdates]
* link:ActionItem.md#_teardownui[_tearDownUI]
* link:ActionItem.md#addeventlistener[addEventListener]
* link:ActionItem.md#addpseudoclass[addPseudoClass]
* link:ActionItem.md#bind[bind]
* link:ActionItem.md#callloaded[callLoaded]
* link:ActionItem.md#callunloaded[callUnloaded]
* link:ActionItem.md#closemodal[closeModal]
* link:ActionItem.md#createnativeview[createNativeView]
* link:ActionItem.md#deletepseudoclass[deletePseudoClass]
* link:ActionItem.md#destroynode[destroyNode]
* link:ActionItem.md#disposenativeview[disposeNativeView]
* link:ActionItem.md#eachchild[eachChild]
* link:ActionItem.md#ensuredomnode[ensureDomNode]
* link:ActionItem.md#get[get]
* link:ActionItem.md#getviewbydomid[getViewByDomId]
* link:ActionItem.md#getviewbyid[getViewById]
* link:ActionItem.md#haslisteners[hasListeners]
* link:ActionItem.md#initnativeview[initNativeView]
* link:ActionItem.md#loadview[loadView]
* link:ActionItem.md#notify[notify]
* link:ActionItem.md#notifypropertychange[notifyPropertyChange]
* link:ActionItem.md#off[off]
* link:ActionItem.md#on[on]
* link:ActionItem.md#onloaded[onLoaded]
* link:ActionItem.md#onresumenativeupdates[onResumeNativeUpdates]
* link:ActionItem.md#onunloaded[onUnloaded]
* link:ActionItem.md#once[once]
* link:ActionItem.md#removeeventlistener[removeEventListener]
* link:ActionItem.md#requestlayout[requestLayout]
* link:ActionItem.md#resetnativeview[resetNativeView]
* link:ActionItem.md#set[set]
* link:ActionItem.md#setinlinestyle[setInlineStyle]
* link:ActionItem.md#setnativeview[setNativeView]
* link:ActionItem.md#setproperty[setProperty]
* link:ActionItem.md#showmodal[showModal]
* link:ActionItem.md#tostring[toString]
* link:ActionItem.md#unbind[unbind]
* link:ActionItem.md#unloadview[unloadView]
* link:ActionItem.md#addeventlistener-1[addEventListener]
* link:ActionItem.md#off-1[off]
* link:ActionItem.md#on-1[on]
* link:ActionItem.md#once-1[once]
* link:ActionItem.md#removeeventlistener-1[removeEventListener]
