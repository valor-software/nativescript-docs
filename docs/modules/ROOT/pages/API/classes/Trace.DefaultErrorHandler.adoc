...
* link:Trace.DefaultErrorHandler.adoc#constructor[constructor]

=== Methods

* link:Trace.DefaultErrorHandler.adoc#handlererror[handlerError]
...
xref:../interfaces/TraceErrorHandler.adoc[TraceErrorHandler].link:../interfaces/TraceErrorHandler.adoc#handlererror[handlerError]
