...
xref:../README.adoc[NativeScript] / xref:../modules.adoc[Exports] / LayoutBase
...
↳ *`LayoutBase`*
+
↳↳ xref:ProxyViewContainer.adoc[`ProxyViewContainer`]
+
↳↳ xref:AbsoluteLayout.adoc[`AbsoluteLayout`]
+
↳↳ xref:DockLayout.adoc[`DockLayout`]
+
↳↳ xref:FlexboxLayout.adoc[`FlexboxLayout`]
+
↳↳ xref:GridLayout.adoc[`GridLayout`]
+
↳↳ xref:StackLayout.adoc[`StackLayout`]
+
↳↳ xref:WrapLayout.adoc[`WrapLayout`]

== Table of contents

=== Constructors

* link:LayoutBase.md#constructor[constructor]

=== Properties

* link:LayoutBase.md#_androidcontentdescriptionupdated[_androidContentDescriptionUpdated]
* link:LayoutBase.md#_automaticallyadjustsscrollviewinsets[_automaticallyAdjustsScrollViewInsets]
* link:LayoutBase.md#_closemodalcallback[_closeModalCallback]
* link:LayoutBase.md#_context[_context]
* link:LayoutBase.md#_cssstate[_cssState]
* link:LayoutBase.md#_currentheightmeasurespec[_currentHeightMeasureSpec]
* link:LayoutBase.md#_currentwidthmeasurespec[_currentWidthMeasureSpec]
* link:LayoutBase.md#_defaultpaddingbottom[_defaultPaddingBottom]
* link:LayoutBase.md#_defaultpaddingleft[_defaultPaddingLeft]
* link:LayoutBase.md#_defaultpaddingright[_defaultPaddingRight]
* link:LayoutBase.md#_defaultpaddingtop[_defaultPaddingTop]
* link:LayoutBase.md#_domid[_domId]
* link:LayoutBase.md#_gestureobservers[_gestureObservers]
* link:LayoutBase.md#_ignoreflexminwidthheightreset[_ignoreFlexMinWidthHeightReset]
* link:LayoutBase.md#_isaddedtonativevisualtree[_isAddedToNativeVisualTree]
* link:LayoutBase.md#_islayoutvalid[_isLayoutValid]
* link:LayoutBase.md#_ispaddingrelative[_isPaddingRelative]
* link:LayoutBase.md#_isstylescopehost[_isStyleScopeHost]
* link:LayoutBase.md#_isviewbase[_isViewBase]
* link:LayoutBase.md#_manager[_manager]
* link:LayoutBase.md#_modalparent[_modalParent]
* link:LayoutBase.md#_modulename[_moduleName]
* link:LayoutBase.md#_oldbottom[_oldBottom]
* link:LayoutBase.md#_oldleft[_oldLeft]
* link:LayoutBase.md#_oldright[_oldRight]
* link:LayoutBase.md#_oldtop[_oldTop]
* link:LayoutBase.md#_stylescope[_styleScope]
* link:LayoutBase.md#_suspendnativeupdatescount[_suspendNativeUpdatesCount]
* link:LayoutBase.md#_suspendedupdates[_suspendedUpdates]
* link:LayoutBase.md#accessibilityhidden[accessibilityHidden]
* link:LayoutBase.md#accessibilityhint[accessibilityHint]
* link:LayoutBase.md#accessibilityidentifier[accessibilityIdentifier]
* link:LayoutBase.md#accessibilitylabel[accessibilityLabel]
* link:LayoutBase.md#accessibilitylanguage[accessibilityLanguage]
* link:LayoutBase.md#accessibilityliveregion[accessibilityLiveRegion]
* link:LayoutBase.md#accessibilitymediasession[accessibilityMediaSession]
* link:LayoutBase.md#accessibilityrole[accessibilityRole]
* link:LayoutBase.md#accessibilitystate[accessibilityState]
* link:LayoutBase.md#accessibilityvalue[accessibilityValue]
* link:LayoutBase.md#accessible[accessible]
* link:LayoutBase.md#alignself[alignSelf]
* link:LayoutBase.md#android[android]
* link:LayoutBase.md#androiddynamicelevationoffset[androidDynamicElevationOffset]
* link:LayoutBase.md#androidelevation[androidElevation]
* link:LayoutBase.md#automationtext[automationText]
* link:LayoutBase.md#background[background]
* link:LayoutBase.md#backgroundcolor[backgroundColor]
* link:LayoutBase.md#backgroundimage[backgroundImage]
* link:LayoutBase.md#bindingcontext[bindingContext]
* link:LayoutBase.md#borderbottomcolor[borderBottomColor]
* link:LayoutBase.md#borderbottomleftradius[borderBottomLeftRadius]
* link:LayoutBase.md#borderbottomrightradius[borderBottomRightRadius]
* link:LayoutBase.md#borderbottomwidth[borderBottomWidth]
* link:LayoutBase.md#bordercolor[borderColor]
* link:LayoutBase.md#borderleftcolor[borderLeftColor]
* link:LayoutBase.md#borderleftwidth[borderLeftWidth]
* link:LayoutBase.md#borderradius[borderRadius]
* link:LayoutBase.md#borderrightcolor[borderRightColor]
* link:LayoutBase.md#borderrightwidth[borderRightWidth]
* link:LayoutBase.md#bordertopcolor[borderTopColor]
* link:LayoutBase.md#bordertopleftradius[borderTopLeftRadius]
* link:LayoutBase.md#bordertoprightradius[borderTopRightRadius]
* link:LayoutBase.md#bordertopwidth[borderTopWidth]
* link:LayoutBase.md#borderwidth[borderWidth]
* link:LayoutBase.md#boxshadow[boxShadow]
* link:LayoutBase.md#classname[className]
* link:LayoutBase.md#cliptobounds[clipToBounds]
* link:LayoutBase.md#col[col]
* link:LayoutBase.md#colspan[colSpan]
* link:LayoutBase.md#color[color]
* link:LayoutBase.md#column[column]
* link:LayoutBase.md#columnspan[columnSpan]
* link:LayoutBase.md#css[css]
* link:LayoutBase.md#cssclasses[cssClasses]
* link:LayoutBase.md#csspseudoclasses[cssPseudoClasses]
* link:LayoutBase.md#csstype[cssType]
* link:LayoutBase.md#dock[dock]
* link:LayoutBase.md#domnode[domNode]
* link:LayoutBase.md#effectiveborderbottomwidth[effectiveBorderBottomWidth]
* link:LayoutBase.md#effectiveborderleftwidth[effectiveBorderLeftWidth]
* link:LayoutBase.md#effectiveborderrightwidth[effectiveBorderRightWidth]
* link:LayoutBase.md#effectivebordertopwidth[effectiveBorderTopWidth]
* link:LayoutBase.md#effectiveheight[effectiveHeight]
* link:LayoutBase.md#effectiveleft[effectiveLeft]
* link:LayoutBase.md#effectivemarginbottom[effectiveMarginBottom]
* link:LayoutBase.md#effectivemarginleft[effectiveMarginLeft]
* link:LayoutBase.md#effectivemarginright[effectiveMarginRight]
* link:LayoutBase.md#effectivemargintop[effectiveMarginTop]
* link:LayoutBase.md#effectiveminheight[effectiveMinHeight]
* link:LayoutBase.md#effectiveminwidth[effectiveMinWidth]
* link:LayoutBase.md#effectivepaddingbottom[effectivePaddingBottom]
* link:LayoutBase.md#effectivepaddingleft[effectivePaddingLeft]
* link:LayoutBase.md#effectivepaddingright[effectivePaddingRight]
* link:LayoutBase.md#effectivepaddingtop[effectivePaddingTop]
* link:LayoutBase.md#effectivetop[effectiveTop]
* link:LayoutBase.md#effectivewidth[effectiveWidth]
* link:LayoutBase.md#flexgrow[flexGrow]
* link:LayoutBase.md#flexshrink[flexShrink]
* link:LayoutBase.md#flexwrapbefore[flexWrapBefore]
* link:LayoutBase.md#height[height]
* link:LayoutBase.md#horizontalalignment[horizontalAlignment]
* link:LayoutBase.md#id[id]
* link:LayoutBase.md#ignoretouchanimation[ignoreTouchAnimation]
* link:LayoutBase.md#ios[ios]
* link:LayoutBase.md#iosignoresafearea[iosIgnoreSafeArea]
* link:LayoutBase.md#iosoverflowsafearea[iosOverflowSafeArea]
* link:LayoutBase.md#iosoverflowsafeareaenabled[iosOverflowSafeAreaEnabled]
* link:LayoutBase.md#iscollapsed[isCollapsed]
* link:LayoutBase.md#isenabled[isEnabled]
* link:LayoutBase.md#islayoutrequired[isLayoutRequired]
* link:LayoutBase.md#islayoutvalid[isLayoutValid]
* link:LayoutBase.md#ispassthroughparentenabled[isPassThroughParentEnabled]
* link:LayoutBase.md#isuserinteractionenabled[isUserInteractionEnabled]
* link:LayoutBase.md#left[left]
* link:LayoutBase.md#margin[margin]
* link:LayoutBase.md#marginbottom[marginBottom]
* link:LayoutBase.md#marginleft[marginLeft]
* link:LayoutBase.md#marginright[marginRight]
* link:LayoutBase.md#margintop[marginTop]
* link:LayoutBase.md#minheight[minHeight]
* link:LayoutBase.md#minwidth[minWidth]
* link:LayoutBase.md#modal[modal]
* link:LayoutBase.md#nativeviewprotected[nativeViewProtected]
* link:LayoutBase.md#opacity[opacity]
* link:LayoutBase.md#order[order]
* link:LayoutBase.md#originx[originX]
* link:LayoutBase.md#originy[originY]
* link:LayoutBase.md#padding[padding]
* link:LayoutBase.md#paddingbottom[paddingBottom]
* link:LayoutBase.md#paddingleft[paddingLeft]
* link:LayoutBase.md#paddingright[paddingRight]
* link:LayoutBase.md#paddingtop[paddingTop]
* link:LayoutBase.md#parent[parent]
* link:LayoutBase.md#perspective[perspective]
* link:LayoutBase.md#recyclenativeview[recycleNativeView]
* link:LayoutBase.md#reusable[reusable]
* link:LayoutBase.md#rotate[rotate]
* link:LayoutBase.md#rotatex[rotateX]
* link:LayoutBase.md#rotatey[rotateY]
* link:LayoutBase.md#row[row]
* link:LayoutBase.md#rowspan[rowSpan]
* link:LayoutBase.md#scalex[scaleX]
* link:LayoutBase.md#scaley[scaleY]
* link:LayoutBase.md#testid[testID]
* link:LayoutBase.md#top[top]
* link:LayoutBase.md#touchanimation[touchAnimation]
* link:LayoutBase.md#touchdelay[touchDelay]
* link:LayoutBase.md#translatex[translateX]
* link:LayoutBase.md#translatey[translateY]
* link:LayoutBase.md#verticalalignment[verticalAlignment]
* link:LayoutBase.md#viewcontroller[viewController]
* link:LayoutBase.md#visibility[visibility]
* link:LayoutBase.md#width[width]
* link:LayoutBase.md#accessibilityblurevent[accessibilityBlurEvent]
* link:LayoutBase.md#accessibilityfocuschangedevent[accessibilityFocusChangedEvent]
* link:LayoutBase.md#accessibilityfocusevent[accessibilityFocusEvent]
* link:LayoutBase.md#accessibilityperformescapeevent[accessibilityPerformEscapeEvent]
* link:LayoutBase.md#createdevent[createdEvent]
* link:LayoutBase.md#disposenativeviewevent[disposeNativeViewEvent]
* link:LayoutBase.md#layoutchangedevent[layoutChangedEvent]
* link:LayoutBase.md#loadedevent[loadedEvent]
* link:LayoutBase.md#propertychangeevent[propertyChangeEvent]
* link:LayoutBase.md#showingmodallyevent[showingModallyEvent]
* link:LayoutBase.md#shownmodallyevent[shownModallyEvent]
* link:LayoutBase.md#unloadedevent[unloadedEvent]

=== Accessors

* link:LayoutBase.md#backgroundposition[backgroundPosition]
* link:LayoutBase.md#backgroundrepeat[backgroundRepeat]
* link:LayoutBase.md#backgroundsize[backgroundSize]
* link:LayoutBase.md#class[class]
* link:LayoutBase.md#isloaded[isLoaded]
* link:LayoutBase.md#nativeview[nativeView]
* link:LayoutBase.md#page[page]
* link:LayoutBase.md#parentnode[parentNode]
* link:LayoutBase.md#style[style]
* link:LayoutBase.md#texttransform[textTransform]
* link:LayoutBase.md#typename[typeName]

=== Methods

* link:LayoutBase.md#_addview[_addView]
* link:LayoutBase.md#_addviewcore[_addViewCore]
* link:LayoutBase.md#_addviewtonativevisualtree[_addViewToNativeVisualTree]
* link:LayoutBase.md#_applybackground[_applyBackground]
* link:LayoutBase.md#_applyxmlattribute[_applyXmlAttribute]
* link:LayoutBase.md#_batchupdate[_batchUpdate]
* link:LayoutBase.md#_childindextonativechildindex[_childIndexToNativeChildIndex]
* link:LayoutBase.md#_closeallmodalviewsinternal[_closeAllModalViewsInternal]
* link:LayoutBase.md#_createpropertychangedata[_createPropertyChangeData]
* link:LayoutBase.md#_dialogclosed[_dialogClosed]
* link:LayoutBase.md#_eachlayoutview[_eachLayoutView]
* link:LayoutBase.md#_emit[_emit]
* link:LayoutBase.md#_getcurrentlayoutbounds[_getCurrentLayoutBounds]
* link:LayoutBase.md#_getfragmentmanager[_getFragmentManager]
* link:LayoutBase.md#_getnativeviewscount[_getNativeViewsCount]
* link:LayoutBase.md#_getrootmodalviews[_getRootModalViews]
* link:LayoutBase.md#_getvalue[_getValue]
* link:LayoutBase.md#_gotovisualstate[_goToVisualState]
* link:LayoutBase.md#_handlelivesync[_handleLivesync]
* link:LayoutBase.md#_hasancestorview[_hasAncestorView]
* link:LayoutBase.md#_hidenativemodalview[_hideNativeModalView]
* link:LayoutBase.md#_inheritstylescope[_inheritStyleScope]
* link:LayoutBase.md#_layoutparent[_layoutParent]
* link:LayoutBase.md#_observe[_observe]
* link:LayoutBase.md#_onattachedtowindow[_onAttachedToWindow]
* link:LayoutBase.md#_oncssstatechange[_onCssStateChange]
* link:LayoutBase.md#_ondetachedfromwindow[_onDetachedFromWindow]
* link:LayoutBase.md#_onlivesync[_onLivesync]
* link:LayoutBase.md#_onrootviewreset[_onRootViewReset]
* link:LayoutBase.md#_onsizechanged[_onSizeChanged]
* link:LayoutBase.md#_parentchanged[_parentChanged]
* link:LayoutBase.md#_raiselayoutchangedevent[_raiseLayoutChangedEvent]
* link:LayoutBase.md#_raiseshowingmodallyevent[_raiseShowingModallyEvent]
* link:LayoutBase.md#_raiseshownmodallyevent[_raiseShownModallyEvent]
* link:LayoutBase.md#_redrawnativebackground[_redrawNativeBackground]
* link:LayoutBase.md#_registerlayoutchild[_registerLayoutChild]
* link:LayoutBase.md#_removeanimation[_removeAnimation]
* link:LayoutBase.md#_removeview[_removeView]
* link:LayoutBase.md#_removeviewcore[_removeViewCore]
* link:LayoutBase.md#_removeviewfromnativevisualtree[_removeViewFromNativeVisualTree]
* link:LayoutBase.md#_resumenativeupdates[_resumeNativeUpdates]
* link:LayoutBase.md#_setchildminheightnative[_setChildMinHeightNative]
* link:LayoutBase.md#_setchildminwidthnative[_setChildMinWidthNative]
* link:LayoutBase.md#_setcurrentlayoutbounds[_setCurrentLayoutBounds]
* link:LayoutBase.md#_setcurrentmeasurespecs[_setCurrentMeasureSpecs]
* link:LayoutBase.md#_setminheightnative[_setMinHeightNative]
* link:LayoutBase.md#_setminwidthnative[_setMinWidthNative]
* link:LayoutBase.md#_setnativecliptobounds[_setNativeClipToBounds]
* link:LayoutBase.md#_setnativeviewframe[_setNativeViewFrame]
* link:LayoutBase.md#_setvalue[_setValue]
* link:LayoutBase.md#_setupasrootview[_setupAsRootView]
* link:LayoutBase.md#_setupui[_setupUI]
* link:LayoutBase.md#_shoulddelaylayout[_shouldDelayLayout]
* link:LayoutBase.md#_shownativemodalview[_showNativeModalView]
* link:LayoutBase.md#_suspendnativeupdates[_suspendNativeUpdates]
* link:LayoutBase.md#_teardownui[_tearDownUI]
* link:LayoutBase.md#_unregisterlayoutchild[_unregisterLayoutChild]
* link:LayoutBase.md#_updateeffectivelayoutvalues[_updateEffectiveLayoutValues]
* link:LayoutBase.md#_updatenativelayoutparams[_updateNativeLayoutParams]
* link:LayoutBase.md#_updatestylescope[_updateStyleScope]
* link:LayoutBase.md#accessibilityannouncement[accessibilityAnnouncement]
* link:LayoutBase.md#accessibilityscreenchanged[accessibilityScreenChanged]
* link:LayoutBase.md#addchild[addChild]
* link:LayoutBase.md#addcss[addCss]
* link:LayoutBase.md#addcssfile[addCssFile]
* link:LayoutBase.md#addeventlistener[addEventListener]
* link:LayoutBase.md#addpseudoclass[addPseudoClass]
* link:LayoutBase.md#animate[animate]
* link:LayoutBase.md#bind[bind]
* link:LayoutBase.md#callloaded[callLoaded]
* link:LayoutBase.md#callunloaded[callUnloaded]
* link:LayoutBase.md#changecssfile[changeCssFile]
* link:LayoutBase.md#closemodal[closeModal]
* link:LayoutBase.md#createanimation[createAnimation]
* link:LayoutBase.md#createnativeview[createNativeView]
* link:LayoutBase.md#deletepseudoclass[deletePseudoClass]
* link:LayoutBase.md#destroynode[destroyNode]
* link:LayoutBase.md#disposenativeview[disposeNativeView]
* link:LayoutBase.md#eachchild[eachChild]
* link:LayoutBase.md#eachchildview[eachChildView]
* link:LayoutBase.md#eachlayoutchild[eachLayoutChild]
* link:LayoutBase.md#ensuredomnode[ensureDomNode]
* link:LayoutBase.md#focus[focus]
* link:LayoutBase.md#get[get]
* link:LayoutBase.md#getactualsize[getActualSize]
* link:LayoutBase.md#getchildat[getChildAt]
* link:LayoutBase.md#getchildindex[getChildIndex]
* link:LayoutBase.md#getchildrencount[getChildrenCount]
* link:LayoutBase.md#getgestureobservers[getGestureObservers]
* link:LayoutBase.md#getlocationinwindow[getLocationInWindow]
* link:LayoutBase.md#getlocationonscreen[getLocationOnScreen]
* link:LayoutBase.md#getlocationrelativeto[getLocationRelativeTo]
* link:LayoutBase.md#getmeasuredheight[getMeasuredHeight]
* link:LayoutBase.md#getmeasuredstate[getMeasuredState]
* link:LayoutBase.md#getmeasuredwidth[getMeasuredWidth]
* link:LayoutBase.md#getsafeareainsets[getSafeAreaInsets]
* link:LayoutBase.md#getviewbydomid[getViewByDomId]
* link:LayoutBase.md#getviewbyid[getViewById]
* link:LayoutBase.md#hasgestureobservers[hasGestureObservers]
* link:LayoutBase.md#haslisteners[hasListeners]
* link:LayoutBase.md#initnativeview[initNativeView]
* link:LayoutBase.md#insertchild[insertChild]
* link:LayoutBase.md#layout[layout]
* link:LayoutBase.md#layoutnativeview[layoutNativeView]
* link:LayoutBase.md#loadview[loadView]
* link:LayoutBase.md#measure[measure]
* link:LayoutBase.md#notify[notify]
* link:LayoutBase.md#notifypropertychange[notifyPropertyChange]
* link:LayoutBase.md#off[off]
* link:LayoutBase.md#on[on]
* link:LayoutBase.md#onbackpressed[onBackPressed]
* link:LayoutBase.md#onlayout[onLayout]
* link:LayoutBase.md#onloaded[onLoaded]
* link:LayoutBase.md#onmeasure[onMeasure]
* link:LayoutBase.md#onresumenativeupdates[onResumeNativeUpdates]
* link:LayoutBase.md#onunloaded[onUnloaded]
* link:LayoutBase.md#once[once]
* link:LayoutBase.md#removechild[removeChild]
* link:LayoutBase.md#removechildren[removeChildren]
* link:LayoutBase.md#removeeventlistener[removeEventListener]
* link:LayoutBase.md#requestlayout[requestLayout]
* link:LayoutBase.md#resetnativeview[resetNativeView]
* link:LayoutBase.md#sendaccessibilityevent[sendAccessibilityEvent]
* link:LayoutBase.md#set[set]
* link:LayoutBase.md#setinlinestyle[setInlineStyle]
* link:LayoutBase.md#setmeasureddimension[setMeasuredDimension]
* link:LayoutBase.md#setnativeview[setNativeView]
* link:LayoutBase.md#setontouchlistener[setOnTouchListener]
* link:LayoutBase.md#setproperty[setProperty]
* link:LayoutBase.md#settestid[setTestID]
* link:LayoutBase.md#showmodal[showModal]
* link:LayoutBase.md#tostring[toString]
* link:LayoutBase.md#unbind[unbind]
* link:LayoutBase.md#unloadview[unloadView]
* link:LayoutBase.md#addeventlistener-1[addEventListener]
* link:LayoutBase.md#combinemeasuredstates[combineMeasuredStates]
* link:LayoutBase.md#layoutchild[layoutChild]
* link:LayoutBase.md#measurechild[measureChild]
* link:LayoutBase.md#off-1[off]
* link:LayoutBase.md#on-1[on]
* link:LayoutBase.md#once-1[once]
* link:LayoutBase.md#removeeventlistener-1[removeEventListener]
* link:LayoutBase.md#resolvesizeandstate[resolveSizeAndState]
...
==== Inherited from xref:CustomLayoutView.adoc[CustomLayoutView].link:CustomLayoutView.md#eachchildview[eachChildView]
...
==== Inherited from xref:CustomLayoutView.adoc[CustomLayoutView].link:CustomLayoutView.md#onlayout[onLayout]
...
==== Inherited from xref:CustomLayoutView.adoc[CustomLayoutView].link:CustomLayoutView.md#onmeasure[onMeasure]
