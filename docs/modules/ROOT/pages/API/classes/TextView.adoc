...
xref:../README.adoc[NativeScript] / xref:../modules.adoc[Exports] / TextView
...
* link:TextView.adoc#constructor[constructor]

=== Properties

* link:TextView.adoc#_androidcontentdescriptionupdated[_androidContentDescriptionUpdated]
* link:TextView.adoc#_automaticallyadjustsscrollviewinsets[_automaticallyAdjustsScrollViewInsets]
* link:TextView.adoc#_closemodalcallback[_closeModalCallback]
* link:TextView.adoc#_context[_context]
* link:TextView.adoc#_cssstate[_cssState]
* link:TextView.adoc#_currentheightmeasurespec[_currentHeightMeasureSpec]
* link:TextView.adoc#_currentwidthmeasurespec[_currentWidthMeasureSpec]
* link:TextView.adoc#_defaultpaddingbottom[_defaultPaddingBottom]
* link:TextView.adoc#_defaultpaddingleft[_defaultPaddingLeft]
* link:TextView.adoc#_defaultpaddingright[_defaultPaddingRight]
* link:TextView.adoc#_defaultpaddingtop[_defaultPaddingTop]
* link:TextView.adoc#_domid[_domId]
* link:TextView.adoc#_gestureobservers[_gestureObservers]
* link:TextView.adoc#_ignoreflexminwidthheightreset[_ignoreFlexMinWidthHeightReset]
* link:TextView.adoc#_isaddedtonativevisualtree[_isAddedToNativeVisualTree]
* link:TextView.adoc#_islayoutvalid[_isLayoutValid]
* link:TextView.adoc#_ispaddingrelative[_isPaddingRelative]
* link:TextView.adoc#_issingleline[_isSingleLine]
* link:TextView.adoc#_isstylescopehost[_isStyleScopeHost]
* link:TextView.adoc#_isviewbase[_isViewBase]
* link:TextView.adoc#_manager[_manager]
* link:TextView.adoc#_modalparent[_modalParent]
* link:TextView.adoc#_modulename[_moduleName]
* link:TextView.adoc#_oldbottom[_oldBottom]
* link:TextView.adoc#_oldleft[_oldLeft]
* link:TextView.adoc#_oldright[_oldRight]
* link:TextView.adoc#_oldtop[_oldTop]
* link:TextView.adoc#_stylescope[_styleScope]
* link:TextView.adoc#_suspendnativeupdatescount[_suspendNativeUpdatesCount]
* link:TextView.adoc#_suspendedupdates[_suspendedUpdates]
* link:TextView.adoc#accessibilityhidden[accessibilityHidden]
* link:TextView.adoc#accessibilityhint[accessibilityHint]
* link:TextView.adoc#accessibilityidentifier[accessibilityIdentifier]
* link:TextView.adoc#accessibilitylabel[accessibilityLabel]
* link:TextView.adoc#accessibilitylanguage[accessibilityLanguage]
* link:TextView.adoc#accessibilityliveregion[accessibilityLiveRegion]
* link:TextView.adoc#accessibilitymediasession[accessibilityMediaSession]
* link:TextView.adoc#accessibilityrole[accessibilityRole]
* link:TextView.adoc#accessibilitystate[accessibilityState]
* link:TextView.adoc#accessibilityvalue[accessibilityValue]
* link:TextView.adoc#accessible[accessible]
* link:TextView.adoc#alignself[alignSelf]
* link:TextView.adoc#android[android]
* link:TextView.adoc#androiddynamicelevationoffset[androidDynamicElevationOffset]
* link:TextView.adoc#androidelevation[androidElevation]
* link:TextView.adoc#autocapitalizationtype[autocapitalizationType]
* link:TextView.adoc#autocorrect[autocorrect]
* link:TextView.adoc#autofilltype[autofillType]
* link:TextView.adoc#automationtext[automationText]
* link:TextView.adoc#background[background]
* link:TextView.adoc#backgroundcolor[backgroundColor]
* link:TextView.adoc#backgroundimage[backgroundImage]
* link:TextView.adoc#bindingcontext[bindingContext]
* link:TextView.adoc#borderbottomcolor[borderBottomColor]
* link:TextView.adoc#borderbottomleftradius[borderBottomLeftRadius]
* link:TextView.adoc#borderbottomrightradius[borderBottomRightRadius]
* link:TextView.adoc#borderbottomwidth[borderBottomWidth]
* link:TextView.adoc#bordercolor[borderColor]
* link:TextView.adoc#borderleftcolor[borderLeftColor]
* link:TextView.adoc#borderleftwidth[borderLeftWidth]
* link:TextView.adoc#borderradius[borderRadius]
* link:TextView.adoc#borderrightcolor[borderRightColor]
* link:TextView.adoc#borderrightwidth[borderRightWidth]
* link:TextView.adoc#bordertopcolor[borderTopColor]
* link:TextView.adoc#bordertopleftradius[borderTopLeftRadius]
* link:TextView.adoc#bordertoprightradius[borderTopRightRadius]
* link:TextView.adoc#bordertopwidth[borderTopWidth]
* link:TextView.adoc#borderwidth[borderWidth]
* link:TextView.adoc#boxshadow[boxShadow]
* link:TextView.adoc#classname[className]
* link:TextView.adoc#col[col]
* link:TextView.adoc#colspan[colSpan]
* link:TextView.adoc#color[color]
* link:TextView.adoc#column[column]
* link:TextView.adoc#columnspan[columnSpan]
* link:TextView.adoc#css[css]
* link:TextView.adoc#cssclasses[cssClasses]
* link:TextView.adoc#csspseudoclasses[cssPseudoClasses]
* link:TextView.adoc#csstype[cssType]
* link:TextView.adoc#dock[dock]
* link:TextView.adoc#domnode[domNode]
* link:TextView.adoc#editable[editable]
* link:TextView.adoc#effectiveborderbottomwidth[effectiveBorderBottomWidth]
* link:TextView.adoc#effectiveborderleftwidth[effectiveBorderLeftWidth]
* link:TextView.adoc#effectiveborderrightwidth[effectiveBorderRightWidth]
* link:TextView.adoc#effectivebordertopwidth[effectiveBorderTopWidth]
* link:TextView.adoc#effectiveheight[effectiveHeight]
* link:TextView.adoc#effectiveleft[effectiveLeft]
* link:TextView.adoc#effectivemarginbottom[effectiveMarginBottom]
* link:TextView.adoc#effectivemarginleft[effectiveMarginLeft]
* link:TextView.adoc#effectivemarginright[effectiveMarginRight]
* link:TextView.adoc#effectivemargintop[effectiveMarginTop]
* link:TextView.adoc#effectiveminheight[effectiveMinHeight]
* link:TextView.adoc#effectiveminwidth[effectiveMinWidth]
* link:TextView.adoc#effectivepaddingbottom[effectivePaddingBottom]
* link:TextView.adoc#effectivepaddingleft[effectivePaddingLeft]
* link:TextView.adoc#effectivepaddingright[effectivePaddingRight]
* link:TextView.adoc#effectivepaddingtop[effectivePaddingTop]
* link:TextView.adoc#effectivetop[effectiveTop]
* link:TextView.adoc#effectivewidth[effectiveWidth]
* link:TextView.adoc#flexgrow[flexGrow]
* link:TextView.adoc#flexshrink[flexShrink]
* link:TextView.adoc#flexwrapbefore[flexWrapBefore]
* link:TextView.adoc#fontsize[fontSize]
* link:TextView.adoc#formattedtext[formattedText]
* link:TextView.adoc#height[height]
* link:TextView.adoc#hint[hint]
* link:TextView.adoc#horizontalalignment[horizontalAlignment]
* link:TextView.adoc#id[id]
* link:TextView.adoc#ignoretouchanimation[ignoreTouchAnimation]
* link:TextView.adoc#ios[ios]
* link:TextView.adoc#iosignoresafearea[iosIgnoreSafeArea]
* link:TextView.adoc#iosoverflowsafearea[iosOverflowSafeArea]
* link:TextView.adoc#iosoverflowsafeareaenabled[iosOverflowSafeAreaEnabled]
* link:TextView.adoc#iscollapsed[isCollapsed]
* link:TextView.adoc#isenabled[isEnabled]
* link:TextView.adoc#islayoutrequired[isLayoutRequired]
* link:TextView.adoc#islayoutvalid[isLayoutValid]
* link:TextView.adoc#isuserinteractionenabled[isUserInteractionEnabled]
* link:TextView.adoc#keyboardtype[keyboardType]
* link:TextView.adoc#left[left]
* link:TextView.adoc#letterspacing[letterSpacing]
* link:TextView.adoc#lineheight[lineHeight]
* link:TextView.adoc#margin[margin]
* link:TextView.adoc#marginbottom[marginBottom]
* link:TextView.adoc#marginleft[marginLeft]
* link:TextView.adoc#marginright[marginRight]
* link:TextView.adoc#margintop[marginTop]
* link:TextView.adoc#maxlength[maxLength]
* link:TextView.adoc#maxlines[maxLines]
* link:TextView.adoc#minheight[minHeight]
* link:TextView.adoc#minwidth[minWidth]
* link:TextView.adoc#modal[modal]
* link:TextView.adoc#nativetextviewprotected[nativeTextViewProtected]
* link:TextView.adoc#nativeviewprotected[nativeViewProtected]
* link:TextView.adoc#opacity[opacity]
* link:TextView.adoc#order[order]
* link:TextView.adoc#originx[originX]
* link:TextView.adoc#originy[originY]
* link:TextView.adoc#padding[padding]
* link:TextView.adoc#paddingbottom[paddingBottom]
* link:TextView.adoc#paddingleft[paddingLeft]
* link:TextView.adoc#paddingright[paddingRight]
* link:TextView.adoc#paddingtop[paddingTop]
* link:TextView.adoc#parent[parent]
* link:TextView.adoc#perspective[perspective]
* link:TextView.adoc#recyclenativeview[recycleNativeView]
* link:TextView.adoc#returnkeytype[returnKeyType]
* link:TextView.adoc#reusable[reusable]
* link:TextView.adoc#rotate[rotate]
* link:TextView.adoc#rotatex[rotateX]
* link:TextView.adoc#rotatey[rotateY]
* link:TextView.adoc#row[row]
* link:TextView.adoc#rowspan[rowSpan]
* link:TextView.adoc#scalex[scaleX]
* link:TextView.adoc#scaley[scaleY]
* link:TextView.adoc#testid[testID]
* link:TextView.adoc#text[text]
* link:TextView.adoc#textalignment[textAlignment]
* link:TextView.adoc#textdecoration[textDecoration]
* link:TextView.adoc#textshadow[textShadow]
* link:TextView.adoc#texttransform[textTransform]
* link:TextView.adoc#top[top]
* link:TextView.adoc#touchanimation[touchAnimation]
* link:TextView.adoc#touchdelay[touchDelay]
* link:TextView.adoc#translatex[translateX]
* link:TextView.adoc#translatey[translateY]
* link:TextView.adoc#updatetexttrigger[updateTextTrigger]
* link:TextView.adoc#verticalalignment[verticalAlignment]
* link:TextView.adoc#viewcontroller[viewController]
* link:TextView.adoc#visibility[visibility]
* link:TextView.adoc#whitespace[whiteSpace]
* link:TextView.adoc#width[width]
* link:TextView.adoc#accessibilityblurevent[accessibilityBlurEvent]
* link:TextView.adoc#accessibilityfocuschangedevent[accessibilityFocusChangedEvent]
* link:TextView.adoc#accessibilityfocusevent[accessibilityFocusEvent]
* link:TextView.adoc#accessibilityperformescapeevent[accessibilityPerformEscapeEvent]
* link:TextView.adoc#blurevent[blurEvent]
* link:TextView.adoc#createdevent[createdEvent]
* link:TextView.adoc#disposenativeviewevent[disposeNativeViewEvent]
* link:TextView.adoc#focusevent[focusEvent]
* link:TextView.adoc#layoutchangedevent[layoutChangedEvent]
* link:TextView.adoc#loadedevent[loadedEvent]
* link:TextView.adoc#propertychangeevent[propertyChangeEvent]
* link:TextView.adoc#showingmodallyevent[showingModallyEvent]
* link:TextView.adoc#shownmodallyevent[shownModallyEvent]
* link:TextView.adoc#textchangeevent[textChangeEvent]
* link:TextView.adoc#unloadedevent[unloadedEvent]

=== Accessors

* link:TextView.adoc#backgroundposition[backgroundPosition]
* link:TextView.adoc#backgroundrepeat[backgroundRepeat]
* link:TextView.adoc#backgroundsize[backgroundSize]
* link:TextView.adoc#class[class]
* link:TextView.adoc#isloaded[isLoaded]
* link:TextView.adoc#nativeview[nativeView]
* link:TextView.adoc#page[page]
* link:TextView.adoc#parentnode[parentNode]
* link:TextView.adoc#style[style]
* link:TextView.adoc#typename[typeName]

=== Methods

* link:TextView.adoc#_addchildfrombuilder[_addChildFromBuilder]
* link:TextView.adoc#_addview[_addView]
* link:TextView.adoc#_addviewcore[_addViewCore]
* link:TextView.adoc#_addviewtonativevisualtree[_addViewToNativeVisualTree]
* link:TextView.adoc#_applybackground[_applyBackground]
* link:TextView.adoc#_applyxmlattribute[_applyXmlAttribute]
* link:TextView.adoc#_batchupdate[_batchUpdate]
* link:TextView.adoc#_childindextonativechildindex[_childIndexToNativeChildIndex]
* link:TextView.adoc#_closeallmodalviewsinternal[_closeAllModalViewsInternal]
* link:TextView.adoc#_createpropertychangedata[_createPropertyChangeData]
* link:TextView.adoc#_dialogclosed[_dialogClosed]
* link:TextView.adoc#_eachlayoutview[_eachLayoutView]
* link:TextView.adoc#_emit[_emit]
* link:TextView.adoc#_getcurrentlayoutbounds[_getCurrentLayoutBounds]
* link:TextView.adoc#_getfragmentmanager[_getFragmentManager]
* link:TextView.adoc#_getnativeviewscount[_getNativeViewsCount]
* link:TextView.adoc#_getrootmodalviews[_getRootModalViews]
* link:TextView.adoc#_getvalue[_getValue]
* link:TextView.adoc#_gotovisualstate[_goToVisualState]
* link:TextView.adoc#_handlelivesync[_handleLivesync]
* link:TextView.adoc#_hasancestorview[_hasAncestorView]
* link:TextView.adoc#_hidenativemodalview[_hideNativeModalView]
* link:TextView.adoc#_inheritstylescope[_inheritStyleScope]
* link:TextView.adoc#_layoutparent[_layoutParent]
* link:TextView.adoc#_observe[_observe]
* link:TextView.adoc#_onattachedtowindow[_onAttachedToWindow]
* link:TextView.adoc#_oncssstatechange[_onCssStateChange]
* link:TextView.adoc#_ondetachedfromwindow[_onDetachedFromWindow]
* link:TextView.adoc#_onlivesync[_onLivesync]
* link:TextView.adoc#_onrootviewreset[_onRootViewReset]
* link:TextView.adoc#_onsizechanged[_onSizeChanged]
* link:TextView.adoc#_parentchanged[_parentChanged]
* link:TextView.adoc#_raiselayoutchangedevent[_raiseLayoutChangedEvent]
* link:TextView.adoc#_raiseshowingmodallyevent[_raiseShowingModallyEvent]
* link:TextView.adoc#_raiseshownmodallyevent[_raiseShownModallyEvent]
* link:TextView.adoc#_redrawnativebackground[_redrawNativeBackground]
* link:TextView.adoc#_removeanimation[_removeAnimation]
* link:TextView.adoc#_removeview[_removeView]
* link:TextView.adoc#_removeviewcore[_removeViewCore]
* link:TextView.adoc#_removeviewfromnativevisualtree[_removeViewFromNativeVisualTree]
* link:TextView.adoc#_requestlayoutontextchanged[_requestLayoutOnTextChanged]
* link:TextView.adoc#_resumenativeupdates[_resumeNativeUpdates]
* link:TextView.adoc#_setcurrentlayoutbounds[_setCurrentLayoutBounds]
* link:TextView.adoc#_setcurrentmeasurespecs[_setCurrentMeasureSpecs]
* link:TextView.adoc#_setinputtype[_setInputType]
* link:TextView.adoc#_setminheightnative[_setMinHeightNative]
* link:TextView.adoc#_setminwidthnative[_setMinWidthNative]
* link:TextView.adoc#_setnativecliptobounds[_setNativeClipToBounds]
* link:TextView.adoc#_setnativetext[_setNativeText]
* link:TextView.adoc#_setnativeviewframe[_setNativeViewFrame]
* link:TextView.adoc#_setvalue[_setValue]
* link:TextView.adoc#_setupasrootview[_setupAsRootView]
* link:TextView.adoc#_setupui[_setupUI]
* link:TextView.adoc#_shoulddelaylayout[_shouldDelayLayout]
* link:TextView.adoc#_shownativemodalview[_showNativeModalView]
* link:TextView.adoc#_suspendnativeupdates[_suspendNativeUpdates]
* link:TextView.adoc#_teardownui[_tearDownUI]
* link:TextView.adoc#_updateeffectivelayoutvalues[_updateEffectiveLayoutValues]
* link:TextView.adoc#_updatestylescope[_updateStyleScope]
* link:TextView.adoc#accessibilityannouncement[accessibilityAnnouncement]
* link:TextView.adoc#accessibilityscreenchanged[accessibilityScreenChanged]
* link:TextView.adoc#addcss[addCss]
* link:TextView.adoc#addcssfile[addCssFile]
* link:TextView.adoc#addeventlistener[addEventListener]
* link:TextView.adoc#addpseudoclass[addPseudoClass]
* link:TextView.adoc#animate[animate]
* link:TextView.adoc#bind[bind]
* link:TextView.adoc#callloaded[callLoaded]
* link:TextView.adoc#callunloaded[callUnloaded]
* link:TextView.adoc#changecssfile[changeCssFile]
* link:TextView.adoc#closemodal[closeModal]
* link:TextView.adoc#createanimation[createAnimation]
* link:TextView.adoc#createnativeview[createNativeView]
* link:TextView.adoc#deletepseudoclass[deletePseudoClass]
* link:TextView.adoc#destroynode[destroyNode]
* link:TextView.adoc#dismisssoftinput[dismissSoftInput]
* link:TextView.adoc#disposenativeview[disposeNativeView]
* link:TextView.adoc#eachchild[eachChild]
* link:TextView.adoc#eachchildview[eachChildView]
* link:TextView.adoc#ensuredomnode[ensureDomNode]
* link:TextView.adoc#focus[focus]
* link:TextView.adoc#get[get]
* link:TextView.adoc#getactualsize[getActualSize]
* link:TextView.adoc#getgestureobservers[getGestureObservers]
* link:TextView.adoc#getlocationinwindow[getLocationInWindow]
* link:TextView.adoc#getlocationonscreen[getLocationOnScreen]
* link:TextView.adoc#getlocationrelativeto[getLocationRelativeTo]
* link:TextView.adoc#getmeasuredheight[getMeasuredHeight]
* link:TextView.adoc#getmeasuredstate[getMeasuredState]
* link:TextView.adoc#getmeasuredwidth[getMeasuredWidth]
* link:TextView.adoc#getsafeareainsets[getSafeAreaInsets]
* link:TextView.adoc#getviewbydomid[getViewByDomId]
* link:TextView.adoc#getviewbyid[getViewById]
* link:TextView.adoc#hasgestureobservers[hasGestureObservers]
* link:TextView.adoc#haslisteners[hasListeners]
* link:TextView.adoc#initnativeview[initNativeView]
* link:TextView.adoc#layout[layout]
* link:TextView.adoc#layoutnativeview[layoutNativeView]
* link:TextView.adoc#loadview[loadView]
* link:TextView.adoc#measure[measure]
* link:TextView.adoc#notify[notify]
* link:TextView.adoc#notifypropertychange[notifyPropertyChange]
* link:TextView.adoc#off[off]
* link:TextView.adoc#on[on]
* link:TextView.adoc#onbackpressed[onBackPressed]
* link:TextView.adoc#onlayout[onLayout]
* link:TextView.adoc#onloaded[onLoaded]
* link:TextView.adoc#onmeasure[onMeasure]
* link:TextView.adoc#onresumenativeupdates[onResumeNativeUpdates]
* link:TextView.adoc#onunloaded[onUnloaded]
* link:TextView.adoc#once[once]
* link:TextView.adoc#removeeventlistener[removeEventListener]
* link:TextView.adoc#requestlayout[requestLayout]
* link:TextView.adoc#resetnativeview[resetNativeView]
* link:TextView.adoc#sendaccessibilityevent[sendAccessibilityEvent]
* link:TextView.adoc#set[set]
* link:TextView.adoc#setinlinestyle[setInlineStyle]
* link:TextView.adoc#setmeasureddimension[setMeasuredDimension]
* link:TextView.adoc#setnativeview[setNativeView]
* link:TextView.adoc#setontouchlistener[setOnTouchListener]
* link:TextView.adoc#setproperty[setProperty]
* link:TextView.adoc#setselection[setSelection]
* link:TextView.adoc#settestid[setTestID]
* link:TextView.adoc#showmodal[showModal]
* link:TextView.adoc#tostring[toString]
* link:TextView.adoc#unbind[unbind]
* link:TextView.adoc#unloadview[unloadView]
* link:TextView.adoc#addeventlistener-1[addEventListener]
* link:TextView.adoc#combinemeasuredstates[combineMeasuredStates]
* link:TextView.adoc#layoutchild[layoutChild]
* link:TextView.adoc#measurechild[measureChild]
* link:TextView.adoc#off-1[off]
* link:TextView.adoc#on-1[on]
* link:TextView.adoc#once-1[once]
* link:TextView.adoc#removeeventlistener-1[removeEventListener]
* link:TextView.adoc#resolvesizeandstate[resolveSizeAndState]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/text-view/index.d.ts#L11[ui/text-view/index.d.ts:11]
...
Gets the native iOS https://developer.apple.com/library/ios/documentation/UIKit/Reference/UITextView_Class/[UITextView] that represents the user interface for this component.
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/text-view/index.d.ts#L16[ui/text-view/index.d.ts:16]
...
xref:EditableTextBase.adoc[EditableTextBase].link:EditableTextBase.adoc#maxlines[maxLines]

==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/text-view/index.d.ts#L21[ui/text-view/index.d.ts:21]
