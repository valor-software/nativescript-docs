...
* link:FormattedString.adoc#constructor[constructor]

=== Properties

* link:FormattedString.adoc#_automaticallyadjustsscrollviewinsets[_automaticallyAdjustsScrollViewInsets]
* link:FormattedString.adoc#_context[_context]
* link:FormattedString.adoc#_cssstate[_cssState]
* link:FormattedString.adoc#_defaultpaddingbottom[_defaultPaddingBottom]
* link:FormattedString.adoc#_defaultpaddingleft[_defaultPaddingLeft]
* link:FormattedString.adoc#_defaultpaddingright[_defaultPaddingRight]
* link:FormattedString.adoc#_defaultpaddingtop[_defaultPaddingTop]
* link:FormattedString.adoc#_domid[_domId]
* link:FormattedString.adoc#_ignoreflexminwidthheightreset[_ignoreFlexMinWidthHeightReset]
* link:FormattedString.adoc#_isaddedtonativevisualtree[_isAddedToNativeVisualTree]
* link:FormattedString.adoc#_ispaddingrelative[_isPaddingRelative]
* link:FormattedString.adoc#_isstylescopehost[_isStyleScopeHost]
* link:FormattedString.adoc#_isviewbase[_isViewBase]
* link:FormattedString.adoc#_modulename[_moduleName]
* link:FormattedString.adoc#_oldbottom[_oldBottom]
* link:FormattedString.adoc#_oldleft[_oldLeft]
* link:FormattedString.adoc#_oldright[_oldRight]
* link:FormattedString.adoc#_oldtop[_oldTop]
* link:FormattedString.adoc#_spans[_spans]
* link:FormattedString.adoc#_stylescope[_styleScope]
* link:FormattedString.adoc#_suspendnativeupdatescount[_suspendNativeUpdatesCount]
* link:FormattedString.adoc#_suspendedupdates[_suspendedUpdates]
* link:FormattedString.adoc#alignself[alignSelf]
* link:FormattedString.adoc#bindingcontext[bindingContext]
* link:FormattedString.adoc#classname[className]
* link:FormattedString.adoc#col[col]
* link:FormattedString.adoc#colspan[colSpan]
* link:FormattedString.adoc#column[column]
* link:FormattedString.adoc#columnspan[columnSpan]
* link:FormattedString.adoc#cssclasses[cssClasses]
* link:FormattedString.adoc#csspseudoclasses[cssPseudoClasses]
* link:FormattedString.adoc#dock[dock]
* link:FormattedString.adoc#domnode[domNode]
* link:FormattedString.adoc#effectiveborderbottomwidth[effectiveBorderBottomWidth]
* link:FormattedString.adoc#effectiveborderleftwidth[effectiveBorderLeftWidth]
* link:FormattedString.adoc#effectiveborderrightwidth[effectiveBorderRightWidth]
* link:FormattedString.adoc#effectivebordertopwidth[effectiveBorderTopWidth]
* link:FormattedString.adoc#effectiveheight[effectiveHeight]
* link:FormattedString.adoc#effectiveleft[effectiveLeft]
* link:FormattedString.adoc#effectivemarginbottom[effectiveMarginBottom]
* link:FormattedString.adoc#effectivemarginleft[effectiveMarginLeft]
* link:FormattedString.adoc#effectivemarginright[effectiveMarginRight]
* link:FormattedString.adoc#effectivemargintop[effectiveMarginTop]
* link:FormattedString.adoc#effectiveminheight[effectiveMinHeight]
* link:FormattedString.adoc#effectiveminwidth[effectiveMinWidth]
* link:FormattedString.adoc#effectivepaddingbottom[effectivePaddingBottom]
* link:FormattedString.adoc#effectivepaddingleft[effectivePaddingLeft]
* link:FormattedString.adoc#effectivepaddingright[effectivePaddingRight]
* link:FormattedString.adoc#effectivepaddingtop[effectivePaddingTop]
* link:FormattedString.adoc#effectivetop[effectiveTop]
* link:FormattedString.adoc#effectivewidth[effectiveWidth]
* link:FormattedString.adoc#flexgrow[flexGrow]
* link:FormattedString.adoc#flexshrink[flexShrink]
* link:FormattedString.adoc#flexwrapbefore[flexWrapBefore]
* link:FormattedString.adoc#id[id]
* link:FormattedString.adoc#iscollapsed[isCollapsed]
* link:FormattedString.adoc#left[left]
* link:FormattedString.adoc#nativeviewprotected[nativeViewProtected]
* link:FormattedString.adoc#order[order]
* link:FormattedString.adoc#parent[parent]
* link:FormattedString.adoc#recyclenativeview[recycleNativeView]
* link:FormattedString.adoc#reusable[reusable]
* link:FormattedString.adoc#row[row]
* link:FormattedString.adoc#rowspan[rowSpan]
* link:FormattedString.adoc#top[top]
* link:FormattedString.adoc#viewcontroller[viewController]
* link:FormattedString.adoc#createdevent[createdEvent]
* link:FormattedString.adoc#disposenativeviewevent[disposeNativeViewEvent]
* link:FormattedString.adoc#loadedevent[loadedEvent]
* link:FormattedString.adoc#propertychangeevent[propertyChangeEvent]
* link:FormattedString.adoc#unloadedevent[unloadedEvent]

=== Accessors

* link:FormattedString.adoc#android[android]
* link:FormattedString.adoc#backgroundcolor[backgroundColor]
* link:FormattedString.adoc#class[class]
* link:FormattedString.adoc#color[color]
* link:FormattedString.adoc#fontfamily[fontFamily]
* link:FormattedString.adoc#fontsize[fontSize]
* link:FormattedString.adoc#fontstyle[fontStyle]
* link:FormattedString.adoc#fontweight[fontWeight]
* link:FormattedString.adoc#ios[ios]
* link:FormattedString.adoc#isloaded[isLoaded]
* link:FormattedString.adoc#nativeview[nativeView]
* link:FormattedString.adoc#page[page]
* link:FormattedString.adoc#parentnode[parentNode]
* link:FormattedString.adoc#spans[spans]
* link:FormattedString.adoc#style[style]
* link:FormattedString.adoc#textdecoration[textDecoration]
* link:FormattedString.adoc#typename[typeName]

=== Methods

* link:FormattedString.adoc#_addarrayfrombuilder[_addArrayFromBuilder]
* link:FormattedString.adoc#_addchildfrombuilder[_addChildFromBuilder]
* link:FormattedString.adoc#_addview[_addView]
* link:FormattedString.adoc#_addviewcore[_addViewCore]
* link:FormattedString.adoc#_addviewtonativevisualtree[_addViewToNativeVisualTree]
* link:FormattedString.adoc#_applyxmlattribute[_applyXmlAttribute]
* link:FormattedString.adoc#_batchupdate[_batchUpdate]
* link:FormattedString.adoc#_childindextonativechildindex[_childIndexToNativeChildIndex]
* link:FormattedString.adoc#_createpropertychangedata[_createPropertyChangeData]
* link:FormattedString.adoc#_dialogclosed[_dialogClosed]
* link:FormattedString.adoc#_emit[_emit]
* link:FormattedString.adoc#_gotovisualstate[_goToVisualState]
* link:FormattedString.adoc#_inheritstylescope[_inheritStyleScope]
* link:FormattedString.adoc#_layoutparent[_layoutParent]
* link:FormattedString.adoc#_oncssstatechange[_onCssStateChange]
* link:FormattedString.adoc#_onrootviewreset[_onRootViewReset]
* link:FormattedString.adoc#_parentchanged[_parentChanged]
* link:FormattedString.adoc#_removeview[_removeView]
* link:FormattedString.adoc#_removeviewcore[_removeViewCore]
* link:FormattedString.adoc#_removeviewfromnativevisualtree[_removeViewFromNativeVisualTree]
* link:FormattedString.adoc#_resumenativeupdates[_resumeNativeUpdates]
* link:FormattedString.adoc#_setupasrootview[_setupAsRootView]
* link:FormattedString.adoc#_setupui[_setupUI]
* link:FormattedString.adoc#_shoulddelaylayout[_shouldDelayLayout]
* link:FormattedString.adoc#_suspendnativeupdates[_suspendNativeUpdates]
* link:FormattedString.adoc#_teardownui[_tearDownUI]
* link:FormattedString.adoc#addeventlistener[addEventListener]
* link:FormattedString.adoc#addpropertychangehandler[addPropertyChangeHandler]
* link:FormattedString.adoc#addpseudoclass[addPseudoClass]
* link:FormattedString.adoc#bind[bind]
* link:FormattedString.adoc#callloaded[callLoaded]
* link:FormattedString.adoc#callunloaded[callUnloaded]
* link:FormattedString.adoc#closemodal[closeModal]
* link:FormattedString.adoc#createnativeview[createNativeView]
* link:FormattedString.adoc#deletepseudoclass[deletePseudoClass]
* link:FormattedString.adoc#destroynode[destroyNode]
* link:FormattedString.adoc#disposenativeview[disposeNativeView]
* link:FormattedString.adoc#eachchild[eachChild]
* link:FormattedString.adoc#ensuredomnode[ensureDomNode]
* link:FormattedString.adoc#get[get]
* link:FormattedString.adoc#getviewbydomid[getViewByDomId]
* link:FormattedString.adoc#getviewbyid[getViewById]
* link:FormattedString.adoc#haslisteners[hasListeners]
* link:FormattedString.adoc#initnativeview[initNativeView]
* link:FormattedString.adoc#loadview[loadView]
* link:FormattedString.adoc#notify[notify]
* link:FormattedString.adoc#notifypropertychange[notifyPropertyChange]
* link:FormattedString.adoc#off[off]
* link:FormattedString.adoc#on[on]
* link:FormattedString.adoc#onloaded[onLoaded]
* link:FormattedString.adoc#onpropertychange[onPropertyChange]
* link:FormattedString.adoc#onresumenativeupdates[onResumeNativeUpdates]
* link:FormattedString.adoc#onspanscollectionchanged[onSpansCollectionChanged]
* link:FormattedString.adoc#onunloaded[onUnloaded]
* link:FormattedString.adoc#once[once]
* link:FormattedString.adoc#removeeventlistener[removeEventListener]
* link:FormattedString.adoc#removepropertychangehandler[removePropertyChangeHandler]
* link:FormattedString.adoc#requestlayout[requestLayout]
* link:FormattedString.adoc#resetnativeview[resetNativeView]
* link:FormattedString.adoc#set[set]
* link:FormattedString.adoc#setinlinestyle[setInlineStyle]
* link:FormattedString.adoc#setnativeview[setNativeView]
* link:FormattedString.adoc#setproperty[setProperty]
* link:FormattedString.adoc#showmodal[showModal]
* link:FormattedString.adoc#tostring[toString]
* link:FormattedString.adoc#unbind[unbind]
* link:FormattedString.adoc#unloadview[unloadView]
* link:FormattedString.adoc#addeventlistener-1[addEventListener]
* link:FormattedString.adoc#off-1[off]
* link:FormattedString.adoc#on-1[on]
* link:FormattedString.adoc#once-1[once]
* link:FormattedString.adoc#removeeventlistener-1[removeEventListener]
...
• `get` *textDecoration*(): link:../modules/CoreTypes.adoc#textdecorationtype[`TextDecorationType`]

==== Returns

link:../modules/CoreTypes.adoc#textdecorationtype[`TextDecorationType`]
