...
* link:ImageCache.adoc#constructor[constructor]

=== Properties

* link:ImageCache.adoc#_isviewbase[_isViewBase]
* link:ImageCache.adoc#maxrequests[maxRequests]
* link:ImageCache.adoc#placeholder[placeholder]
* link:ImageCache.adoc#downloaderrorevent[downloadErrorEvent]
* link:ImageCache.adoc#downloadedevent[downloadedEvent]
* link:ImageCache.adoc#propertychangeevent[propertyChangeEvent]

=== Methods

* link:ImageCache.adoc#_createpropertychangedata[_createPropertyChangeData]
* link:ImageCache.adoc#_downloadcore[_downloadCore]
* link:ImageCache.adoc#_emit[_emit]
* link:ImageCache.adoc#_ondownloadcompleted[_onDownloadCompleted]
* link:ImageCache.adoc#_ondownloaderror[_onDownloadError]
* link:ImageCache.adoc#addeventlistener[addEventListener]
* link:ImageCache.adoc#clear[clear]
* link:ImageCache.adoc#disabledownload[disableDownload]
* link:ImageCache.adoc#enabledownload[enableDownload]
* link:ImageCache.adoc#enqueue[enqueue]
* link:ImageCache.adoc#get[get]
* link:ImageCache.adoc#haslisteners[hasListeners]
* link:ImageCache.adoc#notify[notify]
* link:ImageCache.adoc#notifypropertychange[notifyPropertyChange]
* link:ImageCache.adoc#off[off]
* link:ImageCache.adoc#on[on]
* link:ImageCache.adoc#once[once]
* link:ImageCache.adoc#push[push]
* link:ImageCache.adoc#remove[remove]
* link:ImageCache.adoc#removeeventlistener[removeEventListener]
* link:ImageCache.adoc#set[set]
* link:ImageCache.adoc#setproperty[setProperty]
* link:ImageCache.adoc#addeventlistener-1[addEventListener]
* link:ImageCache.adoc#off-1[off]
* link:ImageCache.adoc#on-1[on]
* link:ImageCache.adoc#once-1[once]
* link:ImageCache.adoc#removeeventlistener-1[removeEventListener]
