...
xref:../README.adoc[NativeScript] / xref:../modules.adoc[Exports] / ContainerView
...
* link:ContainerView.adoc#constructor[constructor]

=== Properties

* link:ContainerView.adoc#_androidcontentdescriptionupdated[_androidContentDescriptionUpdated]
* link:ContainerView.adoc#_automaticallyadjustsscrollviewinsets[_automaticallyAdjustsScrollViewInsets]
* link:ContainerView.adoc#_closemodalcallback[_closeModalCallback]
* link:ContainerView.adoc#_context[_context]
* link:ContainerView.adoc#_cssstate[_cssState]
* link:ContainerView.adoc#_currentheightmeasurespec[_currentHeightMeasureSpec]
* link:ContainerView.adoc#_currentwidthmeasurespec[_currentWidthMeasureSpec]
* link:ContainerView.adoc#_defaultpaddingbottom[_defaultPaddingBottom]
* link:ContainerView.adoc#_defaultpaddingleft[_defaultPaddingLeft]
* link:ContainerView.adoc#_defaultpaddingright[_defaultPaddingRight]
* link:ContainerView.adoc#_defaultpaddingtop[_defaultPaddingTop]
* link:ContainerView.adoc#_domid[_domId]
* link:ContainerView.adoc#_gestureobservers[_gestureObservers]
* link:ContainerView.adoc#_ignoreflexminwidthheightreset[_ignoreFlexMinWidthHeightReset]
* link:ContainerView.adoc#_isaddedtonativevisualtree[_isAddedToNativeVisualTree]
* link:ContainerView.adoc#_islayoutvalid[_isLayoutValid]
* link:ContainerView.adoc#_ispaddingrelative[_isPaddingRelative]
* link:ContainerView.adoc#_isstylescopehost[_isStyleScopeHost]
* link:ContainerView.adoc#_isviewbase[_isViewBase]
* link:ContainerView.adoc#_manager[_manager]
* link:ContainerView.adoc#_modalparent[_modalParent]
* link:ContainerView.adoc#_modulename[_moduleName]
* link:ContainerView.adoc#_oldbottom[_oldBottom]
* link:ContainerView.adoc#_oldleft[_oldLeft]
* link:ContainerView.adoc#_oldright[_oldRight]
* link:ContainerView.adoc#_oldtop[_oldTop]
* link:ContainerView.adoc#_stylescope[_styleScope]
* link:ContainerView.adoc#_suspendnativeupdatescount[_suspendNativeUpdatesCount]
* link:ContainerView.adoc#_suspendedupdates[_suspendedUpdates]
* link:ContainerView.adoc#accessibilityhidden[accessibilityHidden]
* link:ContainerView.adoc#accessibilityhint[accessibilityHint]
* link:ContainerView.adoc#accessibilityidentifier[accessibilityIdentifier]
* link:ContainerView.adoc#accessibilitylabel[accessibilityLabel]
* link:ContainerView.adoc#accessibilitylanguage[accessibilityLanguage]
* link:ContainerView.adoc#accessibilityliveregion[accessibilityLiveRegion]
* link:ContainerView.adoc#accessibilitymediasession[accessibilityMediaSession]
* link:ContainerView.adoc#accessibilityrole[accessibilityRole]
* link:ContainerView.adoc#accessibilitystate[accessibilityState]
* link:ContainerView.adoc#accessibilityvalue[accessibilityValue]
* link:ContainerView.adoc#accessible[accessible]
* link:ContainerView.adoc#alignself[alignSelf]
* link:ContainerView.adoc#android[android]
* link:ContainerView.adoc#androiddynamicelevationoffset[androidDynamicElevationOffset]
* link:ContainerView.adoc#androidelevation[androidElevation]
* link:ContainerView.adoc#automationtext[automationText]
* link:ContainerView.adoc#background[background]
* link:ContainerView.adoc#backgroundcolor[backgroundColor]
* link:ContainerView.adoc#backgroundimage[backgroundImage]
* link:ContainerView.adoc#bindingcontext[bindingContext]
* link:ContainerView.adoc#borderbottomcolor[borderBottomColor]
* link:ContainerView.adoc#borderbottomleftradius[borderBottomLeftRadius]
* link:ContainerView.adoc#borderbottomrightradius[borderBottomRightRadius]
* link:ContainerView.adoc#borderbottomwidth[borderBottomWidth]
* link:ContainerView.adoc#bordercolor[borderColor]
* link:ContainerView.adoc#borderleftcolor[borderLeftColor]
* link:ContainerView.adoc#borderleftwidth[borderLeftWidth]
* link:ContainerView.adoc#borderradius[borderRadius]
* link:ContainerView.adoc#borderrightcolor[borderRightColor]
* link:ContainerView.adoc#borderrightwidth[borderRightWidth]
* link:ContainerView.adoc#bordertopcolor[borderTopColor]
* link:ContainerView.adoc#bordertopleftradius[borderTopLeftRadius]
* link:ContainerView.adoc#bordertoprightradius[borderTopRightRadius]
* link:ContainerView.adoc#bordertopwidth[borderTopWidth]
* link:ContainerView.adoc#borderwidth[borderWidth]
* link:ContainerView.adoc#boxshadow[boxShadow]
* link:ContainerView.adoc#classname[className]
* link:ContainerView.adoc#col[col]
* link:ContainerView.adoc#colspan[colSpan]
* link:ContainerView.adoc#color[color]
* link:ContainerView.adoc#column[column]
* link:ContainerView.adoc#columnspan[columnSpan]
* link:ContainerView.adoc#css[css]
* link:ContainerView.adoc#cssclasses[cssClasses]
* link:ContainerView.adoc#csspseudoclasses[cssPseudoClasses]
* link:ContainerView.adoc#csstype[cssType]
* link:ContainerView.adoc#dock[dock]
* link:ContainerView.adoc#domnode[domNode]
* link:ContainerView.adoc#effectiveborderbottomwidth[effectiveBorderBottomWidth]
* link:ContainerView.adoc#effectiveborderleftwidth[effectiveBorderLeftWidth]
* link:ContainerView.adoc#effectiveborderrightwidth[effectiveBorderRightWidth]
* link:ContainerView.adoc#effectivebordertopwidth[effectiveBorderTopWidth]
* link:ContainerView.adoc#effectiveheight[effectiveHeight]
* link:ContainerView.adoc#effectiveleft[effectiveLeft]
* link:ContainerView.adoc#effectivemarginbottom[effectiveMarginBottom]
* link:ContainerView.adoc#effectivemarginleft[effectiveMarginLeft]
* link:ContainerView.adoc#effectivemarginright[effectiveMarginRight]
* link:ContainerView.adoc#effectivemargintop[effectiveMarginTop]
* link:ContainerView.adoc#effectiveminheight[effectiveMinHeight]
* link:ContainerView.adoc#effectiveminwidth[effectiveMinWidth]
* link:ContainerView.adoc#effectivepaddingbottom[effectivePaddingBottom]
* link:ContainerView.adoc#effectivepaddingleft[effectivePaddingLeft]
* link:ContainerView.adoc#effectivepaddingright[effectivePaddingRight]
* link:ContainerView.adoc#effectivepaddingtop[effectivePaddingTop]
* link:ContainerView.adoc#effectivetop[effectiveTop]
* link:ContainerView.adoc#effectivewidth[effectiveWidth]
* link:ContainerView.adoc#flexgrow[flexGrow]
* link:ContainerView.adoc#flexshrink[flexShrink]
* link:ContainerView.adoc#flexwrapbefore[flexWrapBefore]
* link:ContainerView.adoc#height[height]
* link:ContainerView.adoc#horizontalalignment[horizontalAlignment]
* link:ContainerView.adoc#id[id]
* link:ContainerView.adoc#ignoretouchanimation[ignoreTouchAnimation]
* link:ContainerView.adoc#ios[ios]
* link:ContainerView.adoc#iosignoresafearea[iosIgnoreSafeArea]
* link:ContainerView.adoc#iosoverflowsafearea[iosOverflowSafeArea]
* link:ContainerView.adoc#iosoverflowsafeareaenabled[iosOverflowSafeAreaEnabled]
* link:ContainerView.adoc#iscollapsed[isCollapsed]
* link:ContainerView.adoc#isenabled[isEnabled]
* link:ContainerView.adoc#islayoutrequired[isLayoutRequired]
* link:ContainerView.adoc#islayoutvalid[isLayoutValid]
* link:ContainerView.adoc#isuserinteractionenabled[isUserInteractionEnabled]
* link:ContainerView.adoc#left[left]
* link:ContainerView.adoc#margin[margin]
* link:ContainerView.adoc#marginbottom[marginBottom]
* link:ContainerView.adoc#marginleft[marginLeft]
* link:ContainerView.adoc#marginright[marginRight]
* link:ContainerView.adoc#margintop[marginTop]
* link:ContainerView.adoc#minheight[minHeight]
* link:ContainerView.adoc#minwidth[minWidth]
* link:ContainerView.adoc#modal[modal]
* link:ContainerView.adoc#nativeviewprotected[nativeViewProtected]
* link:ContainerView.adoc#opacity[opacity]
* link:ContainerView.adoc#order[order]
* link:ContainerView.adoc#originx[originX]
* link:ContainerView.adoc#originy[originY]
* link:ContainerView.adoc#parent[parent]
* link:ContainerView.adoc#perspective[perspective]
* link:ContainerView.adoc#recyclenativeview[recycleNativeView]
* link:ContainerView.adoc#reusable[reusable]
* link:ContainerView.adoc#rotate[rotate]
* link:ContainerView.adoc#rotatex[rotateX]
* link:ContainerView.adoc#rotatey[rotateY]
* link:ContainerView.adoc#row[row]
* link:ContainerView.adoc#rowspan[rowSpan]
* link:ContainerView.adoc#scalex[scaleX]
* link:ContainerView.adoc#scaley[scaleY]
* link:ContainerView.adoc#testid[testID]
* link:ContainerView.adoc#top[top]
* link:ContainerView.adoc#touchanimation[touchAnimation]
* link:ContainerView.adoc#touchdelay[touchDelay]
* link:ContainerView.adoc#translatex[translateX]
* link:ContainerView.adoc#translatey[translateY]
* link:ContainerView.adoc#verticalalignment[verticalAlignment]
* link:ContainerView.adoc#viewcontroller[viewController]
* link:ContainerView.adoc#visibility[visibility]
* link:ContainerView.adoc#width[width]
* link:ContainerView.adoc#accessibilityblurevent[accessibilityBlurEvent]
* link:ContainerView.adoc#accessibilityfocuschangedevent[accessibilityFocusChangedEvent]
* link:ContainerView.adoc#accessibilityfocusevent[accessibilityFocusEvent]
* link:ContainerView.adoc#accessibilityperformescapeevent[accessibilityPerformEscapeEvent]
* link:ContainerView.adoc#createdevent[createdEvent]
* link:ContainerView.adoc#disposenativeviewevent[disposeNativeViewEvent]
* link:ContainerView.adoc#layoutchangedevent[layoutChangedEvent]
* link:ContainerView.adoc#loadedevent[loadedEvent]
* link:ContainerView.adoc#propertychangeevent[propertyChangeEvent]
* link:ContainerView.adoc#showingmodallyevent[showingModallyEvent]
* link:ContainerView.adoc#shownmodallyevent[shownModallyEvent]
* link:ContainerView.adoc#unloadedevent[unloadedEvent]

=== Accessors

* link:ContainerView.adoc#backgroundposition[backgroundPosition]
* link:ContainerView.adoc#backgroundrepeat[backgroundRepeat]
* link:ContainerView.adoc#backgroundsize[backgroundSize]
* link:ContainerView.adoc#class[class]
* link:ContainerView.adoc#isloaded[isLoaded]
* link:ContainerView.adoc#nativeview[nativeView]
* link:ContainerView.adoc#page[page]
* link:ContainerView.adoc#parentnode[parentNode]
* link:ContainerView.adoc#style[style]
* link:ContainerView.adoc#texttransform[textTransform]
* link:ContainerView.adoc#typename[typeName]

=== Methods

* link:ContainerView.adoc#_addview[_addView]
* link:ContainerView.adoc#_addviewcore[_addViewCore]
* link:ContainerView.adoc#_addviewtonativevisualtree[_addViewToNativeVisualTree]
* link:ContainerView.adoc#_applybackground[_applyBackground]
* link:ContainerView.adoc#_applyxmlattribute[_applyXmlAttribute]
* link:ContainerView.adoc#_batchupdate[_batchUpdate]
* link:ContainerView.adoc#_childindextonativechildindex[_childIndexToNativeChildIndex]
* link:ContainerView.adoc#_closeallmodalviewsinternal[_closeAllModalViewsInternal]
* link:ContainerView.adoc#_createpropertychangedata[_createPropertyChangeData]
* link:ContainerView.adoc#_dialogclosed[_dialogClosed]
* link:ContainerView.adoc#_eachlayoutview[_eachLayoutView]
* link:ContainerView.adoc#_emit[_emit]
* link:ContainerView.adoc#_getcurrentlayoutbounds[_getCurrentLayoutBounds]
* link:ContainerView.adoc#_getfragmentmanager[_getFragmentManager]
* link:ContainerView.adoc#_getnativeviewscount[_getNativeViewsCount]
* link:ContainerView.adoc#_getrootmodalviews[_getRootModalViews]
* link:ContainerView.adoc#_getvalue[_getValue]
* link:ContainerView.adoc#_gotovisualstate[_goToVisualState]
* link:ContainerView.adoc#_handlelivesync[_handleLivesync]
* link:ContainerView.adoc#_hasancestorview[_hasAncestorView]
* link:ContainerView.adoc#_hidenativemodalview[_hideNativeModalView]
* link:ContainerView.adoc#_inheritstylescope[_inheritStyleScope]
* link:ContainerView.adoc#_layoutparent[_layoutParent]
* link:ContainerView.adoc#_observe[_observe]
* link:ContainerView.adoc#_onattachedtowindow[_onAttachedToWindow]
* link:ContainerView.adoc#_oncssstatechange[_onCssStateChange]
* link:ContainerView.adoc#_ondetachedfromwindow[_onDetachedFromWindow]
* link:ContainerView.adoc#_onlivesync[_onLivesync]
* link:ContainerView.adoc#_onrootviewreset[_onRootViewReset]
* link:ContainerView.adoc#_onsizechanged[_onSizeChanged]
* link:ContainerView.adoc#_parentchanged[_parentChanged]
* link:ContainerView.adoc#_raiselayoutchangedevent[_raiseLayoutChangedEvent]
* link:ContainerView.adoc#_raiseshowingmodallyevent[_raiseShowingModallyEvent]
* link:ContainerView.adoc#_raiseshownmodallyevent[_raiseShownModallyEvent]
* link:ContainerView.adoc#_redrawnativebackground[_redrawNativeBackground]
* link:ContainerView.adoc#_removeanimation[_removeAnimation]
* link:ContainerView.adoc#_removeview[_removeView]
* link:ContainerView.adoc#_removeviewcore[_removeViewCore]
* link:ContainerView.adoc#_removeviewfromnativevisualtree[_removeViewFromNativeVisualTree]
* link:ContainerView.adoc#_resumenativeupdates[_resumeNativeUpdates]
* link:ContainerView.adoc#_setcurrentlayoutbounds[_setCurrentLayoutBounds]
* link:ContainerView.adoc#_setcurrentmeasurespecs[_setCurrentMeasureSpecs]
* link:ContainerView.adoc#_setminheightnative[_setMinHeightNative]
* link:ContainerView.adoc#_setminwidthnative[_setMinWidthNative]
* link:ContainerView.adoc#_setnativecliptobounds[_setNativeClipToBounds]
* link:ContainerView.adoc#_setnativeviewframe[_setNativeViewFrame]
* link:ContainerView.adoc#_setvalue[_setValue]
* link:ContainerView.adoc#_setupasrootview[_setupAsRootView]
* link:ContainerView.adoc#_setupui[_setupUI]
* link:ContainerView.adoc#_shoulddelaylayout[_shouldDelayLayout]
* link:ContainerView.adoc#_shownativemodalview[_showNativeModalView]
* link:ContainerView.adoc#_suspendnativeupdates[_suspendNativeUpdates]
* link:ContainerView.adoc#_teardownui[_tearDownUI]
* link:ContainerView.adoc#_updateeffectivelayoutvalues[_updateEffectiveLayoutValues]
* link:ContainerView.adoc#_updatestylescope[_updateStyleScope]
* link:ContainerView.adoc#accessibilityannouncement[accessibilityAnnouncement]
* link:ContainerView.adoc#accessibilityscreenchanged[accessibilityScreenChanged]
* link:ContainerView.adoc#addcss[addCss]
* link:ContainerView.adoc#addcssfile[addCssFile]
* link:ContainerView.adoc#addeventlistener[addEventListener]
* link:ContainerView.adoc#addpseudoclass[addPseudoClass]
* link:ContainerView.adoc#animate[animate]
* link:ContainerView.adoc#bind[bind]
* link:ContainerView.adoc#callloaded[callLoaded]
* link:ContainerView.adoc#callunloaded[callUnloaded]
* link:ContainerView.adoc#changecssfile[changeCssFile]
* link:ContainerView.adoc#closemodal[closeModal]
* link:ContainerView.adoc#createanimation[createAnimation]
* link:ContainerView.adoc#createnativeview[createNativeView]
* link:ContainerView.adoc#deletepseudoclass[deletePseudoClass]
* link:ContainerView.adoc#destroynode[destroyNode]
* link:ContainerView.adoc#disposenativeview[disposeNativeView]
* link:ContainerView.adoc#eachchild[eachChild]
* link:ContainerView.adoc#eachchildview[eachChildView]
* link:ContainerView.adoc#ensuredomnode[ensureDomNode]
* link:ContainerView.adoc#focus[focus]
* link:ContainerView.adoc#get[get]
* link:ContainerView.adoc#getactualsize[getActualSize]
* link:ContainerView.adoc#getgestureobservers[getGestureObservers]
* link:ContainerView.adoc#getlocationinwindow[getLocationInWindow]
* link:ContainerView.adoc#getlocationonscreen[getLocationOnScreen]
* link:ContainerView.adoc#getlocationrelativeto[getLocationRelativeTo]
* link:ContainerView.adoc#getmeasuredheight[getMeasuredHeight]
* link:ContainerView.adoc#getmeasuredstate[getMeasuredState]
* link:ContainerView.adoc#getmeasuredwidth[getMeasuredWidth]
* link:ContainerView.adoc#getsafeareainsets[getSafeAreaInsets]
* link:ContainerView.adoc#getviewbydomid[getViewByDomId]
* link:ContainerView.adoc#getviewbyid[getViewById]
* link:ContainerView.adoc#hasgestureobservers[hasGestureObservers]
* link:ContainerView.adoc#haslisteners[hasListeners]
* link:ContainerView.adoc#initnativeview[initNativeView]
* link:ContainerView.adoc#layout[layout]
* link:ContainerView.adoc#layoutnativeview[layoutNativeView]
* link:ContainerView.adoc#loadview[loadView]
* link:ContainerView.adoc#measure[measure]
* link:ContainerView.adoc#notify[notify]
* link:ContainerView.adoc#notifypropertychange[notifyPropertyChange]
* link:ContainerView.adoc#off[off]
* link:ContainerView.adoc#on[on]
* link:ContainerView.adoc#onbackpressed[onBackPressed]
* link:ContainerView.adoc#onlayout[onLayout]
* link:ContainerView.adoc#onloaded[onLoaded]
* link:ContainerView.adoc#onmeasure[onMeasure]
* link:ContainerView.adoc#onresumenativeupdates[onResumeNativeUpdates]
* link:ContainerView.adoc#onunloaded[onUnloaded]
* link:ContainerView.adoc#once[once]
* link:ContainerView.adoc#removeeventlistener[removeEventListener]
* link:ContainerView.adoc#requestlayout[requestLayout]
* link:ContainerView.adoc#resetnativeview[resetNativeView]
* link:ContainerView.adoc#sendaccessibilityevent[sendAccessibilityEvent]
* link:ContainerView.adoc#set[set]
* link:ContainerView.adoc#setinlinestyle[setInlineStyle]
* link:ContainerView.adoc#setmeasureddimension[setMeasuredDimension]
* link:ContainerView.adoc#setnativeview[setNativeView]
* link:ContainerView.adoc#setontouchlistener[setOnTouchListener]
* link:ContainerView.adoc#setproperty[setProperty]
* link:ContainerView.adoc#settestid[setTestID]
* link:ContainerView.adoc#showmodal[showModal]
* link:ContainerView.adoc#tostring[toString]
* link:ContainerView.adoc#unbind[unbind]
* link:ContainerView.adoc#unloadview[unloadView]
* link:ContainerView.adoc#addeventlistener-1[addEventListener]
* link:ContainerView.adoc#combinemeasuredstates[combineMeasuredStates]
* link:ContainerView.adoc#layoutchild[layoutChild]
* link:ContainerView.adoc#measurechild[measureChild]
* link:ContainerView.adoc#off-1[off]
* link:ContainerView.adoc#on-1[on]
* link:ContainerView.adoc#once-1[once]
* link:ContainerView.adoc#removeeventlistener-1[removeEventListener]
* link:ContainerView.adoc#resolvesizeandstate[resolveSizeAndState]
...
xref:View.adoc[View].link:View.adoc#iosoverflowsafearea[iosOverflowSafeArea]
