...
* link:TouchManager.adoc#constructor[constructor]

=== Properties

* link:TouchManager.adoc#animations[animations]
* link:TouchManager.adoc#enableglobaltapanimations[enableGlobalTapAnimations]
* link:TouchManager.adoc#touchanimationdefinitions[touchAnimationDefinitions]
* link:TouchManager.adoc#touchhandlers[touchHandlers]

=== Methods

* link:TouchManager.adoc#addanimations[addAnimations]
* link:TouchManager.adoc#startanimationfortype[startAnimationForType]
...
▪ `Static` *animations*: link:../modules.adoc#touchanimationoptions[`TouchAnimationOptions`]
