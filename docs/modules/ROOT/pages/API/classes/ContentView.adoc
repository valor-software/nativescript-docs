...
xref:../README.adoc[NativeScript] / xref:../modules.adoc[Exports] / ContentView
...
* link:ContentView.md#constructor[constructor]

=== Properties

* link:ContentView.md#_androidcontentdescriptionupdated[_androidContentDescriptionUpdated]
* link:ContentView.md#_automaticallyadjustsscrollviewinsets[_automaticallyAdjustsScrollViewInsets]
* link:ContentView.md#_closemodalcallback[_closeModalCallback]
* link:ContentView.md#_content[_content]
* link:ContentView.md#_context[_context]
* link:ContentView.md#_cssstate[_cssState]
* link:ContentView.md#_currentheightmeasurespec[_currentHeightMeasureSpec]
* link:ContentView.md#_currentwidthmeasurespec[_currentWidthMeasureSpec]
* link:ContentView.md#_defaultpaddingbottom[_defaultPaddingBottom]
* link:ContentView.md#_defaultpaddingleft[_defaultPaddingLeft]
* link:ContentView.md#_defaultpaddingright[_defaultPaddingRight]
* link:ContentView.md#_defaultpaddingtop[_defaultPaddingTop]
* link:ContentView.md#_domid[_domId]
* link:ContentView.md#_gestureobservers[_gestureObservers]
* link:ContentView.md#_ignoreflexminwidthheightreset[_ignoreFlexMinWidthHeightReset]
* link:ContentView.md#_isaddedtonativevisualtree[_isAddedToNativeVisualTree]
* link:ContentView.md#_islayoutvalid[_isLayoutValid]
* link:ContentView.md#_ispaddingrelative[_isPaddingRelative]
* link:ContentView.md#_isstylescopehost[_isStyleScopeHost]
* link:ContentView.md#_isviewbase[_isViewBase]
* link:ContentView.md#_manager[_manager]
* link:ContentView.md#_modalparent[_modalParent]
* link:ContentView.md#_modulename[_moduleName]
* link:ContentView.md#_oldbottom[_oldBottom]
* link:ContentView.md#_oldleft[_oldLeft]
* link:ContentView.md#_oldright[_oldRight]
* link:ContentView.md#_oldtop[_oldTop]
* link:ContentView.md#_stylescope[_styleScope]
* link:ContentView.md#_suspendnativeupdatescount[_suspendNativeUpdatesCount]
* link:ContentView.md#_suspendedupdates[_suspendedUpdates]
* link:ContentView.md#accessibilityhidden[accessibilityHidden]
* link:ContentView.md#accessibilityhint[accessibilityHint]
* link:ContentView.md#accessibilityidentifier[accessibilityIdentifier]
* link:ContentView.md#accessibilitylabel[accessibilityLabel]
* link:ContentView.md#accessibilitylanguage[accessibilityLanguage]
* link:ContentView.md#accessibilityliveregion[accessibilityLiveRegion]
* link:ContentView.md#accessibilitymediasession[accessibilityMediaSession]
* link:ContentView.md#accessibilityrole[accessibilityRole]
* link:ContentView.md#accessibilitystate[accessibilityState]
* link:ContentView.md#accessibilityvalue[accessibilityValue]
* link:ContentView.md#accessible[accessible]
* link:ContentView.md#alignself[alignSelf]
* link:ContentView.md#android[android]
* link:ContentView.md#androiddynamicelevationoffset[androidDynamicElevationOffset]
* link:ContentView.md#androidelevation[androidElevation]
* link:ContentView.md#automationtext[automationText]
* link:ContentView.md#background[background]
* link:ContentView.md#backgroundcolor[backgroundColor]
* link:ContentView.md#backgroundimage[backgroundImage]
* link:ContentView.md#bindingcontext[bindingContext]
* link:ContentView.md#borderbottomcolor[borderBottomColor]
* link:ContentView.md#borderbottomleftradius[borderBottomLeftRadius]
* link:ContentView.md#borderbottomrightradius[borderBottomRightRadius]
* link:ContentView.md#borderbottomwidth[borderBottomWidth]
* link:ContentView.md#bordercolor[borderColor]
* link:ContentView.md#borderleftcolor[borderLeftColor]
* link:ContentView.md#borderleftwidth[borderLeftWidth]
* link:ContentView.md#borderradius[borderRadius]
* link:ContentView.md#borderrightcolor[borderRightColor]
* link:ContentView.md#borderrightwidth[borderRightWidth]
* link:ContentView.md#bordertopcolor[borderTopColor]
* link:ContentView.md#bordertopleftradius[borderTopLeftRadius]
* link:ContentView.md#bordertoprightradius[borderTopRightRadius]
* link:ContentView.md#bordertopwidth[borderTopWidth]
* link:ContentView.md#borderwidth[borderWidth]
* link:ContentView.md#boxshadow[boxShadow]
* link:ContentView.md#classname[className]
* link:ContentView.md#col[col]
* link:ContentView.md#colspan[colSpan]
* link:ContentView.md#color[color]
* link:ContentView.md#column[column]
* link:ContentView.md#columnspan[columnSpan]
* link:ContentView.md#css[css]
* link:ContentView.md#cssclasses[cssClasses]
* link:ContentView.md#csspseudoclasses[cssPseudoClasses]
* link:ContentView.md#csstype[cssType]
* link:ContentView.md#dock[dock]
* link:ContentView.md#domnode[domNode]
* link:ContentView.md#effectiveborderbottomwidth[effectiveBorderBottomWidth]
* link:ContentView.md#effectiveborderleftwidth[effectiveBorderLeftWidth]
* link:ContentView.md#effectiveborderrightwidth[effectiveBorderRightWidth]
* link:ContentView.md#effectivebordertopwidth[effectiveBorderTopWidth]
* link:ContentView.md#effectiveheight[effectiveHeight]
* link:ContentView.md#effectiveleft[effectiveLeft]
* link:ContentView.md#effectivemarginbottom[effectiveMarginBottom]
* link:ContentView.md#effectivemarginleft[effectiveMarginLeft]
* link:ContentView.md#effectivemarginright[effectiveMarginRight]
* link:ContentView.md#effectivemargintop[effectiveMarginTop]
* link:ContentView.md#effectiveminheight[effectiveMinHeight]
* link:ContentView.md#effectiveminwidth[effectiveMinWidth]
* link:ContentView.md#effectivepaddingbottom[effectivePaddingBottom]
* link:ContentView.md#effectivepaddingleft[effectivePaddingLeft]
* link:ContentView.md#effectivepaddingright[effectivePaddingRight]
* link:ContentView.md#effectivepaddingtop[effectivePaddingTop]
* link:ContentView.md#effectivetop[effectiveTop]
* link:ContentView.md#effectivewidth[effectiveWidth]
* link:ContentView.md#flexgrow[flexGrow]
* link:ContentView.md#flexshrink[flexShrink]
* link:ContentView.md#flexwrapbefore[flexWrapBefore]
* link:ContentView.md#height[height]
* link:ContentView.md#horizontalalignment[horizontalAlignment]
* link:ContentView.md#id[id]
* link:ContentView.md#ignoretouchanimation[ignoreTouchAnimation]
* link:ContentView.md#ios[ios]
* link:ContentView.md#iosignoresafearea[iosIgnoreSafeArea]
* link:ContentView.md#iosoverflowsafearea[iosOverflowSafeArea]
* link:ContentView.md#iosoverflowsafeareaenabled[iosOverflowSafeAreaEnabled]
* link:ContentView.md#iscollapsed[isCollapsed]
* link:ContentView.md#isenabled[isEnabled]
* link:ContentView.md#islayoutrequired[isLayoutRequired]
* link:ContentView.md#islayoutvalid[isLayoutValid]
* link:ContentView.md#isuserinteractionenabled[isUserInteractionEnabled]
* link:ContentView.md#left[left]
* link:ContentView.md#margin[margin]
* link:ContentView.md#marginbottom[marginBottom]
* link:ContentView.md#marginleft[marginLeft]
* link:ContentView.md#marginright[marginRight]
* link:ContentView.md#margintop[marginTop]
* link:ContentView.md#minheight[minHeight]
* link:ContentView.md#minwidth[minWidth]
* link:ContentView.md#modal[modal]
* link:ContentView.md#nativeviewprotected[nativeViewProtected]
* link:ContentView.md#opacity[opacity]
* link:ContentView.md#order[order]
* link:ContentView.md#originx[originX]
* link:ContentView.md#originy[originY]
* link:ContentView.md#parent[parent]
* link:ContentView.md#perspective[perspective]
* link:ContentView.md#recyclenativeview[recycleNativeView]
* link:ContentView.md#reusable[reusable]
* link:ContentView.md#rotate[rotate]
* link:ContentView.md#rotatex[rotateX]
* link:ContentView.md#rotatey[rotateY]
* link:ContentView.md#row[row]
* link:ContentView.md#rowspan[rowSpan]
* link:ContentView.md#scalex[scaleX]
* link:ContentView.md#scaley[scaleY]
* link:ContentView.md#testid[testID]
* link:ContentView.md#top[top]
* link:ContentView.md#touchanimation[touchAnimation]
* link:ContentView.md#touchdelay[touchDelay]
* link:ContentView.md#translatex[translateX]
* link:ContentView.md#translatey[translateY]
* link:ContentView.md#verticalalignment[verticalAlignment]
* link:ContentView.md#viewcontroller[viewController]
* link:ContentView.md#visibility[visibility]
* link:ContentView.md#width[width]
* link:ContentView.md#accessibilityblurevent[accessibilityBlurEvent]
* link:ContentView.md#accessibilityfocuschangedevent[accessibilityFocusChangedEvent]
* link:ContentView.md#accessibilityfocusevent[accessibilityFocusEvent]
* link:ContentView.md#accessibilityperformescapeevent[accessibilityPerformEscapeEvent]
* link:ContentView.md#createdevent[createdEvent]
* link:ContentView.md#disposenativeviewevent[disposeNativeViewEvent]
* link:ContentView.md#layoutchangedevent[layoutChangedEvent]
* link:ContentView.md#loadedevent[loadedEvent]
* link:ContentView.md#propertychangeevent[propertyChangeEvent]
* link:ContentView.md#showingmodallyevent[showingModallyEvent]
* link:ContentView.md#shownmodallyevent[shownModallyEvent]
* link:ContentView.md#unloadedevent[unloadedEvent]

=== Accessors

* link:ContentView.md#_childrencount[_childrenCount]
* link:ContentView.md#backgroundposition[backgroundPosition]
* link:ContentView.md#backgroundrepeat[backgroundRepeat]
* link:ContentView.md#backgroundsize[backgroundSize]
* link:ContentView.md#class[class]
* link:ContentView.md#content[content]
* link:ContentView.md#isloaded[isLoaded]
* link:ContentView.md#layoutview[layoutView]
* link:ContentView.md#nativeview[nativeView]
* link:ContentView.md#page[page]
* link:ContentView.md#parentnode[parentNode]
* link:ContentView.md#style[style]
* link:ContentView.md#texttransform[textTransform]
* link:ContentView.md#typename[typeName]

=== Methods

* link:ContentView.md#_addchildfrombuilder[_addChildFromBuilder]
* link:ContentView.md#_addview[_addView]
* link:ContentView.md#_addviewcore[_addViewCore]
* link:ContentView.md#_addviewtonativevisualtree[_addViewToNativeVisualTree]
* link:ContentView.md#_applybackground[_applyBackground]
* link:ContentView.md#_applyxmlattribute[_applyXmlAttribute]
* link:ContentView.md#_batchupdate[_batchUpdate]
* link:ContentView.md#_childindextonativechildindex[_childIndexToNativeChildIndex]
* link:ContentView.md#_closeallmodalviewsinternal[_closeAllModalViewsInternal]
* link:ContentView.md#_createpropertychangedata[_createPropertyChangeData]
* link:ContentView.md#_dialogclosed[_dialogClosed]
* link:ContentView.md#_eachlayoutview[_eachLayoutView]
* link:ContentView.md#_emit[_emit]
* link:ContentView.md#_getcurrentlayoutbounds[_getCurrentLayoutBounds]
* link:ContentView.md#_getfragmentmanager[_getFragmentManager]
* link:ContentView.md#_getnativeviewscount[_getNativeViewsCount]
* link:ContentView.md#_getrootmodalviews[_getRootModalViews]
* link:ContentView.md#_getvalue[_getValue]
* link:ContentView.md#_gotovisualstate[_goToVisualState]
* link:ContentView.md#_handlelivesync[_handleLivesync]
* link:ContentView.md#_hasancestorview[_hasAncestorView]
* link:ContentView.md#_hidenativemodalview[_hideNativeModalView]
* link:ContentView.md#_inheritstylescope[_inheritStyleScope]
* link:ContentView.md#_layoutparent[_layoutParent]
* link:ContentView.md#_observe[_observe]
* link:ContentView.md#_onattachedtowindow[_onAttachedToWindow]
* link:ContentView.md#_oncontentchanged[_onContentChanged]
* link:ContentView.md#_oncssstatechange[_onCssStateChange]
* link:ContentView.md#_ondetachedfromwindow[_onDetachedFromWindow]
* link:ContentView.md#_onlivesync[_onLivesync]
* link:ContentView.md#_onrootviewreset[_onRootViewReset]
* link:ContentView.md#_onsizechanged[_onSizeChanged]
* link:ContentView.md#_parentchanged[_parentChanged]
* link:ContentView.md#_raiselayoutchangedevent[_raiseLayoutChangedEvent]
* link:ContentView.md#_raiseshowingmodallyevent[_raiseShowingModallyEvent]
* link:ContentView.md#_raiseshownmodallyevent[_raiseShownModallyEvent]
* link:ContentView.md#_redrawnativebackground[_redrawNativeBackground]
* link:ContentView.md#_removeanimation[_removeAnimation]
* link:ContentView.md#_removeview[_removeView]
* link:ContentView.md#_removeviewcore[_removeViewCore]
* link:ContentView.md#_removeviewfromnativevisualtree[_removeViewFromNativeVisualTree]
* link:ContentView.md#_resumenativeupdates[_resumeNativeUpdates]
* link:ContentView.md#_setchildminheightnative[_setChildMinHeightNative]
* link:ContentView.md#_setchildminwidthnative[_setChildMinWidthNative]
* link:ContentView.md#_setcurrentlayoutbounds[_setCurrentLayoutBounds]
* link:ContentView.md#_setcurrentmeasurespecs[_setCurrentMeasureSpecs]
* link:ContentView.md#_setminheightnative[_setMinHeightNative]
* link:ContentView.md#_setminwidthnative[_setMinWidthNative]
* link:ContentView.md#_setnativecliptobounds[_setNativeClipToBounds]
* link:ContentView.md#_setnativeviewframe[_setNativeViewFrame]
* link:ContentView.md#_setvalue[_setValue]
* link:ContentView.md#_setupasrootview[_setupAsRootView]
* link:ContentView.md#_setupui[_setupUI]
* link:ContentView.md#_shoulddelaylayout[_shouldDelayLayout]
* link:ContentView.md#_shownativemodalview[_showNativeModalView]
* link:ContentView.md#_suspendnativeupdates[_suspendNativeUpdates]
* link:ContentView.md#_teardownui[_tearDownUI]
* link:ContentView.md#_updateeffectivelayoutvalues[_updateEffectiveLayoutValues]
* link:ContentView.md#_updatenativelayoutparams[_updateNativeLayoutParams]
* link:ContentView.md#_updatestylescope[_updateStyleScope]
* link:ContentView.md#accessibilityannouncement[accessibilityAnnouncement]
* link:ContentView.md#accessibilityscreenchanged[accessibilityScreenChanged]
* link:ContentView.md#addcss[addCss]
* link:ContentView.md#addcssfile[addCssFile]
* link:ContentView.md#addeventlistener[addEventListener]
* link:ContentView.md#addpseudoclass[addPseudoClass]
* link:ContentView.md#animate[animate]
* link:ContentView.md#bind[bind]
* link:ContentView.md#callloaded[callLoaded]
* link:ContentView.md#callunloaded[callUnloaded]
* link:ContentView.md#changecssfile[changeCssFile]
* link:ContentView.md#closemodal[closeModal]
* link:ContentView.md#createanimation[createAnimation]
* link:ContentView.md#createnativeview[createNativeView]
* link:ContentView.md#deletepseudoclass[deletePseudoClass]
* link:ContentView.md#destroynode[destroyNode]
* link:ContentView.md#disposenativeview[disposeNativeView]
* link:ContentView.md#eachchild[eachChild]
* link:ContentView.md#eachchildview[eachChildView]
* link:ContentView.md#ensuredomnode[ensureDomNode]
* link:ContentView.md#focus[focus]
* link:ContentView.md#get[get]
* link:ContentView.md#getactualsize[getActualSize]
* link:ContentView.md#getgestureobservers[getGestureObservers]
* link:ContentView.md#getlocationinwindow[getLocationInWindow]
* link:ContentView.md#getlocationonscreen[getLocationOnScreen]
* link:ContentView.md#getlocationrelativeto[getLocationRelativeTo]
* link:ContentView.md#getmeasuredheight[getMeasuredHeight]
* link:ContentView.md#getmeasuredstate[getMeasuredState]
* link:ContentView.md#getmeasuredwidth[getMeasuredWidth]
* link:ContentView.md#getsafeareainsets[getSafeAreaInsets]
* link:ContentView.md#getviewbydomid[getViewByDomId]
* link:ContentView.md#getviewbyid[getViewById]
* link:ContentView.md#hasgestureobservers[hasGestureObservers]
* link:ContentView.md#haslisteners[hasListeners]
* link:ContentView.md#initnativeview[initNativeView]
* link:ContentView.md#layout[layout]
* link:ContentView.md#layoutnativeview[layoutNativeView]
* link:ContentView.md#loadview[loadView]
* link:ContentView.md#measure[measure]
* link:ContentView.md#notify[notify]
* link:ContentView.md#notifypropertychange[notifyPropertyChange]
* link:ContentView.md#off[off]
* link:ContentView.md#on[on]
* link:ContentView.md#onbackpressed[onBackPressed]
* link:ContentView.md#onlayout[onLayout]
* link:ContentView.md#onloaded[onLoaded]
* link:ContentView.md#onmeasure[onMeasure]
* link:ContentView.md#onresumenativeupdates[onResumeNativeUpdates]
* link:ContentView.md#onunloaded[onUnloaded]
* link:ContentView.md#once[once]
* link:ContentView.md#removeeventlistener[removeEventListener]
* link:ContentView.md#requestlayout[requestLayout]
* link:ContentView.md#resetnativeview[resetNativeView]
* link:ContentView.md#sendaccessibilityevent[sendAccessibilityEvent]
* link:ContentView.md#set[set]
* link:ContentView.md#setinlinestyle[setInlineStyle]
* link:ContentView.md#setmeasureddimension[setMeasuredDimension]
* link:ContentView.md#setnativeview[setNativeView]
* link:ContentView.md#setontouchlistener[setOnTouchListener]
* link:ContentView.md#setproperty[setProperty]
* link:ContentView.md#settestid[setTestID]
* link:ContentView.md#showmodal[showModal]
* link:ContentView.md#tostring[toString]
* link:ContentView.md#unbind[unbind]
* link:ContentView.md#unloadview[unloadView]
* link:ContentView.md#addeventlistener-1[addEventListener]
* link:ContentView.md#combinemeasuredstates[combineMeasuredStates]
* link:ContentView.md#layoutchild[layoutChild]
* link:ContentView.md#measurechild[measureChild]
* link:ContentView.md#off-1[off]
* link:ContentView.md#on-1[on]
* link:ContentView.md#once-1[once]
* link:ContentView.md#removeeventlistener-1[removeEventListener]
* link:ContentView.md#resolvesizeandstate[resolveSizeAndState]
...
==== Inherited from xref:CustomLayoutView.adoc[CustomLayoutView].link:CustomLayoutView.md#constructor[constructor]
...
• `Private` *_content*: xref:View.adoc[`View`]

==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/content-view/index.ts#L9[ui/content-view/index.ts:9]
...
==== Inherited from xref:CustomLayoutView.adoc[CustomLayoutView].link:CustomLayoutView.md#android[android]
...
==== Inherited from xref:CustomLayoutView.adoc[CustomLayoutView].link:CustomLayoutView.md#ios[ios]
...
xref:../interfaces/AddChildFromBuilder.adoc[AddChildFromBuilder].link:../interfaces/AddChildFromBuilder.md#_addchildfrombuilder[_addChildFromBuilder]
...
==== Inherited from xref:CustomLayoutView.adoc[CustomLayoutView].link:CustomLayoutView.md#onloaded[onLoaded]
