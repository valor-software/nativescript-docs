...
xref:../README.adoc[NativeScript] / xref:../modules.adoc[Exports] / DockLayout
...
* link:DockLayout.adoc#constructor[constructor]

=== Properties

* link:DockLayout.adoc#_androidcontentdescriptionupdated[_androidContentDescriptionUpdated]
* link:DockLayout.adoc#_automaticallyadjustsscrollviewinsets[_automaticallyAdjustsScrollViewInsets]
* link:DockLayout.adoc#_closemodalcallback[_closeModalCallback]
* link:DockLayout.adoc#_context[_context]
* link:DockLayout.adoc#_cssstate[_cssState]
* link:DockLayout.adoc#_currentheightmeasurespec[_currentHeightMeasureSpec]
* link:DockLayout.adoc#_currentwidthmeasurespec[_currentWidthMeasureSpec]
* link:DockLayout.adoc#_defaultpaddingbottom[_defaultPaddingBottom]
* link:DockLayout.adoc#_defaultpaddingleft[_defaultPaddingLeft]
* link:DockLayout.adoc#_defaultpaddingright[_defaultPaddingRight]
* link:DockLayout.adoc#_defaultpaddingtop[_defaultPaddingTop]
* link:DockLayout.adoc#_domid[_domId]
* link:DockLayout.adoc#_gestureobservers[_gestureObservers]
* link:DockLayout.adoc#_ignoreflexminwidthheightreset[_ignoreFlexMinWidthHeightReset]
* link:DockLayout.adoc#_isaddedtonativevisualtree[_isAddedToNativeVisualTree]
* link:DockLayout.adoc#_islayoutvalid[_isLayoutValid]
* link:DockLayout.adoc#_ispaddingrelative[_isPaddingRelative]
* link:DockLayout.adoc#_isstylescopehost[_isStyleScopeHost]
* link:DockLayout.adoc#_isviewbase[_isViewBase]
* link:DockLayout.adoc#_manager[_manager]
* link:DockLayout.adoc#_modalparent[_modalParent]
* link:DockLayout.adoc#_modulename[_moduleName]
* link:DockLayout.adoc#_oldbottom[_oldBottom]
* link:DockLayout.adoc#_oldleft[_oldLeft]
* link:DockLayout.adoc#_oldright[_oldRight]
* link:DockLayout.adoc#_oldtop[_oldTop]
* link:DockLayout.adoc#_stylescope[_styleScope]
* link:DockLayout.adoc#_suspendnativeupdatescount[_suspendNativeUpdatesCount]
* link:DockLayout.adoc#_suspendedupdates[_suspendedUpdates]
* link:DockLayout.adoc#accessibilityhidden[accessibilityHidden]
* link:DockLayout.adoc#accessibilityhint[accessibilityHint]
* link:DockLayout.adoc#accessibilityidentifier[accessibilityIdentifier]
* link:DockLayout.adoc#accessibilitylabel[accessibilityLabel]
* link:DockLayout.adoc#accessibilitylanguage[accessibilityLanguage]
* link:DockLayout.adoc#accessibilityliveregion[accessibilityLiveRegion]
* link:DockLayout.adoc#accessibilitymediasession[accessibilityMediaSession]
* link:DockLayout.adoc#accessibilityrole[accessibilityRole]
* link:DockLayout.adoc#accessibilitystate[accessibilityState]
* link:DockLayout.adoc#accessibilityvalue[accessibilityValue]
* link:DockLayout.adoc#accessible[accessible]
* link:DockLayout.adoc#alignself[alignSelf]
* link:DockLayout.adoc#android[android]
* link:DockLayout.adoc#androiddynamicelevationoffset[androidDynamicElevationOffset]
* link:DockLayout.adoc#androidelevation[androidElevation]
* link:DockLayout.adoc#automationtext[automationText]
* link:DockLayout.adoc#background[background]
* link:DockLayout.adoc#backgroundcolor[backgroundColor]
* link:DockLayout.adoc#backgroundimage[backgroundImage]
* link:DockLayout.adoc#bindingcontext[bindingContext]
* link:DockLayout.adoc#borderbottomcolor[borderBottomColor]
* link:DockLayout.adoc#borderbottomleftradius[borderBottomLeftRadius]
* link:DockLayout.adoc#borderbottomrightradius[borderBottomRightRadius]
* link:DockLayout.adoc#borderbottomwidth[borderBottomWidth]
* link:DockLayout.adoc#bordercolor[borderColor]
* link:DockLayout.adoc#borderleftcolor[borderLeftColor]
* link:DockLayout.adoc#borderleftwidth[borderLeftWidth]
* link:DockLayout.adoc#borderradius[borderRadius]
* link:DockLayout.adoc#borderrightcolor[borderRightColor]
* link:DockLayout.adoc#borderrightwidth[borderRightWidth]
* link:DockLayout.adoc#bordertopcolor[borderTopColor]
* link:DockLayout.adoc#bordertopleftradius[borderTopLeftRadius]
* link:DockLayout.adoc#bordertoprightradius[borderTopRightRadius]
* link:DockLayout.adoc#bordertopwidth[borderTopWidth]
* link:DockLayout.adoc#borderwidth[borderWidth]
* link:DockLayout.adoc#boxshadow[boxShadow]
* link:DockLayout.adoc#classname[className]
* link:DockLayout.adoc#cliptobounds[clipToBounds]
* link:DockLayout.adoc#col[col]
* link:DockLayout.adoc#colspan[colSpan]
* link:DockLayout.adoc#color[color]
* link:DockLayout.adoc#column[column]
* link:DockLayout.adoc#columnspan[columnSpan]
* link:DockLayout.adoc#css[css]
* link:DockLayout.adoc#cssclasses[cssClasses]
* link:DockLayout.adoc#csspseudoclasses[cssPseudoClasses]
* link:DockLayout.adoc#csstype[cssType]
* link:DockLayout.adoc#dock[dock]
* link:DockLayout.adoc#domnode[domNode]
* link:DockLayout.adoc#effectiveborderbottomwidth[effectiveBorderBottomWidth]
* link:DockLayout.adoc#effectiveborderleftwidth[effectiveBorderLeftWidth]
* link:DockLayout.adoc#effectiveborderrightwidth[effectiveBorderRightWidth]
* link:DockLayout.adoc#effectivebordertopwidth[effectiveBorderTopWidth]
* link:DockLayout.adoc#effectiveheight[effectiveHeight]
* link:DockLayout.adoc#effectiveleft[effectiveLeft]
* link:DockLayout.adoc#effectivemarginbottom[effectiveMarginBottom]
* link:DockLayout.adoc#effectivemarginleft[effectiveMarginLeft]
* link:DockLayout.adoc#effectivemarginright[effectiveMarginRight]
* link:DockLayout.adoc#effectivemargintop[effectiveMarginTop]
* link:DockLayout.adoc#effectiveminheight[effectiveMinHeight]
* link:DockLayout.adoc#effectiveminwidth[effectiveMinWidth]
* link:DockLayout.adoc#effectivepaddingbottom[effectivePaddingBottom]
* link:DockLayout.adoc#effectivepaddingleft[effectivePaddingLeft]
* link:DockLayout.adoc#effectivepaddingright[effectivePaddingRight]
* link:DockLayout.adoc#effectivepaddingtop[effectivePaddingTop]
* link:DockLayout.adoc#effectivetop[effectiveTop]
* link:DockLayout.adoc#effectivewidth[effectiveWidth]
* link:DockLayout.adoc#flexgrow[flexGrow]
* link:DockLayout.adoc#flexshrink[flexShrink]
* link:DockLayout.adoc#flexwrapbefore[flexWrapBefore]
* link:DockLayout.adoc#height[height]
* link:DockLayout.adoc#horizontalalignment[horizontalAlignment]
* link:DockLayout.adoc#id[id]
* link:DockLayout.adoc#ignoretouchanimation[ignoreTouchAnimation]
* link:DockLayout.adoc#ios[ios]
* link:DockLayout.adoc#iosignoresafearea[iosIgnoreSafeArea]
* link:DockLayout.adoc#iosoverflowsafearea[iosOverflowSafeArea]
* link:DockLayout.adoc#iosoverflowsafeareaenabled[iosOverflowSafeAreaEnabled]
* link:DockLayout.adoc#iscollapsed[isCollapsed]
* link:DockLayout.adoc#isenabled[isEnabled]
* link:DockLayout.adoc#islayoutrequired[isLayoutRequired]
* link:DockLayout.adoc#islayoutvalid[isLayoutValid]
* link:DockLayout.adoc#ispassthroughparentenabled[isPassThroughParentEnabled]
* link:DockLayout.adoc#isuserinteractionenabled[isUserInteractionEnabled]
* link:DockLayout.adoc#left[left]
* link:DockLayout.adoc#margin[margin]
* link:DockLayout.adoc#marginbottom[marginBottom]
* link:DockLayout.adoc#marginleft[marginLeft]
* link:DockLayout.adoc#marginright[marginRight]
* link:DockLayout.adoc#margintop[marginTop]
* link:DockLayout.adoc#minheight[minHeight]
* link:DockLayout.adoc#minwidth[minWidth]
* link:DockLayout.adoc#modal[modal]
* link:DockLayout.adoc#nativeviewprotected[nativeViewProtected]
* link:DockLayout.adoc#opacity[opacity]
* link:DockLayout.adoc#order[order]
* link:DockLayout.adoc#originx[originX]
* link:DockLayout.adoc#originy[originY]
* link:DockLayout.adoc#padding[padding]
* link:DockLayout.adoc#paddingbottom[paddingBottom]
* link:DockLayout.adoc#paddingleft[paddingLeft]
* link:DockLayout.adoc#paddingright[paddingRight]
* link:DockLayout.adoc#paddingtop[paddingTop]
* link:DockLayout.adoc#parent[parent]
* link:DockLayout.adoc#perspective[perspective]
* link:DockLayout.adoc#recyclenativeview[recycleNativeView]
* link:DockLayout.adoc#reusable[reusable]
* link:DockLayout.adoc#rotate[rotate]
* link:DockLayout.adoc#rotatex[rotateX]
* link:DockLayout.adoc#rotatey[rotateY]
* link:DockLayout.adoc#row[row]
* link:DockLayout.adoc#rowspan[rowSpan]
* link:DockLayout.adoc#scalex[scaleX]
* link:DockLayout.adoc#scaley[scaleY]
* link:DockLayout.adoc#stretchlastchild[stretchLastChild]
* link:DockLayout.adoc#testid[testID]
* link:DockLayout.adoc#top[top]
* link:DockLayout.adoc#touchanimation[touchAnimation]
* link:DockLayout.adoc#touchdelay[touchDelay]
* link:DockLayout.adoc#translatex[translateX]
* link:DockLayout.adoc#translatey[translateY]
* link:DockLayout.adoc#verticalalignment[verticalAlignment]
* link:DockLayout.adoc#viewcontroller[viewController]
* link:DockLayout.adoc#visibility[visibility]
* link:DockLayout.adoc#width[width]
* link:DockLayout.adoc#accessibilityblurevent[accessibilityBlurEvent]
* link:DockLayout.adoc#accessibilityfocuschangedevent[accessibilityFocusChangedEvent]
* link:DockLayout.adoc#accessibilityfocusevent[accessibilityFocusEvent]
* link:DockLayout.adoc#accessibilityperformescapeevent[accessibilityPerformEscapeEvent]
* link:DockLayout.adoc#createdevent[createdEvent]
* link:DockLayout.adoc#disposenativeviewevent[disposeNativeViewEvent]
* link:DockLayout.adoc#layoutchangedevent[layoutChangedEvent]
* link:DockLayout.adoc#loadedevent[loadedEvent]
* link:DockLayout.adoc#propertychangeevent[propertyChangeEvent]
* link:DockLayout.adoc#showingmodallyevent[showingModallyEvent]
* link:DockLayout.adoc#shownmodallyevent[shownModallyEvent]
* link:DockLayout.adoc#unloadedevent[unloadedEvent]

=== Accessors

* link:DockLayout.adoc#backgroundposition[backgroundPosition]
* link:DockLayout.adoc#backgroundrepeat[backgroundRepeat]
* link:DockLayout.adoc#backgroundsize[backgroundSize]
* link:DockLayout.adoc#class[class]
* link:DockLayout.adoc#isloaded[isLoaded]
* link:DockLayout.adoc#nativeview[nativeView]
* link:DockLayout.adoc#page[page]
* link:DockLayout.adoc#parentnode[parentNode]
* link:DockLayout.adoc#style[style]
* link:DockLayout.adoc#texttransform[textTransform]
* link:DockLayout.adoc#typename[typeName]

=== Methods

* link:DockLayout.adoc#_addview[_addView]
* link:DockLayout.adoc#_addviewcore[_addViewCore]
* link:DockLayout.adoc#_addviewtonativevisualtree[_addViewToNativeVisualTree]
* link:DockLayout.adoc#_applybackground[_applyBackground]
* link:DockLayout.adoc#_applyxmlattribute[_applyXmlAttribute]
* link:DockLayout.adoc#_batchupdate[_batchUpdate]
* link:DockLayout.adoc#_childindextonativechildindex[_childIndexToNativeChildIndex]
* link:DockLayout.adoc#_closeallmodalviewsinternal[_closeAllModalViewsInternal]
* link:DockLayout.adoc#_createpropertychangedata[_createPropertyChangeData]
* link:DockLayout.adoc#_dialogclosed[_dialogClosed]
* link:DockLayout.adoc#_eachlayoutview[_eachLayoutView]
* link:DockLayout.adoc#_emit[_emit]
* link:DockLayout.adoc#_getcurrentlayoutbounds[_getCurrentLayoutBounds]
* link:DockLayout.adoc#_getfragmentmanager[_getFragmentManager]
* link:DockLayout.adoc#_getnativeviewscount[_getNativeViewsCount]
* link:DockLayout.adoc#_getrootmodalviews[_getRootModalViews]
* link:DockLayout.adoc#_getvalue[_getValue]
* link:DockLayout.adoc#_gotovisualstate[_goToVisualState]
* link:DockLayout.adoc#_handlelivesync[_handleLivesync]
* link:DockLayout.adoc#_hasancestorview[_hasAncestorView]
* link:DockLayout.adoc#_hidenativemodalview[_hideNativeModalView]
* link:DockLayout.adoc#_inheritstylescope[_inheritStyleScope]
* link:DockLayout.adoc#_layoutparent[_layoutParent]
* link:DockLayout.adoc#_observe[_observe]
* link:DockLayout.adoc#_onattachedtowindow[_onAttachedToWindow]
* link:DockLayout.adoc#_oncssstatechange[_onCssStateChange]
* link:DockLayout.adoc#_ondetachedfromwindow[_onDetachedFromWindow]
* link:DockLayout.adoc#_onlivesync[_onLivesync]
* link:DockLayout.adoc#_onrootviewreset[_onRootViewReset]
* link:DockLayout.adoc#_onsizechanged[_onSizeChanged]
* link:DockLayout.adoc#_parentchanged[_parentChanged]
* link:DockLayout.adoc#_raiselayoutchangedevent[_raiseLayoutChangedEvent]
* link:DockLayout.adoc#_raiseshowingmodallyevent[_raiseShowingModallyEvent]
* link:DockLayout.adoc#_raiseshownmodallyevent[_raiseShownModallyEvent]
* link:DockLayout.adoc#_redrawnativebackground[_redrawNativeBackground]
* link:DockLayout.adoc#_registerlayoutchild[_registerLayoutChild]
* link:DockLayout.adoc#_removeanimation[_removeAnimation]
* link:DockLayout.adoc#_removeview[_removeView]
* link:DockLayout.adoc#_removeviewcore[_removeViewCore]
* link:DockLayout.adoc#_removeviewfromnativevisualtree[_removeViewFromNativeVisualTree]
* link:DockLayout.adoc#_resumenativeupdates[_resumeNativeUpdates]
* link:DockLayout.adoc#_setchildminheightnative[_setChildMinHeightNative]
* link:DockLayout.adoc#_setchildminwidthnative[_setChildMinWidthNative]
* link:DockLayout.adoc#_setcurrentlayoutbounds[_setCurrentLayoutBounds]
* link:DockLayout.adoc#_setcurrentmeasurespecs[_setCurrentMeasureSpecs]
* link:DockLayout.adoc#_setminheightnative[_setMinHeightNative]
* link:DockLayout.adoc#_setminwidthnative[_setMinWidthNative]
* link:DockLayout.adoc#_setnativecliptobounds[_setNativeClipToBounds]
* link:DockLayout.adoc#_setnativeviewframe[_setNativeViewFrame]
* link:DockLayout.adoc#_setvalue[_setValue]
* link:DockLayout.adoc#_setupasrootview[_setupAsRootView]
* link:DockLayout.adoc#_setupui[_setupUI]
* link:DockLayout.adoc#_shoulddelaylayout[_shouldDelayLayout]
* link:DockLayout.adoc#_shownativemodalview[_showNativeModalView]
* link:DockLayout.adoc#_suspendnativeupdates[_suspendNativeUpdates]
* link:DockLayout.adoc#_teardownui[_tearDownUI]
* link:DockLayout.adoc#_unregisterlayoutchild[_unregisterLayoutChild]
* link:DockLayout.adoc#_updateeffectivelayoutvalues[_updateEffectiveLayoutValues]
* link:DockLayout.adoc#_updatenativelayoutparams[_updateNativeLayoutParams]
* link:DockLayout.adoc#_updatestylescope[_updateStyleScope]
* link:DockLayout.adoc#accessibilityannouncement[accessibilityAnnouncement]
* link:DockLayout.adoc#accessibilityscreenchanged[accessibilityScreenChanged]
* link:DockLayout.adoc#addchild[addChild]
* link:DockLayout.adoc#addcss[addCss]
* link:DockLayout.adoc#addcssfile[addCssFile]
* link:DockLayout.adoc#addeventlistener[addEventListener]
* link:DockLayout.adoc#addpseudoclass[addPseudoClass]
* link:DockLayout.adoc#animate[animate]
* link:DockLayout.adoc#bind[bind]
* link:DockLayout.adoc#callloaded[callLoaded]
* link:DockLayout.adoc#callunloaded[callUnloaded]
* link:DockLayout.adoc#changecssfile[changeCssFile]
* link:DockLayout.adoc#closemodal[closeModal]
* link:DockLayout.adoc#createanimation[createAnimation]
* link:DockLayout.adoc#createnativeview[createNativeView]
* link:DockLayout.adoc#deletepseudoclass[deletePseudoClass]
* link:DockLayout.adoc#destroynode[destroyNode]
* link:DockLayout.adoc#disposenativeview[disposeNativeView]
* link:DockLayout.adoc#eachchild[eachChild]
* link:DockLayout.adoc#eachchildview[eachChildView]
* link:DockLayout.adoc#eachlayoutchild[eachLayoutChild]
* link:DockLayout.adoc#ensuredomnode[ensureDomNode]
* link:DockLayout.adoc#focus[focus]
* link:DockLayout.adoc#get[get]
* link:DockLayout.adoc#getactualsize[getActualSize]
* link:DockLayout.adoc#getchildat[getChildAt]
* link:DockLayout.adoc#getchildindex[getChildIndex]
* link:DockLayout.adoc#getchildrencount[getChildrenCount]
* link:DockLayout.adoc#getgestureobservers[getGestureObservers]
* link:DockLayout.adoc#getlocationinwindow[getLocationInWindow]
* link:DockLayout.adoc#getlocationonscreen[getLocationOnScreen]
* link:DockLayout.adoc#getlocationrelativeto[getLocationRelativeTo]
* link:DockLayout.adoc#getmeasuredheight[getMeasuredHeight]
* link:DockLayout.adoc#getmeasuredstate[getMeasuredState]
* link:DockLayout.adoc#getmeasuredwidth[getMeasuredWidth]
* link:DockLayout.adoc#getsafeareainsets[getSafeAreaInsets]
* link:DockLayout.adoc#getviewbydomid[getViewByDomId]
* link:DockLayout.adoc#getviewbyid[getViewById]
* link:DockLayout.adoc#hasgestureobservers[hasGestureObservers]
* link:DockLayout.adoc#haslisteners[hasListeners]
* link:DockLayout.adoc#initnativeview[initNativeView]
* link:DockLayout.adoc#insertchild[insertChild]
* link:DockLayout.adoc#layout[layout]
* link:DockLayout.adoc#layoutnativeview[layoutNativeView]
* link:DockLayout.adoc#loadview[loadView]
* link:DockLayout.adoc#measure[measure]
* link:DockLayout.adoc#notify[notify]
* link:DockLayout.adoc#notifypropertychange[notifyPropertyChange]
* link:DockLayout.adoc#off[off]
* link:DockLayout.adoc#on[on]
* link:DockLayout.adoc#onbackpressed[onBackPressed]
* link:DockLayout.adoc#onlayout[onLayout]
* link:DockLayout.adoc#onloaded[onLoaded]
* link:DockLayout.adoc#onmeasure[onMeasure]
* link:DockLayout.adoc#onresumenativeupdates[onResumeNativeUpdates]
* link:DockLayout.adoc#onunloaded[onUnloaded]
* link:DockLayout.adoc#once[once]
* link:DockLayout.adoc#removechild[removeChild]
* link:DockLayout.adoc#removechildren[removeChildren]
* link:DockLayout.adoc#removeeventlistener[removeEventListener]
* link:DockLayout.adoc#requestlayout[requestLayout]
* link:DockLayout.adoc#resetnativeview[resetNativeView]
* link:DockLayout.adoc#sendaccessibilityevent[sendAccessibilityEvent]
* link:DockLayout.adoc#set[set]
* link:DockLayout.adoc#setinlinestyle[setInlineStyle]
* link:DockLayout.adoc#setmeasureddimension[setMeasuredDimension]
* link:DockLayout.adoc#setnativeview[setNativeView]
* link:DockLayout.adoc#setontouchlistener[setOnTouchListener]
* link:DockLayout.adoc#setproperty[setProperty]
* link:DockLayout.adoc#settestid[setTestID]
* link:DockLayout.adoc#showmodal[showModal]
* link:DockLayout.adoc#tostring[toString]
* link:DockLayout.adoc#unbind[unbind]
* link:DockLayout.adoc#unloadview[unloadView]
* link:DockLayout.adoc#addeventlistener-1[addEventListener]
* link:DockLayout.adoc#combinemeasuredstates[combineMeasuredStates]
* link:DockLayout.adoc#getdock[getDock]
* link:DockLayout.adoc#layoutchild[layoutChild]
* link:DockLayout.adoc#measurechild[measureChild]
* link:DockLayout.adoc#off-1[off]
* link:DockLayout.adoc#on-1[on]
* link:DockLayout.adoc#once-1[once]
* link:DockLayout.adoc#removeeventlistener-1[removeEventListener]
* link:DockLayout.adoc#resolvesizeandstate[resolveSizeAndState]
* link:DockLayout.adoc#setdock[setDock]
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/layouts/dock-layout/index.d.ts#L24[ui/layouts/dock-layout/index.d.ts:24]
...
▸ `Static` *getDock*(`view`): link:../modules/CoreTypes.adoc#docktype[`DockType`]
...
link:../modules/CoreTypes.adoc#docktype[`DockType`]

==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/layouts/dock-layout/index.d.ts#L13[ui/layouts/dock-layout/index.d.ts:13]
...
▸ `Static` *setDock*(`view`, `value`): `void`
...
==== Defined in https://github.com/NativeScript/NativeScript/blob/02d4834bd/packages/core/ui/layouts/dock-layout/index.d.ts#L18[ui/layouts/dock-layout/index.d.ts:18]
