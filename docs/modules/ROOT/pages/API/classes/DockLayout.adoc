...
* link:DockLayout.md#constructor[constructor]

=== Properties

* link:DockLayout.md#_androidcontentdescriptionupdated[_androidContentDescriptionUpdated]
* link:DockLayout.md#_automaticallyadjustsscrollviewinsets[_automaticallyAdjustsScrollViewInsets]
* link:DockLayout.md#_closemodalcallback[_closeModalCallback]
* link:DockLayout.md#_context[_context]
* link:DockLayout.md#_cssstate[_cssState]
* link:DockLayout.md#_currentheightmeasurespec[_currentHeightMeasureSpec]
* link:DockLayout.md#_currentwidthmeasurespec[_currentWidthMeasureSpec]
* link:DockLayout.md#_defaultpaddingbottom[_defaultPaddingBottom]
* link:DockLayout.md#_defaultpaddingleft[_defaultPaddingLeft]
* link:DockLayout.md#_defaultpaddingright[_defaultPaddingRight]
* link:DockLayout.md#_defaultpaddingtop[_defaultPaddingTop]
* link:DockLayout.md#_domid[_domId]
* link:DockLayout.md#_gestureobservers[_gestureObservers]
* link:DockLayout.md#_ignoreflexminwidthheightreset[_ignoreFlexMinWidthHeightReset]
* link:DockLayout.md#_isaddedtonativevisualtree[_isAddedToNativeVisualTree]
* link:DockLayout.md#_islayoutvalid[_isLayoutValid]
* link:DockLayout.md#_ispaddingrelative[_isPaddingRelative]
* link:DockLayout.md#_isstylescopehost[_isStyleScopeHost]
* link:DockLayout.md#_isviewbase[_isViewBase]
* link:DockLayout.md#_manager[_manager]
* link:DockLayout.md#_modalparent[_modalParent]
* link:DockLayout.md#_modulename[_moduleName]
* link:DockLayout.md#_oldbottom[_oldBottom]
* link:DockLayout.md#_oldleft[_oldLeft]
* link:DockLayout.md#_oldright[_oldRight]
* link:DockLayout.md#_oldtop[_oldTop]
* link:DockLayout.md#_stylescope[_styleScope]
* link:DockLayout.md#_suspendnativeupdatescount[_suspendNativeUpdatesCount]
* link:DockLayout.md#_suspendedupdates[_suspendedUpdates]
* link:DockLayout.md#accessibilityhidden[accessibilityHidden]
* link:DockLayout.md#accessibilityhint[accessibilityHint]
* link:DockLayout.md#accessibilityidentifier[accessibilityIdentifier]
* link:DockLayout.md#accessibilitylabel[accessibilityLabel]
* link:DockLayout.md#accessibilitylanguage[accessibilityLanguage]
* link:DockLayout.md#accessibilityliveregion[accessibilityLiveRegion]
* link:DockLayout.md#accessibilitymediasession[accessibilityMediaSession]
* link:DockLayout.md#accessibilityrole[accessibilityRole]
* link:DockLayout.md#accessibilitystate[accessibilityState]
* link:DockLayout.md#accessibilityvalue[accessibilityValue]
* link:DockLayout.md#accessible[accessible]
* link:DockLayout.md#alignself[alignSelf]
* link:DockLayout.md#android[android]
* link:DockLayout.md#androiddynamicelevationoffset[androidDynamicElevationOffset]
* link:DockLayout.md#androidelevation[androidElevation]
* link:DockLayout.md#automationtext[automationText]
* link:DockLayout.md#background[background]
* link:DockLayout.md#backgroundcolor[backgroundColor]
* link:DockLayout.md#backgroundimage[backgroundImage]
* link:DockLayout.md#bindingcontext[bindingContext]
* link:DockLayout.md#borderbottomcolor[borderBottomColor]
* link:DockLayout.md#borderbottomleftradius[borderBottomLeftRadius]
* link:DockLayout.md#borderbottomrightradius[borderBottomRightRadius]
* link:DockLayout.md#borderbottomwidth[borderBottomWidth]
* link:DockLayout.md#bordercolor[borderColor]
* link:DockLayout.md#borderleftcolor[borderLeftColor]
* link:DockLayout.md#borderleftwidth[borderLeftWidth]
* link:DockLayout.md#borderradius[borderRadius]
* link:DockLayout.md#borderrightcolor[borderRightColor]
* link:DockLayout.md#borderrightwidth[borderRightWidth]
* link:DockLayout.md#bordertopcolor[borderTopColor]
* link:DockLayout.md#bordertopleftradius[borderTopLeftRadius]
* link:DockLayout.md#bordertoprightradius[borderTopRightRadius]
* link:DockLayout.md#bordertopwidth[borderTopWidth]
* link:DockLayout.md#borderwidth[borderWidth]
* link:DockLayout.md#boxshadow[boxShadow]
* link:DockLayout.md#classname[className]
* link:DockLayout.md#cliptobounds[clipToBounds]
* link:DockLayout.md#col[col]
* link:DockLayout.md#colspan[colSpan]
* link:DockLayout.md#color[color]
* link:DockLayout.md#column[column]
* link:DockLayout.md#columnspan[columnSpan]
* link:DockLayout.md#css[css]
* link:DockLayout.md#cssclasses[cssClasses]
* link:DockLayout.md#csspseudoclasses[cssPseudoClasses]
* link:DockLayout.md#csstype[cssType]
* link:DockLayout.md#dock[dock]
* link:DockLayout.md#domnode[domNode]
* link:DockLayout.md#effectiveborderbottomwidth[effectiveBorderBottomWidth]
* link:DockLayout.md#effectiveborderleftwidth[effectiveBorderLeftWidth]
* link:DockLayout.md#effectiveborderrightwidth[effectiveBorderRightWidth]
* link:DockLayout.md#effectivebordertopwidth[effectiveBorderTopWidth]
* link:DockLayout.md#effectiveheight[effectiveHeight]
* link:DockLayout.md#effectiveleft[effectiveLeft]
* link:DockLayout.md#effectivemarginbottom[effectiveMarginBottom]
* link:DockLayout.md#effectivemarginleft[effectiveMarginLeft]
* link:DockLayout.md#effectivemarginright[effectiveMarginRight]
* link:DockLayout.md#effectivemargintop[effectiveMarginTop]
* link:DockLayout.md#effectiveminheight[effectiveMinHeight]
* link:DockLayout.md#effectiveminwidth[effectiveMinWidth]
* link:DockLayout.md#effectivepaddingbottom[effectivePaddingBottom]
* link:DockLayout.md#effectivepaddingleft[effectivePaddingLeft]
* link:DockLayout.md#effectivepaddingright[effectivePaddingRight]
* link:DockLayout.md#effectivepaddingtop[effectivePaddingTop]
* link:DockLayout.md#effectivetop[effectiveTop]
* link:DockLayout.md#effectivewidth[effectiveWidth]
* link:DockLayout.md#flexgrow[flexGrow]
* link:DockLayout.md#flexshrink[flexShrink]
* link:DockLayout.md#flexwrapbefore[flexWrapBefore]
* link:DockLayout.md#height[height]
* link:DockLayout.md#horizontalalignment[horizontalAlignment]
* link:DockLayout.md#id[id]
* link:DockLayout.md#ignoretouchanimation[ignoreTouchAnimation]
* link:DockLayout.md#ios[ios]
* link:DockLayout.md#iosignoresafearea[iosIgnoreSafeArea]
* link:DockLayout.md#iosoverflowsafearea[iosOverflowSafeArea]
* link:DockLayout.md#iosoverflowsafeareaenabled[iosOverflowSafeAreaEnabled]
* link:DockLayout.md#iscollapsed[isCollapsed]
* link:DockLayout.md#isenabled[isEnabled]
* link:DockLayout.md#islayoutrequired[isLayoutRequired]
* link:DockLayout.md#islayoutvalid[isLayoutValid]
* link:DockLayout.md#ispassthroughparentenabled[isPassThroughParentEnabled]
* link:DockLayout.md#isuserinteractionenabled[isUserInteractionEnabled]
* link:DockLayout.md#left[left]
* link:DockLayout.md#margin[margin]
* link:DockLayout.md#marginbottom[marginBottom]
* link:DockLayout.md#marginleft[marginLeft]
* link:DockLayout.md#marginright[marginRight]
* link:DockLayout.md#margintop[marginTop]
* link:DockLayout.md#minheight[minHeight]
* link:DockLayout.md#minwidth[minWidth]
* link:DockLayout.md#modal[modal]
* link:DockLayout.md#nativeviewprotected[nativeViewProtected]
* link:DockLayout.md#opacity[opacity]
* link:DockLayout.md#order[order]
* link:DockLayout.md#originx[originX]
* link:DockLayout.md#originy[originY]
* link:DockLayout.md#padding[padding]
* link:DockLayout.md#paddingbottom[paddingBottom]
* link:DockLayout.md#paddingleft[paddingLeft]
* link:DockLayout.md#paddingright[paddingRight]
* link:DockLayout.md#paddingtop[paddingTop]
* link:DockLayout.md#parent[parent]
* link:DockLayout.md#perspective[perspective]
* link:DockLayout.md#recyclenativeview[recycleNativeView]
* link:DockLayout.md#reusable[reusable]
* link:DockLayout.md#rotate[rotate]
* link:DockLayout.md#rotatex[rotateX]
* link:DockLayout.md#rotatey[rotateY]
* link:DockLayout.md#row[row]
* link:DockLayout.md#rowspan[rowSpan]
* link:DockLayout.md#scalex[scaleX]
* link:DockLayout.md#scaley[scaleY]
* link:DockLayout.md#stretchlastchild[stretchLastChild]
* link:DockLayout.md#testid[testID]
* link:DockLayout.md#top[top]
* link:DockLayout.md#touchanimation[touchAnimation]
* link:DockLayout.md#touchdelay[touchDelay]
* link:DockLayout.md#translatex[translateX]
* link:DockLayout.md#translatey[translateY]
* link:DockLayout.md#verticalalignment[verticalAlignment]
* link:DockLayout.md#viewcontroller[viewController]
* link:DockLayout.md#visibility[visibility]
* link:DockLayout.md#width[width]
* link:DockLayout.md#accessibilityblurevent[accessibilityBlurEvent]
* link:DockLayout.md#accessibilityfocuschangedevent[accessibilityFocusChangedEvent]
* link:DockLayout.md#accessibilityfocusevent[accessibilityFocusEvent]
* link:DockLayout.md#accessibilityperformescapeevent[accessibilityPerformEscapeEvent]
* link:DockLayout.md#createdevent[createdEvent]
* link:DockLayout.md#disposenativeviewevent[disposeNativeViewEvent]
* link:DockLayout.md#layoutchangedevent[layoutChangedEvent]
* link:DockLayout.md#loadedevent[loadedEvent]
* link:DockLayout.md#propertychangeevent[propertyChangeEvent]
* link:DockLayout.md#showingmodallyevent[showingModallyEvent]
* link:DockLayout.md#shownmodallyevent[shownModallyEvent]
* link:DockLayout.md#unloadedevent[unloadedEvent]

=== Accessors

* link:DockLayout.md#backgroundposition[backgroundPosition]
* link:DockLayout.md#backgroundrepeat[backgroundRepeat]
* link:DockLayout.md#backgroundsize[backgroundSize]
* link:DockLayout.md#class[class]
* link:DockLayout.md#isloaded[isLoaded]
* link:DockLayout.md#nativeview[nativeView]
* link:DockLayout.md#page[page]
* link:DockLayout.md#parentnode[parentNode]
* link:DockLayout.md#style[style]
* link:DockLayout.md#texttransform[textTransform]
* link:DockLayout.md#typename[typeName]

=== Methods

* link:DockLayout.md#_addview[_addView]
* link:DockLayout.md#_addviewcore[_addViewCore]
* link:DockLayout.md#_addviewtonativevisualtree[_addViewToNativeVisualTree]
* link:DockLayout.md#_applybackground[_applyBackground]
* link:DockLayout.md#_applyxmlattribute[_applyXmlAttribute]
* link:DockLayout.md#_batchupdate[_batchUpdate]
* link:DockLayout.md#_childindextonativechildindex[_childIndexToNativeChildIndex]
* link:DockLayout.md#_closeallmodalviewsinternal[_closeAllModalViewsInternal]
* link:DockLayout.md#_createpropertychangedata[_createPropertyChangeData]
* link:DockLayout.md#_dialogclosed[_dialogClosed]
* link:DockLayout.md#_eachlayoutview[_eachLayoutView]
* link:DockLayout.md#_emit[_emit]
* link:DockLayout.md#_getcurrentlayoutbounds[_getCurrentLayoutBounds]
* link:DockLayout.md#_getfragmentmanager[_getFragmentManager]
* link:DockLayout.md#_getnativeviewscount[_getNativeViewsCount]
* link:DockLayout.md#_getrootmodalviews[_getRootModalViews]
* link:DockLayout.md#_getvalue[_getValue]
* link:DockLayout.md#_gotovisualstate[_goToVisualState]
* link:DockLayout.md#_handlelivesync[_handleLivesync]
* link:DockLayout.md#_hasancestorview[_hasAncestorView]
* link:DockLayout.md#_hidenativemodalview[_hideNativeModalView]
* link:DockLayout.md#_inheritstylescope[_inheritStyleScope]
* link:DockLayout.md#_layoutparent[_layoutParent]
* link:DockLayout.md#_observe[_observe]
* link:DockLayout.md#_onattachedtowindow[_onAttachedToWindow]
* link:DockLayout.md#_oncssstatechange[_onCssStateChange]
* link:DockLayout.md#_ondetachedfromwindow[_onDetachedFromWindow]
* link:DockLayout.md#_onlivesync[_onLivesync]
* link:DockLayout.md#_onrootviewreset[_onRootViewReset]
* link:DockLayout.md#_onsizechanged[_onSizeChanged]
* link:DockLayout.md#_parentchanged[_parentChanged]
* link:DockLayout.md#_raiselayoutchangedevent[_raiseLayoutChangedEvent]
* link:DockLayout.md#_raiseshowingmodallyevent[_raiseShowingModallyEvent]
* link:DockLayout.md#_raiseshownmodallyevent[_raiseShownModallyEvent]
* link:DockLayout.md#_redrawnativebackground[_redrawNativeBackground]
* link:DockLayout.md#_registerlayoutchild[_registerLayoutChild]
* link:DockLayout.md#_removeanimation[_removeAnimation]
* link:DockLayout.md#_removeview[_removeView]
* link:DockLayout.md#_removeviewcore[_removeViewCore]
* link:DockLayout.md#_removeviewfromnativevisualtree[_removeViewFromNativeVisualTree]
* link:DockLayout.md#_resumenativeupdates[_resumeNativeUpdates]
* link:DockLayout.md#_setchildminheightnative[_setChildMinHeightNative]
* link:DockLayout.md#_setchildminwidthnative[_setChildMinWidthNative]
* link:DockLayout.md#_setcurrentlayoutbounds[_setCurrentLayoutBounds]
* link:DockLayout.md#_setcurrentmeasurespecs[_setCurrentMeasureSpecs]
* link:DockLayout.md#_setminheightnative[_setMinHeightNative]
* link:DockLayout.md#_setminwidthnative[_setMinWidthNative]
* link:DockLayout.md#_setnativecliptobounds[_setNativeClipToBounds]
* link:DockLayout.md#_setnativeviewframe[_setNativeViewFrame]
* link:DockLayout.md#_setvalue[_setValue]
* link:DockLayout.md#_setupasrootview[_setupAsRootView]
* link:DockLayout.md#_setupui[_setupUI]
* link:DockLayout.md#_shoulddelaylayout[_shouldDelayLayout]
* link:DockLayout.md#_shownativemodalview[_showNativeModalView]
* link:DockLayout.md#_suspendnativeupdates[_suspendNativeUpdates]
* link:DockLayout.md#_teardownui[_tearDownUI]
* link:DockLayout.md#_unregisterlayoutchild[_unregisterLayoutChild]
* link:DockLayout.md#_updateeffectivelayoutvalues[_updateEffectiveLayoutValues]
* link:DockLayout.md#_updatenativelayoutparams[_updateNativeLayoutParams]
* link:DockLayout.md#_updatestylescope[_updateStyleScope]
* link:DockLayout.md#accessibilityannouncement[accessibilityAnnouncement]
* link:DockLayout.md#accessibilityscreenchanged[accessibilityScreenChanged]
* link:DockLayout.md#addchild[addChild]
* link:DockLayout.md#addcss[addCss]
* link:DockLayout.md#addcssfile[addCssFile]
* link:DockLayout.md#addeventlistener[addEventListener]
* link:DockLayout.md#addpseudoclass[addPseudoClass]
* link:DockLayout.md#animate[animate]
* link:DockLayout.md#bind[bind]
* link:DockLayout.md#callloaded[callLoaded]
* link:DockLayout.md#callunloaded[callUnloaded]
* link:DockLayout.md#changecssfile[changeCssFile]
* link:DockLayout.md#closemodal[closeModal]
* link:DockLayout.md#createanimation[createAnimation]
* link:DockLayout.md#createnativeview[createNativeView]
* link:DockLayout.md#deletepseudoclass[deletePseudoClass]
* link:DockLayout.md#destroynode[destroyNode]
* link:DockLayout.md#disposenativeview[disposeNativeView]
* link:DockLayout.md#eachchild[eachChild]
* link:DockLayout.md#eachchildview[eachChildView]
* link:DockLayout.md#eachlayoutchild[eachLayoutChild]
* link:DockLayout.md#ensuredomnode[ensureDomNode]
* link:DockLayout.md#focus[focus]
* link:DockLayout.md#get[get]
* link:DockLayout.md#getactualsize[getActualSize]
* link:DockLayout.md#getchildat[getChildAt]
* link:DockLayout.md#getchildindex[getChildIndex]
* link:DockLayout.md#getchildrencount[getChildrenCount]
* link:DockLayout.md#getgestureobservers[getGestureObservers]
* link:DockLayout.md#getlocationinwindow[getLocationInWindow]
* link:DockLayout.md#getlocationonscreen[getLocationOnScreen]
* link:DockLayout.md#getlocationrelativeto[getLocationRelativeTo]
* link:DockLayout.md#getmeasuredheight[getMeasuredHeight]
* link:DockLayout.md#getmeasuredstate[getMeasuredState]
* link:DockLayout.md#getmeasuredwidth[getMeasuredWidth]
* link:DockLayout.md#getsafeareainsets[getSafeAreaInsets]
* link:DockLayout.md#getviewbydomid[getViewByDomId]
* link:DockLayout.md#getviewbyid[getViewById]
* link:DockLayout.md#hasgestureobservers[hasGestureObservers]
* link:DockLayout.md#haslisteners[hasListeners]
* link:DockLayout.md#initnativeview[initNativeView]
* link:DockLayout.md#insertchild[insertChild]
* link:DockLayout.md#layout[layout]
* link:DockLayout.md#layoutnativeview[layoutNativeView]
* link:DockLayout.md#loadview[loadView]
* link:DockLayout.md#measure[measure]
* link:DockLayout.md#notify[notify]
* link:DockLayout.md#notifypropertychange[notifyPropertyChange]
* link:DockLayout.md#off[off]
* link:DockLayout.md#on[on]
* link:DockLayout.md#onbackpressed[onBackPressed]
* link:DockLayout.md#onlayout[onLayout]
* link:DockLayout.md#onloaded[onLoaded]
* link:DockLayout.md#onmeasure[onMeasure]
* link:DockLayout.md#onresumenativeupdates[onResumeNativeUpdates]
* link:DockLayout.md#onunloaded[onUnloaded]
* link:DockLayout.md#once[once]
* link:DockLayout.md#removechild[removeChild]
* link:DockLayout.md#removechildren[removeChildren]
* link:DockLayout.md#removeeventlistener[removeEventListener]
* link:DockLayout.md#requestlayout[requestLayout]
* link:DockLayout.md#resetnativeview[resetNativeView]
* link:DockLayout.md#sendaccessibilityevent[sendAccessibilityEvent]
* link:DockLayout.md#set[set]
* link:DockLayout.md#setinlinestyle[setInlineStyle]
* link:DockLayout.md#setmeasureddimension[setMeasuredDimension]
* link:DockLayout.md#setnativeview[setNativeView]
* link:DockLayout.md#setontouchlistener[setOnTouchListener]
* link:DockLayout.md#setproperty[setProperty]
* link:DockLayout.md#settestid[setTestID]
* link:DockLayout.md#showmodal[showModal]
* link:DockLayout.md#tostring[toString]
* link:DockLayout.md#unbind[unbind]
* link:DockLayout.md#unloadview[unloadView]
* link:DockLayout.md#addeventlistener-1[addEventListener]
* link:DockLayout.md#combinemeasuredstates[combineMeasuredStates]
* link:DockLayout.md#getdock[getDock]
* link:DockLayout.md#layoutchild[layoutChild]
* link:DockLayout.md#measurechild[measureChild]
* link:DockLayout.md#off-1[off]
* link:DockLayout.md#on-1[on]
* link:DockLayout.md#once-1[once]
* link:DockLayout.md#removeeventlistener-1[removeEventListener]
* link:DockLayout.md#resolvesizeandstate[resolveSizeAndState]
* link:DockLayout.md#setdock[setDock]
...
▸ `Static` *getDock*(`view`): link:../modules/CoreTypes.md#docktype[`DockType`]
...
link:../modules/CoreTypes.md#docktype[`DockType`]
