...
* link:DialogOptions.adoc#cancelable[cancelable]
* link:DialogOptions.adoc#message[message]
* link:DialogOptions.adoc#theme[theme]
* link:DialogOptions.adoc#title[title]
