...
* link:AndroidActivityBackPressedEventData.adoc#activity[activity]
* link:AndroidActivityBackPressedEventData.adoc#cancel[cancel]
* link:AndroidActivityBackPressedEventData.adoc#eventname[eventName]
* link:AndroidActivityBackPressedEventData.adoc#object[object]
