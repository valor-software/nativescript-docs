...
* link:LaunchEventData.adoc#android[android]
* link:LaunchEventData.adoc#eventname[eventName]
* link:LaunchEventData.adoc#ios[ios]
* link:LaunchEventData.adoc#object[object]
* link:LaunchEventData.adoc#root[root]
* link:LaunchEventData.adoc#savedinstancestate[savedInstanceState]
