...
* link:AnimationDefinition.adoc#backgroundcolor[backgroundColor]
* link:AnimationDefinition.adoc#curve[curve]
* link:AnimationDefinition.adoc#delay[delay]
* link:AnimationDefinition.adoc#duration[duration]
* link:AnimationDefinition.adoc#height[height]
* link:AnimationDefinition.adoc#iterations[iterations]
* link:AnimationDefinition.adoc#opacity[opacity]
* link:AnimationDefinition.adoc#rotate[rotate]
* link:AnimationDefinition.adoc#scale[scale]
* link:AnimationDefinition.adoc#target[target]
* link:AnimationDefinition.adoc#translate[translate]
* link:AnimationDefinition.adoc#width[width]
...
• `Optional` *height*: `string` | `number` | link:../modules/CoreTypes.adoc#lengthpercentunit[`LengthPercentUnit`] | link:../modules/CoreTypes.adoc#lengthdipunit[`LengthDipUnit`] | link:../modules/CoreTypes.adoc#lengthpxunit[`LengthPxUnit`]
...
• `Optional` *width*: `string` | `number` | link:../modules/CoreTypes.adoc#lengthpercentunit[`LengthPercentUnit`] | link:../modules/CoreTypes.adoc#lengthdipunit[`LengthDipUnit`] | link:../modules/CoreTypes.adoc#lengthpxunit[`LengthPxUnit`]
