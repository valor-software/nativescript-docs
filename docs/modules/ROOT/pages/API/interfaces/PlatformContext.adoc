...
* link:PlatformContext.adoc#devicetype[deviceType]
* link:PlatformContext.adoc#height[height]
* link:PlatformContext.adoc#os[os]
* link:PlatformContext.adoc#width[width]
