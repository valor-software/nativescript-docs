...
* link:SwipeGestureEventData.adoc#android[android]
* link:SwipeGestureEventData.adoc#direction[direction]
* link:SwipeGestureEventData.adoc#eventname[eventName]
* link:SwipeGestureEventData.adoc#ios[ios]
* link:SwipeGestureEventData.adoc#object[object]
* link:SwipeGestureEventData.adoc#type[type]
* link:SwipeGestureEventData.adoc#view[view]
