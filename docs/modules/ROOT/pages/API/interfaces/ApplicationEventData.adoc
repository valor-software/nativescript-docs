...
* link:ApplicationEventData.adoc#android[android]
* link:ApplicationEventData.adoc#eventname[eventName]
* link:ApplicationEventData.adoc#ios[ios]
* link:ApplicationEventData.adoc#object[object]
