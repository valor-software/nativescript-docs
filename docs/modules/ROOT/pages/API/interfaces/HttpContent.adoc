...
* link:HttpContent.adoc#raw[raw]
* link:HttpContent.adoc#toarraybuffer[toArrayBuffer]
* link:HttpContent.adoc#tofile[toFile]
* link:HttpContent.adoc#toimage[toImage]
* link:HttpContent.adoc#tojson[toJSON]
* link:HttpContent.adoc#tostring[toString]
