...
* link:ShadeCoverOptions.adoc#animation[animation]
* link:ShadeCoverOptions.adoc#color[color]
* link:ShadeCoverOptions.adoc#ignoreshaderestore[ignoreShadeRestore]
* link:ShadeCoverOptions.adoc#opacity[opacity]
* link:ShadeCoverOptions.adoc#taptoclose[tapToClose]
