...
* link:ShowModalOptions.adoc#android[android]
* link:ShowModalOptions.adoc#animated[animated]
* link:ShowModalOptions.adoc#cancelable[cancelable]
* link:ShowModalOptions.adoc#closecallback[closeCallback]
* link:ShowModalOptions.adoc#context[context]
* link:ShowModalOptions.adoc#fullscreen[fullscreen]
* link:ShowModalOptions.adoc#ios[ios]
* link:ShowModalOptions.adoc#stretched[stretched]
