...
* link:NativeScriptConfig.adoc#android[android]
* link:NativeScriptConfig.adoc#apppath[appPath]
* link:NativeScriptConfig.adoc#appresourcespath[appResourcesPath]
* link:NativeScriptConfig.adoc#cli[cli]
* link:NativeScriptConfig.adoc#cssparser[cssParser]
* link:NativeScriptConfig.adoc#hooks[hooks]
* link:NativeScriptConfig.adoc#id[id]
* link:NativeScriptConfig.adoc#ignorednativedependencies[ignoredNativeDependencies]
* link:NativeScriptConfig.adoc#ios[ios]
* link:NativeScriptConfig.adoc#main[main]
* link:NativeScriptConfig.adoc#overridepods[overridePods]
* link:NativeScriptConfig.adoc#previewappschema[previewAppSchema]
* link:NativeScriptConfig.adoc#profiling[profiling]
* link:NativeScriptConfig.adoc#shared[shared]
* link:NativeScriptConfig.adoc#webpackconfigpath[webpackConfigPath]
...
• `Optional` *profiling*: link:../modules.adoc#instrumentationmode[`InstrumentationMode`]
