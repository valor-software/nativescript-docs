...
* link:NavigationTransition.adoc#curve[curve]
* link:NavigationTransition.adoc#duration[duration]
* link:NavigationTransition.adoc#instance[instance]
* link:NavigationTransition.adoc#name[name]
