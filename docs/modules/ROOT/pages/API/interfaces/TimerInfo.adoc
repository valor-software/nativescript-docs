...
* link:TimerInfo.adoc#count[count]
* link:TimerInfo.adoc#currentstart[currentStart]
* link:TimerInfo.adoc#lasttime[lastTime]
* link:TimerInfo.adoc#runcount[runCount]
* link:TimerInfo.adoc#totaltime[totalTime]
