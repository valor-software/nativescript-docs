...
* link:TemplatedItemsView.adoc#itemtemplate[itemTemplate]
* link:TemplatedItemsView.adoc#itemtemplates[itemTemplates]
* link:TemplatedItemsView.adoc#items[items]

=== Methods

* link:TemplatedItemsView.adoc#off[off]
* link:TemplatedItemsView.adoc#on[on]
* link:TemplatedItemsView.adoc#refresh[refresh]
