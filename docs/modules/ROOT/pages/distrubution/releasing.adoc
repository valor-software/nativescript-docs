...
image::launch-android-005.png[Setting images in drawable resource folders]
...
image::launch-android-002.png[Setting colors in values folders]
...
image::launch-android-003.png[Setting strings in values folders]
...
image::launch-android-004.png[Setting styles in values folders]
...
image::launch-screen-howto-002.png[App icons config.json]
...
image::launch-screen-howto-003.png[AppIcon setup in Xcode]
...
image::launch-screen-howto-010.png[LaunchScreen setup in Xcode]
...
image::launch-screen-howto-008.png[LaunchScreen.AspectFill setup in Xcode]
...
image::launch-screen-howto-009.png[LaunchScreen.Center setup in Xcode]
