...
The easiest way to animate a *single* link:/api-reference/classes/view.html[`View`] is by using the `View.animate` method which accepts an link:/api-reference/interfaces/animationdefinition.html[`AnimationDefinition`], immediately starts the animation and then returns its finished promise.
...
You should create an link:/api-reference/classes/animation.html[`Animation`] class in order to be able to *cancel* the animation. This is demonstrated below.

:::

=== The AnimationDefinition interface

The link:/api-reference/interfaces/animationdefinition.html[`AnimationDefinition`] interface is central for defining an animation for *one or more properties* of a *single* link:/api-reference/classes/view.html[`View`]. The animatable properties are:
...
The link:/api-reference/interfaces/animationdefinition.html[`AnimationDefinition`] interface has the following members:
...
* *translate*: Animates the translate affine transform of the view. Value should be a https://v6.docs.nativescript.org/api-reference/interfaces/_ui_animation_.pair.html[`Pair`].
* *scale*: Animates the scale affine transform of the view. Value should be a https://v6.docs.nativescript.org/api-reference/interfaces/_ui_animation_.pair.html[`Pair`].
...
* target is only optional when calling the `animate` method of a link:/api-reference/classes/view.html[`View`] instance since it is set automatically for you.
* You must specify at least one property from this list: opacity, backgroundColor, scale, rotate or translate.

=== The Animation class

The link:/api-reference/classes/animation.html[`Animation`] class represents a *set* of one or more link:/api-reference/interfaces/animationdefinition.html[`AnimationDefinitions`] that can be played either *simultaneously or sequentially*. *This class is typically used when you need to animate several views together*. The constructor of the link:/api-reference/classes/animation.html[`Animation`] class accepts an array of link:/api-reference/interfaces/animationdefinition.html[`AnimationDefinitions`] and a boolean parameter indicating whether to play the animations sequentially. Creating an instance of the link:/api-reference/classes/animation.html[`Animation`] class does not start the animation playback. The class has four members:
...
image::/assets/images/modules/animation/multiple-properties.gif[multiple-properties]
...
image::/assets/images/modules/animation/hello-world.gif[hello-world]
...
image::/assets/images/modules/animation/easeinout.gif[easeinout]

* *Spring*: A spring animation curve causes an animation to produce a spring (bounce) effect.

image::/assets/images/modules/animation/spring.gif[spring]
...
image::/assets/images/modules/animation/bezier.gif[bezier]

More detailed examples are available on the <<animation-examples,Animation Examples>> page.

=== Rotation using originX and originY

To create more complex animations, we might need to change the origin point around which the selected view will be transformed. This can be achieved using link:/api-reference/classes/view.html#originx[`originX`] and link:/api-reference/classes/view.html#originy[`originY`] properties of `View`.
...
* `Span` and `FormattedString` can not be animated. `Span` and `FormattedString` elements are not extending the link:/api-reference/classes/view.html[`View`] class, but only link:/api-reference/classes/viewbase.html[`ViewBase`]. Because of this, neither `Span` nor `FormattedString` are ui elements, making it impossible to animate them and causing a crash on iOS.

=== Animation examples

This article contains examples demonstrating how to animate the animatable view properties. A full list of all animatable properties and a detailed explanation of the animations API is presented <<animations,here>>.

The full source code for all samples is located https://github.com/NativeScript/animation-demo[here].

=== Animated opacity

image::/assets/images/modules/animation/opacity.gif[opacity]
...
image::/assets/images/modules/animation/background-color.gif[background-color]
...
image::/assets/images/modules/animation/translate.gif[translate]
...
image::/assets/images/modules/animation/scale.gif[scale]
...
image::/assets/images/modules/animation/rotate.gif[rotate]
...
image::/assets/images/modules/animation/chaining-with-animation-set.gif[chaining-with-animation-set]
...
image::/assets/images/modules/animation/multiple-views.gif[multiple-views]
...
image::/assets/images/modules/animation/reusing.gif[reusing]
...
image::/assets/images/modules/animation/slide-in-effect.gif[slide-in-effect]
...
image::/assets/images/modules/animation/infinite.gif[infinite]
...
image::/assets/images/modules/animation/rotation_origin_x_y.gif[rotation_origin_x_y]
...
| `result`
| `boolean`
| Returns `false` when the dialog is dismissed. Otherwise returns `true`
|===
...
| link:/api-reference/modules.html#dialogs[@nativescript/core/dialogs]
| `Module`

| link:/api-reference/modules.html#dialogs[action]
| `function`

| link:/api-reference/modules.html#dialogs[ActionOptions]
| `interface`

| link:/api-reference/modules.html#dialogs[alert]
| `function`

| link:/api-reference/modules.html#dialogs[AlertOptions]
| `interface`

| link:/api-reference/modules.html#dialogs[confirm]
| `function`

| link:/api-reference/modules.html#dialogs[ConfirmOptions]
| `interface`

| link:/api-reference/modules.html#dialogs[login]
| `function`

| link:/api-reference/modules.html#dialogs[LoginOptions]
| `interface`

| link:/api-reference/modules.html#dialogs[LoginResults]
| `interface`

| link:/api-reference/modules.html#dialogs[prompt]
| `function`

| link:/api-reference/modules.html#dialogs[PromptOptions]
| `interface`
|===
...
| *on(* type _Number_
| name _String_
| names Comma separated _String_, callback _Function_... **)
|===
...
| *type* - _Number_
| *name* - _String_
| *names* - Comma separated _String_
|===
