...
image::multiple-properties.gif[multiple-properties]
...
image::chaining-with-promises.gif[chaining-with-promises]
...
image::hello-world.gif[hello-world]
...
image::bezier-graph.png[beziergraph]
...
image::background-color.gif[background-color]
...
image::chaining-with-animation-set.gif[chaining-with-animation-set]
...
image::multiple-views.gif[multiple-views]
...
image::slide-in-effect.gif[slide-in-effect]
...
image::rotation_origin_x_y.gif[rotation_origin_x_y]
