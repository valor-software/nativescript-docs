...
image::default_app_resources_android.png[Default App_Resources on Android]
...
image::custom_action_bar_color.png[]
...
image::custom_status_bar_color.png[]
...
image::action_bar_under_status_bar.png[]
...
image::date_picker_calendar_mode.png[]
...
image::time_picker_clock_mode.png[]
...
image::android_force_dark_mode.png[]
