= How to contribute to Nativecript Docs
:imagesdir: assets
:toc:
...
image:issue-templates.png[NativeScript Docs issue templates]
...
Everyone is welcome to tackle an https://github.com/omfgnuts/nativescript-docs/issues[open issue] and create a pull request to solve it.
...
. *Fork `nativescript-docs`:* To start, you first need to https://help.github.com/en/github/getting-started-with-github/fork-a-repo#fork-an-example-repository[fork] the `nativescript-docs` repository.
