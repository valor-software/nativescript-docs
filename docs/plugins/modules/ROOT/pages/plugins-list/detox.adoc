= https://github.com/NativeScript/plugins/tree/main/packages/detox[Detox]
...
Dependending on your setup iOS may not be able to communicate with Detox off the bat.
...
Nearly all of the things specified towards React Native apps also apply to NativeScript apps.
...
*NOTE:* If using an Android emulator, Detox will disable animations when the tests are ran.
