= https://github.com/NativeScript/plugins/tree/main/packages/imagepicker[Image Picker]
...
[NOTE]
====
Using the plugin on iOS requres photo library permission.
...
The default message "Requires access to photo library." might not be enough for the App Store reviewers.
...
* create(options) - creates instance of the imagepicker.
