...
Realtime Database Cloud Storage Cloud Functions (callable functions) The https://firebase.google.com/docs/app-check[official Firebase App Check documentation] has more information, including about the iOS AppAttest provider, and testing/ CI integration, it is worth a read.
...
App Check has an "tokenAutoRefreshEnabled" setting.
