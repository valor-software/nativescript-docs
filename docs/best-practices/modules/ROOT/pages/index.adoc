...
Over the years, several distinct best practices have emerged when working with NativeScript, and we'd like to outline a few here for you in hope that you can enjoy NativeScripting as much as we do.
More importantly though, that your end product gives you all the right _feels_ you expect.

We are providing a sample "vanilla" NativeScript app which shows some bad vs.
