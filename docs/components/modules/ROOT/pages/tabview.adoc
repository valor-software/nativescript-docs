...
For more information about how to control the size of icons, see https://docs.nativescript.org/ui/image-resources[Working with image from resource folders].
====
