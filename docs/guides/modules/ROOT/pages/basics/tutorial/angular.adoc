...
[source%linenums,typescript{9,12-15}]
----
...
Since we have an array of flicks to display we can use NativeScript's xref:components::listview.adoc[`ListView`] component.
...
[source%linenums,typescript{6,15,19}]
----
// src/app/features/home/home.component.ts
...
[source%linenums,html,highlight=2..5]
----
<!-- src/app/features/home/home.component.html -->
