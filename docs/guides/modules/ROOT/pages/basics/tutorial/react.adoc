...
[source%linenums,tsx{17-19,24-26}]
----
// src/components/Navigator.tsx
...
[source%linenums,tsx{12,22-24,28-33}]
----
// src/components/HomeScreen.tsx
...
[source%linenums,typescript{6-8}]
----
// src/components/NavigationParamList.ts
